 ...
 * Submissions
 */
@ApiModel(description = "Submissions")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FormsSubmissionAttributes {
  ...
  public FormsSubmissionAttributes() {
  }

  public FormsSubmissionAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Submission ID")
  ...
  public FormsSubmissionAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Submission public ID")
  ...
  public FormsSubmissionAttributes formId(Integer formId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "7", required = true, value = "Form ID")
  ...
  public FormsSubmissionAttributes contactId(Object contactId) {
  ...
  **/
  ...
  public FormsSubmissionAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FormsSubmissionAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the FormsSubmissionAttributes instance itself
   */
  public FormsSubmissionAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionAttributes formsSubmissionAttributes = (FormsSubmissionAttributes) o;
    return Objects.equals(this.id, formsSubmissionAttributes.id) &&
        Objects.equals(this.publicId, formsSubmissionAttributes.publicId) &&
        Objects.equals(this.formId, formsSubmissionAttributes.formId) &&
        Objects.equals(this.contactId, formsSubmissionAttributes.contactId) &&
        Objects.equals(this.createdAt, formsSubmissionAttributes.createdAt) &&
        Objects.equals(this.updatedAt, formsSubmissionAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, formsSubmissionAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, formId, contactId, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsSubmissionAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionAttributes is not found in the empty JSON string", FormsSubmissionAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsSubmissionAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionAttributes>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionAttributes value) throws IOException {
           ...
           @Override
           public FormsSubmissionAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionAttributes
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionAttributes
  */
  public static FormsSubmissionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionAttributes.class);
  }

 /**
  * Convert an instance of FormsSubmissionAttributes to an JSON string
  *
  * @return JSON string
  */
