...
public class CoursesLessonParameters {
  ...
  public CoursesLessonParameters() {
  }

  public CoursesLessonParameters title(String title) {
  ...
  **/
  ...
  public CoursesLessonParameters body(Object body) {
  ...
  **/
   ...
   * @return the CoursesLessonParameters instance itself
   */
  public CoursesLessonParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesLessonParameters coursesLessonParameters = (CoursesLessonParameters) o;
    return Objects.equals(this.title, coursesLessonParameters.title) &&
        Objects.equals(this.body, coursesLessonParameters.body)&&
        Objects.equals(this.additionalProperties, coursesLessonParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, body, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesLessonParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesLessonParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesLessonParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesLessonParameters is not found in the empty JSON string", CoursesLessonParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoursesLessonParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesLessonParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesLessonParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesLessonParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesLessonParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesLessonParameters>() {
           @Override
           public void write(JsonWriter out, CoursesLessonParameters value) throws IOException {
           ...
           @Override
           public CoursesLessonParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesLessonParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesLessonParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesLessonParameters
  * @throws IOException if the JSON string is invalid with respect to CoursesLessonParameters
  */
  public static CoursesLessonParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesLessonParameters.class);
  }

 /**
  * Convert an instance of CoursesLessonParameters to an JSON string
  *
  * @return JSON string
  */
