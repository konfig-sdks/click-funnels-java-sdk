...
public class TeamParameters {
  ...
  public TeamParameters name(String name) {
  ...
  **/
  ...
  public TeamParameters timeZone(Object timeZone) {
  ...
  **/
  ...
  public TeamParameters locale(Object locale) {
  ...
  **/
   ...
   * @return the TeamParameters instance itself
   */
  public TeamParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamParameters teamParameters = (TeamParameters) o;
    return Objects.equals(this.name, teamParameters.name) &&
        Objects.equals(this.timeZone, teamParameters.timeZone) &&
        Objects.equals(this.locale, teamParameters.locale)&&
        Objects.equals(this.additionalProperties, teamParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, timeZone, locale, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamParameters is not found in the empty JSON string", TeamParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamParameters>() {
           @Override
           public void write(JsonWriter out, TeamParameters value) throws IOException {
           ...
           @Override
           public TeamParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamParameters
  * @throws IOException if the JSON string is invalid with respect to TeamParameters
  */
  public static TeamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamParameters.class);
  }

 /**
  * Convert an instance of TeamParameters to an JSON string
  *
  * @return JSON string
  */
