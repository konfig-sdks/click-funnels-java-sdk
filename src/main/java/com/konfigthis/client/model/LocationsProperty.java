...
public class LocationsProperty {
  ...
  public LocationsProperty() {
  }

  public LocationsProperty addressOne(Object addressOne) {
  ...
  **/
  ...
  public void setAddressOne(Object addressOne) {
  ...
  public LocationsProperty addressTwo(Object addressTwo) {
  ...
  **/
  ...
  public LocationsProperty city(Object city) {
  ...
  **/
  ...
  public LocationsProperty region(Object region) {
  ...
  **/
  ...
  public LocationsProperty country(Object country) {
  ...
  **/
   ...
   * @return the LocationsProperty instance itself
   */
  public LocationsProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LocationsProperty locationsProperty = (LocationsProperty) o;
    return Objects.equals(this.addressOne, locationsProperty.addressOne) &&
        Objects.equals(this.addressTwo, locationsProperty.addressTwo) &&
        Objects.equals(this.city, locationsProperty.city) &&
        Objects.equals(this.region, locationsProperty.region) &&
        Objects.equals(this.country, locationsProperty.country)&&
        Objects.equals(this.additionalProperties, locationsProperty.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressOne, addressTwo, city, region, country, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LocationsProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationsProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationsProperty is not found in the empty JSON string", LocationsProperty.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationsProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationsProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationsProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationsProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationsProperty>() {
           @Override
           public void write(JsonWriter out, LocationsProperty value) throws IOException {
           ...
           @Override
           public LocationsProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LocationsProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LocationsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationsProperty
  * @throws IOException if the JSON string is invalid with respect to LocationsProperty
  */
  public static LocationsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationsProperty.class);
  }

 /**
  * Convert an instance of LocationsProperty to an JSON string
  *
  * @return JSON string
  */
