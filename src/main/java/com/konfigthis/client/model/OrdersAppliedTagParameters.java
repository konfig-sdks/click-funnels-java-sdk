...
public class OrdersAppliedTagParameters {
  public static final String SERIALIZED_NAME_TAG_ID = "tag_id";
  @SerializedName(SERIALIZED_NAME_TAG_ID)
  private Integer tagId;

  public OrdersAppliedTagParameters() {
  }

  public OrdersAppliedTagParameters tagId(Integer tagId) {
  ...
  **/
   ...
   * @return the OrdersAppliedTagParameters instance itself
   */
  public OrdersAppliedTagParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersAppliedTagParameters ordersAppliedTagParameters = (OrdersAppliedTagParameters) o;
    return Objects.equals(this.tagId, ordersAppliedTagParameters.tagId)&&
        Objects.equals(this.additionalProperties, ordersAppliedTagParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersAppliedTagParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersAppliedTagParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersAppliedTagParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersAppliedTagParameters is not found in the empty JSON string", OrdersAppliedTagParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersAppliedTagParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersAppliedTagParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersAppliedTagParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersAppliedTagParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersAppliedTagParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersAppliedTagParameters>() {
           @Override
           public void write(JsonWriter out, OrdersAppliedTagParameters value) throws IOException {
           ...
           @Override
           public OrdersAppliedTagParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersAppliedTagParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersAppliedTagParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersAppliedTagParameters
  * @throws IOException if the JSON string is invalid with respect to OrdersAppliedTagParameters
  */
  public static OrdersAppliedTagParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersAppliedTagParameters.class);
  }

 /**
  * Convert an instance of OrdersAppliedTagParameters to an JSON string
  *
  * @return JSON string
  */
