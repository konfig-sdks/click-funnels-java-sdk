...
public class FormsSubmissionsAnswerParameters {
  ...
  public FormsSubmissionsAnswerParameters() {
  }

  public FormsSubmissionsAnswerParameters fieldId(Integer fieldId) {
  ...
  **/
  ...
  public FormsSubmissionsAnswerParameters fieldsOptionId(Object fieldsOptionId) {
  ...
  **/
  ...
  public FormsSubmissionsAnswerParameters entry(Object entry) {
  ...
  **/
  ...
  public FormsSubmissionsAnswerParameters fieldsOptionIds(Object fieldsOptionIds) {
  ...
  **/
   ...
   * @return the FormsSubmissionsAnswerParameters instance itself
   */
  public FormsSubmissionsAnswerParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionsAnswerParameters formsSubmissionsAnswerParameters = (FormsSubmissionsAnswerParameters) o;
    return Objects.equals(this.fieldId, formsSubmissionsAnswerParameters.fieldId) &&
        Objects.equals(this.fieldsOptionId, formsSubmissionsAnswerParameters.fieldsOptionId) &&
        Objects.equals(this.entry, formsSubmissionsAnswerParameters.entry) &&
        Objects.equals(this.fieldsOptionIds, formsSubmissionsAnswerParameters.fieldsOptionIds)&&
        Objects.equals(this.additionalProperties, formsSubmissionsAnswerParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fieldId, fieldsOptionId, entry, fieldsOptionIds, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsSubmissionsAnswerParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionsAnswerParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionsAnswerParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionsAnswerParameters is not found in the empty JSON string", FormsSubmissionsAnswerParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsSubmissionsAnswerParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionsAnswerParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionsAnswerParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionsAnswerParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionsAnswerParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionsAnswerParameters>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionsAnswerParameters value) throws IOException {
           ...
           @Override
           public FormsSubmissionsAnswerParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionsAnswerParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionsAnswerParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionsAnswerParameters
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionsAnswerParameters
  */
  public static FormsSubmissionsAnswerParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionsAnswerParameters.class);
  }

 /**
  * Convert an instance of FormsSubmissionsAnswerParameters to an JSON string
  *
  * @return JSON string
  */
