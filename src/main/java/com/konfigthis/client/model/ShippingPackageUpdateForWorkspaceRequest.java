...
import com.konfigthis.client.model.ShippingPackageParameters;
...
public class ShippingPackageUpdateForWorkspaceRequest {
  public static final String SERIALIZED_NAME_SHIPPING_PACKAGE = "shipping_package";
  @SerializedName(SERIALIZED_NAME_SHIPPING_PACKAGE)
  private ShippingPackageParameters shippingPackage;

  public ShippingPackageUpdateForWorkspaceRequest() {
  }

  public ShippingPackageUpdateForWorkspaceRequest shippingPackage(ShippingPackageParameters shippingPackage) {
  ...
  **/
  ...
  public ShippingPackageParameters getShippingPackage() {
    return shippingPackage;
  }


  public void setShippingPackage(ShippingPackageParameters shippingPackage) {
   ...
   * @return the ShippingPackageUpdateForWorkspaceRequest instance itself
   */
  public ShippingPackageUpdateForWorkspaceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingPackageUpdateForWorkspaceRequest shippingPackageUpdateForWorkspaceRequest = (ShippingPackageUpdateForWorkspaceRequest) o;
    return Objects.equals(this.shippingPackage, shippingPackageUpdateForWorkspaceRequest.shippingPackage)&&
        Objects.equals(this.additionalProperties, shippingPackageUpdateForWorkspaceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shippingPackage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShippingPackageUpdateForWorkspaceRequest {\n");
    sb.append("    shippingPackage: ").append(toIndentedString(shippingPackage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("shipping_package");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingPackageUpdateForWorkspaceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingPackageUpdateForWorkspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingPackageUpdateForWorkspaceRequest is not found in the empty JSON string", ShippingPackageUpdateForWorkspaceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingPackageUpdateForWorkspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingPackageUpdateForWorkspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingPackageUpdateForWorkspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingPackageUpdateForWorkspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingPackageUpdateForWorkspaceRequest>() {
           @Override
           public void write(JsonWriter out, ShippingPackageUpdateForWorkspaceRequest value) throws IOException {
           ...
           @Override
           public ShippingPackageUpdateForWorkspaceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingPackageUpdateForWorkspaceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingPackageUpdateForWorkspaceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingPackageUpdateForWorkspaceRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingPackageUpdateForWorkspaceRequest
  */
  public static ShippingPackageUpdateForWorkspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingPackageUpdateForWorkspaceRequest.class);
  }

 /**
  * Convert an instance of ShippingPackageUpdateForWorkspaceRequest to an JSON string
  *
  * @return JSON string
  */
