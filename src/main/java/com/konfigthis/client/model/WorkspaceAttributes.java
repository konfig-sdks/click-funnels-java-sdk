 ...
 * Workspaces
 */
@ApiModel(description = "Workspaces")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkspaceAttributes {
  ...
  public WorkspaceAttributes() {
  }

  public WorkspaceAttributes id(Integer id) {
  ...
  **/
  ...
  public WorkspaceAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Workspace public ID")
  ...
  public WorkspaceAttributes teamId(Integer teamId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "42", required = true, value = "Team ID")
  ...
  public WorkspaceAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Workspace", required = true, value = "Workspace name")
  ...
  public WorkspaceAttributes subdomain(String subdomain) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "example", required = true, value = "Subdomain")
  ...
  public WorkspaceAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public WorkspaceAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the WorkspaceAttributes instance itself
   */
  public WorkspaceAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkspaceAttributes workspaceAttributes = (WorkspaceAttributes) o;
    return Objects.equals(this.id, workspaceAttributes.id) &&
        Objects.equals(this.publicId, workspaceAttributes.publicId) &&
        Objects.equals(this.teamId, workspaceAttributes.teamId) &&
        Objects.equals(this.name, workspaceAttributes.name) &&
        Objects.equals(this.subdomain, workspaceAttributes.subdomain) &&
        Objects.equals(this.createdAt, workspaceAttributes.createdAt) &&
        Objects.equals(this.updatedAt, workspaceAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, workspaceAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, teamId, name, subdomain, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkspaceAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkspaceAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkspaceAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkspaceAttributes is not found in the empty JSON string", WorkspaceAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkspaceAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkspaceAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkspaceAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkspaceAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkspaceAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkspaceAttributes>() {
           @Override
           public void write(JsonWriter out, WorkspaceAttributes value) throws IOException {
           ...
           @Override
           public WorkspaceAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkspaceAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkspaceAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkspaceAttributes
  * @throws IOException if the JSON string is invalid with respect to WorkspaceAttributes
  */
  public static WorkspaceAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkspaceAttributes.class);
  }

 /**
  * Convert an instance of WorkspaceAttributes to an JSON string
  *
  * @return JSON string
  */
