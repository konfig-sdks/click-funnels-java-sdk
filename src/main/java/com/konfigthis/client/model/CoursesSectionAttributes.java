 ...
 * Modules
 */
@ApiModel(description = "Modules")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CoursesSectionAttributes {
  ...
  public static final String SERIALIZED_NAME_DAYS_TILL_DRIP_ACCESS = "days_till_drip_access";
  @SerializedName(SERIALIZED_NAME_DAYS_TILL_DRIP_ACCESS)
  private Object daysTillDripAccess = null;

  public static final String SERIALIZED_NAME_BLOCKER_SECTION_ID = "blocker_section_id";
  @SerializedName(SERIALIZED_NAME_BLOCKER_SECTION_ID)
  private Object blockerSectionId = null;

  public static final String SERIALIZED_NAME_BLOCKER_LESSON_ID = "blocker_lesson_id";
  @SerializedName(SERIALIZED_NAME_BLOCKER_LESSON_ID)
  private String blockerLessonId;
  ...
  public static final String SERIALIZED_NAME_IS_HIDDEN_FROM_NON_MEMBERS = "is_hidden_from_non_members";
  @SerializedName(SERIALIZED_NAME_IS_HIDDEN_FROM_NON_MEMBERS)
  private Object isHiddenFromNonMembers = null;
  ...
  public CoursesSectionAttributes() {
  }

  public CoursesSectionAttributes title(String title) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Module 1", required = true, value = "Title")
  ...
  public CoursesSectionAttributes description(Object description) {
  ...
  **/
  ...
  public CoursesSectionAttributes id(String id) {
  ...
  **/
  ...
  public CoursesSectionAttributes publicId(Object publicId) {
  ...
  **/
  ...
  public CoursesSectionAttributes courseId(String courseId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Course ID")
  ...
  public CoursesSectionAttributes publishedAt(Object publishedAt) {
  ...
  **/
  ...
  public CoursesSectionAttributes daysTillDripAccess(Object daysTillDripAccess) {
    
    
    
    
    this.daysTillDripAccess = daysTillDripAccess;
    return this;
  }

   /**
   * Days until drip access
   * @return daysTillDripAccess
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Days until drip access")

  public Object getDaysTillDripAccess() {
    return daysTillDripAccess;
  }


  public void setDaysTillDripAccess(Object daysTillDripAccess) {
  ...
  public CoursesSectionAttributes blockerSectionId(Object blockerSectionId) {
    
    
    
    
    this.blockerSectionId = blockerSectionId;
    return this;
  }

   /**
   * Blocker section
   * @return blockerSectionId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Blocker section")

  public Object getBlockerSectionId() {
    return blockerSectionId;
  }


  public void setBlockerSectionId(Object blockerSectionId) {
  ...
  public CoursesSectionAttributes blockerLessonId(String blockerLessonId) {
    
    
    
    
    this.blockerLessonId = blockerLessonId;
    return this;
  }

   /**
   * Blocker lesson
   * @return blockerLessonId
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Blocker lesson")

  public String getBlockerLessonId() {
    return blockerLessonId;
  }


  public void setBlockerLessonId(String blockerLessonId) {
  ...
  public CoursesSectionAttributes currentPath(Object currentPath) {
  ...
  **/
  ...
  public CoursesSectionAttributes isHiddenFromNonMembers(Object isHiddenFromNonMembers) {
    
    
    
    
    this.isHiddenFromNonMembers = isHiddenFromNonMembers;
    return this;
  }

   /**
   * Current Path
   * @return isHiddenFromNonMembers
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Current Path")

  public Object getIsHiddenFromNonMembers() {
    return isHiddenFromNonMembers;
  }


  public void setIsHiddenFromNonMembers(Object isHiddenFromNonMembers) {
  ...
  public CoursesSectionAttributes upgradeUrl(Object upgradeUrl) {
  ...
  **/
  ...
  public CoursesSectionAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public CoursesSectionAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the CoursesSectionAttributes instance itself
   */
  public CoursesSectionAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesSectionAttributes coursesSectionAttributes = (CoursesSectionAttributes) o;
    return Objects.equals(this.title, coursesSectionAttributes.title) &&
        Objects.equals(this.description, coursesSectionAttributes.description) &&
        Objects.equals(this.id, coursesSectionAttributes.id) &&
        Objects.equals(this.publicId, coursesSectionAttributes.publicId) &&
        Objects.equals(this.courseId, coursesSectionAttributes.courseId) &&
        Objects.equals(this.publishedAt, coursesSectionAttributes.publishedAt) &&
        Objects.equals(this.daysTillDripAccess, coursesSectionAttributes.daysTillDripAccess) &&
        Objects.equals(this.blockerSectionId, coursesSectionAttributes.blockerSectionId) &&
        Objects.equals(this.blockerLessonId, coursesSectionAttributes.blockerLessonId) &&
        Objects.equals(this.currentPath, coursesSectionAttributes.currentPath) &&
        Objects.equals(this.isHiddenFromNonMembers, coursesSectionAttributes.isHiddenFromNonMembers) &&
        Objects.equals(this.upgradeUrl, coursesSectionAttributes.upgradeUrl) &&
        Objects.equals(this.createdAt, coursesSectionAttributes.createdAt) &&
        Objects.equals(this.updatedAt, coursesSectionAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, coursesSectionAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, id, publicId, courseId, publishedAt, daysTillDripAccess, blockerSectionId, blockerLessonId, currentPath, isHiddenFromNonMembers, upgradeUrl, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesSectionAttributes {\n");
    ...
    sb.append("    daysTillDripAccess: ").append(toIndentedString(daysTillDripAccess)).append("\n");
    sb.append("    blockerSectionId: ").append(toIndentedString(blockerSectionId)).append("\n");
    sb.append("    blockerLessonId: ").append(toIndentedString(blockerLessonId)).append("\n");
    sb.append("    currentPath: ").append(toIndentedString(currentPath)).append("\n");
    sb.append("    isHiddenFromNonMembers: ").append(toIndentedString(isHiddenFromNonMembers)).append("\n");
  ...
  static {
    ...
    openapiFields.add("days_till_drip_access");
    openapiFields.add("blocker_section_id");
    openapiFields.add("blocker_lesson_id");
    openapiFields.add("current_path");
    openapiFields.add("is_hidden_from_non_members");
    ...
    openapiRequiredFields.add("course_id");
    openapiRequiredFields.add("blocker_lesson_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesSectionAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesSectionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesSectionAttributes is not found in the empty JSON string", CoursesSectionAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoursesSectionAttributes.openapiRequiredFields) {
      ...
      if (!jsonObj.get("course_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `course_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("course_id").toString()));
      }
      if (!jsonObj.get("blocker_lesson_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `blocker_lesson_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("blocker_lesson_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesSectionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesSectionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesSectionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesSectionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesSectionAttributes>() {
           @Override
           public void write(JsonWriter out, CoursesSectionAttributes value) throws IOException {
           ...
           @Override
           public CoursesSectionAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesSectionAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesSectionAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesSectionAttributes
  * @throws IOException if the JSON string is invalid with respect to CoursesSectionAttributes
  */
  public static CoursesSectionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesSectionAttributes.class);
  }

 /**
  * Convert an instance of CoursesSectionAttributes to an JSON string
  *
  * @return JSON string
  */
