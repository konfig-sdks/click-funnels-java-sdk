...
public class LineItemsProperty1 {
  ...
  public LineItemsProperty1() {
  }

  public LineItemsProperty1 description(Object description) {
  ...
  **/
  ...
  public LineItemsProperty1 id(Integer id) {
  ...
  **/
  ...
  public LineItemsProperty1 name(Object name) {
  ...
  **/
  ...
  public LineItemsProperty1 sku(Object sku) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The SKU of the line item")
   ...
   * @return the LineItemsProperty1 instance itself
   */
  public LineItemsProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LineItemsProperty1 lineItemsProperty1 = (LineItemsProperty1) o;
    return Objects.equals(this.description, lineItemsProperty1.description) &&
        Objects.equals(this.id, lineItemsProperty1.id) &&
        Objects.equals(this.name, lineItemsProperty1.name) &&
        Objects.equals(this.sku, lineItemsProperty1.sku)&&
        Objects.equals(this.additionalProperties, lineItemsProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LineItemsProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LineItemsProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LineItemsProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineItemsProperty1 is not found in the empty JSON string", LineItemsProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LineItemsProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineItemsProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineItemsProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineItemsProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineItemsProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<LineItemsProperty1>() {
           @Override
           public void write(JsonWriter out, LineItemsProperty1 value) throws IOException {
           ...
           @Override
           public LineItemsProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LineItemsProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LineItemsProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LineItemsProperty1
  * @throws IOException if the JSON string is invalid with respect to LineItemsProperty1
  */
  public static LineItemsProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineItemsProperty1.class);
  }

 /**
  * Convert an instance of LineItemsProperty1 to an JSON string
  *
  * @return JSON string
  */
