...
public class CoursesEnrollmentParameters {
  ...
  public CoursesEnrollmentParameters() {
  }

  public CoursesEnrollmentParameters contactId(Integer contactId) {
  ...
  **/
  ...
  public CoursesEnrollmentParameters suspended(Object suspended) {
  ...
  **/
  ...
  public CoursesEnrollmentParameters suspensionReason(Object suspensionReason) {
  ...
  **/
   ...
   * @return the CoursesEnrollmentParameters instance itself
   */
  public CoursesEnrollmentParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesEnrollmentParameters coursesEnrollmentParameters = (CoursesEnrollmentParameters) o;
    return Objects.equals(this.contactId, coursesEnrollmentParameters.contactId) &&
        Objects.equals(this.suspended, coursesEnrollmentParameters.suspended) &&
        Objects.equals(this.suspensionReason, coursesEnrollmentParameters.suspensionReason)&&
        Objects.equals(this.additionalProperties, coursesEnrollmentParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contactId, suspended, suspensionReason, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesEnrollmentParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesEnrollmentParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesEnrollmentParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesEnrollmentParameters is not found in the empty JSON string", CoursesEnrollmentParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoursesEnrollmentParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesEnrollmentParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesEnrollmentParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesEnrollmentParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesEnrollmentParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesEnrollmentParameters>() {
           @Override
           public void write(JsonWriter out, CoursesEnrollmentParameters value) throws IOException {
           ...
           @Override
           public CoursesEnrollmentParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesEnrollmentParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesEnrollmentParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesEnrollmentParameters
  * @throws IOException if the JSON string is invalid with respect to CoursesEnrollmentParameters
  */
  public static CoursesEnrollmentParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesEnrollmentParameters.class);
  }

 /**
  * Convert an instance of CoursesEnrollmentParameters to an JSON string
  *
  * @return JSON string
  */
