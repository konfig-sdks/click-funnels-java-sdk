 ...
 * Object Data
 */
@ApiModel(description = "Object Data")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebhooksOutgoingEventAttributesData {
  ...
  public WebhooksOutgoingEventAttributesData() {
  }

  public WebhooksOutgoingEventAttributesData example(String example) {
  ...
  **/
  ...
  @ApiModelProperty(value = "{ \"event_type_name\": \"order.created\", \"payload\": { \"order_id\": 123, \"order_number\": \"12345\" } }")
  ...
  public WebhooksOutgoingEventAttributesData xKonfigOriginalExample(String xKonfigOriginalExample) {
  ...
  **/
   ...
   * @return the WebhooksOutgoingEventAttributesData instance itself
   */
  public WebhooksOutgoingEventAttributesData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOutgoingEventAttributesData webhooksOutgoingEventAttributesData = (WebhooksOutgoingEventAttributesData) o;
    return Objects.equals(this.example, webhooksOutgoingEventAttributesData.example) &&
        Objects.equals(this.xKonfigOriginalExample, webhooksOutgoingEventAttributesData.xKonfigOriginalExample)&&
        Objects.equals(this.additionalProperties, webhooksOutgoingEventAttributesData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(example, xKonfigOriginalExample, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhooksOutgoingEventAttributesData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksOutgoingEventAttributesData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksOutgoingEventAttributesData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksOutgoingEventAttributesData is not found in the empty JSON string", WebhooksOutgoingEventAttributesData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksOutgoingEventAttributesData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksOutgoingEventAttributesData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksOutgoingEventAttributesData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksOutgoingEventAttributesData.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksOutgoingEventAttributesData>() {
           @Override
           public void write(JsonWriter out, WebhooksOutgoingEventAttributesData value) throws IOException {
           ...
           @Override
           public WebhooksOutgoingEventAttributesData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksOutgoingEventAttributesData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksOutgoingEventAttributesData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksOutgoingEventAttributesData
  * @throws IOException if the JSON string is invalid with respect to WebhooksOutgoingEventAttributesData
  */
  public static WebhooksOutgoingEventAttributesData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksOutgoingEventAttributesData.class);
  }

 /**
  * Convert an instance of WebhooksOutgoingEventAttributesData to an JSON string
  *
  * @return JSON string
  */
