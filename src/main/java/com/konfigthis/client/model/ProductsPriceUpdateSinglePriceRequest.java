...
public class ProductsPriceUpdateSinglePriceRequest {
  ...
  public ProductsPriceUpdateSinglePriceRequest() {
  }

  public ProductsPriceUpdateSinglePriceRequest productsPrice(ProductsPriceParameters productsPrice) {
  ...
  **/
   ...
   * @return the ProductsPriceUpdateSinglePriceRequest instance itself
   */
  public ProductsPriceUpdateSinglePriceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest = (ProductsPriceUpdateSinglePriceRequest) o;
    return Objects.equals(this.productsPrice, productsPriceUpdateSinglePriceRequest.productsPrice)&&
        Objects.equals(this.additionalProperties, productsPriceUpdateSinglePriceRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsPriceUpdateSinglePriceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsPriceUpdateSinglePriceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsPriceUpdateSinglePriceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsPriceUpdateSinglePriceRequest is not found in the empty JSON string", ProductsPriceUpdateSinglePriceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsPriceUpdateSinglePriceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsPriceUpdateSinglePriceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsPriceUpdateSinglePriceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsPriceUpdateSinglePriceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsPriceUpdateSinglePriceRequest>() {
           @Override
           public void write(JsonWriter out, ProductsPriceUpdateSinglePriceRequest value) throws IOException {
           ...
           @Override
           public ProductsPriceUpdateSinglePriceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsPriceUpdateSinglePriceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsPriceUpdateSinglePriceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsPriceUpdateSinglePriceRequest
  * @throws IOException if the JSON string is invalid with respect to ProductsPriceUpdateSinglePriceRequest
  */
  public static ProductsPriceUpdateSinglePriceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsPriceUpdateSinglePriceRequest.class);
  }

 /**
  * Convert an instance of ProductsPriceUpdateSinglePriceRequest to an JSON string
  *
  * @return JSON string
  */
