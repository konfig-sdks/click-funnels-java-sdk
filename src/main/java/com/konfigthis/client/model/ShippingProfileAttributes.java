 ...
 * Profiles
 */
@ApiModel(description = "Profiles")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ShippingProfileAttributes {
  ...
  public ShippingProfileAttributes() {
  }

  public ShippingProfileAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", required = true, value = "Profile ID")
  ...
  public ShippingProfileAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Profile public ID")
  ...
  public ShippingProfileAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Shipping Profile", required = true, value = "Name")
  ...
  public ShippingProfileAttributes variantIds(Object variantIds) {
  ...
  **/
  ...
  public ShippingProfileAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ShippingProfileAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ShippingProfileAttributes instance itself
   */
  public ShippingProfileAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingProfileAttributes shippingProfileAttributes = (ShippingProfileAttributes) o;
    return Objects.equals(this.id, shippingProfileAttributes.id) &&
        Objects.equals(this.publicId, shippingProfileAttributes.publicId) &&
        Objects.equals(this.name, shippingProfileAttributes.name) &&
        Objects.equals(this.variantIds, shippingProfileAttributes.variantIds) &&
        Objects.equals(this.createdAt, shippingProfileAttributes.createdAt) &&
        Objects.equals(this.updatedAt, shippingProfileAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, shippingProfileAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, name, variantIds, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingProfileAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingProfileAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingProfileAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingProfileAttributes is not found in the empty JSON string", ShippingProfileAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingProfileAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingProfileAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingProfileAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingProfileAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingProfileAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingProfileAttributes>() {
           @Override
           public void write(JsonWriter out, ShippingProfileAttributes value) throws IOException {
           ...
           @Override
           public ShippingProfileAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingProfileAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingProfileAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingProfileAttributes
  * @throws IOException if the JSON string is invalid with respect to ShippingProfileAttributes
  */
  public static ShippingProfileAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingProfileAttributes.class);
  }

 /**
  * Convert an instance of ShippingProfileAttributes to an JSON string
  *
  * @return JSON string
  */
