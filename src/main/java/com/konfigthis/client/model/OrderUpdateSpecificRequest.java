...
import com.konfigthis.client.model.OrderParameters;
...
public class OrderUpdateSpecificRequest {
  public static final String SERIALIZED_NAME_ORDER = "order";
  @SerializedName(SERIALIZED_NAME_ORDER)
  private OrderParameters order;

  public OrderUpdateSpecificRequest() {
  }

  public OrderUpdateSpecificRequest order(OrderParameters order) {
  ...
  **/
  ...
  public OrderParameters getOrder() {
    return order;
  }


  public void setOrder(OrderParameters order) {
   ...
   * @return the OrderUpdateSpecificRequest instance itself
   */
  public OrderUpdateSpecificRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderUpdateSpecificRequest orderUpdateSpecificRequest = (OrderUpdateSpecificRequest) o;
    return Objects.equals(this.order, orderUpdateSpecificRequest.order)&&
        Objects.equals(this.additionalProperties, orderUpdateSpecificRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderUpdateSpecificRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderUpdateSpecificRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderUpdateSpecificRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderUpdateSpecificRequest is not found in the empty JSON string", OrderUpdateSpecificRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderUpdateSpecificRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderUpdateSpecificRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderUpdateSpecificRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderUpdateSpecificRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderUpdateSpecificRequest>() {
           @Override
           public void write(JsonWriter out, OrderUpdateSpecificRequest value) throws IOException {
           ...
           @Override
           public OrderUpdateSpecificRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderUpdateSpecificRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderUpdateSpecificRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderUpdateSpecificRequest
  * @throws IOException if the JSON string is invalid with respect to OrderUpdateSpecificRequest
  */
  public static OrderUpdateSpecificRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderUpdateSpecificRequest.class);
  }

 /**
  * Convert an instance of OrderUpdateSpecificRequest to an JSON string
  *
  * @return JSON string
  */
