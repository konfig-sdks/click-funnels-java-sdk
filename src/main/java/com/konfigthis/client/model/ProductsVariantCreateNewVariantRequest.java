...
import com.konfigthis.client.model.ProductsVariantParameters;
...
public class ProductsVariantCreateNewVariantRequest {
  ...
  public ProductsVariantCreateNewVariantRequest() {
  }

  public ProductsVariantCreateNewVariantRequest productsVariant(ProductsVariantParameters productsVariant) {
  ...
  **/
  ...
  public ProductsVariantParameters getProductsVariant() {
    return productsVariant;
  }


  public void setProductsVariant(ProductsVariantParameters productsVariant) {
   ...
   * @return the ProductsVariantCreateNewVariantRequest instance itself
   */
  public ProductsVariantCreateNewVariantRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest = (ProductsVariantCreateNewVariantRequest) o;
    return Objects.equals(this.productsVariant, productsVariantCreateNewVariantRequest.productsVariant)&&
        Objects.equals(this.additionalProperties, productsVariantCreateNewVariantRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productsVariant, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductsVariantCreateNewVariantRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsVariantCreateNewVariantRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsVariantCreateNewVariantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsVariantCreateNewVariantRequest is not found in the empty JSON string", ProductsVariantCreateNewVariantRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsVariantCreateNewVariantRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsVariantCreateNewVariantRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsVariantCreateNewVariantRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsVariantCreateNewVariantRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsVariantCreateNewVariantRequest>() {
           @Override
           public void write(JsonWriter out, ProductsVariantCreateNewVariantRequest value) throws IOException {
           ...
           @Override
           public ProductsVariantCreateNewVariantRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsVariantCreateNewVariantRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsVariantCreateNewVariantRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsVariantCreateNewVariantRequest
  * @throws IOException if the JSON string is invalid with respect to ProductsVariantCreateNewVariantRequest
  */
  public static ProductsVariantCreateNewVariantRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsVariantCreateNewVariantRequest.class);
  }

 /**
  * Convert an instance of ProductsVariantCreateNewVariantRequest to an JSON string
  *
  * @return JSON string
  */
