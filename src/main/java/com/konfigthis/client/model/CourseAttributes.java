 ...
 * Courses
 */
@ApiModel(description = "Courses")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CourseAttributes {
  ...
  public static final String SERIALIZED_NAME_ROOT_SECTION_ID = "root_section_id";
  @SerializedName(SERIALIZED_NAME_ROOT_SECTION_ID)
  private Object rootSectionId = null;
  ...
  public static final String SERIALIZED_NAME_SHARING_FINGERPRINT = "sharing_fingerprint";
  @SerializedName(SERIALIZED_NAME_SHARING_FINGERPRINT)
  private Object sharingFingerprint = null;

  public static final String SERIALIZED_NAME_SHOW_IN_COMMUNITY = "show_in_community";
  @SerializedName(SERIALIZED_NAME_SHOW_IN_COMMUNITY)
  private Object showInCommunity = null;

  public static final String SERIALIZED_NAME_SHOW_TO_NON_MEMBERS = "show_to_non_members";
  @SerializedName(SERIALIZED_NAME_SHOW_TO_NON_MEMBERS)
  private Object showToNonMembers = null;

  public static final String SERIALIZED_NAME_UPGRADE_URL = "upgrade_url";
  @SerializedName(SERIALIZED_NAME_UPGRADE_URL)
  private Object upgradeUrl = null;

  public static final String SERIALIZED_NAME_REDIRECT_TO_FULL_COURSE = "redirect_to_full_course";
  @SerializedName(SERIALIZED_NAME_REDIRECT_TO_FULL_COURSE)
  private Object redirectToFullCourse = null;

  public static final String SERIALIZED_NAME_UNAUTHORIZED_REDIRECT_URL = "unauthorized_redirect_url";
  @SerializedName(SERIALIZED_NAME_UNAUTHORIZED_REDIRECT_URL)
  private Object unauthorizedRedirectUrl = null;

  public static final String SERIALIZED_NAME_COMMENTS_ENABLED = "comments_enabled";
  @SerializedName(SERIALIZED_NAME_COMMENTS_ENABLED)
  private Object commentsEnabled = null;
  ...
  public CourseAttributes title(String title) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Example Course", required = true, value = "Title")
  ...
  public CourseAttributes description(String description) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Assumenda nihil beatae. Dignissimos omnis ut. Non voluptatem laboriosam.", required = true, value = "Description")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Course ID")
  ...
  public CourseAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Course public ID")
  ...
  public CourseAttributes publishedAt(Object publishedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Available at")
  ...
  public CourseAttributes rootSectionId(Object rootSectionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Root section")

  public Object getRootSectionId() {
    return rootSectionId;
  }


  public void setRootSectionId(Object rootSectionId) {
  ...
  public CourseAttributes currentPath(Object currentPath) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Course Path URL")
  ...
  public CourseAttributes sharingFingerprint(Object sharingFingerprint) {
    
    
    
    
    this.sharingFingerprint = sharingFingerprint;
    return this;
  }

   /**
   * Sharing Fingerprint
   * @return sharingFingerprint
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Sharing Fingerprint")

  public Object getSharingFingerprint() {
    return sharingFingerprint;
  }


  public void setSharingFingerprint(Object sharingFingerprint) {
  ...
  public CourseAttributes showInCommunity(Object showInCommunity) {
    
    
    
    
    this.showInCommunity = showInCommunity;
    return this;
  }

   /**
   * Show In LearningHub?
   * @return showInCommunity
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Show In LearningHub?")

  public Object getShowInCommunity() {
    return showInCommunity;
  }


  public void setShowInCommunity(Object showInCommunity) {
  ...
  public CourseAttributes showToNonMembers(Object showToNonMembers) {
    
    
    
    
    this.showToNonMembers = showToNonMembers;
    return this;
  }

   /**
   * Show To Non Members
   * @return showToNonMembers
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Show To Non Members")

  public Object getShowToNonMembers() {
    return showToNonMembers;
  }


  public void setShowToNonMembers(Object showToNonMembers) {
  ...
  public CourseAttributes upgradeUrl(Object upgradeUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Upgrade URL")
  ...
  public void setUpgradeUrl(Object upgradeUrl) {
  ...
  public CourseAttributes redirectToFullCourse(Object redirectToFullCourse) {
    
    
    
    
    this.redirectToFullCourse = redirectToFullCourse;
    return this;
  }

   /**
   * Redirect To Full Course
   * @return redirectToFullCourse
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Redirect To Full Course")

  public Object getRedirectToFullCourse() {
    return redirectToFullCourse;
  }


  public void setRedirectToFullCourse(Object redirectToFullCourse) {
  ...
  public CourseAttributes unauthorizedRedirectUrl(Object unauthorizedRedirectUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unauthorized Redirect")

  public Object getUnauthorizedRedirectUrl() {
    return unauthorizedRedirectUrl;
  }


  public void setUnauthorizedRedirectUrl(Object unauthorizedRedirectUrl) {
  ...
  public CourseAttributes commentsEnabled(Object commentsEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Enable Lesson Comments?")

  public Object getCommentsEnabled() {
    return commentsEnabled;
  }


  public void setCommentsEnabled(Object commentsEnabled) {
  ...
  public CourseAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public CourseAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the CourseAttributes instance itself
   */
  public CourseAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, courseAttributes.title) &&
        Objects.equals(this.description, courseAttributes.description) &&
        Objects.equals(this.id, courseAttributes.id) &&
        Objects.equals(this.publicId, courseAttributes.publicId) &&
        Objects.equals(this.publishedAt, courseAttributes.publishedAt) &&
        Objects.equals(this.rootSectionId, courseAttributes.rootSectionId) &&
        Objects.equals(this.currentPath, courseAttributes.currentPath) &&
        Objects.equals(this.sharingFingerprint, courseAttributes.sharingFingerprint) &&
        Objects.equals(this.showInCommunity, courseAttributes.showInCommunity) &&
        Objects.equals(this.showToNonMembers, courseAttributes.showToNonMembers) &&
        Objects.equals(this.upgradeUrl, courseAttributes.upgradeUrl) &&
        Objects.equals(this.redirectToFullCourse, courseAttributes.redirectToFullCourse) &&
        Objects.equals(this.unauthorizedRedirectUrl, courseAttributes.unauthorizedRedirectUrl) &&
        Objects.equals(this.commentsEnabled, courseAttributes.commentsEnabled) &&
        Objects.equals(this.createdAt, courseAttributes.createdAt) &&
        Objects.equals(this.updatedAt, courseAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, courseAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, id, publicId, publishedAt, rootSectionId, currentPath, sharingFingerprint, showInCommunity, showToNonMembers, upgradeUrl, redirectToFullCourse, unauthorizedRedirectUrl, commentsEnabled, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    rootSectionId: ").append(toIndentedString(rootSectionId)).append("\n");
    sb.append("    currentPath: ").append(toIndentedString(currentPath)).append("\n");
    sb.append("    sharingFingerprint: ").append(toIndentedString(sharingFingerprint)).append("\n");
    sb.append("    showInCommunity: ").append(toIndentedString(showInCommunity)).append("\n");
    sb.append("    showToNonMembers: ").append(toIndentedString(showToNonMembers)).append("\n");
    sb.append("    upgradeUrl: ").append(toIndentedString(upgradeUrl)).append("\n");
    sb.append("    redirectToFullCourse: ").append(toIndentedString(redirectToFullCourse)).append("\n");
    sb.append("    unauthorizedRedirectUrl: ").append(toIndentedString(unauthorizedRedirectUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("root_section_id");
    openapiFields.add("current_path");
    openapiFields.add("sharing_fingerprint");
    openapiFields.add("show_in_community");
    openapiFields.add("show_to_non_members");
    openapiFields.add("upgrade_url");
    openapiFields.add("redirect_to_full_course");
    openapiFields.add("unauthorized_redirect_url");
    openapiFields.add("comments_enabled");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CourseAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CourseAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CourseAttributes is not found in the empty JSON string", CourseAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CourseAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CourseAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CourseAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CourseAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CourseAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CourseAttributes>() {
           @Override
           public void write(JsonWriter out, CourseAttributes value) throws IOException {
           ...
           @Override
           public CourseAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CourseAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CourseAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CourseAttributes
  * @throws IOException if the JSON string is invalid with respect to CourseAttributes
  */
  public static CourseAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CourseAttributes.class);
  }

 /**
  * Convert an instance of CourseAttributes to an JSON string
  *
  * @return JSON string
  */
