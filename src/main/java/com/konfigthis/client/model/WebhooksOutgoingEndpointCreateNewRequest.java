...
public class WebhooksOutgoingEndpointCreateNewRequest {
  ...
  public WebhooksOutgoingEndpointCreateNewRequest() {
  }

  public WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpoint(WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint) {
  ...
  **/
   ...
   * @return the WebhooksOutgoingEndpointCreateNewRequest instance itself
   */
  public WebhooksOutgoingEndpointCreateNewRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest = (WebhooksOutgoingEndpointCreateNewRequest) o;
    return Objects.equals(this.webhooksOutgoingEndpoint, webhooksOutgoingEndpointCreateNewRequest.webhooksOutgoingEndpoint)&&
        Objects.equals(this.additionalProperties, webhooksOutgoingEndpointCreateNewRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksOutgoingEndpointCreateNewRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksOutgoingEndpointCreateNewRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksOutgoingEndpointCreateNewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksOutgoingEndpointCreateNewRequest is not found in the empty JSON string", WebhooksOutgoingEndpointCreateNewRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksOutgoingEndpointCreateNewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksOutgoingEndpointCreateNewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksOutgoingEndpointCreateNewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksOutgoingEndpointCreateNewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksOutgoingEndpointCreateNewRequest>() {
           @Override
           public void write(JsonWriter out, WebhooksOutgoingEndpointCreateNewRequest value) throws IOException {
           ...
           @Override
           public WebhooksOutgoingEndpointCreateNewRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksOutgoingEndpointCreateNewRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksOutgoingEndpointCreateNewRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksOutgoingEndpointCreateNewRequest
  * @throws IOException if the JSON string is invalid with respect to WebhooksOutgoingEndpointCreateNewRequest
  */
  public static WebhooksOutgoingEndpointCreateNewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksOutgoingEndpointCreateNewRequest.class);
  }

 /**
  * Convert an instance of WebhooksOutgoingEndpointCreateNewRequest to an JSON string
  *
  * @return JSON string
  */
