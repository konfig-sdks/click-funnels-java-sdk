...
public class CoursesEnrollmentCreateNewEnrollmentRequest {
  ...
  public CoursesEnrollmentCreateNewEnrollmentRequest() {
  }

  public CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollment(CoursesEnrollmentParameters coursesEnrollment) {
  ...
  **/
   ...
   * @return the CoursesEnrollmentCreateNewEnrollmentRequest instance itself
   */
  public CoursesEnrollmentCreateNewEnrollmentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest = (CoursesEnrollmentCreateNewEnrollmentRequest) o;
    return Objects.equals(this.coursesEnrollment, coursesEnrollmentCreateNewEnrollmentRequest.coursesEnrollment)&&
        Objects.equals(this.additionalProperties, coursesEnrollmentCreateNewEnrollmentRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesEnrollmentCreateNewEnrollmentRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesEnrollmentCreateNewEnrollmentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesEnrollmentCreateNewEnrollmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesEnrollmentCreateNewEnrollmentRequest is not found in the empty JSON string", CoursesEnrollmentCreateNewEnrollmentRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesEnrollmentCreateNewEnrollmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesEnrollmentCreateNewEnrollmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesEnrollmentCreateNewEnrollmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesEnrollmentCreateNewEnrollmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesEnrollmentCreateNewEnrollmentRequest>() {
           @Override
           public void write(JsonWriter out, CoursesEnrollmentCreateNewEnrollmentRequest value) throws IOException {
           ...
           @Override
           public CoursesEnrollmentCreateNewEnrollmentRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesEnrollmentCreateNewEnrollmentRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesEnrollmentCreateNewEnrollmentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesEnrollmentCreateNewEnrollmentRequest
  * @throws IOException if the JSON string is invalid with respect to CoursesEnrollmentCreateNewEnrollmentRequest
  */
  public static CoursesEnrollmentCreateNewEnrollmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesEnrollmentCreateNewEnrollmentRequest.class);
  }

 /**
  * Convert an instance of CoursesEnrollmentCreateNewEnrollmentRequest to an JSON string
  *
  * @return JSON string
  */
