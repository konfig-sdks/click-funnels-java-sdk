...
public class ContactsTagCreateNewTagRequest {
  ...
  public ContactsTagCreateNewTagRequest() {
  }

  public ContactsTagCreateNewTagRequest contactsTag(ContactsTagParameters contactsTag) {
  ...
  **/
   ...
   * @return the ContactsTagCreateNewTagRequest instance itself
   */
  public ContactsTagCreateNewTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest = (ContactsTagCreateNewTagRequest) o;
    return Objects.equals(this.contactsTag, contactsTagCreateNewTagRequest.contactsTag)&&
        Objects.equals(this.additionalProperties, contactsTagCreateNewTagRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactsTagCreateNewTagRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsTagCreateNewTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsTagCreateNewTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsTagCreateNewTagRequest is not found in the empty JSON string", ContactsTagCreateNewTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsTagCreateNewTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsTagCreateNewTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsTagCreateNewTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsTagCreateNewTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsTagCreateNewTagRequest>() {
           @Override
           public void write(JsonWriter out, ContactsTagCreateNewTagRequest value) throws IOException {
           ...
           @Override
           public ContactsTagCreateNewTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsTagCreateNewTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsTagCreateNewTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsTagCreateNewTagRequest
  * @throws IOException if the JSON string is invalid with respect to ContactsTagCreateNewTagRequest
  */
  public static ContactsTagCreateNewTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsTagCreateNewTagRequest.class);
  }

 /**
  * Convert an instance of ContactsTagCreateNewTagRequest to an JSON string
  *
  * @return JSON string
  */
