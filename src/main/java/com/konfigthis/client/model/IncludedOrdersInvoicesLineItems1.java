 ...
 */
@ApiModel(description = "Included Orders Invoices Line Item")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IncludedOrdersInvoicesLineItems1 {
  ...
  private Integer invoicesLineItemId;

  public IncludedOrdersInvoicesLineItems1() {
  }

  public IncludedOrdersInvoicesLineItems1 id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Included Orders Line Item ID")
  ...
  public IncludedOrdersInvoicesLineItems1 publicId(Object publicId) {
  ...
  **/
  ...
  public IncludedOrdersInvoicesLineItems1 fulfillmentId(Integer fulfillmentId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Restock ID")
  ...
  public IncludedOrdersInvoicesLineItems1 quantity(Integer quantity) {
  ...
  **/
  ...
  public IncludedOrdersInvoicesLineItems1 invoicesLineItemId(Integer invoicesLineItemId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Invoices Line Item")

  public Integer getInvoicesLineItemId() {
    return invoicesLineItemId;
  }


  public void setInvoicesLineItemId(Integer invoicesLineItemId) {
   ...
   * @return the IncludedOrdersInvoicesLineItems1 instance itself
   */
  public IncludedOrdersInvoicesLineItems1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncludedOrdersInvoicesLineItems1 includedOrdersInvoicesLineItems1 = (IncludedOrdersInvoicesLineItems1) o;
    return Objects.equals(this.id, includedOrdersInvoicesLineItems1.id) &&
        Objects.equals(this.publicId, includedOrdersInvoicesLineItems1.publicId) &&
        Objects.equals(this.fulfillmentId, includedOrdersInvoicesLineItems1.fulfillmentId) &&
        Objects.equals(this.quantity, includedOrdersInvoicesLineItems1.quantity) &&
        Objects.equals(this.invoicesLineItemId, includedOrdersInvoicesLineItems1.invoicesLineItemId)&&
        Objects.equals(this.additionalProperties, includedOrdersInvoicesLineItems1.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, fulfillmentId, quantity, invoicesLineItemId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncludedOrdersInvoicesLineItems1 {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("invoices_line_item_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncludedOrdersInvoicesLineItems1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncludedOrdersInvoicesLineItems1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncludedOrdersInvoicesLineItems1 is not found in the empty JSON string", IncludedOrdersInvoicesLineItems1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncludedOrdersInvoicesLineItems1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncludedOrdersInvoicesLineItems1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncludedOrdersInvoicesLineItems1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncludedOrdersInvoicesLineItems1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncludedOrdersInvoicesLineItems1.class));

       return (TypeAdapter<T>) new TypeAdapter<IncludedOrdersInvoicesLineItems1>() {
           @Override
           public void write(JsonWriter out, IncludedOrdersInvoicesLineItems1 value) throws IOException {
           ...
           @Override
           public IncludedOrdersInvoicesLineItems1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncludedOrdersInvoicesLineItems1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncludedOrdersInvoicesLineItems1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncludedOrdersInvoicesLineItems1
  * @throws IOException if the JSON string is invalid with respect to IncludedOrdersInvoicesLineItems1
  */
  public static IncludedOrdersInvoicesLineItems1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncludedOrdersInvoicesLineItems1.class);
  }

 /**
  * Convert an instance of IncludedOrdersInvoicesLineItems1 to an JSON string
  *
  * @return JSON string
  */
