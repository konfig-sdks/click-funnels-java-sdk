...
public class FormsFieldsOptionParameters {
  public static final String SERIALIZED_NAME_LABEL = "label";
  @SerializedName(SERIALIZED_NAME_LABEL)
  private String label;

  public FormsFieldsOptionParameters() {
  }

  public FormsFieldsOptionParameters label(String label) {
  ...
  **/
   ...
   * @return the FormsFieldsOptionParameters instance itself
   */
  public FormsFieldsOptionParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldsOptionParameters formsFieldsOptionParameters = (FormsFieldsOptionParameters) o;
    return Objects.equals(this.label, formsFieldsOptionParameters.label)&&
        Objects.equals(this.additionalProperties, formsFieldsOptionParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldsOptionParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldsOptionParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldsOptionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldsOptionParameters is not found in the empty JSON string", FormsFieldsOptionParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsFieldsOptionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldsOptionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldsOptionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldsOptionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldsOptionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldsOptionParameters>() {
           @Override
           public void write(JsonWriter out, FormsFieldsOptionParameters value) throws IOException {
           ...
           @Override
           public FormsFieldsOptionParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldsOptionParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldsOptionParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldsOptionParameters
  * @throws IOException if the JSON string is invalid with respect to FormsFieldsOptionParameters
  */
  public static FormsFieldsOptionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldsOptionParameters.class);
  }

 /**
  * Convert an instance of FormsFieldsOptionParameters to an JSON string
  *
  * @return JSON string
  */
