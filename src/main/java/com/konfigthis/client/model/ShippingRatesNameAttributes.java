 ...
 * Rate Names
 */
@ApiModel(description = "Rate Names")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ShippingRatesNameAttributes {
  ...
  public ShippingRatesNameAttributes() {
  }

  public ShippingRatesNameAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", required = true, value = "Rate Name ID")
  ...
  public ShippingRatesNameAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Rate Name public ID")
  ...
  public ShippingRatesNameAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public ShippingRatesNameAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Shipping Rates Name", required = true, value = "Rate Name")
  ...
  public ShippingRatesNameAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ShippingRatesNameAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ShippingRatesNameAttributes instance itself
   */
  public ShippingRatesNameAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRatesNameAttributes shippingRatesNameAttributes = (ShippingRatesNameAttributes) o;
    return Objects.equals(this.id, shippingRatesNameAttributes.id) &&
        Objects.equals(this.publicId, shippingRatesNameAttributes.publicId) &&
        Objects.equals(this.workspaceId, shippingRatesNameAttributes.workspaceId) &&
        Objects.equals(this.name, shippingRatesNameAttributes.name) &&
        Objects.equals(this.createdAt, shippingRatesNameAttributes.createdAt) &&
        Objects.equals(this.updatedAt, shippingRatesNameAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, shippingRatesNameAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, name, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingRatesNameAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRatesNameAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRatesNameAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRatesNameAttributes is not found in the empty JSON string", ShippingRatesNameAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingRatesNameAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRatesNameAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRatesNameAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRatesNameAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRatesNameAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRatesNameAttributes>() {
           @Override
           public void write(JsonWriter out, ShippingRatesNameAttributes value) throws IOException {
           ...
           @Override
           public ShippingRatesNameAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRatesNameAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRatesNameAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRatesNameAttributes
  * @throws IOException if the JSON string is invalid with respect to ShippingRatesNameAttributes
  */
  public static ShippingRatesNameAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRatesNameAttributes.class);
  }

 /**
  * Convert an instance of ShippingRatesNameAttributes to an JSON string
  *
  * @return JSON string
  */
