...
public class ContactTagAttributes {
  ...
  public ContactTagAttributes() {
  }

  public ContactTagAttributes id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the tag")
  ...
  public ContactTagAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The name of the tag")
  ...
  public ContactTagAttributes color(String color) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The color of the tag")
   ...
   * @return the ContactTagAttributes instance itself
   */
  public ContactTagAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactTagAttributes contactTagAttributes = (ContactTagAttributes) o;
    return Objects.equals(this.id, contactTagAttributes.id) &&
        Objects.equals(this.name, contactTagAttributes.name) &&
        Objects.equals(this.color, contactTagAttributes.color)&&
        Objects.equals(this.additionalProperties, contactTagAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactTagAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactTagAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactTagAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactTagAttributes is not found in the empty JSON string", ContactTagAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactTagAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactTagAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactTagAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactTagAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactTagAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactTagAttributes>() {
           @Override
           public void write(JsonWriter out, ContactTagAttributes value) throws IOException {
           ...
           @Override
           public ContactTagAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactTagAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactTagAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactTagAttributes
  * @throws IOException if the JSON string is invalid with respect to ContactTagAttributes
  */
  public static ContactTagAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactTagAttributes.class);
  }

 /**
  * Convert an instance of ContactTagAttributes to an JSON string
  *
  * @return JSON string
  */
