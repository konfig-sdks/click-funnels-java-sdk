 ...
 * Pages
 */
@ApiModel(description = "Pages")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PagesProperty {
  ...
  public PagesProperty() {
  }

  public PagesProperty id(Integer id) {
  ...
  **/
  ...
  public PagesProperty publicId(Object publicId) {
  ...
  **/
  ...
  public PagesProperty name(String name) {
  ...
  **/
   ...
   * @return the PagesProperty instance itself
   */
  public PagesProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagesProperty pagesProperty = (PagesProperty) o;
    return Objects.equals(this.id, pagesProperty.id) &&
        Objects.equals(this.publicId, pagesProperty.publicId) &&
        Objects.equals(this.name, pagesProperty.name)&&
        Objects.equals(this.additionalProperties, pagesProperty.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, name, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagesProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagesProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagesProperty is not found in the empty JSON string", PagesProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagesProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagesProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagesProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagesProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagesProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<PagesProperty>() {
           @Override
           public void write(JsonWriter out, PagesProperty value) throws IOException {
           ...
           @Override
           public PagesProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagesProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagesProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagesProperty
  * @throws IOException if the JSON string is invalid with respect to PagesProperty
  */
  public static PagesProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagesProperty.class);
  }

 /**
  * Convert an instance of PagesProperty to an JSON string
  *
  * @return JSON string
  */
