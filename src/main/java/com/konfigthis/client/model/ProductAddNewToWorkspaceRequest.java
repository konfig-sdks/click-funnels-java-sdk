...
public class ProductAddNewToWorkspaceRequest {
  public static final String SERIALIZED_NAME_PRODUCT = "product";
  @SerializedName(SERIALIZED_NAME_PRODUCT)
  private ProductParameters product;

  public ProductAddNewToWorkspaceRequest() {
  }

  public ProductAddNewToWorkspaceRequest product(ProductParameters product) {
  ...
  **/
   ...
   * @return the ProductAddNewToWorkspaceRequest instance itself
   */
  public ProductAddNewToWorkspaceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest = (ProductAddNewToWorkspaceRequest) o;
    return Objects.equals(this.product, productAddNewToWorkspaceRequest.product)&&
        Objects.equals(this.additionalProperties, productAddNewToWorkspaceRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductAddNewToWorkspaceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductAddNewToWorkspaceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductAddNewToWorkspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductAddNewToWorkspaceRequest is not found in the empty JSON string", ProductAddNewToWorkspaceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductAddNewToWorkspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductAddNewToWorkspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductAddNewToWorkspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductAddNewToWorkspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductAddNewToWorkspaceRequest>() {
           @Override
           public void write(JsonWriter out, ProductAddNewToWorkspaceRequest value) throws IOException {
           ...
           @Override
           public ProductAddNewToWorkspaceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductAddNewToWorkspaceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductAddNewToWorkspaceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductAddNewToWorkspaceRequest
  * @throws IOException if the JSON string is invalid with respect to ProductAddNewToWorkspaceRequest
  */
  public static ProductAddNewToWorkspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductAddNewToWorkspaceRequest.class);
  }

 /**
  * Convert an instance of ProductAddNewToWorkspaceRequest to an JSON string
  *
  * @return JSON string
  */
