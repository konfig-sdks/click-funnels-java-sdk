...
public class FulfillmentCreateRequest {
  ...
  public FulfillmentCreateRequest fulfillment(FulfillmentParameters fulfillment) {
  ...
  **/
   ...
   * @return the FulfillmentCreateRequest instance itself
   */
  public FulfillmentCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fulfillment, fulfillmentCreateRequest.fulfillment)&&
        Objects.equals(this.additionalProperties, fulfillmentCreateRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentCreateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentCreateRequest is not found in the empty JSON string", FulfillmentCreateRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentCreateRequest>() {
           @Override
           public void write(JsonWriter out, FulfillmentCreateRequest value) throws IOException {
           ...
           @Override
           public FulfillmentCreateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentCreateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentCreateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentCreateRequest
  * @throws IOException if the JSON string is invalid with respect to FulfillmentCreateRequest
  */
  public static FulfillmentCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentCreateRequest.class);
  }

 /**
  * Convert an instance of FulfillmentCreateRequest to an JSON string
  *
  * @return JSON string
  */
