...
public class FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner {
  public static final String SERIALIZED_NAME_INVOICES_LINE_ITEM_ID = "invoices_line_item_id";
  @SerializedName(SERIALIZED_NAME_INVOICES_LINE_ITEM_ID)
  private String invoicesLineItemId;

  public static final String SERIALIZED_NAME_QUANTITY = "quantity";
  @SerializedName(SERIALIZED_NAME_QUANTITY)
  private Integer quantity;

  public FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner() {
  }

  public FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner invoicesLineItemId(String invoicesLineItemId) {
    
    
    
    
    this.invoicesLineItemId = invoicesLineItemId;
    return this;
  }

   /**
   * The orders invoice line item to fulfill
   * @return invoicesLineItemId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The orders invoice line item to fulfill")

  public String getInvoicesLineItemId() {
    return invoicesLineItemId;
  }


  public void setInvoicesLineItemId(String invoicesLineItemId) {
  ...
  public FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner quantity(Integer quantity) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The quantity to fulfill")
   ...
   * @return the FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner instance itself
   */
  public FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner fulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner = (FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner) o;
    return Objects.equals(this.invoicesLineItemId, fulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.invoicesLineItemId) &&
        Objects.equals(this.quantity, fulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.quantity)&&
        Objects.equals(this.additionalProperties, fulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoicesLineItemId, quantity, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner {\n");
    sb.append("    invoicesLineItemId: ").append(toIndentedString(invoicesLineItemId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("invoices_line_item_id");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner is not found in the empty JSON string", FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("invoices_line_item_id") != null && !jsonObj.get("invoices_line_item_id").isJsonNull()) && !jsonObj.get("invoices_line_item_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `invoices_line_item_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("invoices_line_item_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner>() {
           @Override
           public void write(JsonWriter out, FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner value) throws IOException {
           ...
           @Override
           public FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner
  * @throws IOException if the JSON string is invalid with respect to FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner
  */
  public static FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.class);
  }

 /**
  * Convert an instance of FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner to an JSON string
  *
  * @return JSON string
  */
