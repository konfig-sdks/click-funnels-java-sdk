 ...
 * Payments
 */
@ApiModel(description = "Payments")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrdersTransactionAttributes {
  ...
  private Object externalType = null;
  ...
  public static final String SERIALIZED_NAME_ADJUSTED_TRANSACTION_ID = "adjusted_transaction_id";
  @SerializedName(SERIALIZED_NAME_ADJUSTED_TRANSACTION_ID)
  private Object adjustedTransactionId = null;

  public static final String SERIALIZED_NAME_RESULT = "result";
  @SerializedName(SERIALIZED_NAME_RESULT)
  private String result;

  public static final String SERIALIZED_NAME_BILLING_PAYMENT_INSTRUCTION_ID = "billing_payment_instruction_id";
  @SerializedName(SERIALIZED_NAME_BILLING_PAYMENT_INSTRUCTION_ID)
  private Object billingPaymentInstructionId = null;

  public static final String SERIALIZED_NAME_BILLING_PAYMENT_INSTRUCTION_TYPE = "billing_payment_instruction_type";
  @SerializedName(SERIALIZED_NAME_BILLING_PAYMENT_INSTRUCTION_TYPE)
  private Object billingPaymentInstructionType = null;

  public static final String SERIALIZED_NAME_ARN = "arn";
  @SerializedName(SERIALIZED_NAME_ARN)
  private Object arn = null;

  public static final String SERIALIZED_NAME_IS_REBILL = "is_rebill";
  @SerializedName(SERIALIZED_NAME_IS_REBILL)
  private Object isRebill = null;

  public static final String SERIALIZED_NAME_REBILL_NUMBER = "rebill_number";
  @SerializedName(SERIALIZED_NAME_REBILL_NUMBER)
  private Object rebillNumber = null;
  ...
  public OrdersTransactionAttributes() {
  }

  public OrdersTransactionAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Transaction ID")
  ...
  public OrdersTransactionAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Transaction public ID")
  ...
  public OrdersTransactionAttributes orderId(Integer orderId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "6", required = true, value = "Order ID")
  ...
  public OrdersTransactionAttributes status(String status) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "completed", required = true, value = "Status")
  ...
  public OrdersTransactionAttributes externalType(Object externalType) {
  ...
  **/
  ...
  public void setExternalType(Object externalType) {
  ...
  public OrdersTransactionAttributes externalId(String externalId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2a8fe83567d58b3ff0fecc37b0206768", required = true, value = "External ID")
  ...
  public OrdersTransactionAttributes amount(Object amount) {
  ...
  **/
  ...
  public OrdersTransactionAttributes currency(Object currency) {
  ...
  **/
  ...
  public OrdersTransactionAttributes reason(Object reason) {
  ...
  **/
  ...
  public OrdersTransactionAttributes adjustedTransactionId(Object adjustedTransactionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Adjusted transaction")

  public Object getAdjustedTransactionId() {
    return adjustedTransactionId;
  }


  public void setAdjustedTransactionId(Object adjustedTransactionId) {
  ...
  public OrdersTransactionAttributes result(String result) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "approved", required = true, value = "Result")
  ...
  public OrdersTransactionAttributes billingPaymentInstructionId(Object billingPaymentInstructionId) {
    
    
    
    
    this.billingPaymentInstructionId = billingPaymentInstructionId;
    return this;
  }

   /**
   * Billing Payment Instruction ID
   * @return billingPaymentInstructionId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Billing Payment Instruction ID")

  public Object getBillingPaymentInstructionId() {
    return billingPaymentInstructionId;
  }


  public void setBillingPaymentInstructionId(Object billingPaymentInstructionId) {
  ...
  public OrdersTransactionAttributes billingPaymentInstructionType(Object billingPaymentInstructionType) {
    
    
    
    
    this.billingPaymentInstructionType = billingPaymentInstructionType;
    return this;
  }

   /**
   * Billing Payment Instruction Type
   * @return billingPaymentInstructionType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Billing Payment Instruction Type")

  public Object getBillingPaymentInstructionType() {
    return billingPaymentInstructionType;
  }


  public void setBillingPaymentInstructionType(Object billingPaymentInstructionType) {
  ...
  public OrdersTransactionAttributes arn(Object arn) {
  ...
  **/
  ...
  public OrdersTransactionAttributes isRebill(Object isRebill) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Is Rebill")

  public Object getIsRebill() {
    return isRebill;
  }


  public void setIsRebill(Object isRebill) {
  ...
  public OrdersTransactionAttributes rebillNumber(Object rebillNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Rebill Number")

  public Object getRebillNumber() {
    return rebillNumber;
  }


  public void setRebillNumber(Object rebillNumber) {
  ...
  public OrdersTransactionAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public OrdersTransactionAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the OrdersTransactionAttributes instance itself
   */
  public OrdersTransactionAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersTransactionAttributes ordersTransactionAttributes = (OrdersTransactionAttributes) o;
    return Objects.equals(this.id, ordersTransactionAttributes.id) &&
        Objects.equals(this.publicId, ordersTransactionAttributes.publicId) &&
        Objects.equals(this.orderId, ordersTransactionAttributes.orderId) &&
        Objects.equals(this.status, ordersTransactionAttributes.status) &&
        Objects.equals(this.externalType, ordersTransactionAttributes.externalType) &&
        Objects.equals(this.externalId, ordersTransactionAttributes.externalId) &&
        Objects.equals(this.amount, ordersTransactionAttributes.amount) &&
        Objects.equals(this.currency, ordersTransactionAttributes.currency) &&
        Objects.equals(this.reason, ordersTransactionAttributes.reason) &&
        Objects.equals(this.adjustedTransactionId, ordersTransactionAttributes.adjustedTransactionId) &&
        Objects.equals(this.result, ordersTransactionAttributes.result) &&
        Objects.equals(this.billingPaymentInstructionId, ordersTransactionAttributes.billingPaymentInstructionId) &&
        Objects.equals(this.billingPaymentInstructionType, ordersTransactionAttributes.billingPaymentInstructionType) &&
        Objects.equals(this.arn, ordersTransactionAttributes.arn) &&
        Objects.equals(this.isRebill, ordersTransactionAttributes.isRebill) &&
        Objects.equals(this.rebillNumber, ordersTransactionAttributes.rebillNumber) &&
        Objects.equals(this.createdAt, ordersTransactionAttributes.createdAt) &&
        Objects.equals(this.updatedAt, ordersTransactionAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, ordersTransactionAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, orderId, status, externalType, externalId, amount, currency, reason, adjustedTransactionId, result, billingPaymentInstructionId, billingPaymentInstructionType, arn, isRebill, rebillNumber, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersTransactionAttributes {\n");
    ...
    sb.append("    adjustedTransactionId: ").append(toIndentedString(adjustedTransactionId)).append("\n");
    sb.append("    result: ").append(toIndentedString(result)).append("\n");
    sb.append("    billingPaymentInstructionId: ").append(toIndentedString(billingPaymentInstructionId)).append("\n");
    sb.append("    billingPaymentInstructionType: ").append(toIndentedString(billingPaymentInstructionType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("adjusted_transaction_id");
    openapiFields.add("result");
    openapiFields.add("billing_payment_instruction_id");
    openapiFields.add("billing_payment_instruction_type");
    openapiFields.add("arn");
    openapiFields.add("is_rebill");
    openapiFields.add("rebill_number");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersTransactionAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersTransactionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersTransactionAttributes is not found in the empty JSON string", OrdersTransactionAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersTransactionAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersTransactionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersTransactionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersTransactionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersTransactionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersTransactionAttributes>() {
           @Override
           public void write(JsonWriter out, OrdersTransactionAttributes value) throws IOException {
           ...
           @Override
           public OrdersTransactionAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersTransactionAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersTransactionAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersTransactionAttributes
  * @throws IOException if the JSON string is invalid with respect to OrdersTransactionAttributes
  */
  public static OrdersTransactionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersTransactionAttributes.class);
  }

 /**
  * Convert an instance of OrdersTransactionAttributes to an JSON string
  *
  * @return JSON string
  */
