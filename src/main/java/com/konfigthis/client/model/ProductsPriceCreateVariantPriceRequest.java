...
import com.konfigthis.client.model.ProductsPriceParameters;
...
public class ProductsPriceCreateVariantPriceRequest {
  ...
  public ProductsPriceCreateVariantPriceRequest() {
  }

  public ProductsPriceCreateVariantPriceRequest productsPrice(ProductsPriceParameters productsPrice) {
  ...
  **/
  ...
  public ProductsPriceParameters getProductsPrice() {
    return productsPrice;
  }


  public void setProductsPrice(ProductsPriceParameters productsPrice) {
   ...
   * @return the ProductsPriceCreateVariantPriceRequest instance itself
   */
  public ProductsPriceCreateVariantPriceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest = (ProductsPriceCreateVariantPriceRequest) o;
    return Objects.equals(this.productsPrice, productsPriceCreateVariantPriceRequest.productsPrice)&&
        Objects.equals(this.additionalProperties, productsPriceCreateVariantPriceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productsPrice, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductsPriceCreateVariantPriceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsPriceCreateVariantPriceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsPriceCreateVariantPriceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsPriceCreateVariantPriceRequest is not found in the empty JSON string", ProductsPriceCreateVariantPriceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsPriceCreateVariantPriceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsPriceCreateVariantPriceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsPriceCreateVariantPriceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsPriceCreateVariantPriceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsPriceCreateVariantPriceRequest>() {
           @Override
           public void write(JsonWriter out, ProductsPriceCreateVariantPriceRequest value) throws IOException {
           ...
           @Override
           public ProductsPriceCreateVariantPriceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsPriceCreateVariantPriceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsPriceCreateVariantPriceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsPriceCreateVariantPriceRequest
  * @throws IOException if the JSON string is invalid with respect to ProductsPriceCreateVariantPriceRequest
  */
  public static ProductsPriceCreateVariantPriceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsPriceCreateVariantPriceRequest.class);
  }

 /**
  * Convert an instance of ProductsPriceCreateVariantPriceRequest to an JSON string
  *
  * @return JSON string
  */
