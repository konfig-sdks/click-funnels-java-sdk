 ...
 */
@ApiModel(description = "Contacts Applied Tags")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContactsAppliedTagAttributes {
  ...
  public ContactsAppliedTagAttributes() {
  }

  public ContactsAppliedTagAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Applied Tag ID")
  ...
  public ContactsAppliedTagAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Applied Tag public ID")
  ...
  public ContactsAppliedTagAttributes contactId(Integer contactId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Contact ID")
  ...
  public ContactsAppliedTagAttributes tagId(Integer tagId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3", required = true, value = "Tag ID")
  ...
  public ContactsAppliedTagAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ContactsAppliedTagAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ContactsAppliedTagAttributes instance itself
   */
  public ContactsAppliedTagAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsAppliedTagAttributes contactsAppliedTagAttributes = (ContactsAppliedTagAttributes) o;
    return Objects.equals(this.id, contactsAppliedTagAttributes.id) &&
        Objects.equals(this.publicId, contactsAppliedTagAttributes.publicId) &&
        Objects.equals(this.contactId, contactsAppliedTagAttributes.contactId) &&
        Objects.equals(this.tagId, contactsAppliedTagAttributes.tagId) &&
        Objects.equals(this.createdAt, contactsAppliedTagAttributes.createdAt) &&
        Objects.equals(this.updatedAt, contactsAppliedTagAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, contactsAppliedTagAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, contactId, tagId, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactsAppliedTagAttributes {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("tag_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsAppliedTagAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsAppliedTagAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsAppliedTagAttributes is not found in the empty JSON string", ContactsAppliedTagAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactsAppliedTagAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsAppliedTagAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsAppliedTagAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsAppliedTagAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsAppliedTagAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsAppliedTagAttributes>() {
           @Override
           public void write(JsonWriter out, ContactsAppliedTagAttributes value) throws IOException {
           ...
           @Override
           public ContactsAppliedTagAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsAppliedTagAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsAppliedTagAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsAppliedTagAttributes
  * @throws IOException if the JSON string is invalid with respect to ContactsAppliedTagAttributes
  */
  public static ContactsAppliedTagAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsAppliedTagAttributes.class);
  }

 /**
  * Convert an instance of ContactsAppliedTagAttributes to an JSON string
  *
  * @return JSON string
  */
