...
import com.konfigthis.client.model.IncludedOrdersInvoicesLineItems1;
 ...
 * Restock
 */
@ApiModel(description = "Restock")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrdersInvoicesRestockGetRestockResponse {
 ...
 public enum StatusEnum {
  ...
  private List<IncludedOrdersInvoicesLineItems1> includedInvoicesLineItems = null;

  public OrdersInvoicesRestockGetRestockResponse() {
  }

  public OrdersInvoicesRestockGetRestockResponse id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Restock")
  ...
  public OrdersInvoicesRestockGetRestockResponse publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Public Restock ID")
  ...
  public OrdersInvoicesRestockGetRestockResponse workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public OrdersInvoicesRestockGetRestockResponse contactId(Integer contactId) {
  ...
  **/
  ...
  public OrdersInvoicesRestockGetRestockResponse status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "RESTOCKED", required = true, value = "Status")
  ...
  public OrdersInvoicesRestockGetRestockResponse createdAt(Object createdAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Created At Date")
  ...
  public OrdersInvoicesRestockGetRestockResponse updatedAt(Object updatedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Updated At Date")
  ...
  public OrdersInvoicesRestockGetRestockResponse includedInvoicesLineItems(List<IncludedOrdersInvoicesLineItems1> includedInvoicesLineItems) {
  ...
  public OrdersInvoicesRestockGetRestockResponse addIncludedInvoicesLineItemsItem(IncludedOrdersInvoicesLineItems1 includedInvoicesLineItemsItem) {
  ...
  **/
  ...
  public List<IncludedOrdersInvoicesLineItems1> getIncludedInvoicesLineItems() {
    return includedInvoicesLineItems;
  }


  public void setIncludedInvoicesLineItems(List<IncludedOrdersInvoicesLineItems1> includedInvoicesLineItems) {
   ...
   * @return the OrdersInvoicesRestockGetRestockResponse instance itself
   */
  public OrdersInvoicesRestockGetRestockResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersInvoicesRestockGetRestockResponse ordersInvoicesRestockGetRestockResponse = (OrdersInvoicesRestockGetRestockResponse) o;
    return Objects.equals(this.id, ordersInvoicesRestockGetRestockResponse.id) &&
        Objects.equals(this.publicId, ordersInvoicesRestockGetRestockResponse.publicId) &&
        Objects.equals(this.workspaceId, ordersInvoicesRestockGetRestockResponse.workspaceId) &&
        Objects.equals(this.contactId, ordersInvoicesRestockGetRestockResponse.contactId) &&
        Objects.equals(this.status, ordersInvoicesRestockGetRestockResponse.status) &&
        Objects.equals(this.createdAt, ordersInvoicesRestockGetRestockResponse.createdAt) &&
        Objects.equals(this.updatedAt, ordersInvoicesRestockGetRestockResponse.updatedAt) &&
        Objects.equals(this.includedInvoicesLineItems, ordersInvoicesRestockGetRestockResponse.includedInvoicesLineItems)&&
        Objects.equals(this.additionalProperties, ordersInvoicesRestockGetRestockResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, contactId, status, createdAt, updatedAt, includedInvoicesLineItems, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersInvoicesRestockGetRestockResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersInvoicesRestockGetRestockResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersInvoicesRestockGetRestockResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersInvoicesRestockGetRestockResponse is not found in the empty JSON string", OrdersInvoicesRestockGetRestockResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersInvoicesRestockGetRestockResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("included_invoices_line_items") != null && !jsonObj.get("included_invoices_line_items").isJsonNull()) {
        ...
        if (jsonArrayincludedInvoicesLineItems != null) {
          ...
          for (int i = 0; i < jsonArrayincludedInvoicesLineItems.size(); i++) {
            IncludedOrdersInvoicesLineItems1.validateJsonObject(jsonArrayincludedInvoicesLineItems.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersInvoicesRestockGetRestockResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersInvoicesRestockGetRestockResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersInvoicesRestockGetRestockResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersInvoicesRestockGetRestockResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersInvoicesRestockGetRestockResponse>() {
           @Override
           public void write(JsonWriter out, OrdersInvoicesRestockGetRestockResponse value) throws IOException {
           ...
           @Override
           public OrdersInvoicesRestockGetRestockResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersInvoicesRestockGetRestockResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersInvoicesRestockGetRestockResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersInvoicesRestockGetRestockResponse
  * @throws IOException if the JSON string is invalid with respect to OrdersInvoicesRestockGetRestockResponse
  */
  public static OrdersInvoicesRestockGetRestockResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersInvoicesRestockGetRestockResponse.class);
  }

 /**
  * Convert an instance of OrdersInvoicesRestockGetRestockResponse to an JSON string
  *
  * @return JSON string
  */
