...
import com.konfigthis.client.model.FormsFieldsOptionParameters;
...
public class FormsFieldsOptionCreateNewFieldOptionRequest {
  public static final String SERIALIZED_NAME_FORMS_FIELDS_OPTION = "forms_fields_option";
  @SerializedName(SERIALIZED_NAME_FORMS_FIELDS_OPTION)
  private FormsFieldsOptionParameters formsFieldsOption;

  public FormsFieldsOptionCreateNewFieldOptionRequest() {
  }

  public FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOption(FormsFieldsOptionParameters formsFieldsOption) {
   ...
   /**
   * Get formsFieldsOption
   * @return formsFieldsOption
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public FormsFieldsOptionParameters getFormsFieldsOption() {
    return formsFieldsOption;
  }


  public void setFormsFieldsOption(FormsFieldsOptionParameters formsFieldsOption) {
   ...
   * @return the FormsFieldsOptionCreateNewFieldOptionRequest instance itself
   */
  public FormsFieldsOptionCreateNewFieldOptionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest = (FormsFieldsOptionCreateNewFieldOptionRequest) o;
    return Objects.equals(this.formsFieldsOption, formsFieldsOptionCreateNewFieldOptionRequest.formsFieldsOption)&&
        Objects.equals(this.additionalProperties, formsFieldsOptionCreateNewFieldOptionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formsFieldsOption, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormsFieldsOptionCreateNewFieldOptionRequest {\n");
    sb.append("    formsFieldsOption: ").append(toIndentedString(formsFieldsOption)).append("\n");
  ...
  static {
    ...
    openapiFields.add("forms_fields_option");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldsOptionCreateNewFieldOptionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldsOptionCreateNewFieldOptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldsOptionCreateNewFieldOptionRequest is not found in the empty JSON string", FormsFieldsOptionCreateNewFieldOptionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldsOptionCreateNewFieldOptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldsOptionCreateNewFieldOptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldsOptionCreateNewFieldOptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldsOptionCreateNewFieldOptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldsOptionCreateNewFieldOptionRequest>() {
           @Override
           public void write(JsonWriter out, FormsFieldsOptionCreateNewFieldOptionRequest value) throws IOException {
           ...
           @Override
           public FormsFieldsOptionCreateNewFieldOptionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldsOptionCreateNewFieldOptionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldsOptionCreateNewFieldOptionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldsOptionCreateNewFieldOptionRequest
  * @throws IOException if the JSON string is invalid with respect to FormsFieldsOptionCreateNewFieldOptionRequest
  */
  public static FormsFieldsOptionCreateNewFieldOptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldsOptionCreateNewFieldOptionRequest.class);
  }

 /**
  * Convert an instance of FormsFieldsOptionCreateNewFieldOptionRequest to an JSON string
  *
  * @return JSON string
  */
