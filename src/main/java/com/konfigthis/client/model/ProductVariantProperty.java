 ...
 * Product Variant
 */
@ApiModel(description = "Product Variant")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProductVariantProperty {
  ...
  public ProductVariantProperty description(Object description) {
  ...
  **/
  ...
  public ProductVariantProperty id(Integer id) {
  ...
  **/
  ...
  public ProductVariantProperty name(String name) {
  ...
  **/
  ...
  public ProductVariantProperty sku(Object sku) {
  ...
  **/
   ...
   * @return the ProductVariantProperty instance itself
   */
  public ProductVariantProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductVariantProperty productVariantProperty = (ProductVariantProperty) o;
    return Objects.equals(this.description, productVariantProperty.description) &&
        Objects.equals(this.id, productVariantProperty.id) &&
        Objects.equals(this.name, productVariantProperty.name) &&
        Objects.equals(this.sku, productVariantProperty.sku)&&
        Objects.equals(this.additionalProperties, productVariantProperty.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, sku, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductVariantProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductVariantProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductVariantProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductVariantProperty is not found in the empty JSON string", ProductVariantProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductVariantProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductVariantProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductVariantProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductVariantProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductVariantProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductVariantProperty>() {
           @Override
           public void write(JsonWriter out, ProductVariantProperty value) throws IOException {
           ...
           @Override
           public ProductVariantProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductVariantProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductVariantProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductVariantProperty
  * @throws IOException if the JSON string is invalid with respect to ProductVariantProperty
  */
  public static ProductVariantProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductVariantProperty.class);
  }

 /**
  * Convert an instance of ProductVariantProperty to an JSON string
  *
  * @return JSON string
  */
