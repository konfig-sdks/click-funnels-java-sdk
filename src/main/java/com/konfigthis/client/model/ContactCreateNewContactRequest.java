...
public class ContactCreateNewContactRequest {
  public static final String SERIALIZED_NAME_CONTACT = "contact";
  @SerializedName(SERIALIZED_NAME_CONTACT)
  private ContactParameters contact;

  public ContactCreateNewContactRequest() {
  }

  public ContactCreateNewContactRequest contact(ContactParameters contact) {
  ...
  **/
   ...
   * @return the ContactCreateNewContactRequest instance itself
   */
  public ContactCreateNewContactRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactCreateNewContactRequest contactCreateNewContactRequest = (ContactCreateNewContactRequest) o;
    return Objects.equals(this.contact, contactCreateNewContactRequest.contact)&&
        Objects.equals(this.additionalProperties, contactCreateNewContactRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactCreateNewContactRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactCreateNewContactRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactCreateNewContactRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactCreateNewContactRequest is not found in the empty JSON string", ContactCreateNewContactRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactCreateNewContactRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactCreateNewContactRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactCreateNewContactRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactCreateNewContactRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactCreateNewContactRequest>() {
           @Override
           public void write(JsonWriter out, ContactCreateNewContactRequest value) throws IOException {
           ...
           @Override
           public ContactCreateNewContactRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactCreateNewContactRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactCreateNewContactRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactCreateNewContactRequest
  * @throws IOException if the JSON string is invalid with respect to ContactCreateNewContactRequest
  */
  public static ContactCreateNewContactRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactCreateNewContactRequest.class);
  }

 /**
  * Convert an instance of ContactCreateNewContactRequest to an JSON string
  *
  * @return JSON string
  */
