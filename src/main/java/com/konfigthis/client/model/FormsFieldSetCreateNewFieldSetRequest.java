...
public class FormsFieldSetCreateNewFieldSetRequest {
  ...
  public FormsFieldSetCreateNewFieldSetRequest() {
  }

  public FormsFieldSetCreateNewFieldSetRequest formsFieldSet(FormsFieldSetParameters formsFieldSet) {
  ...
  **/
   ...
   * @return the FormsFieldSetCreateNewFieldSetRequest instance itself
   */
  public FormsFieldSetCreateNewFieldSetRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldSetCreateNewFieldSetRequest formsFieldSetCreateNewFieldSetRequest = (FormsFieldSetCreateNewFieldSetRequest) o;
    return Objects.equals(this.formsFieldSet, formsFieldSetCreateNewFieldSetRequest.formsFieldSet)&&
        Objects.equals(this.additionalProperties, formsFieldSetCreateNewFieldSetRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldSetCreateNewFieldSetRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldSetCreateNewFieldSetRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldSetCreateNewFieldSetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldSetCreateNewFieldSetRequest is not found in the empty JSON string", FormsFieldSetCreateNewFieldSetRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldSetCreateNewFieldSetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldSetCreateNewFieldSetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldSetCreateNewFieldSetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldSetCreateNewFieldSetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldSetCreateNewFieldSetRequest>() {
           @Override
           public void write(JsonWriter out, FormsFieldSetCreateNewFieldSetRequest value) throws IOException {
           ...
           @Override
           public FormsFieldSetCreateNewFieldSetRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldSetCreateNewFieldSetRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldSetCreateNewFieldSetRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldSetCreateNewFieldSetRequest
  * @throws IOException if the JSON string is invalid with respect to FormsFieldSetCreateNewFieldSetRequest
  */
  public static FormsFieldSetCreateNewFieldSetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldSetCreateNewFieldSetRequest.class);
  }

 /**
  * Convert an instance of FormsFieldSetCreateNewFieldSetRequest to an JSON string
  *
  * @return JSON string
  */
