 ...
 * Forms
 */
@ApiModel(description = "Forms")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FormParameters {
  ...
  public FormParameters name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Example Form", required = true, value = "Name")
   ...
   * @return the FormParameters instance itself
   */
  public FormParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormParameters formParameters = (FormParameters) o;
    return Objects.equals(this.name, formParameters.name)&&
        Objects.equals(this.additionalProperties, formParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormParameters is not found in the empty JSON string", FormParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FormParameters>() {
           @Override
           public void write(JsonWriter out, FormParameters value) throws IOException {
           ...
           @Override
           public FormParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormParameters
  * @throws IOException if the JSON string is invalid with respect to FormParameters
  */
  public static FormParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormParameters.class);
  }

 /**
  * Convert an instance of FormParameters to an JSON string
  *
  * @return JSON string
  */
