...
public class WorkspaceUpdateRequest {
  ...
  public WorkspaceUpdateRequest workspace(WorkspaceParameters workspace) {
  ...
  **/
   ...
   * @return the WorkspaceUpdateRequest instance itself
   */
  public WorkspaceUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workspace, workspaceUpdateRequest.workspace)&&
        Objects.equals(this.additionalProperties, workspaceUpdateRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkspaceUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkspaceUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkspaceUpdateRequest>() {
           ...
           public WorkspaceUpdateRequest read(JsonReader in) throws IOException {
             ...
             WorkspaceUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
