...
import com.konfigthis.client.model.ProductsTagParameters;
...
public class ProductsTagUpdateTagByIdRequest {
  public static final String SERIALIZED_NAME_PRODUCTS_TAG = "products_tag";
  @SerializedName(SERIALIZED_NAME_PRODUCTS_TAG)
  private ProductsTagParameters productsTag;

  public ProductsTagUpdateTagByIdRequest() {
  }

  public ProductsTagUpdateTagByIdRequest productsTag(ProductsTagParameters productsTag) {
  ...
  **/
  ...
  public ProductsTagParameters getProductsTag() {
    return productsTag;
  }


  public void setProductsTag(ProductsTagParameters productsTag) {
   ...
   * @return the ProductsTagUpdateTagByIdRequest instance itself
   */
  public ProductsTagUpdateTagByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest = (ProductsTagUpdateTagByIdRequest) o;
    return Objects.equals(this.productsTag, productsTagUpdateTagByIdRequest.productsTag)&&
        Objects.equals(this.additionalProperties, productsTagUpdateTagByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productsTag, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductsTagUpdateTagByIdRequest {\n");
    sb.append("    productsTag: ").append(toIndentedString(productsTag)).append("\n");
  ...
  static {
    ...
    openapiFields.add("products_tag");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsTagUpdateTagByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsTagUpdateTagByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsTagUpdateTagByIdRequest is not found in the empty JSON string", ProductsTagUpdateTagByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsTagUpdateTagByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsTagUpdateTagByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsTagUpdateTagByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsTagUpdateTagByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsTagUpdateTagByIdRequest>() {
           @Override
           public void write(JsonWriter out, ProductsTagUpdateTagByIdRequest value) throws IOException {
           ...
           @Override
           public ProductsTagUpdateTagByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsTagUpdateTagByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsTagUpdateTagByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsTagUpdateTagByIdRequest
  * @throws IOException if the JSON string is invalid with respect to ProductsTagUpdateTagByIdRequest
  */
  public static ProductsTagUpdateTagByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsTagUpdateTagByIdRequest.class);
  }

 /**
  * Convert an instance of ProductsTagUpdateTagByIdRequest to an JSON string
  *
  * @return JSON string
  */
