...
public class FormCreateNewFormRequest {
  public static final String SERIALIZED_NAME_FORM = "form";
  @SerializedName(SERIALIZED_NAME_FORM)
  private FormParameters form;

  public FormCreateNewFormRequest() {
  }

  public FormCreateNewFormRequest form(FormParameters form) {
  ...
  **/
   ...
   * @return the FormCreateNewFormRequest instance itself
   */
  public FormCreateNewFormRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormCreateNewFormRequest formCreateNewFormRequest = (FormCreateNewFormRequest) o;
    return Objects.equals(this.form, formCreateNewFormRequest.form)&&
        Objects.equals(this.additionalProperties, formCreateNewFormRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormCreateNewFormRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormCreateNewFormRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormCreateNewFormRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormCreateNewFormRequest is not found in the empty JSON string", FormCreateNewFormRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormCreateNewFormRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormCreateNewFormRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormCreateNewFormRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormCreateNewFormRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormCreateNewFormRequest>() {
           @Override
           public void write(JsonWriter out, FormCreateNewFormRequest value) throws IOException {
           ...
           @Override
           public FormCreateNewFormRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormCreateNewFormRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormCreateNewFormRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormCreateNewFormRequest
  * @throws IOException if the JSON string is invalid with respect to FormCreateNewFormRequest
  */
  public static FormCreateNewFormRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormCreateNewFormRequest.class);
  }

 /**
  * Convert an instance of FormCreateNewFormRequest to an JSON string
  *
  * @return JSON string
  */
