...
public class ProductsTagParameters {
  ...
  public ProductsTagParameters() {
  }

  public ProductsTagParameters name(String name) {
  ...
  **/
  ...
  public ProductsTagParameters color(String color) {
  ...
  **/
   ...
   * @return the ProductsTagParameters instance itself
   */
  public ProductsTagParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsTagParameters productsTagParameters = (ProductsTagParameters) o;
    return Objects.equals(this.name, productsTagParameters.name) &&
        Objects.equals(this.color, productsTagParameters.color)&&
        Objects.equals(this.additionalProperties, productsTagParameters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, color, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductsTagParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsTagParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsTagParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsTagParameters is not found in the empty JSON string", ProductsTagParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductsTagParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsTagParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsTagParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsTagParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsTagParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsTagParameters>() {
           @Override
           public void write(JsonWriter out, ProductsTagParameters value) throws IOException {
           ...
           @Override
           public ProductsTagParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsTagParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsTagParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsTagParameters
  * @throws IOException if the JSON string is invalid with respect to ProductsTagParameters
  */
  public static ProductsTagParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsTagParameters.class);
  }

 /**
  * Convert an instance of ProductsTagParameters to an JSON string
  *
  * @return JSON string
  */
