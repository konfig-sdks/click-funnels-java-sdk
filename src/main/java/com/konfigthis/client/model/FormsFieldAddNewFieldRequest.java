...
public class FormsFieldAddNewFieldRequest {
  ...
  public FormsFieldAddNewFieldRequest() {
  }

  public FormsFieldAddNewFieldRequest formsField(FormsFieldParameters formsField) {
  ...
  **/
   ...
   * @return the FormsFieldAddNewFieldRequest instance itself
   */
  public FormsFieldAddNewFieldRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldAddNewFieldRequest formsFieldAddNewFieldRequest = (FormsFieldAddNewFieldRequest) o;
    return Objects.equals(this.formsField, formsFieldAddNewFieldRequest.formsField)&&
        Objects.equals(this.additionalProperties, formsFieldAddNewFieldRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldAddNewFieldRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldAddNewFieldRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldAddNewFieldRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldAddNewFieldRequest is not found in the empty JSON string", FormsFieldAddNewFieldRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldAddNewFieldRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldAddNewFieldRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldAddNewFieldRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldAddNewFieldRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldAddNewFieldRequest>() {
           @Override
           public void write(JsonWriter out, FormsFieldAddNewFieldRequest value) throws IOException {
           ...
           @Override
           public FormsFieldAddNewFieldRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldAddNewFieldRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldAddNewFieldRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldAddNewFieldRequest
  * @throws IOException if the JSON string is invalid with respect to FormsFieldAddNewFieldRequest
  */
  public static FormsFieldAddNewFieldRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldAddNewFieldRequest.class);
  }

 /**
  * Convert an instance of FormsFieldAddNewFieldRequest to an JSON string
  *
  * @return JSON string
  */
