 ...
 * Profile
 */
@ApiModel(description = "Profile")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserAttributes {
  ...
  public UserAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "User ID")
  ...
  public UserAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "User public ID")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "huong@stroman-kuhlman.co", required = true, value = "Email Address")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Louis", required = true, value = "First Name")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Von", required = true, value = "Last Name")
  ...
  public UserAttributes timeZone(Object timeZone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Your Time Zone")
  ...
  public UserAttributes locale(Object locale) {
  ...
  **/
  ...
  public UserAttributes createdAt(Object createdAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Signed up")
  ...
  public UserAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the UserAttributes instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userAttributes.id) &&
        Objects.equals(this.publicId, userAttributes.publicId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, email, firstName, lastName, timeZone, locale, createdAt, updatedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserAttributes>() {
           ...
           public UserAttributes read(JsonReader in) throws IOException {
             ...
             UserAttributes instance = thisAdapter.fromJsonTree(jsonObj);
