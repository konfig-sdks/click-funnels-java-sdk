...
public class OrderParameters {
  ...
  public OrderParameters notes(Object notes) {
  ...
  **/
   ...
   * @return the OrderParameters instance itself
   */
  public OrderParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.notes, orderParameters.notes)&&
        Objects.equals(this.additionalProperties, orderParameters.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderParameters is not found in the empty JSON string", OrderParameters.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderParameters>() {
           @Override
           public void write(JsonWriter out, OrderParameters value) throws IOException {
           ...
           @Override
           public OrderParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderParameters
  * @throws IOException if the JSON string is invalid with respect to OrderParameters
  */
  public static OrderParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderParameters.class);
  }

 /**
  * Convert an instance of OrderParameters to an JSON string
  *
  * @return JSON string
  */
