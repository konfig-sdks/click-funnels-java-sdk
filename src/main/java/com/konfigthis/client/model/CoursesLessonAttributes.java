 ...
 * Lessons
 */
@ApiModel(description = "Lessons")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CoursesLessonAttributes {
  ...
  public CoursesLessonAttributes() {
  }

  public CoursesLessonAttributes title(String title) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Lesson 1", required = true, value = "Title")
  ...
  public CoursesLessonAttributes id(String id) {
  ...
  **/
  ...
  public CoursesLessonAttributes publicId(Object publicId) {
  ...
  **/
  ...
  public CoursesLessonAttributes body(Object body) {
  ...
  **/
  ...
  public CoursesLessonAttributes sectionId(Object sectionId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Parent module")
  ...
  public CoursesLessonAttributes publishedAt(Object publishedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Schedule for")
  ...
  public CoursesLessonAttributes currentPath(Object currentPath) {
  ...
  **/
  ...
  public CoursesLessonAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public CoursesLessonAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the CoursesLessonAttributes instance itself
   */
  public CoursesLessonAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesLessonAttributes coursesLessonAttributes = (CoursesLessonAttributes) o;
    return Objects.equals(this.title, coursesLessonAttributes.title) &&
        Objects.equals(this.id, coursesLessonAttributes.id) &&
        Objects.equals(this.publicId, coursesLessonAttributes.publicId) &&
        Objects.equals(this.body, coursesLessonAttributes.body) &&
        Objects.equals(this.sectionId, coursesLessonAttributes.sectionId) &&
        Objects.equals(this.publishedAt, coursesLessonAttributes.publishedAt) &&
        Objects.equals(this.currentPath, coursesLessonAttributes.currentPath) &&
        Objects.equals(this.createdAt, coursesLessonAttributes.createdAt) &&
        Objects.equals(this.updatedAt, coursesLessonAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, coursesLessonAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, id, publicId, body, sectionId, publishedAt, currentPath, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesLessonAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesLessonAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesLessonAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesLessonAttributes is not found in the empty JSON string", CoursesLessonAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoursesLessonAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesLessonAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesLessonAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesLessonAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesLessonAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesLessonAttributes>() {
           @Override
           public void write(JsonWriter out, CoursesLessonAttributes value) throws IOException {
           ...
           @Override
           public CoursesLessonAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesLessonAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesLessonAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesLessonAttributes
  * @throws IOException if the JSON string is invalid with respect to CoursesLessonAttributes
  */
  public static CoursesLessonAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesLessonAttributes.class);
  }

 /**
  * Convert an instance of CoursesLessonAttributes to an JSON string
  *
  * @return JSON string
  */
