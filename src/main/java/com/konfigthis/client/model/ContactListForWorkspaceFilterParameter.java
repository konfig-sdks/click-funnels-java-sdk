...
public class ContactListForWorkspaceFilterParameter {
  ...
  public ContactListForWorkspaceFilterParameter() {
  }

  public ContactListForWorkspaceFilterParameter emailAddress(List<String> emailAddress) {
  ...
  public ContactListForWorkspaceFilterParameter addEmailAddressItem(String emailAddressItem) {
  ...
  **/
  ...
  @ApiModelProperty(example = "russel@clickfunnels.com,todd@clickfunnels.com", value = "")
  ...
  public ContactListForWorkspaceFilterParameter id(List<String> id) {
  ...
  public ContactListForWorkspaceFilterParameter addIdItem(String idItem) {
    if (this.id == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "142", value = "")
   ...
   * @return the ContactListForWorkspaceFilterParameter instance itself
   */
  public ContactListForWorkspaceFilterParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactListForWorkspaceFilterParameter contactListForWorkspaceFilterParameter = (ContactListForWorkspaceFilterParameter) o;
    return Objects.equals(this.emailAddress, contactListForWorkspaceFilterParameter.emailAddress) &&
        Objects.equals(this.id, contactListForWorkspaceFilterParameter.id)&&
        Objects.equals(this.additionalProperties, contactListForWorkspaceFilterParameter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, id, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContactListForWorkspaceFilterParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactListForWorkspaceFilterParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactListForWorkspaceFilterParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactListForWorkspaceFilterParameter is not found in the empty JSON string", ContactListForWorkspaceFilterParameter.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("email_address") != null && !jsonObj.get("email_address").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactListForWorkspaceFilterParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactListForWorkspaceFilterParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactListForWorkspaceFilterParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactListForWorkspaceFilterParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactListForWorkspaceFilterParameter>() {
           @Override
           public void write(JsonWriter out, ContactListForWorkspaceFilterParameter value) throws IOException {
           ...
           @Override
           public ContactListForWorkspaceFilterParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactListForWorkspaceFilterParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactListForWorkspaceFilterParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactListForWorkspaceFilterParameter
  * @throws IOException if the JSON string is invalid with respect to ContactListForWorkspaceFilterParameter
  */
  public static ContactListForWorkspaceFilterParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactListForWorkspaceFilterParameter.class);
  }

 /**
  * Convert an instance of ContactListForWorkspaceFilterParameter to an JSON string
  *
  * @return JSON string
  */
