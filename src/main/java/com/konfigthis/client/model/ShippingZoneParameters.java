...
public class ShippingZoneParameters {
  ...
  public ShippingZoneParameters() {
  }

  public ShippingZoneParameters name(String name) {
  ...
  **/
  ...
  public ShippingZoneParameters addressFilterId(Object addressFilterId) {
  ...
  **/
  ...
  public ShippingZoneParameters regionIds(Object regionIds) {
  ...
  **/
  ...
  public ShippingZoneParameters countryIds(Object countryIds) {
  ...
  **/
  ...
  public ShippingZoneParameters includesRestOfWorld(Object includesRestOfWorld) {
  ...
  **/
   ...
   * @return the ShippingZoneParameters instance itself
   */
  public ShippingZoneParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingZoneParameters shippingZoneParameters = (ShippingZoneParameters) o;
    return Objects.equals(this.name, shippingZoneParameters.name) &&
        Objects.equals(this.addressFilterId, shippingZoneParameters.addressFilterId) &&
        Objects.equals(this.regionIds, shippingZoneParameters.regionIds) &&
        Objects.equals(this.countryIds, shippingZoneParameters.countryIds) &&
        Objects.equals(this.includesRestOfWorld, shippingZoneParameters.includesRestOfWorld)&&
        Objects.equals(this.additionalProperties, shippingZoneParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, addressFilterId, regionIds, countryIds, includesRestOfWorld, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingZoneParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingZoneParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingZoneParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingZoneParameters is not found in the empty JSON string", ShippingZoneParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingZoneParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingZoneParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingZoneParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingZoneParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingZoneParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingZoneParameters>() {
           @Override
           public void write(JsonWriter out, ShippingZoneParameters value) throws IOException {
           ...
           @Override
           public ShippingZoneParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingZoneParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingZoneParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingZoneParameters
  * @throws IOException if the JSON string is invalid with respect to ShippingZoneParameters
  */
  public static ShippingZoneParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingZoneParameters.class);
  }

 /**
  * Convert an instance of ShippingZoneParameters to an JSON string
  *
  * @return JSON string
  */
