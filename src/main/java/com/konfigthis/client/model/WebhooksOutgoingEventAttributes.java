...
import com.konfigthis.client.model.WebhooksOutgoingEventAttributesData;
 ...
 * Webhooks Events
 */
@ApiModel(description = "Webhooks Events")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebhooksOutgoingEventAttributes {
  ...
  private Object eventTypeId = null;
  ...
  private Object subjectType = null;

  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private WebhooksOutgoingEventAttributesData data;

  public static final String SERIALIZED_NAME_CREATED_AT = "created_at";
  @SerializedName(SERIALIZED_NAME_CREATED_AT)
  private Object createdAt = null;

  public WebhooksOutgoingEventAttributes() {
  }

  public WebhooksOutgoingEventAttributes id(String id) {
  ...
  **/
  ...
  public WebhooksOutgoingEventAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Event public ID")
  ...
  public WebhooksOutgoingEventAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public WebhooksOutgoingEventAttributes uuid(Object uuid) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Event UUID")
  ...
  public WebhooksOutgoingEventAttributes eventTypeId(Object eventTypeId) {
  ...
  **/
  ...
  public WebhooksOutgoingEventAttributes subjectId(Integer subjectId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "14", required = true, value = "Subject ID")
  ...
  public WebhooksOutgoingEventAttributes subjectType(Object subjectType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Subject Type")
  ...
  public WebhooksOutgoingEventAttributes data(WebhooksOutgoingEventAttributesData data) {
  ...
  **/
  ...
  public WebhooksOutgoingEventAttributesData getData() {
    return data;
  }


  public void setData(WebhooksOutgoingEventAttributesData data) {
  ...
  public WebhooksOutgoingEventAttributes createdAt(Object createdAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Happened At")
   ...
   * @return the WebhooksOutgoingEventAttributes instance itself
   */
  public WebhooksOutgoingEventAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOutgoingEventAttributes webhooksOutgoingEventAttributes = (WebhooksOutgoingEventAttributes) o;
    return Objects.equals(this.id, webhooksOutgoingEventAttributes.id) &&
        Objects.equals(this.publicId, webhooksOutgoingEventAttributes.publicId) &&
        Objects.equals(this.workspaceId, webhooksOutgoingEventAttributes.workspaceId) &&
        Objects.equals(this.uuid, webhooksOutgoingEventAttributes.uuid) &&
        Objects.equals(this.eventTypeId, webhooksOutgoingEventAttributes.eventTypeId) &&
        Objects.equals(this.subjectId, webhooksOutgoingEventAttributes.subjectId) &&
        Objects.equals(this.subjectType, webhooksOutgoingEventAttributes.subjectType) &&
        Objects.equals(this.data, webhooksOutgoingEventAttributes.data) &&
        Objects.equals(this.createdAt, webhooksOutgoingEventAttributes.createdAt)&&
        Objects.equals(this.additionalProperties, webhooksOutgoingEventAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, uuid, eventTypeId, subjectId, subjectType, data, createdAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksOutgoingEventAttributes {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("subject_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksOutgoingEventAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksOutgoingEventAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksOutgoingEventAttributes is not found in the empty JSON string", WebhooksOutgoingEventAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksOutgoingEventAttributes.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        WebhooksOutgoingEventAttributesData.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksOutgoingEventAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksOutgoingEventAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksOutgoingEventAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksOutgoingEventAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksOutgoingEventAttributes>() {
           @Override
           public void write(JsonWriter out, WebhooksOutgoingEventAttributes value) throws IOException {
           ...
           @Override
           public WebhooksOutgoingEventAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksOutgoingEventAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksOutgoingEventAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksOutgoingEventAttributes
  * @throws IOException if the JSON string is invalid with respect to WebhooksOutgoingEventAttributes
  */
  public static WebhooksOutgoingEventAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksOutgoingEventAttributes.class);
  }

 /**
  * Convert an instance of WebhooksOutgoingEventAttributes to an JSON string
  *
  * @return JSON string
  */
