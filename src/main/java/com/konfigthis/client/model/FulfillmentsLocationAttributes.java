...
import com.konfigthis.client.model.LocationsProperty;
 ...
 * Locations
 */
@ApiModel(description = "Locations")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FulfillmentsLocationAttributes {
  ...
  public static final String SERIALIZED_NAME_EXTERNAL_APP = "external_app";
  @SerializedName(SERIALIZED_NAME_EXTERNAL_APP)
  private Object externalApp = null;
  ...
  private LocationsProperty address;

  public FulfillmentsLocationAttributes() {
  }

  public FulfillmentsLocationAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", required = true, value = "Location ID")
  ...
  public FulfillmentsLocationAttributes publicId(Object publicId) {
  ...
  **/
  ...
  public FulfillmentsLocationAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public FulfillmentsLocationAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Location", required = true, value = "Location name")
  ...
  public FulfillmentsLocationAttributes addressName(String addressName) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Address", required = true, value = "Address name")
  ...
  public FulfillmentsLocationAttributes emailAddress(String emailAddress) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "myemail1710866918@example.com", required = true, value = "Email address")
  ...
  public FulfillmentsLocationAttributes phoneNumber(Object phoneNumber) {
  ...
  **/
  ...
  public FulfillmentsLocationAttributes sortOrder(Object sortOrder) {
  ...
  **/
  ...
  public FulfillmentsLocationAttributes externalApp(Object externalApp) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "External app")

  public Object getExternalApp() {
    return externalApp;
  }


  public void setExternalApp(Object externalApp) {
  ...
  public FulfillmentsLocationAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FulfillmentsLocationAttributes updatedAt(Object updatedAt) {
  ...
  **/
  ...
  public FulfillmentsLocationAttributes address(LocationsProperty address) {
  ...
  **/
  ...
  public LocationsProperty getAddress() {
    return address;
  }


  public void setAddress(LocationsProperty address) {
   ...
   * @return the FulfillmentsLocationAttributes instance itself
   */
  public FulfillmentsLocationAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentsLocationAttributes fulfillmentsLocationAttributes = (FulfillmentsLocationAttributes) o;
    return Objects.equals(this.id, fulfillmentsLocationAttributes.id) &&
        Objects.equals(this.publicId, fulfillmentsLocationAttributes.publicId) &&
        Objects.equals(this.workspaceId, fulfillmentsLocationAttributes.workspaceId) &&
        Objects.equals(this.name, fulfillmentsLocationAttributes.name) &&
        Objects.equals(this.addressName, fulfillmentsLocationAttributes.addressName) &&
        Objects.equals(this.emailAddress, fulfillmentsLocationAttributes.emailAddress) &&
        Objects.equals(this.phoneNumber, fulfillmentsLocationAttributes.phoneNumber) &&
        Objects.equals(this.sortOrder, fulfillmentsLocationAttributes.sortOrder) &&
        Objects.equals(this.externalApp, fulfillmentsLocationAttributes.externalApp) &&
        Objects.equals(this.createdAt, fulfillmentsLocationAttributes.createdAt) &&
        Objects.equals(this.updatedAt, fulfillmentsLocationAttributes.updatedAt) &&
        Objects.equals(this.address, fulfillmentsLocationAttributes.address)&&
        Objects.equals(this.additionalProperties, fulfillmentsLocationAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, name, addressName, emailAddress, phoneNumber, sortOrder, externalApp, createdAt, updatedAt, address, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentsLocationAttributes {\n");
    ...
    sb.append("    externalApp: ").append(toIndentedString(externalApp)).append("\n");
  ...
  static {
    ...
    openapiFields.add("external_app");
    ...
    openapiRequiredFields.add("address_name");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentsLocationAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentsLocationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentsLocationAttributes is not found in the empty JSON string", FulfillmentsLocationAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FulfillmentsLocationAttributes.openapiRequiredFields) {
      ...
      if (!jsonObj.get("address_name").isJsonPrimitive()) {
      ...
      LocationsProperty.validateJsonObject(jsonObj.getAsJsonObject("address"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentsLocationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentsLocationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentsLocationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentsLocationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentsLocationAttributes>() {
           @Override
           public void write(JsonWriter out, FulfillmentsLocationAttributes value) throws IOException {
           ...
           @Override
           public FulfillmentsLocationAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentsLocationAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentsLocationAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentsLocationAttributes
  * @throws IOException if the JSON string is invalid with respect to FulfillmentsLocationAttributes
  */
  public static FulfillmentsLocationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentsLocationAttributes.class);
  }

 /**
  * Convert an instance of FulfillmentsLocationAttributes to an JSON string
  *
  * @return JSON string
  */
