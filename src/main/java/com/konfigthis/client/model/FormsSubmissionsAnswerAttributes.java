 ...
 * Answers
 */
@ApiModel(description = "Answers")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FormsSubmissionsAnswerAttributes {
  ...
  public static final String SERIALIZED_NAME_FIELDS_OPTION_ID = "fields_option_id";
  @SerializedName(SERIALIZED_NAME_FIELDS_OPTION_ID)
  private Object fieldsOptionId = null;

  public static final String SERIALIZED_NAME_ENTRY = "entry";
  @SerializedName(SERIALIZED_NAME_ENTRY)
  private Object entry = null;

  public static final String SERIALIZED_NAME_FIELDS_OPTION_IDS = "fields_option_ids";
  @SerializedName(SERIALIZED_NAME_FIELDS_OPTION_IDS)
  private Object fieldsOptionIds = null;
  ...
  public FormsSubmissionsAnswerAttributes() {
  }

  public FormsSubmissionsAnswerAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Answer ID")
  ...
  public FormsSubmissionsAnswerAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Answer public ID")
  ...
  public FormsSubmissionsAnswerAttributes submissionId(Integer submissionId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Submission ID")
  ...
  public FormsSubmissionsAnswerAttributes fieldId(Integer fieldId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3", required = true, value = "Field")
  ...
  public FormsSubmissionsAnswerAttributes fieldsOptionId(Object fieldsOptionId) {
    
    
    
    
    this.fieldsOptionId = fieldsOptionId;
    return this;
  }

   /**
   * Fields Option
   * @return fieldsOptionId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fields Option")

  public Object getFieldsOptionId() {
    return fieldsOptionId;
  }


  public void setFieldsOptionId(Object fieldsOptionId) {
  ...
  public FormsSubmissionsAnswerAttributes entry(Object entry) {
  ...
  **/
  ...
  public FormsSubmissionsAnswerAttributes fieldsOptionIds(Object fieldsOptionIds) {
    
    
    
    
    this.fieldsOptionIds = fieldsOptionIds;
    return this;
  }

   /**
   * Fields Options
   * @return fieldsOptionIds
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fields Options")

  public Object getFieldsOptionIds() {
    return fieldsOptionIds;
  }


  public void setFieldsOptionIds(Object fieldsOptionIds) {
  ...
  public FormsSubmissionsAnswerAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FormsSubmissionsAnswerAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the FormsSubmissionsAnswerAttributes instance itself
   */
  public FormsSubmissionsAnswerAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionsAnswerAttributes formsSubmissionsAnswerAttributes = (FormsSubmissionsAnswerAttributes) o;
    return Objects.equals(this.id, formsSubmissionsAnswerAttributes.id) &&
        Objects.equals(this.publicId, formsSubmissionsAnswerAttributes.publicId) &&
        Objects.equals(this.submissionId, formsSubmissionsAnswerAttributes.submissionId) &&
        Objects.equals(this.fieldId, formsSubmissionsAnswerAttributes.fieldId) &&
        Objects.equals(this.fieldsOptionId, formsSubmissionsAnswerAttributes.fieldsOptionId) &&
        Objects.equals(this.entry, formsSubmissionsAnswerAttributes.entry) &&
        Objects.equals(this.fieldsOptionIds, formsSubmissionsAnswerAttributes.fieldsOptionIds) &&
        Objects.equals(this.createdAt, formsSubmissionsAnswerAttributes.createdAt) &&
        Objects.equals(this.updatedAt, formsSubmissionsAnswerAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, formsSubmissionsAnswerAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, submissionId, fieldId, fieldsOptionId, entry, fieldsOptionIds, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsSubmissionsAnswerAttributes {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    publicId: ").append(toIndentedString(publicId)).append("\n");
    sb.append("    submissionId: ").append(toIndentedString(submissionId)).append("\n");
    sb.append("    fieldId: ").append(toIndentedString(fieldId)).append("\n");
    sb.append("    fieldsOptionId: ").append(toIndentedString(fieldsOptionId)).append("\n");
    sb.append("    entry: ").append(toIndentedString(entry)).append("\n");
    sb.append("    fieldsOptionIds: ").append(toIndentedString(fieldsOptionIds)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fields_option_id");
    openapiFields.add("entry");
    openapiFields.add("fields_option_ids");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionsAnswerAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionsAnswerAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionsAnswerAttributes is not found in the empty JSON string", FormsSubmissionsAnswerAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsSubmissionsAnswerAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionsAnswerAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionsAnswerAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionsAnswerAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionsAnswerAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionsAnswerAttributes>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionsAnswerAttributes value) throws IOException {
           ...
           @Override
           public FormsSubmissionsAnswerAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionsAnswerAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionsAnswerAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionsAnswerAttributes
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionsAnswerAttributes
  */
  public static FormsSubmissionsAnswerAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionsAnswerAttributes.class);
  }

 /**
  * Convert an instance of FormsSubmissionsAnswerAttributes to an JSON string
  *
  * @return JSON string
  */
