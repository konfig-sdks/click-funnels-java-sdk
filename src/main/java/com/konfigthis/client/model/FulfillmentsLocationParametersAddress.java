...
public class FulfillmentsLocationParametersAddress {
  public static final String SERIALIZED_NAME_ADDRESS_ONE = "address_one";
  @SerializedName(SERIALIZED_NAME_ADDRESS_ONE)
  private String addressOne;

  public static final String SERIALIZED_NAME_ADDRESS_TWO = "address_two";
  ...
  public FulfillmentsLocationParametersAddress() {
  }

  public FulfillmentsLocationParametersAddress addressOne(String addressOne) {
  ...
  **/
  ...
  public FulfillmentsLocationParametersAddress addressTwo(String addressTwo) {
  ...
  **/
  ...
  public FulfillmentsLocationParametersAddress city(String city) {
  ...
  **/
  ...
  public FulfillmentsLocationParametersAddress region(String region) {
  ...
  **/
  ...
  public FulfillmentsLocationParametersAddress country(String country) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The country (ISO2 code)")
  ...
  public FulfillmentsLocationParametersAddress postalCode(String postalCode) {
  ...
  **/
   ...
   * @return the FulfillmentsLocationParametersAddress instance itself
   */
  public FulfillmentsLocationParametersAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentsLocationParametersAddress fulfillmentsLocationParametersAddress = (FulfillmentsLocationParametersAddress) o;
    return Objects.equals(this.addressOne, fulfillmentsLocationParametersAddress.addressOne) &&
        Objects.equals(this.addressTwo, fulfillmentsLocationParametersAddress.addressTwo) &&
        Objects.equals(this.city, fulfillmentsLocationParametersAddress.city) &&
        Objects.equals(this.region, fulfillmentsLocationParametersAddress.region) &&
        Objects.equals(this.country, fulfillmentsLocationParametersAddress.country) &&
        Objects.equals(this.postalCode, fulfillmentsLocationParametersAddress.postalCode)&&
        Objects.equals(this.additionalProperties, fulfillmentsLocationParametersAddress.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressOne, addressTwo, city, region, country, postalCode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FulfillmentsLocationParametersAddress {\n");
  ...
  static {
    ...
    openapiFields.add("address_one");
    openapiFields.add("address_two");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentsLocationParametersAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentsLocationParametersAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentsLocationParametersAddress is not found in the empty JSON string", FulfillmentsLocationParametersAddress.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("address_one") != null && !jsonObj.get("address_one").isJsonNull()) && !jsonObj.get("address_one").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `address_one` to be a primitive type in the JSON string but got `%s`", jsonObj.get("address_one").toString()));
      }
      if ((jsonObj.get("address_two") != null && !jsonObj.get("address_two").isJsonNull()) && !jsonObj.get("address_two").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `address_two` to be a primitive type in the JSON string but got `%s`", jsonObj.get("address_two").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentsLocationParametersAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentsLocationParametersAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentsLocationParametersAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentsLocationParametersAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentsLocationParametersAddress>() {
           @Override
           public void write(JsonWriter out, FulfillmentsLocationParametersAddress value) throws IOException {
           ...
           @Override
           public FulfillmentsLocationParametersAddress read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentsLocationParametersAddress instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentsLocationParametersAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentsLocationParametersAddress
  * @throws IOException if the JSON string is invalid with respect to FulfillmentsLocationParametersAddress
  */
  public static FulfillmentsLocationParametersAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentsLocationParametersAddress.class);
  }

 /**
  * Convert an instance of FulfillmentsLocationParametersAddress to an JSON string
  *
  * @return JSON string
  */
