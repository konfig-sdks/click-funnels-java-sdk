 ...
 * Contact Groups
 */
@ApiModel(description = "Contact Groups")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderContactGroupAttributes {
  ...
  public OrderContactGroupAttributes() {
  }

  public OrderContactGroupAttributes id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the contact group")
  ...
  public OrderContactGroupAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The name of the contact group")
   ...
   * @return the OrderContactGroupAttributes instance itself
   */
  public OrderContactGroupAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderContactGroupAttributes orderContactGroupAttributes = (OrderContactGroupAttributes) o;
    return Objects.equals(this.id, orderContactGroupAttributes.id) &&
        Objects.equals(this.name, orderContactGroupAttributes.name)&&
        Objects.equals(this.additionalProperties, orderContactGroupAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderContactGroupAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderContactGroupAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderContactGroupAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderContactGroupAttributes is not found in the empty JSON string", OrderContactGroupAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderContactGroupAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderContactGroupAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderContactGroupAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderContactGroupAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderContactGroupAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderContactGroupAttributes>() {
           @Override
           public void write(JsonWriter out, OrderContactGroupAttributes value) throws IOException {
           ...
           @Override
           public OrderContactGroupAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderContactGroupAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderContactGroupAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderContactGroupAttributes
  * @throws IOException if the JSON string is invalid with respect to OrderContactGroupAttributes
  */
  public static OrderContactGroupAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderContactGroupAttributes.class);
  }

 /**
  * Convert an instance of OrderContactGroupAttributes to an JSON string
  *
  * @return JSON string
  */
