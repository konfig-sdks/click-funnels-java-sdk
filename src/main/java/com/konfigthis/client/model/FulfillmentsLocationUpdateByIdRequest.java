...
public class FulfillmentsLocationUpdateByIdRequest {
  ...
  public FulfillmentsLocationUpdateByIdRequest() {
  }

  public FulfillmentsLocationUpdateByIdRequest fulfillmentsLocation(FulfillmentsLocationParameters fulfillmentsLocation) {
  ...
  **/
   ...
   * @return the FulfillmentsLocationUpdateByIdRequest instance itself
   */
  public FulfillmentsLocationUpdateByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest = (FulfillmentsLocationUpdateByIdRequest) o;
    return Objects.equals(this.fulfillmentsLocation, fulfillmentsLocationUpdateByIdRequest.fulfillmentsLocation)&&
        Objects.equals(this.additionalProperties, fulfillmentsLocationUpdateByIdRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentsLocationUpdateByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentsLocationUpdateByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentsLocationUpdateByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentsLocationUpdateByIdRequest is not found in the empty JSON string", FulfillmentsLocationUpdateByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentsLocationUpdateByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentsLocationUpdateByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentsLocationUpdateByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentsLocationUpdateByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentsLocationUpdateByIdRequest>() {
           @Override
           public void write(JsonWriter out, FulfillmentsLocationUpdateByIdRequest value) throws IOException {
           ...
           @Override
           public FulfillmentsLocationUpdateByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentsLocationUpdateByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentsLocationUpdateByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentsLocationUpdateByIdRequest
  * @throws IOException if the JSON string is invalid with respect to FulfillmentsLocationUpdateByIdRequest
  */
  public static FulfillmentsLocationUpdateByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentsLocationUpdateByIdRequest.class);
  }

 /**
  * Convert an instance of FulfillmentsLocationUpdateByIdRequest to an JSON string
  *
  * @return JSON string
  */
