...
import com.konfigthis.client.model.FormsFieldSetParameters;
...
public class FormsFieldSetUpdateFieldSetByIdRequest {
  public static final String SERIALIZED_NAME_FORMS_FIELD_SET = "forms_field_set";
  @SerializedName(SERIALIZED_NAME_FORMS_FIELD_SET)
  private FormsFieldSetParameters formsFieldSet;

  public FormsFieldSetUpdateFieldSetByIdRequest() {
  }

  public FormsFieldSetUpdateFieldSetByIdRequest formsFieldSet(FormsFieldSetParameters formsFieldSet) {
   ...
   /**
   * Get formsFieldSet
   * @return formsFieldSet
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public FormsFieldSetParameters getFormsFieldSet() {
    return formsFieldSet;
  }


  public void setFormsFieldSet(FormsFieldSetParameters formsFieldSet) {
   ...
   * @return the FormsFieldSetUpdateFieldSetByIdRequest instance itself
   */
  public FormsFieldSetUpdateFieldSetByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldSetUpdateFieldSetByIdRequest formsFieldSetUpdateFieldSetByIdRequest = (FormsFieldSetUpdateFieldSetByIdRequest) o;
    return Objects.equals(this.formsFieldSet, formsFieldSetUpdateFieldSetByIdRequest.formsFieldSet)&&
        Objects.equals(this.additionalProperties, formsFieldSetUpdateFieldSetByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formsFieldSet, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormsFieldSetUpdateFieldSetByIdRequest {\n");
    sb.append("    formsFieldSet: ").append(toIndentedString(formsFieldSet)).append("\n");
  ...
  static {
    ...
    openapiFields.add("forms_field_set");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldSetUpdateFieldSetByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldSetUpdateFieldSetByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldSetUpdateFieldSetByIdRequest is not found in the empty JSON string", FormsFieldSetUpdateFieldSetByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldSetUpdateFieldSetByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldSetUpdateFieldSetByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldSetUpdateFieldSetByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldSetUpdateFieldSetByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldSetUpdateFieldSetByIdRequest>() {
           @Override
           public void write(JsonWriter out, FormsFieldSetUpdateFieldSetByIdRequest value) throws IOException {
           ...
           @Override
           public FormsFieldSetUpdateFieldSetByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldSetUpdateFieldSetByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldSetUpdateFieldSetByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldSetUpdateFieldSetByIdRequest
  * @throws IOException if the JSON string is invalid with respect to FormsFieldSetUpdateFieldSetByIdRequest
  */
  public static FormsFieldSetUpdateFieldSetByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldSetUpdateFieldSetByIdRequest.class);
  }

 /**
  * Convert an instance of FormsFieldSetUpdateFieldSetByIdRequest to an JSON string
  *
  * @return JSON string
  */
