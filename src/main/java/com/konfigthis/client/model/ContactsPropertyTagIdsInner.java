...
public class ContactsPropertyTagIdsInner {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;

  public ContactsPropertyTagIdsInner() {
  }

  public ContactsPropertyTagIdsInner id(String id) {
  ...
  **/
   ...
   * @return the ContactsPropertyTagIdsInner instance itself
   */
  public ContactsPropertyTagIdsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsPropertyTagIdsInner contactsPropertyTagIdsInner = (ContactsPropertyTagIdsInner) o;
    return Objects.equals(this.id, contactsPropertyTagIdsInner.id)&&
        Objects.equals(this.additionalProperties, contactsPropertyTagIdsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactsPropertyTagIdsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsPropertyTagIdsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsPropertyTagIdsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsPropertyTagIdsInner is not found in the empty JSON string", ContactsPropertyTagIdsInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsPropertyTagIdsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsPropertyTagIdsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsPropertyTagIdsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsPropertyTagIdsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsPropertyTagIdsInner>() {
           @Override
           public void write(JsonWriter out, ContactsPropertyTagIdsInner value) throws IOException {
           ...
           @Override
           public ContactsPropertyTagIdsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsPropertyTagIdsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsPropertyTagIdsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsPropertyTagIdsInner
  * @throws IOException if the JSON string is invalid with respect to ContactsPropertyTagIdsInner
  */
  public static ContactsPropertyTagIdsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsPropertyTagIdsInner.class);
  }

 /**
  * Convert an instance of ContactsPropertyTagIdsInner to an JSON string
  *
  * @return JSON string
  */
