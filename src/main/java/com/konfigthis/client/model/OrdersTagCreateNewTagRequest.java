...
public class OrdersTagCreateNewTagRequest {
  ...
  public OrdersTagCreateNewTagRequest() {
  }

  public OrdersTagCreateNewTagRequest ordersTag(OrdersTagParameters ordersTag) {
  ...
  **/
   ...
   * @return the OrdersTagCreateNewTagRequest instance itself
   */
  public OrdersTagCreateNewTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest = (OrdersTagCreateNewTagRequest) o;
    return Objects.equals(this.ordersTag, ordersTagCreateNewTagRequest.ordersTag)&&
        Objects.equals(this.additionalProperties, ordersTagCreateNewTagRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersTagCreateNewTagRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersTagCreateNewTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersTagCreateNewTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersTagCreateNewTagRequest is not found in the empty JSON string", OrdersTagCreateNewTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersTagCreateNewTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersTagCreateNewTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersTagCreateNewTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersTagCreateNewTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersTagCreateNewTagRequest>() {
           @Override
           public void write(JsonWriter out, OrdersTagCreateNewTagRequest value) throws IOException {
           ...
           @Override
           public OrdersTagCreateNewTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersTagCreateNewTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersTagCreateNewTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersTagCreateNewTagRequest
  * @throws IOException if the JSON string is invalid with respect to OrdersTagCreateNewTagRequest
  */
  public static OrdersTagCreateNewTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersTagCreateNewTagRequest.class);
  }

 /**
  * Convert an instance of OrdersTagCreateNewTagRequest to an JSON string
  *
  * @return JSON string
  */
