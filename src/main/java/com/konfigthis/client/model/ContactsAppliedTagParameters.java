...
public class ContactsAppliedTagParameters {
  public static final String SERIALIZED_NAME_TAG_ID = "tag_id";
  @SerializedName(SERIALIZED_NAME_TAG_ID)
  private Integer tagId;

  public ContactsAppliedTagParameters() {
  }

  public ContactsAppliedTagParameters tagId(Integer tagId) {
  ...
  **/
   ...
   * @return the ContactsAppliedTagParameters instance itself
   */
  public ContactsAppliedTagParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsAppliedTagParameters contactsAppliedTagParameters = (ContactsAppliedTagParameters) o;
    return Objects.equals(this.tagId, contactsAppliedTagParameters.tagId)&&
        Objects.equals(this.additionalProperties, contactsAppliedTagParameters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tagId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContactsAppliedTagParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsAppliedTagParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsAppliedTagParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsAppliedTagParameters is not found in the empty JSON string", ContactsAppliedTagParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactsAppliedTagParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsAppliedTagParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsAppliedTagParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsAppliedTagParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsAppliedTagParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsAppliedTagParameters>() {
           @Override
           public void write(JsonWriter out, ContactsAppliedTagParameters value) throws IOException {
           ...
           @Override
           public ContactsAppliedTagParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsAppliedTagParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsAppliedTagParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsAppliedTagParameters
  * @throws IOException if the JSON string is invalid with respect to ContactsAppliedTagParameters
  */
  public static ContactsAppliedTagParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsAppliedTagParameters.class);
  }

 /**
  * Convert an instance of ContactsAppliedTagParameters to an JSON string
  *
  * @return JSON string
  */
