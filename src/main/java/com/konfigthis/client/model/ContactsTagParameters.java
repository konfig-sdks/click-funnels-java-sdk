...
public class ContactsTagParameters {
  ...
  public ContactsTagParameters() {
  }

  public ContactsTagParameters name(String name) {
  ...
  **/
  ...
  public ContactsTagParameters color(String color) {
  ...
  **/
   ...
   * @return the ContactsTagParameters instance itself
   */
  public ContactsTagParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsTagParameters contactsTagParameters = (ContactsTagParameters) o;
    return Objects.equals(this.name, contactsTagParameters.name) &&
        Objects.equals(this.color, contactsTagParameters.color)&&
        Objects.equals(this.additionalProperties, contactsTagParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactsTagParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsTagParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsTagParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsTagParameters is not found in the empty JSON string", ContactsTagParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactsTagParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsTagParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsTagParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsTagParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsTagParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsTagParameters>() {
           @Override
           public void write(JsonWriter out, ContactsTagParameters value) throws IOException {
           ...
           @Override
           public ContactsTagParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsTagParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsTagParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsTagParameters
  * @throws IOException if the JSON string is invalid with respect to ContactsTagParameters
  */
  public static ContactsTagParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsTagParameters.class);
  }

 /**
  * Convert an instance of ContactsTagParameters to an JSON string
  *
  * @return JSON string
  */
