 ...
 * Product Tags
 */
@ApiModel(description = "Product Tags")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProductsTagAttributes {
  ...
  public ProductsTagAttributes() {
  }

  public ProductsTagAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "40", required = true, value = "Tag ID")
  ...
  public ProductsTagAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Tag public ID")
  ...
  public ProductsTagAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public ProductsTagAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Tag", required = true, value = "Name")
  ...
  public ProductsTagAttributes color(String color) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "emerald", required = true, value = "Color")
  ...
  public ProductsTagAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ProductsTagAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ProductsTagAttributes instance itself
   */
  public ProductsTagAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsTagAttributes productsTagAttributes = (ProductsTagAttributes) o;
    return Objects.equals(this.id, productsTagAttributes.id) &&
        Objects.equals(this.publicId, productsTagAttributes.publicId) &&
        Objects.equals(this.workspaceId, productsTagAttributes.workspaceId) &&
        Objects.equals(this.name, productsTagAttributes.name) &&
        Objects.equals(this.color, productsTagAttributes.color) &&
        Objects.equals(this.createdAt, productsTagAttributes.createdAt) &&
        Objects.equals(this.updatedAt, productsTagAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, productsTagAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, name, color, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsTagAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsTagAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsTagAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsTagAttributes is not found in the empty JSON string", ProductsTagAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductsTagAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsTagAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsTagAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsTagAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsTagAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsTagAttributes>() {
           @Override
           public void write(JsonWriter out, ProductsTagAttributes value) throws IOException {
           ...
           @Override
           public ProductsTagAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsTagAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsTagAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsTagAttributes
  * @throws IOException if the JSON string is invalid with respect to ProductsTagAttributes
  */
  public static ProductsTagAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsTagAttributes.class);
  }

 /**
  * Convert an instance of ProductsTagAttributes to an JSON string
  *
  * @return JSON string
  */
