...
import com.konfigthis.client.model.FormsFieldParameters;
...
public class FormsFieldUpdateFieldByIdRequest {
  public static final String SERIALIZED_NAME_FORMS_FIELD = "forms_field";
  @SerializedName(SERIALIZED_NAME_FORMS_FIELD)
  private FormsFieldParameters formsField;

  public FormsFieldUpdateFieldByIdRequest() {
  }

  public FormsFieldUpdateFieldByIdRequest formsField(FormsFieldParameters formsField) {
  ...
  **/
  ...
  public FormsFieldParameters getFormsField() {
    return formsField;
  }


  public void setFormsField(FormsFieldParameters formsField) {
   ...
   * @return the FormsFieldUpdateFieldByIdRequest instance itself
   */
  public FormsFieldUpdateFieldByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldUpdateFieldByIdRequest formsFieldUpdateFieldByIdRequest = (FormsFieldUpdateFieldByIdRequest) o;
    return Objects.equals(this.formsField, formsFieldUpdateFieldByIdRequest.formsField)&&
        Objects.equals(this.additionalProperties, formsFieldUpdateFieldByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formsField, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormsFieldUpdateFieldByIdRequest {\n");
    sb.append("    formsField: ").append(toIndentedString(formsField)).append("\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldUpdateFieldByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldUpdateFieldByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldUpdateFieldByIdRequest is not found in the empty JSON string", FormsFieldUpdateFieldByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldUpdateFieldByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldUpdateFieldByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldUpdateFieldByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldUpdateFieldByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldUpdateFieldByIdRequest>() {
           @Override
           public void write(JsonWriter out, FormsFieldUpdateFieldByIdRequest value) throws IOException {
           ...
           @Override
           public FormsFieldUpdateFieldByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldUpdateFieldByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldUpdateFieldByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldUpdateFieldByIdRequest
  * @throws IOException if the JSON string is invalid with respect to FormsFieldUpdateFieldByIdRequest
  */
  public static FormsFieldUpdateFieldByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldUpdateFieldByIdRequest.class);
  }

 /**
  * Convert an instance of FormsFieldUpdateFieldByIdRequest to an JSON string
  *
  * @return JSON string
  */
