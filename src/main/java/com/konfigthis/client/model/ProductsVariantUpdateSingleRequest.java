...
public class ProductsVariantUpdateSingleRequest {
  ...
  public ProductsVariantUpdateSingleRequest() {
  }

  public ProductsVariantUpdateSingleRequest productsVariant(ProductsVariantParameters productsVariant) {
  ...
  **/
   ...
   * @return the ProductsVariantUpdateSingleRequest instance itself
   */
  public ProductsVariantUpdateSingleRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest = (ProductsVariantUpdateSingleRequest) o;
    return Objects.equals(this.productsVariant, productsVariantUpdateSingleRequest.productsVariant)&&
        Objects.equals(this.additionalProperties, productsVariantUpdateSingleRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsVariantUpdateSingleRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsVariantUpdateSingleRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsVariantUpdateSingleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsVariantUpdateSingleRequest is not found in the empty JSON string", ProductsVariantUpdateSingleRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsVariantUpdateSingleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsVariantUpdateSingleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsVariantUpdateSingleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsVariantUpdateSingleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsVariantUpdateSingleRequest>() {
           @Override
           public void write(JsonWriter out, ProductsVariantUpdateSingleRequest value) throws IOException {
           ...
           @Override
           public ProductsVariantUpdateSingleRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsVariantUpdateSingleRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsVariantUpdateSingleRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsVariantUpdateSingleRequest
  * @throws IOException if the JSON string is invalid with respect to ProductsVariantUpdateSingleRequest
  */
  public static ProductsVariantUpdateSingleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsVariantUpdateSingleRequest.class);
  }

 /**
  * Convert an instance of ProductsVariantUpdateSingleRequest to an JSON string
  *
  * @return JSON string
  */
