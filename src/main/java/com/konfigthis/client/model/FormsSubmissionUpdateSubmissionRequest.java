...
public class FormsSubmissionUpdateSubmissionRequest {
  ...
  public FormsSubmissionUpdateSubmissionRequest() {
  }

  public FormsSubmissionUpdateSubmissionRequest formsSubmission(FormsSubmissionParameters formsSubmission) {
  ...
  **/
   ...
   * @return the FormsSubmissionUpdateSubmissionRequest instance itself
   */
  public FormsSubmissionUpdateSubmissionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionUpdateSubmissionRequest formsSubmissionUpdateSubmissionRequest = (FormsSubmissionUpdateSubmissionRequest) o;
    return Objects.equals(this.formsSubmission, formsSubmissionUpdateSubmissionRequest.formsSubmission)&&
        Objects.equals(this.additionalProperties, formsSubmissionUpdateSubmissionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsSubmissionUpdateSubmissionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionUpdateSubmissionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionUpdateSubmissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionUpdateSubmissionRequest is not found in the empty JSON string", FormsSubmissionUpdateSubmissionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionUpdateSubmissionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionUpdateSubmissionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionUpdateSubmissionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionUpdateSubmissionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionUpdateSubmissionRequest>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionUpdateSubmissionRequest value) throws IOException {
           ...
           @Override
           public FormsSubmissionUpdateSubmissionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionUpdateSubmissionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionUpdateSubmissionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionUpdateSubmissionRequest
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionUpdateSubmissionRequest
  */
  public static FormsSubmissionUpdateSubmissionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionUpdateSubmissionRequest.class);
  }

 /**
  * Convert an instance of FormsSubmissionUpdateSubmissionRequest to an JSON string
  *
  * @return JSON string
  */
