...
import com.konfigthis.client.model.WebhooksOutgoingEndpointParameters;
...
public class WebhooksOutgoingEndpointUpdateEndpointRequest {
  public static final String SERIALIZED_NAME_WEBHOOKS_OUTGOING_ENDPOINT = "webhooks_outgoing_endpoint";
  @SerializedName(SERIALIZED_NAME_WEBHOOKS_OUTGOING_ENDPOINT)
  private WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint;

  public WebhooksOutgoingEndpointUpdateEndpointRequest() {
  }

  public WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpoint(WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint) {
   ...
   /**
   * Get webhooksOutgoingEndpoint
   * @return webhooksOutgoingEndpoint
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public WebhooksOutgoingEndpointParameters getWebhooksOutgoingEndpoint() {
    return webhooksOutgoingEndpoint;
  }


  public void setWebhooksOutgoingEndpoint(WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint) {
   ...
   * @return the WebhooksOutgoingEndpointUpdateEndpointRequest instance itself
   */
  public WebhooksOutgoingEndpointUpdateEndpointRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest = (WebhooksOutgoingEndpointUpdateEndpointRequest) o;
    return Objects.equals(this.webhooksOutgoingEndpoint, webhooksOutgoingEndpointUpdateEndpointRequest.webhooksOutgoingEndpoint)&&
        Objects.equals(this.additionalProperties, webhooksOutgoingEndpointUpdateEndpointRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhooksOutgoingEndpoint, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhooksOutgoingEndpointUpdateEndpointRequest {\n");
    sb.append("    webhooksOutgoingEndpoint: ").append(toIndentedString(webhooksOutgoingEndpoint)).append("\n");
  ...
  static {
    ...
    openapiFields.add("webhooks_outgoing_endpoint");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksOutgoingEndpointUpdateEndpointRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksOutgoingEndpointUpdateEndpointRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksOutgoingEndpointUpdateEndpointRequest is not found in the empty JSON string", WebhooksOutgoingEndpointUpdateEndpointRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksOutgoingEndpointUpdateEndpointRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksOutgoingEndpointUpdateEndpointRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksOutgoingEndpointUpdateEndpointRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksOutgoingEndpointUpdateEndpointRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksOutgoingEndpointUpdateEndpointRequest>() {
           @Override
           public void write(JsonWriter out, WebhooksOutgoingEndpointUpdateEndpointRequest value) throws IOException {
           ...
           @Override
           public WebhooksOutgoingEndpointUpdateEndpointRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksOutgoingEndpointUpdateEndpointRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksOutgoingEndpointUpdateEndpointRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksOutgoingEndpointUpdateEndpointRequest
  * @throws IOException if the JSON string is invalid with respect to WebhooksOutgoingEndpointUpdateEndpointRequest
  */
  public static WebhooksOutgoingEndpointUpdateEndpointRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksOutgoingEndpointUpdateEndpointRequest.class);
  }

 /**
  * Convert an instance of WebhooksOutgoingEndpointUpdateEndpointRequest to an JSON string
  *
  * @return JSON string
  */
