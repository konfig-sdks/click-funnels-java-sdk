...
import com.konfigthis.client.model.FulfillmentsLocationParametersAddress;
...
public class FulfillmentsLocationParameters {
  ...
  private FulfillmentsLocationParametersAddress address;

  public FulfillmentsLocationParameters() {
  }

  public FulfillmentsLocationParameters name(String name) {
  ...
  **/
  ...
  public FulfillmentsLocationParameters addressName(String addressName) {
  ...
  **/
  ...
  public FulfillmentsLocationParameters emailAddress(String emailAddress) {
  ...
  **/
  ...
  public FulfillmentsLocationParameters phoneNumber(Object phoneNumber) {
  ...
  **/
  ...
  public FulfillmentsLocationParameters externalApp(Boolean externalApp) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates external application request. Only to be used for requests made with Oauth 2.0 access tokens. When acting on behalf of others, you might have special requirements or exemptions, like not needing to provide an address for the fulfillment location.")
  ...
  public FulfillmentsLocationParameters address(FulfillmentsLocationParametersAddress address) {
  ...
  **/
  ...
  public FulfillmentsLocationParametersAddress getAddress() {
    return address;
  }


  public void setAddress(FulfillmentsLocationParametersAddress address) {
   ...
   * @return the FulfillmentsLocationParameters instance itself
   */
  public FulfillmentsLocationParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentsLocationParameters fulfillmentsLocationParameters = (FulfillmentsLocationParameters) o;
    return Objects.equals(this.name, fulfillmentsLocationParameters.name) &&
        Objects.equals(this.addressName, fulfillmentsLocationParameters.addressName) &&
        Objects.equals(this.emailAddress, fulfillmentsLocationParameters.emailAddress) &&
        Objects.equals(this.phoneNumber, fulfillmentsLocationParameters.phoneNumber) &&
        Objects.equals(this.externalApp, fulfillmentsLocationParameters.externalApp) &&
        Objects.equals(this.address, fulfillmentsLocationParameters.address)&&
        Objects.equals(this.additionalProperties, fulfillmentsLocationParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, addressName, emailAddress, phoneNumber, externalApp, address, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentsLocationParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentsLocationParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentsLocationParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentsLocationParameters is not found in the empty JSON string", FulfillmentsLocationParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FulfillmentsLocationParameters.openapiRequiredFields) {
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        FulfillmentsLocationParametersAddress.validateJsonObject(jsonObj.getAsJsonObject("address"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentsLocationParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentsLocationParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentsLocationParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentsLocationParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentsLocationParameters>() {
           @Override
           public void write(JsonWriter out, FulfillmentsLocationParameters value) throws IOException {
           ...
           @Override
           public FulfillmentsLocationParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentsLocationParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentsLocationParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentsLocationParameters
  * @throws IOException if the JSON string is invalid with respect to FulfillmentsLocationParameters
  */
  public static FulfillmentsLocationParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentsLocationParameters.class);
  }

 /**
  * Convert an instance of FulfillmentsLocationParameters to an JSON string
  *
  * @return JSON string
  */
