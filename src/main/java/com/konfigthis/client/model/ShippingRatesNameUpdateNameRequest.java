...
public class ShippingRatesNameUpdateNameRequest {
  ...
  public ShippingRatesNameUpdateNameRequest() {
  }

  public ShippingRatesNameUpdateNameRequest shippingRatesName(ShippingRatesNameParameters shippingRatesName) {
  ...
  **/
   ...
   * @return the ShippingRatesNameUpdateNameRequest instance itself
   */
  public ShippingRatesNameUpdateNameRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest = (ShippingRatesNameUpdateNameRequest) o;
    return Objects.equals(this.shippingRatesName, shippingRatesNameUpdateNameRequest.shippingRatesName)&&
        Objects.equals(this.additionalProperties, shippingRatesNameUpdateNameRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingRatesNameUpdateNameRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRatesNameUpdateNameRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRatesNameUpdateNameRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRatesNameUpdateNameRequest is not found in the empty JSON string", ShippingRatesNameUpdateNameRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRatesNameUpdateNameRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRatesNameUpdateNameRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRatesNameUpdateNameRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRatesNameUpdateNameRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRatesNameUpdateNameRequest>() {
           @Override
           public void write(JsonWriter out, ShippingRatesNameUpdateNameRequest value) throws IOException {
           ...
           @Override
           public ShippingRatesNameUpdateNameRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRatesNameUpdateNameRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRatesNameUpdateNameRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRatesNameUpdateNameRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingRatesNameUpdateNameRequest
  */
  public static ShippingRatesNameUpdateNameRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRatesNameUpdateNameRequest.class);
  }

 /**
  * Convert an instance of ShippingRatesNameUpdateNameRequest to an JSON string
  *
  * @return JSON string
  */
