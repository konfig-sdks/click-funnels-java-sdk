...
public class ShippingPackageAddToWorkspaceRequest {
  ...
  public ShippingPackageAddToWorkspaceRequest() {
  }

  public ShippingPackageAddToWorkspaceRequest shippingPackage(ShippingPackageParameters shippingPackage) {
  ...
  **/
   ...
   * @return the ShippingPackageAddToWorkspaceRequest instance itself
   */
  public ShippingPackageAddToWorkspaceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingPackageAddToWorkspaceRequest shippingPackageAddToWorkspaceRequest = (ShippingPackageAddToWorkspaceRequest) o;
    return Objects.equals(this.shippingPackage, shippingPackageAddToWorkspaceRequest.shippingPackage)&&
        Objects.equals(this.additionalProperties, shippingPackageAddToWorkspaceRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingPackageAddToWorkspaceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingPackageAddToWorkspaceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingPackageAddToWorkspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingPackageAddToWorkspaceRequest is not found in the empty JSON string", ShippingPackageAddToWorkspaceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingPackageAddToWorkspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingPackageAddToWorkspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingPackageAddToWorkspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingPackageAddToWorkspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingPackageAddToWorkspaceRequest>() {
           @Override
           public void write(JsonWriter out, ShippingPackageAddToWorkspaceRequest value) throws IOException {
           ...
           @Override
           public ShippingPackageAddToWorkspaceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingPackageAddToWorkspaceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingPackageAddToWorkspaceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingPackageAddToWorkspaceRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingPackageAddToWorkspaceRequest
  */
  public static ShippingPackageAddToWorkspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingPackageAddToWorkspaceRequest.class);
  }

 /**
  * Convert an instance of ShippingPackageAddToWorkspaceRequest to an JSON string
  *
  * @return JSON string
  */
