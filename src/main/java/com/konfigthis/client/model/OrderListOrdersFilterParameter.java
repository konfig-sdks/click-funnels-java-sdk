...
public class OrderListOrdersFilterParameter {
  ...
  public OrderListOrdersFilterParameter() {
  }

  public OrderListOrdersFilterParameter contactId(List<String> contactId) {
  ...
  public OrderListOrdersFilterParameter addContactIdItem(String contactIdItem) {
  ...
  **/
  ...
  public OrderListOrdersFilterParameter id(List<String> id) {
  ...
  public OrderListOrdersFilterParameter addIdItem(String idItem) {
    if (this.id == null) {
  ...
  **/
   ...
   * @return the OrderListOrdersFilterParameter instance itself
   */
  public OrderListOrdersFilterParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderListOrdersFilterParameter orderListOrdersFilterParameter = (OrderListOrdersFilterParameter) o;
    return Objects.equals(this.contactId, orderListOrdersFilterParameter.contactId) &&
        Objects.equals(this.id, orderListOrdersFilterParameter.id)&&
        Objects.equals(this.additionalProperties, orderListOrdersFilterParameter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactId, id, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderListOrdersFilterParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderListOrdersFilterParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderListOrdersFilterParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderListOrdersFilterParameter is not found in the empty JSON string", OrderListOrdersFilterParameter.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("contact_id") != null && !jsonObj.get("contact_id").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `contact_id` to be an array in the JSON string but got `%s`", jsonObj.get("contact_id").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderListOrdersFilterParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderListOrdersFilterParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderListOrdersFilterParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderListOrdersFilterParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderListOrdersFilterParameter>() {
           @Override
           public void write(JsonWriter out, OrderListOrdersFilterParameter value) throws IOException {
           ...
           @Override
           public OrderListOrdersFilterParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderListOrdersFilterParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderListOrdersFilterParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderListOrdersFilterParameter
  * @throws IOException if the JSON string is invalid with respect to OrderListOrdersFilterParameter
  */
  public static OrderListOrdersFilterParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderListOrdersFilterParameter.class);
  }

 /**
  * Convert an instance of OrderListOrdersFilterParameter to an JSON string
  *
  * @return JSON string
  */
