...
import com.konfigthis.client.model.ShippingZoneParameters;
...
public class ShippingZoneUpdateZoneByIdRequest {
  public static final String SERIALIZED_NAME_SHIPPING_ZONE = "shipping_zone";
  @SerializedName(SERIALIZED_NAME_SHIPPING_ZONE)
  private ShippingZoneParameters shippingZone;

  public ShippingZoneUpdateZoneByIdRequest() {
  }

  public ShippingZoneUpdateZoneByIdRequest shippingZone(ShippingZoneParameters shippingZone) {
  ...
  **/
  ...
  public ShippingZoneParameters getShippingZone() {
    return shippingZone;
  }


  public void setShippingZone(ShippingZoneParameters shippingZone) {
   ...
   * @return the ShippingZoneUpdateZoneByIdRequest instance itself
   */
  public ShippingZoneUpdateZoneByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest = (ShippingZoneUpdateZoneByIdRequest) o;
    return Objects.equals(this.shippingZone, shippingZoneUpdateZoneByIdRequest.shippingZone)&&
        Objects.equals(this.additionalProperties, shippingZoneUpdateZoneByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shippingZone, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShippingZoneUpdateZoneByIdRequest {\n");
  ...
  static {
    ...
    openapiFields.add("shipping_zone");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingZoneUpdateZoneByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingZoneUpdateZoneByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingZoneUpdateZoneByIdRequest is not found in the empty JSON string", ShippingZoneUpdateZoneByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingZoneUpdateZoneByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingZoneUpdateZoneByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingZoneUpdateZoneByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingZoneUpdateZoneByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingZoneUpdateZoneByIdRequest>() {
           @Override
           public void write(JsonWriter out, ShippingZoneUpdateZoneByIdRequest value) throws IOException {
           ...
           @Override
           public ShippingZoneUpdateZoneByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingZoneUpdateZoneByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingZoneUpdateZoneByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingZoneUpdateZoneByIdRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingZoneUpdateZoneByIdRequest
  */
  public static ShippingZoneUpdateZoneByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingZoneUpdateZoneByIdRequest.class);
  }

 /**
  * Convert an instance of ShippingZoneUpdateZoneByIdRequest to an JSON string
  *
  * @return JSON string
  */
