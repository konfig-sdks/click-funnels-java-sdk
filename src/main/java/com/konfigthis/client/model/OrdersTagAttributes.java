 ...
 * Order Tags
 */
@ApiModel(description = "Order Tags")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrdersTagAttributes {
  ...
  public OrdersTagAttributes() {
  }

  public OrdersTagAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "8", required = true, value = "Tag ID")
  ...
  public OrdersTagAttributes publicId(Object publicId) {
  ...
  **/
  ...
  public OrdersTagAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public OrdersTagAttributes name(String name) {
  ...
  **/
  ...
  public OrdersTagAttributes color(String color) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "#4f4ca7", required = true, value = "Color")
  ...
  public OrdersTagAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public OrdersTagAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the OrdersTagAttributes instance itself
   */
  public OrdersTagAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersTagAttributes ordersTagAttributes = (OrdersTagAttributes) o;
    return Objects.equals(this.id, ordersTagAttributes.id) &&
        Objects.equals(this.publicId, ordersTagAttributes.publicId) &&
        Objects.equals(this.workspaceId, ordersTagAttributes.workspaceId) &&
        Objects.equals(this.name, ordersTagAttributes.name) &&
        Objects.equals(this.color, ordersTagAttributes.color) &&
        Objects.equals(this.createdAt, ordersTagAttributes.createdAt) &&
        Objects.equals(this.updatedAt, ordersTagAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, ordersTagAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersTagAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersTagAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersTagAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersTagAttributes is not found in the empty JSON string", OrdersTagAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersTagAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersTagAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersTagAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersTagAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersTagAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersTagAttributes>() {
           @Override
           public void write(JsonWriter out, OrdersTagAttributes value) throws IOException {
           ...
           @Override
           public OrdersTagAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersTagAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersTagAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersTagAttributes
  * @throws IOException if the JSON string is invalid with respect to OrdersTagAttributes
  */
  public static OrdersTagAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersTagAttributes.class);
  }

 /**
  * Convert an instance of OrdersTagAttributes to an JSON string
  *
  * @return JSON string
  */
