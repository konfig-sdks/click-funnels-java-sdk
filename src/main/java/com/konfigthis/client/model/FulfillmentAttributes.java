...
import com.konfigthis.client.model.IncludedOrdersLineItems;
...
public class FulfillmentAttributes {
 ...
 public enum StatusEnum {
  ...
  private Object fulfillmentNumber = null;
  ...
  public static final String SERIALIZED_NAME_INCLUDED_INVOICES_LINE_ITEMS = "included_invoices_line_items";
  @SerializedName(SERIALIZED_NAME_INCLUDED_INVOICES_LINE_ITEMS)
  private List<IncludedOrdersLineItems> includedInvoicesLineItems = null;

  public FulfillmentAttributes() {
  }

  public FulfillmentAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Fulfillment")
  ...
  public FulfillmentAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Public Fulfillment ID")
  ...
  public FulfillmentAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public FulfillmentAttributes contactId(Integer contactId) {
  ...
  **/
  ...
  public FulfillmentAttributes status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "FULFILLED", required = true, value = "Status")
  ...
  public FulfillmentAttributes trackingUrl(Object trackingUrl) {
  ...
  **/
  ...
  public FulfillmentAttributes shippingProvider(Object shippingProvider) {
  ...
  **/
  ...
  public FulfillmentAttributes trackingCode(Object trackingCode) {
  ...
  **/
  ...
  public FulfillmentAttributes locationId(Integer locationId) {
  ...
  **/
  ...
  public FulfillmentAttributes fulfillmentNumber(Object fulfillmentNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fulfillment Number")

  public Object getFulfillmentNumber() {
    return fulfillmentNumber;
  }


  public void setFulfillmentNumber(Object fulfillmentNumber) {
  ...
  public FulfillmentAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FulfillmentAttributes updatedAt(Object updatedAt) {
  ...
  **/
  ...
  public FulfillmentAttributes includedInvoicesLineItems(List<IncludedOrdersLineItems> includedInvoicesLineItems) {
    
    
    
    
    this.includedInvoicesLineItems = includedInvoicesLineItems;
    return this;
  }

  public FulfillmentAttributes addIncludedInvoicesLineItemsItem(IncludedOrdersLineItems includedInvoicesLineItemsItem) {
    if (this.includedInvoicesLineItems == null) {
      this.includedInvoicesLineItems = new ArrayList<>();
    }
    this.includedInvoicesLineItems.add(includedInvoicesLineItemsItem);
    return this;
  }

   /**
   * Included order invoices line items
   * @return includedInvoicesLineItems
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Included order invoices line items")

  public List<IncludedOrdersLineItems> getIncludedInvoicesLineItems() {
    return includedInvoicesLineItems;
  }


  public void setIncludedInvoicesLineItems(List<IncludedOrdersLineItems> includedInvoicesLineItems) {
   ...
   * @return the FulfillmentAttributes instance itself
   */
  public FulfillmentAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentAttributes fulfillmentAttributes = (FulfillmentAttributes) o;
    return Objects.equals(this.id, fulfillmentAttributes.id) &&
        Objects.equals(this.publicId, fulfillmentAttributes.publicId) &&
        Objects.equals(this.workspaceId, fulfillmentAttributes.workspaceId) &&
        Objects.equals(this.contactId, fulfillmentAttributes.contactId) &&
        Objects.equals(this.status, fulfillmentAttributes.status) &&
        Objects.equals(this.trackingUrl, fulfillmentAttributes.trackingUrl) &&
        Objects.equals(this.shippingProvider, fulfillmentAttributes.shippingProvider) &&
        Objects.equals(this.trackingCode, fulfillmentAttributes.trackingCode) &&
        Objects.equals(this.locationId, fulfillmentAttributes.locationId) &&
        Objects.equals(this.fulfillmentNumber, fulfillmentAttributes.fulfillmentNumber) &&
        Objects.equals(this.createdAt, fulfillmentAttributes.createdAt) &&
        Objects.equals(this.updatedAt, fulfillmentAttributes.updatedAt) &&
        Objects.equals(this.includedInvoicesLineItems, fulfillmentAttributes.includedInvoicesLineItems)&&
        Objects.equals(this.additionalProperties, fulfillmentAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, contactId, status, trackingUrl, shippingProvider, trackingCode, locationId, fulfillmentNumber, createdAt, updatedAt, includedInvoicesLineItems, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentAttributes {\n");
    ...
    sb.append("    includedInvoicesLineItems: ").append(toIndentedString(includedInvoicesLineItems)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fulfillment_number");
    openapiFields.add("created_at");
    openapiFields.add("updated_at");
    openapiFields.add("included_invoices_line_items");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentAttributes is not found in the empty JSON string", FulfillmentAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FulfillmentAttributes.openapiRequiredFields) {
      ...
      if (jsonObj.get("included_invoices_line_items") != null && !jsonObj.get("included_invoices_line_items").isJsonNull()) {
        JsonArray jsonArrayincludedInvoicesLineItems = jsonObj.getAsJsonArray("included_invoices_line_items");
        if (jsonArrayincludedInvoicesLineItems != null) {
          // ensure the json data is an array
          if (!jsonObj.get("included_invoices_line_items").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `included_invoices_line_items` to be an array in the JSON string but got `%s`", jsonObj.get("included_invoices_line_items").toString()));
          }

          // validate the optional field `included_invoices_line_items` (array)
          for (int i = 0; i < jsonArrayincludedInvoicesLineItems.size(); i++) {
            IncludedOrdersLineItems.validateJsonObject(jsonArrayincludedInvoicesLineItems.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentAttributes>() {
           @Override
           public void write(JsonWriter out, FulfillmentAttributes value) throws IOException {
           ...
           @Override
           public FulfillmentAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentAttributes
  * @throws IOException if the JSON string is invalid with respect to FulfillmentAttributes
  */
  public static FulfillmentAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentAttributes.class);
  }

 /**
  * Convert an instance of FulfillmentAttributes to an JSON string
  *
  * @return JSON string
  */
