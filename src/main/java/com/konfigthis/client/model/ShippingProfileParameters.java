...
public class ShippingProfileParameters {
  ...
  public ShippingProfileParameters() {
  }

  public ShippingProfileParameters name(String name) {
  ...
  **/
  ...
  public ShippingProfileParameters variantIds(Object variantIds) {
  ...
  **/
   ...
   * @return the ShippingProfileParameters instance itself
   */
  public ShippingProfileParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingProfileParameters shippingProfileParameters = (ShippingProfileParameters) o;
    return Objects.equals(this.name, shippingProfileParameters.name) &&
        Objects.equals(this.variantIds, shippingProfileParameters.variantIds)&&
        Objects.equals(this.additionalProperties, shippingProfileParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, variantIds, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingProfileParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingProfileParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingProfileParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingProfileParameters is not found in the empty JSON string", ShippingProfileParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingProfileParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingProfileParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingProfileParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingProfileParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingProfileParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingProfileParameters>() {
           @Override
           public void write(JsonWriter out, ShippingProfileParameters value) throws IOException {
           ...
           @Override
           public ShippingProfileParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingProfileParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingProfileParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingProfileParameters
  * @throws IOException if the JSON string is invalid with respect to ShippingProfileParameters
  */
  public static ShippingProfileParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingProfileParameters.class);
  }

 /**
  * Convert an instance of ShippingProfileParameters to an JSON string
  *
  * @return JSON string
  */
