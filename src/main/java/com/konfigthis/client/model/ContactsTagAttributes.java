 ...
 * Contact Tags
 */
@ApiModel(description = "Contact Tags")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContactsTagAttributes {
  ...
  public ContactsTagAttributes() {
  }

  public ContactsTagAttributes id(Integer id) {
  ...
  **/
  ...
  public ContactsTagAttributes publicId(Object publicId) {
  ...
  **/
  ...
  public ContactsTagAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public ContactsTagAttributes name(String name) {
  ...
  **/
  ...
  public ContactsTagAttributes color(String color) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "#044662", required = true, value = "Color")
  ...
  public ContactsTagAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ContactsTagAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ContactsTagAttributes instance itself
   */
  public ContactsTagAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsTagAttributes contactsTagAttributes = (ContactsTagAttributes) o;
    return Objects.equals(this.id, contactsTagAttributes.id) &&
        Objects.equals(this.publicId, contactsTagAttributes.publicId) &&
        Objects.equals(this.workspaceId, contactsTagAttributes.workspaceId) &&
        Objects.equals(this.name, contactsTagAttributes.name) &&
        Objects.equals(this.color, contactsTagAttributes.color) &&
        Objects.equals(this.createdAt, contactsTagAttributes.createdAt) &&
        Objects.equals(this.updatedAt, contactsTagAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, contactsTagAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactsTagAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsTagAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsTagAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsTagAttributes is not found in the empty JSON string", ContactsTagAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactsTagAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsTagAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsTagAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsTagAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsTagAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsTagAttributes>() {
           @Override
           public void write(JsonWriter out, ContactsTagAttributes value) throws IOException {
           ...
           @Override
           public ContactsTagAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsTagAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsTagAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsTagAttributes
  * @throws IOException if the JSON string is invalid with respect to ContactsTagAttributes
  */
  public static ContactsTagAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsTagAttributes.class);
  }

 /**
  * Convert an instance of ContactsTagAttributes to an JSON string
  *
  * @return JSON string
  */
