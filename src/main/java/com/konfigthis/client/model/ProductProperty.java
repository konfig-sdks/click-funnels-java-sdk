...
public class ProductProperty {
  ...
  public ProductProperty id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "20", required = true, value = "ID")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Enormous Wool Keyboard 67229a", required = true, value = "Product name")
   ...
   * @return the ProductProperty instance itself
   */
  public ProductProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productProperty.id) &&
        Objects.equals(this.name, productProperty.name)&&
        Objects.equals(this.additionalProperties, productProperty.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductProperty is not found in the empty JSON string", ProductProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductProperty>() {
           @Override
           public void write(JsonWriter out, ProductProperty value) throws IOException {
           ...
           @Override
           public ProductProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductProperty
  * @throws IOException if the JSON string is invalid with respect to ProductProperty
  */
  public static ProductProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductProperty.class);
  }

 /**
  * Convert an instance of ProductProperty to an JSON string
  *
  * @return JSON string
  */
