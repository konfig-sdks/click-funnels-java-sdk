 ...
 * Order Segments
 */
@ApiModel(description = "Order Segments")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderSegmentAttributes {
  ...
  public OrderSegmentAttributes() {
  }

  public OrderSegmentAttributes id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the segment")
  ...
  public OrderSegmentAttributes name(String name) {
  ...
  **/
   ...
   * @return the OrderSegmentAttributes instance itself
   */
  public OrderSegmentAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderSegmentAttributes orderSegmentAttributes = (OrderSegmentAttributes) o;
    return Objects.equals(this.id, orderSegmentAttributes.id) &&
        Objects.equals(this.name, orderSegmentAttributes.name)&&
        Objects.equals(this.additionalProperties, orderSegmentAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderSegmentAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderSegmentAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderSegmentAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderSegmentAttributes is not found in the empty JSON string", OrderSegmentAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderSegmentAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderSegmentAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderSegmentAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderSegmentAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderSegmentAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderSegmentAttributes>() {
           @Override
           public void write(JsonWriter out, OrderSegmentAttributes value) throws IOException {
           ...
           @Override
           public OrderSegmentAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderSegmentAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderSegmentAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderSegmentAttributes
  * @throws IOException if the JSON string is invalid with respect to OrderSegmentAttributes
  */
  public static OrderSegmentAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderSegmentAttributes.class);
  }

 /**
  * Convert an instance of OrderSegmentAttributes to an JSON string
  *
  * @return JSON string
  */
