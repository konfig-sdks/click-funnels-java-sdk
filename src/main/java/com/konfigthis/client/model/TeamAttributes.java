 ...
 * Teams
 */
@ApiModel(description = "Teams")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TeamAttributes {
  ...
  public TeamAttributes id(Integer id) {
  ...
  **/
  ...
  public TeamAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Team public ID")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Team", required = true, value = "Team")
  ...
  public TeamAttributes timeZone(Object timeZone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Primary time zone")
  ...
  public TeamAttributes locale(Object locale) {
  ...
  **/
  ...
  public TeamAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public TeamAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the TeamAttributes instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, teamAttributes.id) &&
        Objects.equals(this.publicId, teamAttributes.publicId) &&
        Objects.equals(this.name, teamAttributes.name) &&
        Objects.equals(this.timeZone, teamAttributes.timeZone) &&
        Objects.equals(this.locale, teamAttributes.locale) &&
        Objects.equals(this.createdAt, teamAttributes.createdAt) &&
        Objects.equals(this.updatedAt, teamAttributes.updatedAt)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, name, timeZone, locale, createdAt, updatedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamAttributes is not found in the empty JSON string", TeamAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamAttributes>() {
           @Override
           public void write(JsonWriter out, TeamAttributes value) throws IOException {
           ...
           @Override
           public TeamAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamAttributes
  * @throws IOException if the JSON string is invalid with respect to TeamAttributes
  */
  public static TeamAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamAttributes.class);
  }

 /**
  * Convert an instance of TeamAttributes to an JSON string
  *
  * @return JSON string
  */
