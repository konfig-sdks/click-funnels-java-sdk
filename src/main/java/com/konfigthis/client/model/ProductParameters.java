...
import com.konfigthis.client.model.ProductParametersVariantPropertiesInner;
...
public class ProductParameters {
  ...
  private List<ProductParametersVariantPropertiesInner> variantProperties = null;

  public ProductParameters() {
  }

  public ProductParameters name(String name) {
  ...
  **/
  ...
  public ProductParameters currentPath(Object currentPath) {
  ...
  **/
  ...
  public ProductParameters visibleInStore(Object visibleInStore) {
  ...
  **/
  ...
  public ProductParameters visibleInCustomerCenter(Object visibleInCustomerCenter) {
  ...
  **/
  ...
  public ProductParameters seoTitle(Object seoTitle) {
  ...
  **/
  ...
  public ProductParameters seoDescription(Object seoDescription) {
  ...
  **/
  ...
  public ProductParameters seoImageId(Object seoImageId) {
  ...
  **/
  ...
  public ProductParameters commissionable(Object commissionable) {
  ...
  **/
  ...
  public ProductParameters imageIds(Object imageIds) {
  ...
  **/
  ...
  public ProductParameters variantIds(Object variantIds) {
  ...
  **/
  ...
  public ProductParameters priceIds(Object priceIds) {
  ...
  **/
  ...
  public ProductParameters redirectFunnelId(Object redirectFunnelId) {
  ...
  **/
  ...
  public ProductParameters cancellationFunnelUrl(Object cancellationFunnelUrl) {
  ...
  **/
  ...
  public ProductParameters tagIds(List<Integer> tagIds) {
  ...
  public ProductParameters addTagIdsItem(Integer tagIdsItem) {
    if (this.tagIds == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Product::Tag IDs")
  ...
  public ProductParameters variantProperties(List<ProductParametersVariantPropertiesInner> variantProperties) {
  ...
  public ProductParameters addVariantPropertiesItem(ProductParametersVariantPropertiesInner variantPropertiesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The properties of the product's variants. e.g. 'Size', 'Color' etc.")

  public List<ProductParametersVariantPropertiesInner> getVariantProperties() {
    return variantProperties;
  }


  public void setVariantProperties(List<ProductParametersVariantPropertiesInner> variantProperties) {
   ...
   * @return the ProductParameters instance itself
   */
  public ProductParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductParameters productParameters = (ProductParameters) o;
    return Objects.equals(this.name, productParameters.name) &&
        Objects.equals(this.currentPath, productParameters.currentPath) &&
        Objects.equals(this.visibleInStore, productParameters.visibleInStore) &&
        Objects.equals(this.visibleInCustomerCenter, productParameters.visibleInCustomerCenter) &&
        Objects.equals(this.seoTitle, productParameters.seoTitle) &&
        Objects.equals(this.seoDescription, productParameters.seoDescription) &&
        Objects.equals(this.seoImageId, productParameters.seoImageId) &&
        Objects.equals(this.commissionable, productParameters.commissionable) &&
        Objects.equals(this.imageIds, productParameters.imageIds) &&
        Objects.equals(this.variantIds, productParameters.variantIds) &&
        Objects.equals(this.priceIds, productParameters.priceIds) &&
        Objects.equals(this.redirectFunnelId, productParameters.redirectFunnelId) &&
        Objects.equals(this.cancellationFunnelUrl, productParameters.cancellationFunnelUrl) &&
        Objects.equals(this.tagIds, productParameters.tagIds) &&
        Objects.equals(this.variantProperties, productParameters.variantProperties)&&
        Objects.equals(this.additionalProperties, productParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, currentPath, visibleInStore, visibleInCustomerCenter, seoTitle, seoDescription, seoImageId, commissionable, imageIds, variantIds, priceIds, redirectFunnelId, cancellationFunnelUrl, tagIds, variantProperties, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductParameters is not found in the empty JSON string", ProductParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductParameters.openapiRequiredFields) {
      ...
      if (jsonObj.get("variant_properties") != null && !jsonObj.get("variant_properties").isJsonNull()) {
        ...
        if (jsonArrayvariantProperties != null) {
          ...
          for (int i = 0; i < jsonArrayvariantProperties.size(); i++) {
            ProductParametersVariantPropertiesInner.validateJsonObject(jsonArrayvariantProperties.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductParameters>() {
           @Override
           public void write(JsonWriter out, ProductParameters value) throws IOException {
           ...
           @Override
           public ProductParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductParameters
  * @throws IOException if the JSON string is invalid with respect to ProductParameters
  */
  public static ProductParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductParameters.class);
  }

 /**
  * Convert an instance of ProductParameters to an JSON string
  *
  * @return JSON string
  */
