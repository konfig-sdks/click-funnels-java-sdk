 ...
 * Product Price
 */
@ApiModel(description = "Product Price")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProductPriceProperty {
  ...
  public ProductPriceProperty id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "13", required = true, value = "ID")
  ...
  public ProductPriceProperty amount(String amount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "100.0", required = true, value = "Amount")
  ...
  public ProductPriceProperty currency(String currency) {
  ...
  **/
  ...
  public ProductPriceProperty duration(Integer duration) {
  ...
  **/
  ...
  public ProductPriceProperty interval(String interval) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Interval")
  ...
  public ProductPriceProperty intervalCount(String intervalCount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Interval count")
   ...
   * @return the ProductPriceProperty instance itself
   */
  public ProductPriceProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductPriceProperty productPriceProperty = (ProductPriceProperty) o;
    return Objects.equals(this.id, productPriceProperty.id) &&
        Objects.equals(this.amount, productPriceProperty.amount) &&
        Objects.equals(this.currency, productPriceProperty.currency) &&
        Objects.equals(this.duration, productPriceProperty.duration) &&
        Objects.equals(this.interval, productPriceProperty.interval) &&
        Objects.equals(this.intervalCount, productPriceProperty.intervalCount)&&
        Objects.equals(this.additionalProperties, productPriceProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, amount, currency, duration, interval, intervalCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductPriceProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductPriceProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductPriceProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductPriceProperty is not found in the empty JSON string", ProductPriceProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductPriceProperty.openapiRequiredFields) {
      ...
      if (!jsonObj.get("interval_count").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `interval_count` to be a primitive type in the JSON string but got `%s`", jsonObj.get("interval_count").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductPriceProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductPriceProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductPriceProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductPriceProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductPriceProperty>() {
           @Override
           public void write(JsonWriter out, ProductPriceProperty value) throws IOException {
           ...
           @Override
           public ProductPriceProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductPriceProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductPriceProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductPriceProperty
  * @throws IOException if the JSON string is invalid with respect to ProductPriceProperty
  */
  public static ProductPriceProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductPriceProperty.class);
  }

 /**
  * Convert an instance of ProductPriceProperty to an JSON string
  *
  * @return JSON string
  */
