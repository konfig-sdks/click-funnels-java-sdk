...
public class FormsFieldAttributes {
  ...
  public static final String SERIALIZED_NAME_FIELD_SET_ID = "field_set_id";
  @SerializedName(SERIALIZED_NAME_FIELD_SET_ID)
  ...
  private Object allowMultiple = null;
  ...
  public FormsFieldAttributes() {
  }

  public FormsFieldAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Field ID")
  ...
  public FormsFieldAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Field public ID")
  ...
  public FormsFieldAttributes fieldSetId(Integer fieldSetId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Field set ID")
  ...
  public FormsFieldAttributes label(String label) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "MyString", required = true, value = "Label")
  ...
  public FormsFieldAttributes fieldType(Object fieldType) {
  ...
  **/
  ...
  public FormsFieldAttributes allowMultiple(Object allowMultiple) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Allow Multiple")

  public Object getAllowMultiple() {
    return allowMultiple;
  }


  public void setAllowMultiple(Object allowMultiple) {
  ...
  public FormsFieldAttributes key(Object key) {
  ...
  **/
  ...
  public FormsFieldAttributes hidden(Object hidden) {
  ...
  **/
  ...
  public FormsFieldAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FormsFieldAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the FormsFieldAttributes instance itself
   */
  public FormsFieldAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldAttributes formsFieldAttributes = (FormsFieldAttributes) o;
    return Objects.equals(this.id, formsFieldAttributes.id) &&
        Objects.equals(this.publicId, formsFieldAttributes.publicId) &&
        Objects.equals(this.fieldSetId, formsFieldAttributes.fieldSetId) &&
        Objects.equals(this.label, formsFieldAttributes.label) &&
        Objects.equals(this.fieldType, formsFieldAttributes.fieldType) &&
        Objects.equals(this.allowMultiple, formsFieldAttributes.allowMultiple) &&
        Objects.equals(this.key, formsFieldAttributes.key) &&
        Objects.equals(this.hidden, formsFieldAttributes.hidden) &&
        Objects.equals(this.createdAt, formsFieldAttributes.createdAt) &&
        Objects.equals(this.updatedAt, formsFieldAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, formsFieldAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, fieldSetId, label, fieldType, allowMultiple, key, hidden, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldAttributes {\n");
  ...
  static {
    ...
    openapiFields.add("field_set_id");
    openapiFields.add("label");
    openapiFields.add("field_type");
    openapiFields.add("allow_multiple");
    ...
    openapiRequiredFields.add("field_set_id");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldAttributes is not found in the empty JSON string", FormsFieldAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsFieldAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldAttributes>() {
           @Override
           public void write(JsonWriter out, FormsFieldAttributes value) throws IOException {
           ...
           @Override
           public FormsFieldAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldAttributes
  * @throws IOException if the JSON string is invalid with respect to FormsFieldAttributes
  */
  public static FormsFieldAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldAttributes.class);
  }

 /**
  * Convert an instance of FormsFieldAttributes to an JSON string
  *
  * @return JSON string
  */
