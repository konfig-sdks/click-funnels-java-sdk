...
import com.konfigthis.client.model.ShippingRatesNameParameters;
...
public class ShippingRatesNameCreateNewRateNameRequest {
  public static final String SERIALIZED_NAME_SHIPPING_RATES_NAME = "shipping_rates_name";
  @SerializedName(SERIALIZED_NAME_SHIPPING_RATES_NAME)
  private ShippingRatesNameParameters shippingRatesName;

  public ShippingRatesNameCreateNewRateNameRequest() {
  }

  public ShippingRatesNameCreateNewRateNameRequest shippingRatesName(ShippingRatesNameParameters shippingRatesName) {
   ...
   /**
   * Get shippingRatesName
   * @return shippingRatesName
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public ShippingRatesNameParameters getShippingRatesName() {
    return shippingRatesName;
  }


  public void setShippingRatesName(ShippingRatesNameParameters shippingRatesName) {
   ...
   * @return the ShippingRatesNameCreateNewRateNameRequest instance itself
   */
  public ShippingRatesNameCreateNewRateNameRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest = (ShippingRatesNameCreateNewRateNameRequest) o;
    return Objects.equals(this.shippingRatesName, shippingRatesNameCreateNewRateNameRequest.shippingRatesName)&&
        Objects.equals(this.additionalProperties, shippingRatesNameCreateNewRateNameRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shippingRatesName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShippingRatesNameCreateNewRateNameRequest {\n");
    sb.append("    shippingRatesName: ").append(toIndentedString(shippingRatesName)).append("\n");
  ...
  static {
    ...
    openapiFields.add("shipping_rates_name");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRatesNameCreateNewRateNameRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRatesNameCreateNewRateNameRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRatesNameCreateNewRateNameRequest is not found in the empty JSON string", ShippingRatesNameCreateNewRateNameRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRatesNameCreateNewRateNameRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRatesNameCreateNewRateNameRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRatesNameCreateNewRateNameRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRatesNameCreateNewRateNameRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRatesNameCreateNewRateNameRequest>() {
           @Override
           public void write(JsonWriter out, ShippingRatesNameCreateNewRateNameRequest value) throws IOException {
           ...
           @Override
           public ShippingRatesNameCreateNewRateNameRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRatesNameCreateNewRateNameRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRatesNameCreateNewRateNameRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRatesNameCreateNewRateNameRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingRatesNameCreateNewRateNameRequest
  */
  public static ShippingRatesNameCreateNewRateNameRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRatesNameCreateNewRateNameRequest.class);
  }

 /**
  * Convert an instance of ShippingRatesNameCreateNewRateNameRequest to an JSON string
  *
  * @return JSON string
  */
