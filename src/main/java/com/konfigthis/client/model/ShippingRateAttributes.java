 ...
 * Rates
 */
@ApiModel(description = "Rates")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ShippingRateAttributes {
  ...
  public static final String SERIALIZED_NAME_RATES_NAME_ID = "rates_name_id";
  @SerializedName(SERIALIZED_NAME_RATES_NAME_ID)
  private Integer ratesNameId;

  /**
   * Live Rates Provider
   */
  @JsonAdapter(LiveRatesProviderEnum.Adapter.class)
 public enum LiveRatesProviderEnum {
    SHIPPO("Shippo");

    private String value;

    LiveRatesProviderEnum(String value) {
      this.value = value;
    }
    ...
    public static LiveRatesProviderEnum fromValue(String value) {
      for (LiveRatesProviderEnum b : LiveRatesProviderEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<LiveRatesProviderEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LiveRatesProviderEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LiveRatesProviderEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return LiveRatesProviderEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_LIVE_RATES_PROVIDER = "live_rates_provider";
  @SerializedName(SERIALIZED_NAME_LIVE_RATES_PROVIDER)
  private LiveRatesProviderEnum liveRatesProvider;
  ...
  public ShippingRateAttributes() {
  }

  public ShippingRateAttributes description(Object description) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Rate name")
  ...
  public ShippingRateAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Rate ID")
  ...
  public ShippingRateAttributes publicId(Object publicId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Rate public ID")
  ...
  public ShippingRateAttributes zoneId(Integer zoneId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Zone ID")
  ...
  public ShippingRateAttributes providerName(Object providerName) {
  ...
  **/
  ...
  public ShippingRateAttributes price(String price) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "10.00", required = true, value = "Price")
  ...
  public ShippingRateAttributes priceCurrency(String priceCurrency) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "USD", required = true, value = "Price Currency")
  ...
  public ShippingRateAttributes ratesNameId(Integer ratesNameId) {
    
    
    
    
    this.ratesNameId = ratesNameId;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Rate name ID")

  public Integer getRatesNameId() {
    return ratesNameId;
  }


  public void setRatesNameId(Integer ratesNameId) {
  ...
  public ShippingRateAttributes liveRatesProvider(LiveRatesProviderEnum liveRatesProvider) {
    
    
    
    
    this.liveRatesProvider = liveRatesProvider;
    return this;
  }

   /**
   * Live Rates Provider
   * @return liveRatesProvider
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Live Rates Provider")

  public LiveRatesProviderEnum getLiveRatesProvider() {
    return liveRatesProvider;
  }


  public void setLiveRatesProvider(LiveRatesProviderEnum liveRatesProvider) {
  ...
  public ShippingRateAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ShippingRateAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ShippingRateAttributes instance itself
   */
  public ShippingRateAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRateAttributes shippingRateAttributes = (ShippingRateAttributes) o;
    return Objects.equals(this.description, shippingRateAttributes.description) &&
        Objects.equals(this.id, shippingRateAttributes.id) &&
        Objects.equals(this.publicId, shippingRateAttributes.publicId) &&
        Objects.equals(this.zoneId, shippingRateAttributes.zoneId) &&
        Objects.equals(this.providerName, shippingRateAttributes.providerName) &&
        Objects.equals(this.price, shippingRateAttributes.price) &&
        Objects.equals(this.priceCurrency, shippingRateAttributes.priceCurrency) &&
        Objects.equals(this.ratesNameId, shippingRateAttributes.ratesNameId) &&
        Objects.equals(this.liveRatesProvider, shippingRateAttributes.liveRatesProvider) &&
        Objects.equals(this.createdAt, shippingRateAttributes.createdAt) &&
        Objects.equals(this.updatedAt, shippingRateAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, shippingRateAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, publicId, zoneId, providerName, price, priceCurrency, ratesNameId, liveRatesProvider, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingRateAttributes {\n");
    ...
    sb.append("    ratesNameId: ").append(toIndentedString(ratesNameId)).append("\n");
    sb.append("    liveRatesProvider: ").append(toIndentedString(liveRatesProvider)).append("\n");
  ...
  static {
    ...
    openapiFields.add("rates_name_id");
    openapiFields.add("live_rates_provider");
    ...
    openapiRequiredFields.add("price_currency");
    openapiRequiredFields.add("rates_name_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRateAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRateAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRateAttributes is not found in the empty JSON string", ShippingRateAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingRateAttributes.openapiRequiredFields) {
      ...
      if (!jsonObj.get("price_currency").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("live_rates_provider") != null && !jsonObj.get("live_rates_provider").isJsonNull()) && !jsonObj.get("live_rates_provider").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `live_rates_provider` to be a primitive type in the JSON string but got `%s`", jsonObj.get("live_rates_provider").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRateAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRateAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRateAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRateAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRateAttributes>() {
           @Override
           public void write(JsonWriter out, ShippingRateAttributes value) throws IOException {
           ...
           @Override
           public ShippingRateAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRateAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRateAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRateAttributes
  * @throws IOException if the JSON string is invalid with respect to ShippingRateAttributes
  */
  public static ShippingRateAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRateAttributes.class);
  }

 /**
  * Convert an instance of ShippingRateAttributes to an JSON string
  *
  * @return JSON string
  */
