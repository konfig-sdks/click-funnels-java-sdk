 ...
 * Field sets
 */
@ApiModel(description = "Field sets")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FormsFieldSetAttributes {
  ...
  public FormsFieldSetAttributes() {
  }

  public FormsFieldSetAttributes title(String title) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Example Field Set", required = true, value = "Title")
  ...
  public FormsFieldSetAttributes id(Integer id) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Field set ID")
  ...
  public FormsFieldSetAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Field set public ID")
  ...
  public FormsFieldSetAttributes formId(Integer formId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Form ID")
  ...
  public FormsFieldSetAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FormsFieldSetAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the FormsFieldSetAttributes instance itself
   */
  public FormsFieldSetAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldSetAttributes formsFieldSetAttributes = (FormsFieldSetAttributes) o;
    return Objects.equals(this.title, formsFieldSetAttributes.title) &&
        Objects.equals(this.id, formsFieldSetAttributes.id) &&
        Objects.equals(this.publicId, formsFieldSetAttributes.publicId) &&
        Objects.equals(this.formId, formsFieldSetAttributes.formId) &&
        Objects.equals(this.createdAt, formsFieldSetAttributes.createdAt) &&
        Objects.equals(this.updatedAt, formsFieldSetAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, formsFieldSetAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, id, publicId, formId, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldSetAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldSetAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldSetAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldSetAttributes is not found in the empty JSON string", FormsFieldSetAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsFieldSetAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldSetAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldSetAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldSetAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldSetAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldSetAttributes>() {
           @Override
           public void write(JsonWriter out, FormsFieldSetAttributes value) throws IOException {
           ...
           @Override
           public FormsFieldSetAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldSetAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldSetAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldSetAttributes
  * @throws IOException if the JSON string is invalid with respect to FormsFieldSetAttributes
  */
  public static FormsFieldSetAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldSetAttributes.class);
  }

 /**
  * Convert an instance of FormsFieldSetAttributes to an JSON string
  *
  * @return JSON string
  */
