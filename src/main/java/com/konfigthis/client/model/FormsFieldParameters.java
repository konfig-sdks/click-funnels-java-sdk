...
public class FormsFieldParameters {
  ...
  public FormsFieldParameters() {
  }

  public FormsFieldParameters label(String label) {
  ...
  **/
  ...
  public FormsFieldParameters fieldType(Object fieldType) {
  ...
  **/
  ...
  public FormsFieldParameters allowMultiple(Object allowMultiple) {
  ...
  **/
  ...
  public FormsFieldParameters key(Object key) {
  ...
  **/
  ...
  public FormsFieldParameters hidden(Object hidden) {
  ...
  **/
   ...
   * @return the FormsFieldParameters instance itself
   */
  public FormsFieldParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldParameters formsFieldParameters = (FormsFieldParameters) o;
    return Objects.equals(this.label, formsFieldParameters.label) &&
        Objects.equals(this.fieldType, formsFieldParameters.fieldType) &&
        Objects.equals(this.allowMultiple, formsFieldParameters.allowMultiple) &&
        Objects.equals(this.key, formsFieldParameters.key) &&
        Objects.equals(this.hidden, formsFieldParameters.hidden)&&
        Objects.equals(this.additionalProperties, formsFieldParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(label, fieldType, allowMultiple, key, hidden, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldParameters is not found in the empty JSON string", FormsFieldParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsFieldParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldParameters>() {
           @Override
           public void write(JsonWriter out, FormsFieldParameters value) throws IOException {
           ...
           @Override
           public FormsFieldParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldParameters
  * @throws IOException if the JSON string is invalid with respect to FormsFieldParameters
  */
  public static FormsFieldParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldParameters.class);
  }

 /**
  * Convert an instance of FormsFieldParameters to an JSON string
  *
  * @return JSON string
  */
