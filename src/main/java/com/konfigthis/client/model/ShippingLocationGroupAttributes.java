 ...
 * Location groups
 */
@ApiModel(description = "Location groups")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ShippingLocationGroupAttributes {
  ...
  public ShippingLocationGroupAttributes() {
  }

  public ShippingLocationGroupAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Location group ID")
  ...
  public ShippingLocationGroupAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Location group public ID")
  ...
  public ShippingLocationGroupAttributes profileId(Integer profileId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Profile ID")
  ...
  public ShippingLocationGroupAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Location Group", required = true, value = "Name")
  ...
  public ShippingLocationGroupAttributes fulfillmentsLocationIds(Object fulfillmentsLocationIds) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Fulfillments Locations")
  ...
  public ShippingLocationGroupAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ShippingLocationGroupAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ShippingLocationGroupAttributes instance itself
   */
  public ShippingLocationGroupAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingLocationGroupAttributes shippingLocationGroupAttributes = (ShippingLocationGroupAttributes) o;
    return Objects.equals(this.id, shippingLocationGroupAttributes.id) &&
        Objects.equals(this.publicId, shippingLocationGroupAttributes.publicId) &&
        Objects.equals(this.profileId, shippingLocationGroupAttributes.profileId) &&
        Objects.equals(this.name, shippingLocationGroupAttributes.name) &&
        Objects.equals(this.fulfillmentsLocationIds, shippingLocationGroupAttributes.fulfillmentsLocationIds) &&
        Objects.equals(this.createdAt, shippingLocationGroupAttributes.createdAt) &&
        Objects.equals(this.updatedAt, shippingLocationGroupAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, shippingLocationGroupAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, profileId, name, fulfillmentsLocationIds, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingLocationGroupAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingLocationGroupAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingLocationGroupAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingLocationGroupAttributes is not found in the empty JSON string", ShippingLocationGroupAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingLocationGroupAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingLocationGroupAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingLocationGroupAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingLocationGroupAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingLocationGroupAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingLocationGroupAttributes>() {
           @Override
           public void write(JsonWriter out, ShippingLocationGroupAttributes value) throws IOException {
           ...
           @Override
           public ShippingLocationGroupAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingLocationGroupAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingLocationGroupAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingLocationGroupAttributes
  * @throws IOException if the JSON string is invalid with respect to ShippingLocationGroupAttributes
  */
  public static ShippingLocationGroupAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingLocationGroupAttributes.class);
  }

 /**
  * Convert an instance of ShippingLocationGroupAttributes to an JSON string
  *
  * @return JSON string
  */
