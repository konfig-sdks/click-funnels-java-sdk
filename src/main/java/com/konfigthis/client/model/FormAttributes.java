...
public class FormAttributes {
  ...
  public FormAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Form ID")
  ...
  public FormAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Form public ID")
  ...
  public FormAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public FormAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FormAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the FormAttributes instance itself
   */
  public FormAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, formAttributes.id) &&
        Objects.equals(this.publicId, formAttributes.publicId) &&
        Objects.equals(this.workspaceId, formAttributes.workspaceId) &&
        Objects.equals(this.name, formAttributes.name) &&
        Objects.equals(this.createdAt, formAttributes.createdAt) &&
        Objects.equals(this.updatedAt, formAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, formAttributes.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : FormAttributes.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FormAttributes>() {
           ...
           public FormAttributes read(JsonReader in) throws IOException {
             ...
             FormAttributes instance = thisAdapter.fromJsonTree(jsonObj);
