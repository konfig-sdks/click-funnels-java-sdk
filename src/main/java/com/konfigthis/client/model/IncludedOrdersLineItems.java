...
public class IncludedOrdersLineItems {
  ...
  public IncludedOrdersLineItems() {
  }

  public IncludedOrdersLineItems id(Integer id) {
  ...
  **/
  ...
  public IncludedOrdersLineItems publicId(Object publicId) {
  ...
  **/
  ...
  public IncludedOrdersLineItems fulfillmentId(Integer fulfillmentId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Fulfillment ID")
  ...
  public IncludedOrdersLineItems quantity(Integer quantity) {
  ...
  **/
  ...
  public IncludedOrdersLineItems invoicesLineItemId(Integer invoicesLineItemId) {
  ...
  **/
   ...
   * @return the IncludedOrdersLineItems instance itself
   */
  public IncludedOrdersLineItems putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncludedOrdersLineItems includedOrdersLineItems = (IncludedOrdersLineItems) o;
    return Objects.equals(this.id, includedOrdersLineItems.id) &&
        Objects.equals(this.publicId, includedOrdersLineItems.publicId) &&
        Objects.equals(this.fulfillmentId, includedOrdersLineItems.fulfillmentId) &&
        Objects.equals(this.quantity, includedOrdersLineItems.quantity) &&
        Objects.equals(this.invoicesLineItemId, includedOrdersLineItems.invoicesLineItemId)&&
        Objects.equals(this.additionalProperties, includedOrdersLineItems.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncludedOrdersLineItems {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncludedOrdersLineItems
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncludedOrdersLineItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncludedOrdersLineItems is not found in the empty JSON string", IncludedOrdersLineItems.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncludedOrdersLineItems.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncludedOrdersLineItems.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncludedOrdersLineItems' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncludedOrdersLineItems> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncludedOrdersLineItems.class));

       return (TypeAdapter<T>) new TypeAdapter<IncludedOrdersLineItems>() {
           @Override
           public void write(JsonWriter out, IncludedOrdersLineItems value) throws IOException {
           ...
           @Override
           public IncludedOrdersLineItems read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncludedOrdersLineItems instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncludedOrdersLineItems given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncludedOrdersLineItems
  * @throws IOException if the JSON string is invalid with respect to IncludedOrdersLineItems
  */
  public static IncludedOrdersLineItems fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncludedOrdersLineItems.class);
  }

 /**
  * Convert an instance of IncludedOrdersLineItems to an JSON string
  *
  * @return JSON string
  */
