...
public class OrdersTagParameters {
  ...
  public OrdersTagParameters() {
  }

  public OrdersTagParameters name(String name) {
  ...
  **/
  ...
  public OrdersTagParameters color(String color) {
  ...
  **/
   ...
   * @return the OrdersTagParameters instance itself
   */
  public OrdersTagParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersTagParameters ordersTagParameters = (OrdersTagParameters) o;
    return Objects.equals(this.name, ordersTagParameters.name) &&
        Objects.equals(this.color, ordersTagParameters.color)&&
        Objects.equals(this.additionalProperties, ordersTagParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersTagParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersTagParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersTagParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersTagParameters is not found in the empty JSON string", OrdersTagParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersTagParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersTagParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersTagParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersTagParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersTagParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersTagParameters>() {
           @Override
           public void write(JsonWriter out, OrdersTagParameters value) throws IOException {
           ...
           @Override
           public OrdersTagParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersTagParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersTagParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersTagParameters
  * @throws IOException if the JSON string is invalid with respect to OrdersTagParameters
  */
  public static OrdersTagParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersTagParameters.class);
  }

 /**
  * Convert an instance of OrdersTagParameters to an JSON string
  *
  * @return JSON string
  */
