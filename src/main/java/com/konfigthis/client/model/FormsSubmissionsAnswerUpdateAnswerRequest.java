...
import com.konfigthis.client.model.FormsSubmissionsAnswerParameters;
...
public class FormsSubmissionsAnswerUpdateAnswerRequest {
  public static final String SERIALIZED_NAME_FORMS_SUBMISSIONS_ANSWER = "forms_submissions_answer";
  @SerializedName(SERIALIZED_NAME_FORMS_SUBMISSIONS_ANSWER)
  private FormsSubmissionsAnswerParameters formsSubmissionsAnswer;

  public FormsSubmissionsAnswerUpdateAnswerRequest() {
  }

  public FormsSubmissionsAnswerUpdateAnswerRequest formsSubmissionsAnswer(FormsSubmissionsAnswerParameters formsSubmissionsAnswer) {
   ...
   /**
   * Get formsSubmissionsAnswer
   * @return formsSubmissionsAnswer
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public FormsSubmissionsAnswerParameters getFormsSubmissionsAnswer() {
    return formsSubmissionsAnswer;
  }


  public void setFormsSubmissionsAnswer(FormsSubmissionsAnswerParameters formsSubmissionsAnswer) {
   ...
   * @return the FormsSubmissionsAnswerUpdateAnswerRequest instance itself
   */
  public FormsSubmissionsAnswerUpdateAnswerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionsAnswerUpdateAnswerRequest formsSubmissionsAnswerUpdateAnswerRequest = (FormsSubmissionsAnswerUpdateAnswerRequest) o;
    return Objects.equals(this.formsSubmissionsAnswer, formsSubmissionsAnswerUpdateAnswerRequest.formsSubmissionsAnswer)&&
        Objects.equals(this.additionalProperties, formsSubmissionsAnswerUpdateAnswerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formsSubmissionsAnswer, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormsSubmissionsAnswerUpdateAnswerRequest {\n");
    sb.append("    formsSubmissionsAnswer: ").append(toIndentedString(formsSubmissionsAnswer)).append("\n");
  ...
  static {
    ...
    openapiFields.add("forms_submissions_answer");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionsAnswerUpdateAnswerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionsAnswerUpdateAnswerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionsAnswerUpdateAnswerRequest is not found in the empty JSON string", FormsSubmissionsAnswerUpdateAnswerRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionsAnswerUpdateAnswerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionsAnswerUpdateAnswerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionsAnswerUpdateAnswerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionsAnswerUpdateAnswerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionsAnswerUpdateAnswerRequest>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionsAnswerUpdateAnswerRequest value) throws IOException {
           ...
           @Override
           public FormsSubmissionsAnswerUpdateAnswerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionsAnswerUpdateAnswerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionsAnswerUpdateAnswerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionsAnswerUpdateAnswerRequest
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionsAnswerUpdateAnswerRequest
  */
  public static FormsSubmissionsAnswerUpdateAnswerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionsAnswerUpdateAnswerRequest.class);
  }

 /**
  * Convert an instance of FormsSubmissionsAnswerUpdateAnswerRequest to an JSON string
  *
  * @return JSON string
  */
