...
public class FormsFieldSetParameters {
  public static final String SERIALIZED_NAME_TITLE = "title";
  @SerializedName(SERIALIZED_NAME_TITLE)
  private String title;

  public FormsFieldSetParameters() {
  }

  public FormsFieldSetParameters title(String title) {
  ...
  **/
   ...
   * @return the FormsFieldSetParameters instance itself
   */
  public FormsFieldSetParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldSetParameters formsFieldSetParameters = (FormsFieldSetParameters) o;
    return Objects.equals(this.title, formsFieldSetParameters.title)&&
        Objects.equals(this.additionalProperties, formsFieldSetParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldSetParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldSetParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldSetParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldSetParameters is not found in the empty JSON string", FormsFieldSetParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsFieldSetParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldSetParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldSetParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldSetParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldSetParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldSetParameters>() {
           @Override
           public void write(JsonWriter out, FormsFieldSetParameters value) throws IOException {
           ...
           @Override
           public FormsFieldSetParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldSetParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldSetParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldSetParameters
  * @throws IOException if the JSON string is invalid with respect to FormsFieldSetParameters
  */
  public static FormsFieldSetParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldSetParameters.class);
  }

 /**
  * Convert an instance of FormsFieldSetParameters to an JSON string
  *
  * @return JSON string
  */
