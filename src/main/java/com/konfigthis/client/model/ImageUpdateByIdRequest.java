...
import com.konfigthis.client.model.ImageParameters;
...
public class ImageUpdateByIdRequest {
  public static final String SERIALIZED_NAME_IMAGE = "image";
  @SerializedName(SERIALIZED_NAME_IMAGE)
  private ImageParameters image;

  public ImageUpdateByIdRequest() {
  }

  public ImageUpdateByIdRequest image(ImageParameters image) {
  ...
  **/
  ...
  public void setImage(ImageParameters image) {
   ...
   * @return the ImageUpdateByIdRequest instance itself
   */
  public ImageUpdateByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImageUpdateByIdRequest imageUpdateByIdRequest = (ImageUpdateByIdRequest) o;
    return Objects.equals(this.image, imageUpdateByIdRequest.image)&&
        Objects.equals(this.additionalProperties, imageUpdateByIdRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageUpdateByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageUpdateByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageUpdateByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageUpdateByIdRequest is not found in the empty JSON string", ImageUpdateByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageUpdateByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageUpdateByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageUpdateByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageUpdateByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageUpdateByIdRequest>() {
           @Override
           public void write(JsonWriter out, ImageUpdateByIdRequest value) throws IOException {
           ...
           @Override
           public ImageUpdateByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageUpdateByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageUpdateByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageUpdateByIdRequest
  * @throws IOException if the JSON string is invalid with respect to ImageUpdateByIdRequest
  */
  public static ImageUpdateByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageUpdateByIdRequest.class);
  }

 /**
  * Convert an instance of ImageUpdateByIdRequest to an JSON string
  *
  * @return JSON string
  */
