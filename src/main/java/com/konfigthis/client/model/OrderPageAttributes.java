 ...
 * Order Page
 */
@ApiModel(description = "Order Page")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderPageAttributes {
  ...
  public OrderPageAttributes() {
  }

  public OrderPageAttributes id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The ID of the order page")
  ...
  public OrderPageAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The name of the order page")
  ...
  public OrderPageAttributes url(String url) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The URL of the order page")
   ...
   * @return the OrderPageAttributes instance itself
   */
  public OrderPageAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderPageAttributes orderPageAttributes = (OrderPageAttributes) o;
    return Objects.equals(this.id, orderPageAttributes.id) &&
        Objects.equals(this.name, orderPageAttributes.name) &&
        Objects.equals(this.url, orderPageAttributes.url)&&
        Objects.equals(this.additionalProperties, orderPageAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderPageAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderPageAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderPageAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderPageAttributes is not found in the empty JSON string", OrderPageAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderPageAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderPageAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderPageAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderPageAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderPageAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderPageAttributes>() {
           @Override
           public void write(JsonWriter out, OrderPageAttributes value) throws IOException {
           ...
           @Override
           public OrderPageAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderPageAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderPageAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderPageAttributes
  * @throws IOException if the JSON string is invalid with respect to OrderPageAttributes
  */
  public static OrderPageAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderPageAttributes.class);
  }

 /**
  * Convert an instance of OrderPageAttributes to an JSON string
  *
  * @return JSON string
  */
