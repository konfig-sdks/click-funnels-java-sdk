 ...
 * Webhooks
 */
@ApiModel(description = "Webhooks")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WebhooksOutgoingEndpointAttributes {
  ...
  public static final String SERIALIZED_NAME_EVENT_TYPE_IDS = "event_type_ids";
  @SerializedName(SERIALIZED_NAME_EVENT_TYPE_IDS)
  private Object eventTypeIds = null;
  ...
  public WebhooksOutgoingEndpointAttributes() {
  }

  public WebhooksOutgoingEndpointAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Endpoint ID")
  ...
  public WebhooksOutgoingEndpointAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Endpoint public ID")
  ...
  public WebhooksOutgoingEndpointAttributes workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public WebhooksOutgoingEndpointAttributes url(String url) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "https://example.com/some-endpoint-url", required = true, value = "URL")
  ...
  public WebhooksOutgoingEndpointAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Example Endpoint", required = true, value = "Name")
  ...
  public WebhooksOutgoingEndpointAttributes eventTypeIds(Object eventTypeIds) {
  ...
  **/
  ...
  public Object getEventTypeIds() {
    return eventTypeIds;
  }


  public void setEventTypeIds(Object eventTypeIds) {
  ...
  public WebhooksOutgoingEndpointAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public WebhooksOutgoingEndpointAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the WebhooksOutgoingEndpointAttributes instance itself
   */
  public WebhooksOutgoingEndpointAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOutgoingEndpointAttributes webhooksOutgoingEndpointAttributes = (WebhooksOutgoingEndpointAttributes) o;
    return Objects.equals(this.id, webhooksOutgoingEndpointAttributes.id) &&
        Objects.equals(this.publicId, webhooksOutgoingEndpointAttributes.publicId) &&
        Objects.equals(this.workspaceId, webhooksOutgoingEndpointAttributes.workspaceId) &&
        Objects.equals(this.url, webhooksOutgoingEndpointAttributes.url) &&
        Objects.equals(this.name, webhooksOutgoingEndpointAttributes.name) &&
        Objects.equals(this.eventTypeIds, webhooksOutgoingEndpointAttributes.eventTypeIds) &&
        Objects.equals(this.createdAt, webhooksOutgoingEndpointAttributes.createdAt) &&
        Objects.equals(this.updatedAt, webhooksOutgoingEndpointAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, webhooksOutgoingEndpointAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, workspaceId, url, name, eventTypeIds, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksOutgoingEndpointAttributes {\n");
  ...
  static {
    ...
    openapiFields.add("event_type_ids");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksOutgoingEndpointAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksOutgoingEndpointAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksOutgoingEndpointAttributes is not found in the empty JSON string", WebhooksOutgoingEndpointAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksOutgoingEndpointAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksOutgoingEndpointAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksOutgoingEndpointAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksOutgoingEndpointAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksOutgoingEndpointAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksOutgoingEndpointAttributes>() {
           @Override
           public void write(JsonWriter out, WebhooksOutgoingEndpointAttributes value) throws IOException {
           ...
           @Override
           public WebhooksOutgoingEndpointAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksOutgoingEndpointAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksOutgoingEndpointAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksOutgoingEndpointAttributes
  * @throws IOException if the JSON string is invalid with respect to WebhooksOutgoingEndpointAttributes
  */
  public static WebhooksOutgoingEndpointAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksOutgoingEndpointAttributes.class);
  }

 /**
  * Convert an instance of WebhooksOutgoingEndpointAttributes to an JSON string
  *
  * @return JSON string
  */
