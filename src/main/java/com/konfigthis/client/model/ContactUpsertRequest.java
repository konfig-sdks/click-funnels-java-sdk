...
public class ContactUpsertRequest {
  ...
  public ContactUpsertRequest() {
  }

  public ContactUpsertRequest contact(ContactsProperty contact) {
  ...
  **/
  ...
  public ContactsProperty getContact() {
    return contact;
  }


  public void setContact(ContactsProperty contact) {
   ...
   * @return the ContactUpsertRequest instance itself
   */
  public ContactUpsertRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactUpsertRequest contactUpsertRequest = (ContactUpsertRequest) o;
    return Objects.equals(this.contact, contactUpsertRequest.contact)&&
        Objects.equals(this.additionalProperties, contactUpsertRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactUpsertRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactUpsertRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactUpsertRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactUpsertRequest is not found in the empty JSON string", ContactUpsertRequest.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `contact`
      if (jsonObj.get("contact") != null && !jsonObj.get("contact").isJsonNull()) {
        ContactsProperty.validateJsonObject(jsonObj.getAsJsonObject("contact"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactUpsertRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactUpsertRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactUpsertRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactUpsertRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactUpsertRequest>() {
           @Override
           public void write(JsonWriter out, ContactUpsertRequest value) throws IOException {
           ...
           @Override
           public ContactUpsertRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactUpsertRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactUpsertRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactUpsertRequest
  * @throws IOException if the JSON string is invalid with respect to ContactUpsertRequest
  */
  public static ContactUpsertRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactUpsertRequest.class);
  }

 /**
  * Convert an instance of ContactUpsertRequest to an JSON string
  *
  * @return JSON string
  */
