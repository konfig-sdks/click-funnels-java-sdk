...
import com.konfigthis.client.model.FormsSubmissionParameters;
...
public class FormsSubmissionCreateNewSubmissionRequest {
  public static final String SERIALIZED_NAME_FORMS_SUBMISSION = "forms_submission";
  @SerializedName(SERIALIZED_NAME_FORMS_SUBMISSION)
  private FormsSubmissionParameters formsSubmission;

  public FormsSubmissionCreateNewSubmissionRequest() {
  }

  public FormsSubmissionCreateNewSubmissionRequest formsSubmission(FormsSubmissionParameters formsSubmission) {
   ...
   /**
   * Get formsSubmission
   * @return formsSubmission
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public FormsSubmissionParameters getFormsSubmission() {
    return formsSubmission;
  }


  public void setFormsSubmission(FormsSubmissionParameters formsSubmission) {
   ...
   * @return the FormsSubmissionCreateNewSubmissionRequest instance itself
   */
  public FormsSubmissionCreateNewSubmissionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionCreateNewSubmissionRequest formsSubmissionCreateNewSubmissionRequest = (FormsSubmissionCreateNewSubmissionRequest) o;
    return Objects.equals(this.formsSubmission, formsSubmissionCreateNewSubmissionRequest.formsSubmission)&&
        Objects.equals(this.additionalProperties, formsSubmissionCreateNewSubmissionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formsSubmission, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormsSubmissionCreateNewSubmissionRequest {\n");
    sb.append("    formsSubmission: ").append(toIndentedString(formsSubmission)).append("\n");
  ...
  static {
    ...
    openapiFields.add("forms_submission");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionCreateNewSubmissionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionCreateNewSubmissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionCreateNewSubmissionRequest is not found in the empty JSON string", FormsSubmissionCreateNewSubmissionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionCreateNewSubmissionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionCreateNewSubmissionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionCreateNewSubmissionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionCreateNewSubmissionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionCreateNewSubmissionRequest>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionCreateNewSubmissionRequest value) throws IOException {
           ...
           @Override
           public FormsSubmissionCreateNewSubmissionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionCreateNewSubmissionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionCreateNewSubmissionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionCreateNewSubmissionRequest
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionCreateNewSubmissionRequest
  */
  public static FormsSubmissionCreateNewSubmissionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionCreateNewSubmissionRequest.class);
  }

 /**
  * Convert an instance of FormsSubmissionCreateNewSubmissionRequest to an JSON string
  *
  * @return JSON string
  */
