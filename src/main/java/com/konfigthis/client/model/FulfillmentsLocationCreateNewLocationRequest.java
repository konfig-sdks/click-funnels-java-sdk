...
import com.konfigthis.client.model.FulfillmentsLocationParameters;
...
public class FulfillmentsLocationCreateNewLocationRequest {
  public static final String SERIALIZED_NAME_FULFILLMENTS_LOCATION = "fulfillments_location";
  @SerializedName(SERIALIZED_NAME_FULFILLMENTS_LOCATION)
  private FulfillmentsLocationParameters fulfillmentsLocation;

  public FulfillmentsLocationCreateNewLocationRequest() {
  }

  public FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocation(FulfillmentsLocationParameters fulfillmentsLocation) {
   ...
   /**
   * Get fulfillmentsLocation
   * @return fulfillmentsLocation
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public FulfillmentsLocationParameters getFulfillmentsLocation() {
    return fulfillmentsLocation;
  }


  public void setFulfillmentsLocation(FulfillmentsLocationParameters fulfillmentsLocation) {
   ...
   * @return the FulfillmentsLocationCreateNewLocationRequest instance itself
   */
  public FulfillmentsLocationCreateNewLocationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest = (FulfillmentsLocationCreateNewLocationRequest) o;
    return Objects.equals(this.fulfillmentsLocation, fulfillmentsLocationCreateNewLocationRequest.fulfillmentsLocation)&&
        Objects.equals(this.additionalProperties, fulfillmentsLocationCreateNewLocationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fulfillmentsLocation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FulfillmentsLocationCreateNewLocationRequest {\n");
    sb.append("    fulfillmentsLocation: ").append(toIndentedString(fulfillmentsLocation)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fulfillments_location");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentsLocationCreateNewLocationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentsLocationCreateNewLocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentsLocationCreateNewLocationRequest is not found in the empty JSON string", FulfillmentsLocationCreateNewLocationRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentsLocationCreateNewLocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentsLocationCreateNewLocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentsLocationCreateNewLocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentsLocationCreateNewLocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentsLocationCreateNewLocationRequest>() {
           @Override
           public void write(JsonWriter out, FulfillmentsLocationCreateNewLocationRequest value) throws IOException {
           ...
           @Override
           public FulfillmentsLocationCreateNewLocationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentsLocationCreateNewLocationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentsLocationCreateNewLocationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentsLocationCreateNewLocationRequest
  * @throws IOException if the JSON string is invalid with respect to FulfillmentsLocationCreateNewLocationRequest
  */
  public static FulfillmentsLocationCreateNewLocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentsLocationCreateNewLocationRequest.class);
  }

 /**
  * Convert an instance of FulfillmentsLocationCreateNewLocationRequest to an JSON string
  *
  * @return JSON string
  */
