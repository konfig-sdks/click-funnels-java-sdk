...
import com.konfigthis.client.model.CoursesSectionParameters;
...
public class CoursesSectionUpdateSectionByIdRequest {
  public static final String SERIALIZED_NAME_COURSES_SECTION = "courses_section";
  @SerializedName(SERIALIZED_NAME_COURSES_SECTION)
  private CoursesSectionParameters coursesSection;

  public CoursesSectionUpdateSectionByIdRequest() {
  }

  public CoursesSectionUpdateSectionByIdRequest coursesSection(CoursesSectionParameters coursesSection) {
  ...
  **/
  ...
  public CoursesSectionParameters getCoursesSection() {
    return coursesSection;
  }


  public void setCoursesSection(CoursesSectionParameters coursesSection) {
   ...
   * @return the CoursesSectionUpdateSectionByIdRequest instance itself
   */
  public CoursesSectionUpdateSectionByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest = (CoursesSectionUpdateSectionByIdRequest) o;
    return Objects.equals(this.coursesSection, coursesSectionUpdateSectionByIdRequest.coursesSection)&&
        Objects.equals(this.additionalProperties, coursesSectionUpdateSectionByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coursesSection, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CoursesSectionUpdateSectionByIdRequest {\n");
    sb.append("    coursesSection: ").append(toIndentedString(coursesSection)).append("\n");
  ...
  static {
    ...
    openapiFields.add("courses_section");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesSectionUpdateSectionByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesSectionUpdateSectionByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesSectionUpdateSectionByIdRequest is not found in the empty JSON string", CoursesSectionUpdateSectionByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesSectionUpdateSectionByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesSectionUpdateSectionByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesSectionUpdateSectionByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesSectionUpdateSectionByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesSectionUpdateSectionByIdRequest>() {
           @Override
           public void write(JsonWriter out, CoursesSectionUpdateSectionByIdRequest value) throws IOException {
           ...
           @Override
           public CoursesSectionUpdateSectionByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesSectionUpdateSectionByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesSectionUpdateSectionByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesSectionUpdateSectionByIdRequest
  * @throws IOException if the JSON string is invalid with respect to CoursesSectionUpdateSectionByIdRequest
  */
  public static CoursesSectionUpdateSectionByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesSectionUpdateSectionByIdRequest.class);
  }

 /**
  * Convert an instance of CoursesSectionUpdateSectionByIdRequest to an JSON string
  *
  * @return JSON string
  */
