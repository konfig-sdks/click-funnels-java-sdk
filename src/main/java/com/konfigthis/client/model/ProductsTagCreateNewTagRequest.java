...
public class ProductsTagCreateNewTagRequest {
  ...
  public ProductsTagCreateNewTagRequest() {
  }

  public ProductsTagCreateNewTagRequest productsTag(ProductsTagParameters productsTag) {
  ...
  **/
   ...
   * @return the ProductsTagCreateNewTagRequest instance itself
   */
  public ProductsTagCreateNewTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest = (ProductsTagCreateNewTagRequest) o;
    return Objects.equals(this.productsTag, productsTagCreateNewTagRequest.productsTag)&&
        Objects.equals(this.additionalProperties, productsTagCreateNewTagRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsTagCreateNewTagRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsTagCreateNewTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsTagCreateNewTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsTagCreateNewTagRequest is not found in the empty JSON string", ProductsTagCreateNewTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsTagCreateNewTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsTagCreateNewTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsTagCreateNewTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsTagCreateNewTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsTagCreateNewTagRequest>() {
           @Override
           public void write(JsonWriter out, ProductsTagCreateNewTagRequest value) throws IOException {
           ...
           @Override
           public ProductsTagCreateNewTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsTagCreateNewTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsTagCreateNewTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsTagCreateNewTagRequest
  * @throws IOException if the JSON string is invalid with respect to ProductsTagCreateNewTagRequest
  */
  public static ProductsTagCreateNewTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsTagCreateNewTagRequest.class);
  }

 /**
  * Convert an instance of ProductsTagCreateNewTagRequest to an JSON string
  *
  * @return JSON string
  */
