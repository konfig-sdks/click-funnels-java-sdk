...
import com.konfigthis.client.model.ShippingRateParameters;
...
public class ShippingRateCreateRateForZoneRequest {
  public static final String SERIALIZED_NAME_SHIPPING_RATE = "shipping_rate";
  @SerializedName(SERIALIZED_NAME_SHIPPING_RATE)
  private ShippingRateParameters shippingRate;

  public ShippingRateCreateRateForZoneRequest() {
  }

  public ShippingRateCreateRateForZoneRequest shippingRate(ShippingRateParameters shippingRate) {
  ...
  **/
  ...
  public ShippingRateParameters getShippingRate() {
    return shippingRate;
  }


  public void setShippingRate(ShippingRateParameters shippingRate) {
   ...
   * @return the ShippingRateCreateRateForZoneRequest instance itself
   */
  public ShippingRateCreateRateForZoneRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRateCreateRateForZoneRequest shippingRateCreateRateForZoneRequest = (ShippingRateCreateRateForZoneRequest) o;
    return Objects.equals(this.shippingRate, shippingRateCreateRateForZoneRequest.shippingRate)&&
        Objects.equals(this.additionalProperties, shippingRateCreateRateForZoneRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shippingRate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShippingRateCreateRateForZoneRequest {\n");
  ...
  static {
    ...
    openapiFields.add("shipping_rate");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRateCreateRateForZoneRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRateCreateRateForZoneRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRateCreateRateForZoneRequest is not found in the empty JSON string", ShippingRateCreateRateForZoneRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRateCreateRateForZoneRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRateCreateRateForZoneRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRateCreateRateForZoneRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRateCreateRateForZoneRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRateCreateRateForZoneRequest>() {
           @Override
           public void write(JsonWriter out, ShippingRateCreateRateForZoneRequest value) throws IOException {
           ...
           @Override
           public ShippingRateCreateRateForZoneRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRateCreateRateForZoneRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRateCreateRateForZoneRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRateCreateRateForZoneRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingRateCreateRateForZoneRequest
  */
  public static ShippingRateCreateRateForZoneRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRateCreateRateForZoneRequest.class);
  }

 /**
  * Convert an instance of ShippingRateCreateRateForZoneRequest to an JSON string
  *
  * @return JSON string
  */
