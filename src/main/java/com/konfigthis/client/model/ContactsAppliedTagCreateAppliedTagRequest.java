...
import com.konfigthis.client.model.ContactsAppliedTagParameters;
...
public class ContactsAppliedTagCreateAppliedTagRequest {
  public static final String SERIALIZED_NAME_CONTACTS_APPLIED_TAG = "contacts_applied_tag";
  @SerializedName(SERIALIZED_NAME_CONTACTS_APPLIED_TAG)
  private ContactsAppliedTagParameters contactsAppliedTag;

  public ContactsAppliedTagCreateAppliedTagRequest() {
  }

  public ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTag(ContactsAppliedTagParameters contactsAppliedTag) {
   ...
   /**
   * Get contactsAppliedTag
   * @return contactsAppliedTag
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public ContactsAppliedTagParameters getContactsAppliedTag() {
    return contactsAppliedTag;
  }


  public void setContactsAppliedTag(ContactsAppliedTagParameters contactsAppliedTag) {
   ...
   * @return the ContactsAppliedTagCreateAppliedTagRequest instance itself
   */
  public ContactsAppliedTagCreateAppliedTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest = (ContactsAppliedTagCreateAppliedTagRequest) o;
    return Objects.equals(this.contactsAppliedTag, contactsAppliedTagCreateAppliedTagRequest.contactsAppliedTag)&&
        Objects.equals(this.additionalProperties, contactsAppliedTagCreateAppliedTagRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactsAppliedTag, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContactsAppliedTagCreateAppliedTagRequest {\n");
    sb.append("    contactsAppliedTag: ").append(toIndentedString(contactsAppliedTag)).append("\n");
  ...
  static {
    ...
    openapiFields.add("contacts_applied_tag");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsAppliedTagCreateAppliedTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsAppliedTagCreateAppliedTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsAppliedTagCreateAppliedTagRequest is not found in the empty JSON string", ContactsAppliedTagCreateAppliedTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsAppliedTagCreateAppliedTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsAppliedTagCreateAppliedTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsAppliedTagCreateAppliedTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsAppliedTagCreateAppliedTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsAppliedTagCreateAppliedTagRequest>() {
           @Override
           public void write(JsonWriter out, ContactsAppliedTagCreateAppliedTagRequest value) throws IOException {
           ...
           @Override
           public ContactsAppliedTagCreateAppliedTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsAppliedTagCreateAppliedTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsAppliedTagCreateAppliedTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsAppliedTagCreateAppliedTagRequest
  * @throws IOException if the JSON string is invalid with respect to ContactsAppliedTagCreateAppliedTagRequest
  */
  public static ContactsAppliedTagCreateAppliedTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsAppliedTagCreateAppliedTagRequest.class);
  }

 /**
  * Convert an instance of ContactsAppliedTagCreateAppliedTagRequest to an JSON string
  *
  * @return JSON string
  */
