...
import com.konfigthis.client.model.WorkspaceParameters;
...
public class WorkspaceAddNewRequest {
  ...
  public WorkspaceAddNewRequest() {
  }

  public WorkspaceAddNewRequest workspace(WorkspaceParameters workspace) {
  ...
  **/
  ...
  public WorkspaceParameters getWorkspace() {
    return workspace;
  }


  public void setWorkspace(WorkspaceParameters workspace) {
   ...
   * @return the WorkspaceAddNewRequest instance itself
   */
  public WorkspaceAddNewRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkspaceAddNewRequest workspaceAddNewRequest = (WorkspaceAddNewRequest) o;
    return Objects.equals(this.workspace, workspaceAddNewRequest.workspace)&&
        Objects.equals(this.additionalProperties, workspaceAddNewRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workspace, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkspaceAddNewRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkspaceAddNewRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkspaceAddNewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkspaceAddNewRequest is not found in the empty JSON string", WorkspaceAddNewRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkspaceAddNewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkspaceAddNewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkspaceAddNewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkspaceAddNewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkspaceAddNewRequest>() {
           @Override
           public void write(JsonWriter out, WorkspaceAddNewRequest value) throws IOException {
           ...
           @Override
           public WorkspaceAddNewRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkspaceAddNewRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkspaceAddNewRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkspaceAddNewRequest
  * @throws IOException if the JSON string is invalid with respect to WorkspaceAddNewRequest
  */
  public static WorkspaceAddNewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkspaceAddNewRequest.class);
  }

 /**
  * Convert an instance of WorkspaceAddNewRequest to an JSON string
  *
  * @return JSON string
  */
