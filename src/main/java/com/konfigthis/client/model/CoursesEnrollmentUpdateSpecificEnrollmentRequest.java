...
import com.konfigthis.client.model.CoursesEnrollmentParameters;
...
public class CoursesEnrollmentUpdateSpecificEnrollmentRequest {
  public static final String SERIALIZED_NAME_COURSES_ENROLLMENT = "courses_enrollment";
  @SerializedName(SERIALIZED_NAME_COURSES_ENROLLMENT)
  private CoursesEnrollmentParameters coursesEnrollment;

  public CoursesEnrollmentUpdateSpecificEnrollmentRequest() {
  }

  public CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollment(CoursesEnrollmentParameters coursesEnrollment) {
   ...
   /**
   * Get coursesEnrollment
   * @return coursesEnrollment
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public CoursesEnrollmentParameters getCoursesEnrollment() {
    return coursesEnrollment;
  }


  public void setCoursesEnrollment(CoursesEnrollmentParameters coursesEnrollment) {
   ...
   * @return the CoursesEnrollmentUpdateSpecificEnrollmentRequest instance itself
   */
  public CoursesEnrollmentUpdateSpecificEnrollmentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest = (CoursesEnrollmentUpdateSpecificEnrollmentRequest) o;
    return Objects.equals(this.coursesEnrollment, coursesEnrollmentUpdateSpecificEnrollmentRequest.coursesEnrollment)&&
        Objects.equals(this.additionalProperties, coursesEnrollmentUpdateSpecificEnrollmentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coursesEnrollment, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CoursesEnrollmentUpdateSpecificEnrollmentRequest {\n");
    sb.append("    coursesEnrollment: ").append(toIndentedString(coursesEnrollment)).append("\n");
  ...
  static {
    ...
    openapiFields.add("courses_enrollment");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesEnrollmentUpdateSpecificEnrollmentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesEnrollmentUpdateSpecificEnrollmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesEnrollmentUpdateSpecificEnrollmentRequest is not found in the empty JSON string", CoursesEnrollmentUpdateSpecificEnrollmentRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesEnrollmentUpdateSpecificEnrollmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesEnrollmentUpdateSpecificEnrollmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesEnrollmentUpdateSpecificEnrollmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesEnrollmentUpdateSpecificEnrollmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesEnrollmentUpdateSpecificEnrollmentRequest>() {
           @Override
           public void write(JsonWriter out, CoursesEnrollmentUpdateSpecificEnrollmentRequest value) throws IOException {
           ...
           @Override
           public CoursesEnrollmentUpdateSpecificEnrollmentRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesEnrollmentUpdateSpecificEnrollmentRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesEnrollmentUpdateSpecificEnrollmentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesEnrollmentUpdateSpecificEnrollmentRequest
  * @throws IOException if the JSON string is invalid with respect to CoursesEnrollmentUpdateSpecificEnrollmentRequest
  */
  public static CoursesEnrollmentUpdateSpecificEnrollmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesEnrollmentUpdateSpecificEnrollmentRequest.class);
  }

 /**
  * Convert an instance of CoursesEnrollmentUpdateSpecificEnrollmentRequest to an JSON string
  *
  * @return JSON string
  */
