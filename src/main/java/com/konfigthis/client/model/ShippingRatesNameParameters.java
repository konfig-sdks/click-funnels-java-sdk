...
public class ShippingRatesNameParameters {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public ShippingRatesNameParameters() {
  }

  public ShippingRatesNameParameters name(String name) {
  ...
  **/
   ...
   * @return the ShippingRatesNameParameters instance itself
   */
  public ShippingRatesNameParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRatesNameParameters shippingRatesNameParameters = (ShippingRatesNameParameters) o;
    return Objects.equals(this.name, shippingRatesNameParameters.name)&&
        Objects.equals(this.additionalProperties, shippingRatesNameParameters.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingRatesNameParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRatesNameParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRatesNameParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRatesNameParameters is not found in the empty JSON string", ShippingRatesNameParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingRatesNameParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRatesNameParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRatesNameParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRatesNameParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRatesNameParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRatesNameParameters>() {
           @Override
           public void write(JsonWriter out, ShippingRatesNameParameters value) throws IOException {
           ...
           @Override
           public ShippingRatesNameParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRatesNameParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRatesNameParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRatesNameParameters
  * @throws IOException if the JSON string is invalid with respect to ShippingRatesNameParameters
  */
  public static ShippingRatesNameParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRatesNameParameters.class);
  }

 /**
  * Convert an instance of ShippingRatesNameParameters to an JSON string
  *
  * @return JSON string
  */
