...
public class ShippingProfileCreateNewRequest {
  ...
  public ShippingProfileCreateNewRequest() {
  }

  public ShippingProfileCreateNewRequest shippingProfile(ShippingProfileParameters shippingProfile) {
  ...
  **/
   ...
   * @return the ShippingProfileCreateNewRequest instance itself
   */
  public ShippingProfileCreateNewRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingProfileCreateNewRequest shippingProfileCreateNewRequest = (ShippingProfileCreateNewRequest) o;
    return Objects.equals(this.shippingProfile, shippingProfileCreateNewRequest.shippingProfile)&&
        Objects.equals(this.additionalProperties, shippingProfileCreateNewRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingProfileCreateNewRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingProfileCreateNewRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingProfileCreateNewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingProfileCreateNewRequest is not found in the empty JSON string", ShippingProfileCreateNewRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingProfileCreateNewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingProfileCreateNewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingProfileCreateNewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingProfileCreateNewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingProfileCreateNewRequest>() {
           @Override
           public void write(JsonWriter out, ShippingProfileCreateNewRequest value) throws IOException {
           ...
           @Override
           public ShippingProfileCreateNewRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingProfileCreateNewRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingProfileCreateNewRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingProfileCreateNewRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingProfileCreateNewRequest
  */
  public static ShippingProfileCreateNewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingProfileCreateNewRequest.class);
  }

 /**
  * Convert an instance of ShippingProfileCreateNewRequest to an JSON string
  *
  * @return JSON string
  */
