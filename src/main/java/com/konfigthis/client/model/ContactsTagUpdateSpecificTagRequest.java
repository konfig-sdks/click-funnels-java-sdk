...
import com.konfigthis.client.model.ContactsTagParameters;
...
public class ContactsTagUpdateSpecificTagRequest {
  public static final String SERIALIZED_NAME_CONTACTS_TAG = "contacts_tag";
  @SerializedName(SERIALIZED_NAME_CONTACTS_TAG)
  private ContactsTagParameters contactsTag;

  public ContactsTagUpdateSpecificTagRequest() {
  }

  public ContactsTagUpdateSpecificTagRequest contactsTag(ContactsTagParameters contactsTag) {
  ...
  **/
  ...
  public ContactsTagParameters getContactsTag() {
    return contactsTag;
  }


  public void setContactsTag(ContactsTagParameters contactsTag) {
   ...
   * @return the ContactsTagUpdateSpecificTagRequest instance itself
   */
  public ContactsTagUpdateSpecificTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest = (ContactsTagUpdateSpecificTagRequest) o;
    return Objects.equals(this.contactsTag, contactsTagUpdateSpecificTagRequest.contactsTag)&&
        Objects.equals(this.additionalProperties, contactsTagUpdateSpecificTagRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactsTag, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContactsTagUpdateSpecificTagRequest {\n");
    sb.append("    contactsTag: ").append(toIndentedString(contactsTag)).append("\n");
  ...
  static {
    ...
    openapiFields.add("contacts_tag");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactsTagUpdateSpecificTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactsTagUpdateSpecificTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactsTagUpdateSpecificTagRequest is not found in the empty JSON string", ContactsTagUpdateSpecificTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactsTagUpdateSpecificTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactsTagUpdateSpecificTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactsTagUpdateSpecificTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactsTagUpdateSpecificTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactsTagUpdateSpecificTagRequest>() {
           @Override
           public void write(JsonWriter out, ContactsTagUpdateSpecificTagRequest value) throws IOException {
           ...
           @Override
           public ContactsTagUpdateSpecificTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactsTagUpdateSpecificTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactsTagUpdateSpecificTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactsTagUpdateSpecificTagRequest
  * @throws IOException if the JSON string is invalid with respect to ContactsTagUpdateSpecificTagRequest
  */
  public static ContactsTagUpdateSpecificTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactsTagUpdateSpecificTagRequest.class);
  }

 /**
  * Convert an instance of ContactsTagUpdateSpecificTagRequest to an JSON string
  *
  * @return JSON string
  */
