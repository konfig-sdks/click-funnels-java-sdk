...
public class FormsSubmissionParameters {
  public static final String SERIALIZED_NAME_CONTACT_ID = "contact_id";
  @SerializedName(SERIALIZED_NAME_CONTACT_ID)
  private Object contactId = null;

  public FormsSubmissionParameters() {
  }

  public FormsSubmissionParameters contactId(Object contactId) {
  ...
  **/
   ...
   * @return the FormsSubmissionParameters instance itself
   */
  public FormsSubmissionParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionParameters formsSubmissionParameters = (FormsSubmissionParameters) o;
    return Objects.equals(this.contactId, formsSubmissionParameters.contactId)&&
        Objects.equals(this.additionalProperties, formsSubmissionParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contactId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsSubmissionParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionParameters is not found in the empty JSON string", FormsSubmissionParameters.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionParameters>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionParameters value) throws IOException {
           ...
           @Override
           public FormsSubmissionParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionParameters
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionParameters
  */
  public static FormsSubmissionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionParameters.class);
  }

 /**
  * Convert an instance of FormsSubmissionParameters to an JSON string
  *
  * @return JSON string
  */
