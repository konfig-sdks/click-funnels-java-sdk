...
public class FormsSubmissionsAnswerAddNewAnswerRequest {
  ...
  public FormsSubmissionsAnswerAddNewAnswerRequest() {
  }

  public FormsSubmissionsAnswerAddNewAnswerRequest formsSubmissionsAnswer(FormsSubmissionsAnswerParameters formsSubmissionsAnswer) {
  ...
  **/
   ...
   * @return the FormsSubmissionsAnswerAddNewAnswerRequest instance itself
   */
  public FormsSubmissionsAnswerAddNewAnswerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsSubmissionsAnswerAddNewAnswerRequest formsSubmissionsAnswerAddNewAnswerRequest = (FormsSubmissionsAnswerAddNewAnswerRequest) o;
    return Objects.equals(this.formsSubmissionsAnswer, formsSubmissionsAnswerAddNewAnswerRequest.formsSubmissionsAnswer)&&
        Objects.equals(this.additionalProperties, formsSubmissionsAnswerAddNewAnswerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsSubmissionsAnswerAddNewAnswerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsSubmissionsAnswerAddNewAnswerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsSubmissionsAnswerAddNewAnswerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsSubmissionsAnswerAddNewAnswerRequest is not found in the empty JSON string", FormsSubmissionsAnswerAddNewAnswerRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsSubmissionsAnswerAddNewAnswerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsSubmissionsAnswerAddNewAnswerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsSubmissionsAnswerAddNewAnswerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsSubmissionsAnswerAddNewAnswerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsSubmissionsAnswerAddNewAnswerRequest>() {
           @Override
           public void write(JsonWriter out, FormsSubmissionsAnswerAddNewAnswerRequest value) throws IOException {
           ...
           @Override
           public FormsSubmissionsAnswerAddNewAnswerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsSubmissionsAnswerAddNewAnswerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsSubmissionsAnswerAddNewAnswerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsSubmissionsAnswerAddNewAnswerRequest
  * @throws IOException if the JSON string is invalid with respect to FormsSubmissionsAnswerAddNewAnswerRequest
  */
  public static FormsSubmissionsAnswerAddNewAnswerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsSubmissionsAnswerAddNewAnswerRequest.class);
  }

 /**
  * Convert an instance of FormsSubmissionsAnswerAddNewAnswerRequest to an JSON string
  *
  * @return JSON string
  */
