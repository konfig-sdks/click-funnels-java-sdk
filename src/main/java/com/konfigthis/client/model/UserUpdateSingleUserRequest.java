...
import com.konfigthis.client.model.UserParameters;
...
public class UserUpdateSingleUserRequest {
  public static final String SERIALIZED_NAME_USER = "user";
  @SerializedName(SERIALIZED_NAME_USER)
  private UserParameters user;

  public UserUpdateSingleUserRequest() {
  }

  public UserUpdateSingleUserRequest user(UserParameters user) {
  ...
  **/
   ...
   * @return the UserUpdateSingleUserRequest instance itself
   */
  public UserUpdateSingleUserRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserUpdateSingleUserRequest userUpdateSingleUserRequest = (UserUpdateSingleUserRequest) o;
    return Objects.equals(this.user, userUpdateSingleUserRequest.user)&&
        Objects.equals(this.additionalProperties, userUpdateSingleUserRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserUpdateSingleUserRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserUpdateSingleUserRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserUpdateSingleUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserUpdateSingleUserRequest is not found in the empty JSON string", UserUpdateSingleUserRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserUpdateSingleUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserUpdateSingleUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserUpdateSingleUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserUpdateSingleUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UserUpdateSingleUserRequest>() {
           @Override
           public void write(JsonWriter out, UserUpdateSingleUserRequest value) throws IOException {
           ...
           @Override
           public UserUpdateSingleUserRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserUpdateSingleUserRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserUpdateSingleUserRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserUpdateSingleUserRequest
  * @throws IOException if the JSON string is invalid with respect to UserUpdateSingleUserRequest
  */
  public static UserUpdateSingleUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserUpdateSingleUserRequest.class);
  }

 /**
  * Convert an instance of UserUpdateSingleUserRequest to an JSON string
  *
  * @return JSON string
  */
