 ...
 * Enrollments
 */
@ApiModel(description = "Enrollments")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CoursesEnrollmentAttributes {
  ...
  public static final String SERIALIZED_NAME_SUSPENSION_REASON = "suspension_reason";
  @SerializedName(SERIALIZED_NAME_SUSPENSION_REASON)
  private Object suspensionReason = null;
  ...
  public static final String SERIALIZED_NAME_ORIGINATION_SOURCE_TYPE = "origination_source_type";
  @SerializedName(SERIALIZED_NAME_ORIGINATION_SOURCE_TYPE)
  private Object originationSourceType = null;

  public static final String SERIALIZED_NAME_ORIGINATION_SOURCE_ID = "origination_source_id";
  @SerializedName(SERIALIZED_NAME_ORIGINATION_SOURCE_ID)
  private Integer originationSourceId;

  public CoursesEnrollmentAttributes() {
  }

  public CoursesEnrollmentAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Enrollment ID")
  ...
  public CoursesEnrollmentAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Enrollment public ID")
  ...
  public CoursesEnrollmentAttributes contactId(Integer contactId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3", required = true, value = "Contact ID")
  ...
  public CoursesEnrollmentAttributes courseId(Integer courseId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Course")
  ...
  public CoursesEnrollmentAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public CoursesEnrollmentAttributes updatedAt(Object updatedAt) {
  ...
  **/
  ...
  public CoursesEnrollmentAttributes suspended(Object suspended) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Suspended")
  ...
  public CoursesEnrollmentAttributes suspensionReason(Object suspensionReason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Suspension Reason")

  public Object getSuspensionReason() {
    return suspensionReason;
  }


  public void setSuspensionReason(Object suspensionReason) {
  ...
  public CoursesEnrollmentAttributes currentPath(Object currentPath) {
  ...
  **/
  ...
  public CoursesEnrollmentAttributes originationSourceType(Object originationSourceType) {
    
    
    
    
    this.originationSourceType = originationSourceType;
    return this;
  }

   /**
   * Origination Source Type
   * @return originationSourceType
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Origination Source Type")

  public Object getOriginationSourceType() {
    return originationSourceType;
  }


  public void setOriginationSourceType(Object originationSourceType) {
  ...
  public CoursesEnrollmentAttributes originationSourceId(Integer originationSourceId) {
    
    
    
    
    this.originationSourceId = originationSourceId;
    return this;
  }

   /**
   * Origination Source ID
   * @return originationSourceId
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Origination Source ID")

  public Integer getOriginationSourceId() {
    return originationSourceId;
  }


  public void setOriginationSourceId(Integer originationSourceId) {
   ...
   * @return the CoursesEnrollmentAttributes instance itself
   */
  public CoursesEnrollmentAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesEnrollmentAttributes coursesEnrollmentAttributes = (CoursesEnrollmentAttributes) o;
    return Objects.equals(this.id, coursesEnrollmentAttributes.id) &&
        Objects.equals(this.publicId, coursesEnrollmentAttributes.publicId) &&
        Objects.equals(this.contactId, coursesEnrollmentAttributes.contactId) &&
        Objects.equals(this.courseId, coursesEnrollmentAttributes.courseId) &&
        Objects.equals(this.createdAt, coursesEnrollmentAttributes.createdAt) &&
        Objects.equals(this.updatedAt, coursesEnrollmentAttributes.updatedAt) &&
        Objects.equals(this.suspended, coursesEnrollmentAttributes.suspended) &&
        Objects.equals(this.suspensionReason, coursesEnrollmentAttributes.suspensionReason) &&
        Objects.equals(this.currentPath, coursesEnrollmentAttributes.currentPath) &&
        Objects.equals(this.originationSourceType, coursesEnrollmentAttributes.originationSourceType) &&
        Objects.equals(this.originationSourceId, coursesEnrollmentAttributes.originationSourceId)&&
        Objects.equals(this.additionalProperties, coursesEnrollmentAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, contactId, courseId, createdAt, updatedAt, suspended, suspensionReason, currentPath, originationSourceType, originationSourceId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesEnrollmentAttributes {\n");
    ...
    sb.append("    originationSourceType: ").append(toIndentedString(originationSourceType)).append("\n");
    sb.append("    originationSourceId: ").append(toIndentedString(originationSourceId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("suspension_reason");
    openapiFields.add("current_path");
    openapiFields.add("origination_source_type");
    openapiFields.add("origination_source_id");
    ...
    openapiRequiredFields.add("origination_source_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesEnrollmentAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesEnrollmentAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesEnrollmentAttributes is not found in the empty JSON string", CoursesEnrollmentAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoursesEnrollmentAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesEnrollmentAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesEnrollmentAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesEnrollmentAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesEnrollmentAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesEnrollmentAttributes>() {
           @Override
           public void write(JsonWriter out, CoursesEnrollmentAttributes value) throws IOException {
           ...
           @Override
           public CoursesEnrollmentAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesEnrollmentAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesEnrollmentAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesEnrollmentAttributes
  * @throws IOException if the JSON string is invalid with respect to CoursesEnrollmentAttributes
  */
  public static CoursesEnrollmentAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesEnrollmentAttributes.class);
  }

 /**
  * Convert an instance of CoursesEnrollmentAttributes to an JSON string
  *
  * @return JSON string
  */
