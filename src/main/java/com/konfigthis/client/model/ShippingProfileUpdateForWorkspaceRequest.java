...
import com.konfigthis.client.model.ShippingProfileParameters;
...
public class ShippingProfileUpdateForWorkspaceRequest {
  ...
  public ShippingProfileUpdateForWorkspaceRequest() {
  }

  public ShippingProfileUpdateForWorkspaceRequest shippingProfile(ShippingProfileParameters shippingProfile) {
  ...
  **/
  ...
  public ShippingProfileParameters getShippingProfile() {
    return shippingProfile;
  }


  public void setShippingProfile(ShippingProfileParameters shippingProfile) {
   ...
   * @return the ShippingProfileUpdateForWorkspaceRequest instance itself
   */
  public ShippingProfileUpdateForWorkspaceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingProfileUpdateForWorkspaceRequest shippingProfileUpdateForWorkspaceRequest = (ShippingProfileUpdateForWorkspaceRequest) o;
    return Objects.equals(this.shippingProfile, shippingProfileUpdateForWorkspaceRequest.shippingProfile)&&
        Objects.equals(this.additionalProperties, shippingProfileUpdateForWorkspaceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shippingProfile, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShippingProfileUpdateForWorkspaceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingProfileUpdateForWorkspaceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingProfileUpdateForWorkspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingProfileUpdateForWorkspaceRequest is not found in the empty JSON string", ShippingProfileUpdateForWorkspaceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingProfileUpdateForWorkspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingProfileUpdateForWorkspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingProfileUpdateForWorkspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingProfileUpdateForWorkspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingProfileUpdateForWorkspaceRequest>() {
           @Override
           public void write(JsonWriter out, ShippingProfileUpdateForWorkspaceRequest value) throws IOException {
           ...
           @Override
           public ShippingProfileUpdateForWorkspaceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingProfileUpdateForWorkspaceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingProfileUpdateForWorkspaceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingProfileUpdateForWorkspaceRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingProfileUpdateForWorkspaceRequest
  */
  public static ShippingProfileUpdateForWorkspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingProfileUpdateForWorkspaceRequest.class);
  }

 /**
  * Convert an instance of ShippingProfileUpdateForWorkspaceRequest to an JSON string
  *
  * @return JSON string
  */
