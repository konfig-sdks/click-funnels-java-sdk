...
import com.konfigthis.client.model.IncludedOrdersInvoicesLineItems;
 ...
 * Restocks
 */
@ApiModel(description = "Restocks")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Restocks {
 ...
 public enum StatusEnum {
  ...
  private List<IncludedOrdersInvoicesLineItems> includedInvoicesLineItems = new ArrayList<>();

  public Restocks() {
  }

  public Restocks id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "Restock ID")
  ...
  public Restocks publicId(Object publicId) {
  ...
  **/
  ...
  public Restocks workspaceId(Integer workspaceId) {
  ...
  **/
  ...
  public Restocks contactId(Integer contactId) {
  ...
  **/
  ...
  public Restocks status(StatusEnum status) {
  ...
  **/
  ...
  public Restocks createdAt(Object createdAt) {
  ...
  **/
  ...
  public Restocks updatedAt(Object updatedAt) {
  ...
  **/
  ...
  public Restocks includedInvoicesLineItems(List<IncludedOrdersInvoicesLineItems> includedInvoicesLineItems) {
  ...
  public Restocks addIncludedInvoicesLineItemsItem(IncludedOrdersInvoicesLineItems includedInvoicesLineItemsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Included order invoices line items")

  public List<IncludedOrdersInvoicesLineItems> getIncludedInvoicesLineItems() {
    return includedInvoicesLineItems;
  }


  public void setIncludedInvoicesLineItems(List<IncludedOrdersInvoicesLineItems> includedInvoicesLineItems) {
   ...
   * @return the Restocks instance itself
   */
  public Restocks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Restocks restocks = (Restocks) o;
    return Objects.equals(this.id, restocks.id) &&
        Objects.equals(this.publicId, restocks.publicId) &&
        Objects.equals(this.workspaceId, restocks.workspaceId) &&
        Objects.equals(this.contactId, restocks.contactId) &&
        Objects.equals(this.status, restocks.status) &&
        Objects.equals(this.createdAt, restocks.createdAt) &&
        Objects.equals(this.updatedAt, restocks.updatedAt) &&
        Objects.equals(this.includedInvoicesLineItems, restocks.includedInvoicesLineItems)&&
        Objects.equals(this.additionalProperties, restocks.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("included_invoices_line_items");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Restocks
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Restocks.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Restocks is not found in the empty JSON string", Restocks.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Restocks.openapiRequiredFields) {
      ...
      // validate the required field `included_invoices_line_items` (array)
      for (int i = 0; i < jsonArrayincludedInvoicesLineItems.size(); i++) {
        IncludedOrdersInvoicesLineItems.validateJsonObject(jsonArrayincludedInvoicesLineItems.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Restocks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Restocks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Restocks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Restocks.class));

       return (TypeAdapter<T>) new TypeAdapter<Restocks>() {
           @Override
           public void write(JsonWriter out, Restocks value) throws IOException {
           ...
           @Override
           public Restocks read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Restocks instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Restocks given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Restocks
  * @throws IOException if the JSON string is invalid with respect to Restocks
  */
  public static Restocks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Restocks.class);
  }

 /**
  * Convert an instance of Restocks to an JSON string
  *
  * @return JSON string
  */
