...
import com.konfigthis.client.model.OrdersAppliedTagParameters;
...
public class OrdersAppliedTagCreateAppliedTagRequest {
  public static final String SERIALIZED_NAME_ORDERS_APPLIED_TAG = "orders_applied_tag";
  @SerializedName(SERIALIZED_NAME_ORDERS_APPLIED_TAG)
  private OrdersAppliedTagParameters ordersAppliedTag;

  public OrdersAppliedTagCreateAppliedTagRequest() {
  }

  public OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTag(OrdersAppliedTagParameters ordersAppliedTag) {
   ...
   /**
   * Get ordersAppliedTag
   * @return ordersAppliedTag
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public OrdersAppliedTagParameters getOrdersAppliedTag() {
    return ordersAppliedTag;
  }


  public void setOrdersAppliedTag(OrdersAppliedTagParameters ordersAppliedTag) {
   ...
   * @return the OrdersAppliedTagCreateAppliedTagRequest instance itself
   */
  public OrdersAppliedTagCreateAppliedTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest = (OrdersAppliedTagCreateAppliedTagRequest) o;
    return Objects.equals(this.ordersAppliedTag, ordersAppliedTagCreateAppliedTagRequest.ordersAppliedTag)&&
        Objects.equals(this.additionalProperties, ordersAppliedTagCreateAppliedTagRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ordersAppliedTag, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrdersAppliedTagCreateAppliedTagRequest {\n");
    sb.append("    ordersAppliedTag: ").append(toIndentedString(ordersAppliedTag)).append("\n");
  ...
  static {
    ...
    openapiFields.add("orders_applied_tag");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersAppliedTagCreateAppliedTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersAppliedTagCreateAppliedTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersAppliedTagCreateAppliedTagRequest is not found in the empty JSON string", OrdersAppliedTagCreateAppliedTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersAppliedTagCreateAppliedTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersAppliedTagCreateAppliedTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersAppliedTagCreateAppliedTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersAppliedTagCreateAppliedTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersAppliedTagCreateAppliedTagRequest>() {
           @Override
           public void write(JsonWriter out, OrdersAppliedTagCreateAppliedTagRequest value) throws IOException {
           ...
           @Override
           public OrdersAppliedTagCreateAppliedTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersAppliedTagCreateAppliedTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersAppliedTagCreateAppliedTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersAppliedTagCreateAppliedTagRequest
  * @throws IOException if the JSON string is invalid with respect to OrdersAppliedTagCreateAppliedTagRequest
  */
  public static OrdersAppliedTagCreateAppliedTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersAppliedTagCreateAppliedTagRequest.class);
  }

 /**
  * Convert an instance of OrdersAppliedTagCreateAppliedTagRequest to an JSON string
  *
  * @return JSON string
  */
