...
public class FormsFieldsOptionUpdateFieldOptionRequest {
  ...
  public FormsFieldsOptionUpdateFieldOptionRequest() {
  }

  public FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOption(FormsFieldsOptionParameters formsFieldsOption) {
  ...
  **/
   ...
   * @return the FormsFieldsOptionUpdateFieldOptionRequest instance itself
   */
  public FormsFieldsOptionUpdateFieldOptionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest = (FormsFieldsOptionUpdateFieldOptionRequest) o;
    return Objects.equals(this.formsFieldsOption, formsFieldsOptionUpdateFieldOptionRequest.formsFieldsOption)&&
        Objects.equals(this.additionalProperties, formsFieldsOptionUpdateFieldOptionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldsOptionUpdateFieldOptionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldsOptionUpdateFieldOptionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldsOptionUpdateFieldOptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldsOptionUpdateFieldOptionRequest is not found in the empty JSON string", FormsFieldsOptionUpdateFieldOptionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldsOptionUpdateFieldOptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldsOptionUpdateFieldOptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldsOptionUpdateFieldOptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldsOptionUpdateFieldOptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldsOptionUpdateFieldOptionRequest>() {
           @Override
           public void write(JsonWriter out, FormsFieldsOptionUpdateFieldOptionRequest value) throws IOException {
           ...
           @Override
           public FormsFieldsOptionUpdateFieldOptionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldsOptionUpdateFieldOptionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldsOptionUpdateFieldOptionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldsOptionUpdateFieldOptionRequest
  * @throws IOException if the JSON string is invalid with respect to FormsFieldsOptionUpdateFieldOptionRequest
  */
  public static FormsFieldsOptionUpdateFieldOptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldsOptionUpdateFieldOptionRequest.class);
  }

 /**
  * Convert an instance of FormsFieldsOptionUpdateFieldOptionRequest to an JSON string
  *
  * @return JSON string
  */
