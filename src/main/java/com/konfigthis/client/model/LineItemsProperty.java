...
public class LineItemsProperty {
  ...
  private Object intervalCount = null;

  public LineItemsProperty() {
  }

  public LineItemsProperty id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Line item ID")
  ...
  public LineItemsProperty amount(Object amount) {
  ...
  **/
  ...
  public LineItemsProperty currency(Object currency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The currency of the line item")
  ...
  public LineItemsProperty duration(Object duration) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The duration of the line item")
  ...
  public LineItemsProperty interval(Object interval) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The interval of the line item")
  ...
  public LineItemsProperty intervalCount(Object intervalCount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The interval count of the line item")
  ...
  public void setIntervalCount(Object intervalCount) {
   ...
   * @return the LineItemsProperty instance itself
   */
  public LineItemsProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LineItemsProperty lineItemsProperty = (LineItemsProperty) o;
    return Objects.equals(this.id, lineItemsProperty.id) &&
        Objects.equals(this.amount, lineItemsProperty.amount) &&
        Objects.equals(this.currency, lineItemsProperty.currency) &&
        Objects.equals(this.duration, lineItemsProperty.duration) &&
        Objects.equals(this.interval, lineItemsProperty.interval) &&
        Objects.equals(this.intervalCount, lineItemsProperty.intervalCount)&&
        Objects.equals(this.additionalProperties, lineItemsProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LineItemsProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LineItemsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LineItemsProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineItemsProperty is not found in the empty JSON string", LineItemsProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LineItemsProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineItemsProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineItemsProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineItemsProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineItemsProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LineItemsProperty>() {
           @Override
           public void write(JsonWriter out, LineItemsProperty value) throws IOException {
           ...
           @Override
           public LineItemsProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LineItemsProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LineItemsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LineItemsProperty
  * @throws IOException if the JSON string is invalid with respect to LineItemsProperty
  */
  public static LineItemsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineItemsProperty.class);
  }

 /**
  * Convert an instance of LineItemsProperty to an JSON string
  *
  * @return JSON string
  */
