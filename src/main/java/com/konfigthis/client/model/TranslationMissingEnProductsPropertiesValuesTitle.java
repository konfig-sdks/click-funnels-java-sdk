 ...
 * Properties Values
 */
@ApiModel(description = "Properties Values")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TranslationMissingEnProductsPropertiesValuesTitle {
  ...
  public TranslationMissingEnProductsPropertiesValuesTitle() {
  }

  public TranslationMissingEnProductsPropertiesValuesTitle propertyId(Object propertyId) {
  ...
  **/
  ...
  public TranslationMissingEnProductsPropertiesValuesTitle value(Object value) {
  ...
  **/
   ...
   * @return the TranslationMissingEnProductsPropertiesValuesTitle instance itself
   */
  public TranslationMissingEnProductsPropertiesValuesTitle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TranslationMissingEnProductsPropertiesValuesTitle translationMissingEnProductsPropertiesValuesTitle = (TranslationMissingEnProductsPropertiesValuesTitle) o;
    return Objects.equals(this.propertyId, translationMissingEnProductsPropertiesValuesTitle.propertyId) &&
        Objects.equals(this.value, translationMissingEnProductsPropertiesValuesTitle.value)&&
        Objects.equals(this.additionalProperties, translationMissingEnProductsPropertiesValuesTitle.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(propertyId, value, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TranslationMissingEnProductsPropertiesValuesTitle {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TranslationMissingEnProductsPropertiesValuesTitle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TranslationMissingEnProductsPropertiesValuesTitle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TranslationMissingEnProductsPropertiesValuesTitle is not found in the empty JSON string", TranslationMissingEnProductsPropertiesValuesTitle.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TranslationMissingEnProductsPropertiesValuesTitle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TranslationMissingEnProductsPropertiesValuesTitle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TranslationMissingEnProductsPropertiesValuesTitle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TranslationMissingEnProductsPropertiesValuesTitle.class));

       return (TypeAdapter<T>) new TypeAdapter<TranslationMissingEnProductsPropertiesValuesTitle>() {
           @Override
           public void write(JsonWriter out, TranslationMissingEnProductsPropertiesValuesTitle value) throws IOException {
           ...
           @Override
           public TranslationMissingEnProductsPropertiesValuesTitle read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TranslationMissingEnProductsPropertiesValuesTitle instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TranslationMissingEnProductsPropertiesValuesTitle given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TranslationMissingEnProductsPropertiesValuesTitle
  * @throws IOException if the JSON string is invalid with respect to TranslationMissingEnProductsPropertiesValuesTitle
  */
  public static TranslationMissingEnProductsPropertiesValuesTitle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TranslationMissingEnProductsPropertiesValuesTitle.class);
  }

 /**
  * Convert an instance of TranslationMissingEnProductsPropertiesValuesTitle to an JSON string
  *
  * @return JSON string
  */
