...
public class ShippingRateUpdateRateForZoneRequest {
  ...
  public ShippingRateUpdateRateForZoneRequest() {
  }

  public ShippingRateUpdateRateForZoneRequest shippingRate(ShippingRateParameters shippingRate) {
  ...
  **/
   ...
   * @return the ShippingRateUpdateRateForZoneRequest instance itself
   */
  public ShippingRateUpdateRateForZoneRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRateUpdateRateForZoneRequest shippingRateUpdateRateForZoneRequest = (ShippingRateUpdateRateForZoneRequest) o;
    return Objects.equals(this.shippingRate, shippingRateUpdateRateForZoneRequest.shippingRate)&&
        Objects.equals(this.additionalProperties, shippingRateUpdateRateForZoneRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingRateUpdateRateForZoneRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRateUpdateRateForZoneRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRateUpdateRateForZoneRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRateUpdateRateForZoneRequest is not found in the empty JSON string", ShippingRateUpdateRateForZoneRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRateUpdateRateForZoneRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRateUpdateRateForZoneRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRateUpdateRateForZoneRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRateUpdateRateForZoneRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRateUpdateRateForZoneRequest>() {
           @Override
           public void write(JsonWriter out, ShippingRateUpdateRateForZoneRequest value) throws IOException {
           ...
           @Override
           public ShippingRateUpdateRateForZoneRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRateUpdateRateForZoneRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRateUpdateRateForZoneRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRateUpdateRateForZoneRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingRateUpdateRateForZoneRequest
  */
  public static ShippingRateUpdateRateForZoneRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRateUpdateRateForZoneRequest.class);
  }

 /**
  * Convert an instance of ShippingRateUpdateRateForZoneRequest to an JSON string
  *
  * @return JSON string
  */
