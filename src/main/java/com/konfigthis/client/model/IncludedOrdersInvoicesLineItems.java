...
public class IncludedOrdersInvoicesLineItems {
  ...
  public IncludedOrdersInvoicesLineItems() {
  }

  public IncludedOrdersInvoicesLineItems id(Integer id) {
  ...
  **/
  ...
  public IncludedOrdersInvoicesLineItems publicId(Object publicId) {
  ...
  **/
  ...
  public IncludedOrdersInvoicesLineItems fulfillmentId(Integer fulfillmentId) {
  ...
  **/
  ...
  public IncludedOrdersInvoicesLineItems quantity(Integer quantity) {
  ...
  **/
  ...
  public IncludedOrdersInvoicesLineItems invoicesLineItemId(Integer invoicesLineItemId) {
  ...
  **/
   ...
   * @return the IncludedOrdersInvoicesLineItems instance itself
   */
  public IncludedOrdersInvoicesLineItems putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncludedOrdersInvoicesLineItems includedOrdersInvoicesLineItems = (IncludedOrdersInvoicesLineItems) o;
    return Objects.equals(this.id, includedOrdersInvoicesLineItems.id) &&
        Objects.equals(this.publicId, includedOrdersInvoicesLineItems.publicId) &&
        Objects.equals(this.fulfillmentId, includedOrdersInvoicesLineItems.fulfillmentId) &&
        Objects.equals(this.quantity, includedOrdersInvoicesLineItems.quantity) &&
        Objects.equals(this.invoicesLineItemId, includedOrdersInvoicesLineItems.invoicesLineItemId)&&
        Objects.equals(this.additionalProperties, includedOrdersInvoicesLineItems.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncludedOrdersInvoicesLineItems {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncludedOrdersInvoicesLineItems
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncludedOrdersInvoicesLineItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncludedOrdersInvoicesLineItems is not found in the empty JSON string", IncludedOrdersInvoicesLineItems.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncludedOrdersInvoicesLineItems.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncludedOrdersInvoicesLineItems.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncludedOrdersInvoicesLineItems' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncludedOrdersInvoicesLineItems> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncludedOrdersInvoicesLineItems.class));

       return (TypeAdapter<T>) new TypeAdapter<IncludedOrdersInvoicesLineItems>() {
           @Override
           public void write(JsonWriter out, IncludedOrdersInvoicesLineItems value) throws IOException {
           ...
           @Override
           public IncludedOrdersInvoicesLineItems read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncludedOrdersInvoicesLineItems instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncludedOrdersInvoicesLineItems given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncludedOrdersInvoicesLineItems
  * @throws IOException if the JSON string is invalid with respect to IncludedOrdersInvoicesLineItems
  */
  public static IncludedOrdersInvoicesLineItems fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncludedOrdersInvoicesLineItems.class);
  }

 /**
  * Convert an instance of IncludedOrdersInvoicesLineItems to an JSON string
  *
  * @return JSON string
  */
