...
import com.konfigthis.client.model.ProductPriceProperty;
import com.konfigthis.client.model.ProductProperty;
import com.konfigthis.client.model.ProductVariantProperty;
...
public class OrdersLineItemAttributes {
  ...
  public static final String SERIALIZED_NAME_ORIGINAL_PRODUCT = "original_product";
  @SerializedName(SERIALIZED_NAME_ORIGINAL_PRODUCT)
  private ProductProperty originalProduct;

  public static final String SERIALIZED_NAME_PRODUCTS_PRICE = "products_price";
  @SerializedName(SERIALIZED_NAME_PRODUCTS_PRICE)
  private ProductPriceProperty productsPrice;
  ...
  private ProductVariantProperty productsVariant;

  public OrdersLineItemAttributes() {
  }

  public OrdersLineItemAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "8", required = true, value = "Line item ID")
  ...
  public OrdersLineItemAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Line item public ID")
  ...
  public OrdersLineItemAttributes orderId(Integer orderId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "7", required = true, value = "Order ID")
  ...
  public OrdersLineItemAttributes quantity(Object quantity) {
  ...
  **/
  ...
  public OrdersLineItemAttributes prorated(Object prorated) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Prorate invoice")

  public Object getProrated() {
    return prorated;
  }


  public void setProrated(Object prorated) {
  ...
  public OrdersLineItemAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public OrdersLineItemAttributes updatedAt(Object updatedAt) {
  ...
  **/
  ...
  public OrdersLineItemAttributes originalProduct(ProductProperty originalProduct) {
  ...
  **/
  ...
  public ProductProperty getOriginalProduct() {
    return originalProduct;
  }


  public void setOriginalProduct(ProductProperty originalProduct) {
  ...
  public OrdersLineItemAttributes productsPrice(ProductPriceProperty productsPrice) {
  ...
  **/
  ...
  public ProductPriceProperty getProductsPrice() {
    return productsPrice;
  }


  public void setProductsPrice(ProductPriceProperty productsPrice) {
  ...
  public OrdersLineItemAttributes productsVariant(ProductVariantProperty productsVariant) {
  ...
  **/
  ...
  public ProductVariantProperty getProductsVariant() {
    return productsVariant;
  }


  public void setProductsVariant(ProductVariantProperty productsVariant) {
   ...
   * @return the OrdersLineItemAttributes instance itself
   */
  public OrdersLineItemAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersLineItemAttributes ordersLineItemAttributes = (OrdersLineItemAttributes) o;
    return Objects.equals(this.id, ordersLineItemAttributes.id) &&
        Objects.equals(this.publicId, ordersLineItemAttributes.publicId) &&
        Objects.equals(this.orderId, ordersLineItemAttributes.orderId) &&
        Objects.equals(this.quantity, ordersLineItemAttributes.quantity) &&
        Objects.equals(this.prorated, ordersLineItemAttributes.prorated) &&
        Objects.equals(this.createdAt, ordersLineItemAttributes.createdAt) &&
        Objects.equals(this.updatedAt, ordersLineItemAttributes.updatedAt) &&
        Objects.equals(this.originalProduct, ordersLineItemAttributes.originalProduct) &&
        Objects.equals(this.productsPrice, ordersLineItemAttributes.productsPrice) &&
        Objects.equals(this.productsVariant, ordersLineItemAttributes.productsVariant)&&
        Objects.equals(this.additionalProperties, ordersLineItemAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, orderId, quantity, prorated, createdAt, updatedAt, originalProduct, productsPrice, productsVariant, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersLineItemAttributes {\n");
    ...
    sb.append("    originalProduct: ").append(toIndentedString(originalProduct)).append("\n");
  ...
  static {
    ...
    openapiFields.add("original_product");
    ...
    openapiRequiredFields.add("original_product");
    openapiRequiredFields.add("products_price");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersLineItemAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersLineItemAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersLineItemAttributes is not found in the empty JSON string", OrdersLineItemAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersLineItemAttributes.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `original_product`
      ProductProperty.validateJsonObject(jsonObj.getAsJsonObject("original_product"));
      // validate the required field `products_price`
      ProductPriceProperty.validateJsonObject(jsonObj.getAsJsonObject("products_price"));
      // validate the optional field `products_variant`
      if (jsonObj.get("products_variant") != null && !jsonObj.get("products_variant").isJsonNull()) {
        ProductVariantProperty.validateJsonObject(jsonObj.getAsJsonObject("products_variant"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersLineItemAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersLineItemAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersLineItemAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersLineItemAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersLineItemAttributes>() {
           @Override
           public void write(JsonWriter out, OrdersLineItemAttributes value) throws IOException {
           ...
           @Override
           public OrdersLineItemAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersLineItemAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersLineItemAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersLineItemAttributes
  * @throws IOException if the JSON string is invalid with respect to OrdersLineItemAttributes
  */
  public static OrdersLineItemAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersLineItemAttributes.class);
  }

 /**
  * Convert an instance of OrdersLineItemAttributes to an JSON string
  *
  * @return JSON string
  */
