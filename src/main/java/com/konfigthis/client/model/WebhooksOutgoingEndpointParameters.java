...
public class WebhooksOutgoingEndpointParameters {
  ...
  public WebhooksOutgoingEndpointParameters() {
  }

  public WebhooksOutgoingEndpointParameters url(String url) {
  ...
  **/
  ...
  public WebhooksOutgoingEndpointParameters name(String name) {
  ...
  **/
  ...
  public WebhooksOutgoingEndpointParameters eventTypeIds(Object eventTypeIds) {
  ...
  **/
   ...
   * @return the WebhooksOutgoingEndpointParameters instance itself
   */
  public WebhooksOutgoingEndpointParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOutgoingEndpointParameters webhooksOutgoingEndpointParameters = (WebhooksOutgoingEndpointParameters) o;
    return Objects.equals(this.url, webhooksOutgoingEndpointParameters.url) &&
        Objects.equals(this.name, webhooksOutgoingEndpointParameters.name) &&
        Objects.equals(this.eventTypeIds, webhooksOutgoingEndpointParameters.eventTypeIds)&&
        Objects.equals(this.additionalProperties, webhooksOutgoingEndpointParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, name, eventTypeIds, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksOutgoingEndpointParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksOutgoingEndpointParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksOutgoingEndpointParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksOutgoingEndpointParameters is not found in the empty JSON string", WebhooksOutgoingEndpointParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksOutgoingEndpointParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksOutgoingEndpointParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksOutgoingEndpointParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksOutgoingEndpointParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksOutgoingEndpointParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksOutgoingEndpointParameters>() {
           @Override
           public void write(JsonWriter out, WebhooksOutgoingEndpointParameters value) throws IOException {
           ...
           @Override
           public WebhooksOutgoingEndpointParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksOutgoingEndpointParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksOutgoingEndpointParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksOutgoingEndpointParameters
  * @throws IOException if the JSON string is invalid with respect to WebhooksOutgoingEndpointParameters
  */
  public static WebhooksOutgoingEndpointParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksOutgoingEndpointParameters.class);
  }

 /**
  * Convert an instance of WebhooksOutgoingEndpointParameters to an JSON string
  *
  * @return JSON string
  */
