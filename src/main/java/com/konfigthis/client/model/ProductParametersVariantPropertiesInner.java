...
public class ProductParametersVariantPropertiesInner {
  ...
  public ProductParametersVariantPropertiesInner() {
  }

  public ProductParametersVariantPropertiesInner id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the property, if updating the property")
  ...
  public ProductParametersVariantPropertiesInner name(String name) {
  ...
  **/
   ...
   * @return the ProductParametersVariantPropertiesInner instance itself
   */
  public ProductParametersVariantPropertiesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductParametersVariantPropertiesInner productParametersVariantPropertiesInner = (ProductParametersVariantPropertiesInner) o;
    return Objects.equals(this.id, productParametersVariantPropertiesInner.id) &&
        Objects.equals(this.name, productParametersVariantPropertiesInner.name)&&
        Objects.equals(this.additionalProperties, productParametersVariantPropertiesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductParametersVariantPropertiesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductParametersVariantPropertiesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductParametersVariantPropertiesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductParametersVariantPropertiesInner is not found in the empty JSON string", ProductParametersVariantPropertiesInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductParametersVariantPropertiesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductParametersVariantPropertiesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductParametersVariantPropertiesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductParametersVariantPropertiesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductParametersVariantPropertiesInner>() {
           @Override
           public void write(JsonWriter out, ProductParametersVariantPropertiesInner value) throws IOException {
           ...
           @Override
           public ProductParametersVariantPropertiesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductParametersVariantPropertiesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductParametersVariantPropertiesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductParametersVariantPropertiesInner
  * @throws IOException if the JSON string is invalid with respect to ProductParametersVariantPropertiesInner
  */
  public static ProductParametersVariantPropertiesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductParametersVariantPropertiesInner.class);
  }

 /**
  * Convert an instance of ProductParametersVariantPropertiesInner to an JSON string
  *
  * @return JSON string
  */
