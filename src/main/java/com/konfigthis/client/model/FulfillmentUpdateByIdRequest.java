...
import com.konfigthis.client.model.FulfillmentParameters;
...
public class FulfillmentUpdateByIdRequest {
  ...
  public FulfillmentUpdateByIdRequest() {
  }

  public FulfillmentUpdateByIdRequest fulfillment(FulfillmentParameters fulfillment) {
  ...
  **/
  ...
  public FulfillmentParameters getFulfillment() {
    return fulfillment;
  }


  public void setFulfillment(FulfillmentParameters fulfillment) {
   ...
   * @return the FulfillmentUpdateByIdRequest instance itself
   */
  public FulfillmentUpdateByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest = (FulfillmentUpdateByIdRequest) o;
    return Objects.equals(this.fulfillment, fulfillmentUpdateByIdRequest.fulfillment)&&
        Objects.equals(this.additionalProperties, fulfillmentUpdateByIdRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentUpdateByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentUpdateByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentUpdateByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentUpdateByIdRequest is not found in the empty JSON string", FulfillmentUpdateByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentUpdateByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentUpdateByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentUpdateByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentUpdateByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentUpdateByIdRequest>() {
           @Override
           public void write(JsonWriter out, FulfillmentUpdateByIdRequest value) throws IOException {
           ...
           @Override
           public FulfillmentUpdateByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentUpdateByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentUpdateByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentUpdateByIdRequest
  * @throws IOException if the JSON string is invalid with respect to FulfillmentUpdateByIdRequest
  */
  public static FulfillmentUpdateByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentUpdateByIdRequest.class);
  }

 /**
  * Convert an instance of FulfillmentUpdateByIdRequest to an JSON string
  *
  * @return JSON string
  */
