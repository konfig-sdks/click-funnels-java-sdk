...
import com.konfigthis.client.model.OrdersTagParameters;
...
public class OrdersTagUpdateSpecificOrderTagRequest {
  public static final String SERIALIZED_NAME_ORDERS_TAG = "orders_tag";
  @SerializedName(SERIALIZED_NAME_ORDERS_TAG)
  private OrdersTagParameters ordersTag;

  public OrdersTagUpdateSpecificOrderTagRequest() {
  }

  public OrdersTagUpdateSpecificOrderTagRequest ordersTag(OrdersTagParameters ordersTag) {
  ...
  **/
  ...
  public OrdersTagParameters getOrdersTag() {
    return ordersTag;
  }


  public void setOrdersTag(OrdersTagParameters ordersTag) {
   ...
   * @return the OrdersTagUpdateSpecificOrderTagRequest instance itself
   */
  public OrdersTagUpdateSpecificOrderTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest = (OrdersTagUpdateSpecificOrderTagRequest) o;
    return Objects.equals(this.ordersTag, ordersTagUpdateSpecificOrderTagRequest.ordersTag)&&
        Objects.equals(this.additionalProperties, ordersTagUpdateSpecificOrderTagRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ordersTag, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrdersTagUpdateSpecificOrderTagRequest {\n");
    sb.append("    ordersTag: ").append(toIndentedString(ordersTag)).append("\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersTagUpdateSpecificOrderTagRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersTagUpdateSpecificOrderTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersTagUpdateSpecificOrderTagRequest is not found in the empty JSON string", OrdersTagUpdateSpecificOrderTagRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersTagUpdateSpecificOrderTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersTagUpdateSpecificOrderTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersTagUpdateSpecificOrderTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersTagUpdateSpecificOrderTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersTagUpdateSpecificOrderTagRequest>() {
           @Override
           public void write(JsonWriter out, OrdersTagUpdateSpecificOrderTagRequest value) throws IOException {
           ...
           @Override
           public OrdersTagUpdateSpecificOrderTagRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersTagUpdateSpecificOrderTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersTagUpdateSpecificOrderTagRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersTagUpdateSpecificOrderTagRequest
  * @throws IOException if the JSON string is invalid with respect to OrdersTagUpdateSpecificOrderTagRequest
  */
  public static OrdersTagUpdateSpecificOrderTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersTagUpdateSpecificOrderTagRequest.class);
  }

 /**
  * Convert an instance of OrdersTagUpdateSpecificOrderTagRequest to an JSON string
  *
  * @return JSON string
  */
