...
import com.konfigthis.client.model.ContactParameters;
...
public class ContactUpdateContactByIdRequest {
  public static final String SERIALIZED_NAME_CONTACT = "contact";
  @SerializedName(SERIALIZED_NAME_CONTACT)
  private ContactParameters contact;

  public ContactUpdateContactByIdRequest() {
  }

  public ContactUpdateContactByIdRequest contact(ContactParameters contact) {
  ...
  **/
  ...
  public ContactParameters getContact() {
    return contact;
  }


  public void setContact(ContactParameters contact) {
   ...
   * @return the ContactUpdateContactByIdRequest instance itself
   */
  public ContactUpdateContactByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContactUpdateContactByIdRequest contactUpdateContactByIdRequest = (ContactUpdateContactByIdRequest) o;
    return Objects.equals(this.contact, contactUpdateContactByIdRequest.contact)&&
        Objects.equals(this.additionalProperties, contactUpdateContactByIdRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactUpdateContactByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactUpdateContactByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactUpdateContactByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactUpdateContactByIdRequest is not found in the empty JSON string", ContactUpdateContactByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactUpdateContactByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactUpdateContactByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactUpdateContactByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactUpdateContactByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactUpdateContactByIdRequest>() {
           @Override
           public void write(JsonWriter out, ContactUpdateContactByIdRequest value) throws IOException {
           ...
           @Override
           public ContactUpdateContactByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactUpdateContactByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactUpdateContactByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactUpdateContactByIdRequest
  * @throws IOException if the JSON string is invalid with respect to ContactUpdateContactByIdRequest
  */
  public static ContactUpdateContactByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactUpdateContactByIdRequest.class);
  }

 /**
  * Convert an instance of ContactUpdateContactByIdRequest to an JSON string
  *
  * @return JSON string
  */
