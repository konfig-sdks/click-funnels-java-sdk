...
public class ProductsVariantParametersPropertiesValuesInner {
  ...
  public ProductsVariantParametersPropertiesValuesInner() {
  }

  public ProductsVariantParametersPropertiesValuesInner propertyId(Integer propertyId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the property")
  ...
  public ProductsVariantParametersPropertiesValuesInner value(String value) {
  ...
  **/
   ...
   * @return the ProductsVariantParametersPropertiesValuesInner instance itself
   */
  public ProductsVariantParametersPropertiesValuesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsVariantParametersPropertiesValuesInner productsVariantParametersPropertiesValuesInner = (ProductsVariantParametersPropertiesValuesInner) o;
    return Objects.equals(this.propertyId, productsVariantParametersPropertiesValuesInner.propertyId) &&
        Objects.equals(this.value, productsVariantParametersPropertiesValuesInner.value)&&
        Objects.equals(this.additionalProperties, productsVariantParametersPropertiesValuesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsVariantParametersPropertiesValuesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsVariantParametersPropertiesValuesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsVariantParametersPropertiesValuesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsVariantParametersPropertiesValuesInner is not found in the empty JSON string", ProductsVariantParametersPropertiesValuesInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsVariantParametersPropertiesValuesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsVariantParametersPropertiesValuesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsVariantParametersPropertiesValuesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsVariantParametersPropertiesValuesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsVariantParametersPropertiesValuesInner>() {
           @Override
           public void write(JsonWriter out, ProductsVariantParametersPropertiesValuesInner value) throws IOException {
           ...
           @Override
           public ProductsVariantParametersPropertiesValuesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsVariantParametersPropertiesValuesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsVariantParametersPropertiesValuesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsVariantParametersPropertiesValuesInner
  * @throws IOException if the JSON string is invalid with respect to ProductsVariantParametersPropertiesValuesInner
  */
  public static ProductsVariantParametersPropertiesValuesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsVariantParametersPropertiesValuesInner.class);
  }

 /**
  * Convert an instance of ProductsVariantParametersPropertiesValuesInner to an JSON string
  *
  * @return JSON string
  */
