 ...
 * Images
 */
@ApiModel(description = "Images")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ImageParameters {
  public static final String SERIALIZED_NAME_ALT_TEXT = "alt_text";
  @SerializedName(SERIALIZED_NAME_ALT_TEXT)
  private Object altText = null;

  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private Object name = null;

  public static final String SERIALIZED_NAME_UPLOAD_SOURCE_URL = "upload_source_url";
  @SerializedName(SERIALIZED_NAME_UPLOAD_SOURCE_URL)
  private String uploadSourceUrl;

  public ImageParameters() {
  }

  public ImageParameters altText(Object altText) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Image alt attribute")
  ...
  public ImageParameters name(Object name) {
  ...
  **/
  ...
  public ImageParameters uploadSourceUrl(String uploadSourceUrl) {
    
    
    
    
    this.uploadSourceUrl = uploadSourceUrl;
    return this;
  }

   /**
   * The source URL of the image that you want to upload. Not required on Update when not needed to re-upload the image.
   * @return uploadSourceUrl
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "https://image-hosting-x.com/cdn/123", required = true, value = "The source URL of the image that you want to upload. Not required on Update when not needed to re-upload the image.")

  public String getUploadSourceUrl() {
    return uploadSourceUrl;
  }


  public void setUploadSourceUrl(String uploadSourceUrl) {
   ...
   * @return the ImageParameters instance itself
   */
  public ImageParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImageParameters imageParameters = (ImageParameters) o;
    return Objects.equals(this.altText, imageParameters.altText) &&
        Objects.equals(this.name, imageParameters.name) &&
        Objects.equals(this.uploadSourceUrl, imageParameters.uploadSourceUrl)&&
        Objects.equals(this.additionalProperties, imageParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(altText, name, uploadSourceUrl, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageParameters {\n");
    sb.append("    altText: ").append(toIndentedString(altText)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    uploadSourceUrl: ").append(toIndentedString(uploadSourceUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("upload_source_url");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("upload_source_url");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageParameters is not found in the empty JSON string", ImageParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageParameters.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("upload_source_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `upload_source_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("upload_source_url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageParameters>() {
           @Override
           public void write(JsonWriter out, ImageParameters value) throws IOException {
           ...
           @Override
           public ImageParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageParameters
  * @throws IOException if the JSON string is invalid with respect to ImageParameters
  */
  public static ImageParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageParameters.class);
  }

 /**
  * Convert an instance of ImageParameters to an JSON string
  *
  * @return JSON string
  */
