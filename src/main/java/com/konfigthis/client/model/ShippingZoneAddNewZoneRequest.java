...
public class ShippingZoneAddNewZoneRequest {
  ...
  public ShippingZoneAddNewZoneRequest() {
  }

  public ShippingZoneAddNewZoneRequest shippingZone(ShippingZoneParameters shippingZone) {
  ...
  **/
   ...
   * @return the ShippingZoneAddNewZoneRequest instance itself
   */
  public ShippingZoneAddNewZoneRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest = (ShippingZoneAddNewZoneRequest) o;
    return Objects.equals(this.shippingZone, shippingZoneAddNewZoneRequest.shippingZone)&&
        Objects.equals(this.additionalProperties, shippingZoneAddNewZoneRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingZoneAddNewZoneRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingZoneAddNewZoneRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingZoneAddNewZoneRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingZoneAddNewZoneRequest is not found in the empty JSON string", ShippingZoneAddNewZoneRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingZoneAddNewZoneRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingZoneAddNewZoneRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingZoneAddNewZoneRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingZoneAddNewZoneRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingZoneAddNewZoneRequest>() {
           @Override
           public void write(JsonWriter out, ShippingZoneAddNewZoneRequest value) throws IOException {
           ...
           @Override
           public ShippingZoneAddNewZoneRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingZoneAddNewZoneRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingZoneAddNewZoneRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingZoneAddNewZoneRequest
  * @throws IOException if the JSON string is invalid with respect to ShippingZoneAddNewZoneRequest
  */
  public static ShippingZoneAddNewZoneRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingZoneAddNewZoneRequest.class);
  }

 /**
  * Convert an instance of ShippingZoneAddNewZoneRequest to an JSON string
  *
  * @return JSON string
  */
