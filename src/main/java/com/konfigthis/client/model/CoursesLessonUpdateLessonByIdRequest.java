...
import com.konfigthis.client.model.CoursesLessonParameters;
...
public class CoursesLessonUpdateLessonByIdRequest {
  public static final String SERIALIZED_NAME_COURSES_LESSON = "courses_lesson";
  @SerializedName(SERIALIZED_NAME_COURSES_LESSON)
  private CoursesLessonParameters coursesLesson;

  public CoursesLessonUpdateLessonByIdRequest() {
  }

  public CoursesLessonUpdateLessonByIdRequest coursesLesson(CoursesLessonParameters coursesLesson) {
  ...
  **/
  ...
  public CoursesLessonParameters getCoursesLesson() {
    return coursesLesson;
  }


  public void setCoursesLesson(CoursesLessonParameters coursesLesson) {
   ...
   * @return the CoursesLessonUpdateLessonByIdRequest instance itself
   */
  public CoursesLessonUpdateLessonByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest = (CoursesLessonUpdateLessonByIdRequest) o;
    return Objects.equals(this.coursesLesson, coursesLessonUpdateLessonByIdRequest.coursesLesson)&&
        Objects.equals(this.additionalProperties, coursesLessonUpdateLessonByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coursesLesson, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CoursesLessonUpdateLessonByIdRequest {\n");
    sb.append("    coursesLesson: ").append(toIndentedString(coursesLesson)).append("\n");
  ...
  static {
    ...
    openapiFields.add("courses_lesson");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesLessonUpdateLessonByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesLessonUpdateLessonByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesLessonUpdateLessonByIdRequest is not found in the empty JSON string", CoursesLessonUpdateLessonByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesLessonUpdateLessonByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesLessonUpdateLessonByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesLessonUpdateLessonByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesLessonUpdateLessonByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesLessonUpdateLessonByIdRequest>() {
           @Override
           public void write(JsonWriter out, CoursesLessonUpdateLessonByIdRequest value) throws IOException {
           ...
           @Override
           public CoursesLessonUpdateLessonByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesLessonUpdateLessonByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesLessonUpdateLessonByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesLessonUpdateLessonByIdRequest
  * @throws IOException if the JSON string is invalid with respect to CoursesLessonUpdateLessonByIdRequest
  */
  public static CoursesLessonUpdateLessonByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesLessonUpdateLessonByIdRequest.class);
  }

 /**
  * Convert an instance of CoursesLessonUpdateLessonByIdRequest to an JSON string
  *
  * @return JSON string
  */
