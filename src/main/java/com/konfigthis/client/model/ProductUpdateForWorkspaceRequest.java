...
import com.konfigthis.client.model.ProductParameters;
...
public class ProductUpdateForWorkspaceRequest {
  public static final String SERIALIZED_NAME_PRODUCT = "product";
  @SerializedName(SERIALIZED_NAME_PRODUCT)
  private ProductParameters product;

  public ProductUpdateForWorkspaceRequest() {
  }

  public ProductUpdateForWorkspaceRequest product(ProductParameters product) {
  ...
  **/
   ...
   * @return the ProductUpdateForWorkspaceRequest instance itself
   */
  public ProductUpdateForWorkspaceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest = (ProductUpdateForWorkspaceRequest) o;
    return Objects.equals(this.product, productUpdateForWorkspaceRequest.product)&&
        Objects.equals(this.additionalProperties, productUpdateForWorkspaceRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductUpdateForWorkspaceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductUpdateForWorkspaceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductUpdateForWorkspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductUpdateForWorkspaceRequest is not found in the empty JSON string", ProductUpdateForWorkspaceRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductUpdateForWorkspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductUpdateForWorkspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductUpdateForWorkspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductUpdateForWorkspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductUpdateForWorkspaceRequest>() {
           @Override
           public void write(JsonWriter out, ProductUpdateForWorkspaceRequest value) throws IOException {
           ...
           @Override
           public ProductUpdateForWorkspaceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductUpdateForWorkspaceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductUpdateForWorkspaceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductUpdateForWorkspaceRequest
  * @throws IOException if the JSON string is invalid with respect to ProductUpdateForWorkspaceRequest
  */
  public static ProductUpdateForWorkspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductUpdateForWorkspaceRequest.class);
  }

 /**
  * Convert an instance of ProductUpdateForWorkspaceRequest to an JSON string
  *
  * @return JSON string
  */
