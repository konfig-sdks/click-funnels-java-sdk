...
public class WorkspaceParameters {
  ...
  public WorkspaceParameters name(String name) {
  ...
  **/
  ...
  public WorkspaceParameters subdomain(String subdomain) {
  ...
  **/
   ...
   * @return the WorkspaceParameters instance itself
   */
  public WorkspaceParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkspaceParameters workspaceParameters = (WorkspaceParameters) o;
    return Objects.equals(this.name, workspaceParameters.name) &&
        Objects.equals(this.subdomain, workspaceParameters.subdomain)&&
        Objects.equals(this.additionalProperties, workspaceParameters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, subdomain, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkspaceParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkspaceParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkspaceParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkspaceParameters is not found in the empty JSON string", WorkspaceParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkspaceParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkspaceParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkspaceParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkspaceParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkspaceParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkspaceParameters>() {
           @Override
           public void write(JsonWriter out, WorkspaceParameters value) throws IOException {
           ...
           @Override
           public WorkspaceParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkspaceParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkspaceParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkspaceParameters
  * @throws IOException if the JSON string is invalid with respect to WorkspaceParameters
  */
  public static WorkspaceParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkspaceParameters.class);
  }

 /**
  * Convert an instance of WorkspaceParameters to an JSON string
  *
  * @return JSON string
  */
