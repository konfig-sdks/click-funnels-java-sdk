 ...
 * Orders Applied Tags
 */
@ApiModel(description = "Orders Applied Tags")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrdersAppliedTagAttributes {
  ...
  public OrdersAppliedTagAttributes() {
  }

  public OrdersAppliedTagAttributes id(Integer id) {
  ...
  **/
  ...
  public OrdersAppliedTagAttributes publicId(Object publicId) {
  ...
  **/
  ...
  public OrdersAppliedTagAttributes orderId(Integer orderId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3", required = true, value = "Order ID")
  ...
  public OrdersAppliedTagAttributes tagId(Integer tagId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "4", required = true, value = "Tag ID")
  ...
  public OrdersAppliedTagAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public OrdersAppliedTagAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the OrdersAppliedTagAttributes instance itself
   */
  public OrdersAppliedTagAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrdersAppliedTagAttributes ordersAppliedTagAttributes = (OrdersAppliedTagAttributes) o;
    return Objects.equals(this.id, ordersAppliedTagAttributes.id) &&
        Objects.equals(this.publicId, ordersAppliedTagAttributes.publicId) &&
        Objects.equals(this.orderId, ordersAppliedTagAttributes.orderId) &&
        Objects.equals(this.tagId, ordersAppliedTagAttributes.tagId) &&
        Objects.equals(this.createdAt, ordersAppliedTagAttributes.createdAt) &&
        Objects.equals(this.updatedAt, ordersAppliedTagAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, ordersAppliedTagAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, orderId, tagId, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersAppliedTagAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrdersAppliedTagAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrdersAppliedTagAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrdersAppliedTagAttributes is not found in the empty JSON string", OrdersAppliedTagAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrdersAppliedTagAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrdersAppliedTagAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrdersAppliedTagAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrdersAppliedTagAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrdersAppliedTagAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<OrdersAppliedTagAttributes>() {
           @Override
           public void write(JsonWriter out, OrdersAppliedTagAttributes value) throws IOException {
           ...
           @Override
           public OrdersAppliedTagAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrdersAppliedTagAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrdersAppliedTagAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrdersAppliedTagAttributes
  * @throws IOException if the JSON string is invalid with respect to OrdersAppliedTagAttributes
  */
  public static OrdersAppliedTagAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrdersAppliedTagAttributes.class);
  }

 /**
  * Convert an instance of OrdersAppliedTagAttributes to an JSON string
  *
  * @return JSON string
  */
