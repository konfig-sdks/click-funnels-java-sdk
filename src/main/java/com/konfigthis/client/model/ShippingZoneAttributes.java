 ...
 * Zones
 */
@ApiModel(description = "Zones")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ShippingZoneAttributes {
  ...
  public static final String SERIALIZED_NAME_LOCATION_GROUP_ID = "location_group_id";
  ...
  public static final String SERIALIZED_NAME_ADDRESS_FILTER_ID = "address_filter_id";
  @SerializedName(SERIALIZED_NAME_ADDRESS_FILTER_ID)
  private Object addressFilterId = null;

  public static final String SERIALIZED_NAME_REGION_IDS = "region_ids";
  @SerializedName(SERIALIZED_NAME_REGION_IDS)
  private Object regionIds = null;

  public static final String SERIALIZED_NAME_COUNTRY_IDS = "country_ids";
  @SerializedName(SERIALIZED_NAME_COUNTRY_IDS)
  private Object countryIds = null;

  public static final String SERIALIZED_NAME_INCLUDES_REST_OF_WORLD = "includes_rest_of_world";
  @SerializedName(SERIALIZED_NAME_INCLUDES_REST_OF_WORLD)
  private Object includesRestOfWorld = null;
  ...
  public ShippingZoneAttributes() {
  }

  public ShippingZoneAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2", required = true, value = "Zone ID")
  ...
  public ShippingZoneAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Zone public ID")
  ...
  public ShippingZoneAttributes locationGroupId(Integer locationGroupId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3", required = true, value = "Location group ID")
  ...
  public ShippingZoneAttributes name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Bruce Marquardt", required = true, value = "Name")
  ...
  public ShippingZoneAttributes addressFilterId(Object addressFilterId) {
    
    
    
    
    this.addressFilterId = addressFilterId;
    return this;
  }

   /**
   * Zone
   * @return addressFilterId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Zone")

  public Object getAddressFilterId() {
    return addressFilterId;
  }


  public void setAddressFilterId(Object addressFilterId) {
  ...
  public ShippingZoneAttributes regionIds(Object regionIds) {
  ...
  **/
  ...
  public ShippingZoneAttributes countryIds(Object countryIds) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Country IDs")
  ...
  public ShippingZoneAttributes includesRestOfWorld(Object includesRestOfWorld) {
    
    
    
    
    this.includesRestOfWorld = includesRestOfWorld;
    return this;
  }

   /**
   * Includes Rest of the World
   * @return includesRestOfWorld
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Includes Rest of the World")

  public Object getIncludesRestOfWorld() {
    return includesRestOfWorld;
  }


  public void setIncludesRestOfWorld(Object includesRestOfWorld) {
  ...
  public ShippingZoneAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public ShippingZoneAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the ShippingZoneAttributes instance itself
   */
  public ShippingZoneAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingZoneAttributes shippingZoneAttributes = (ShippingZoneAttributes) o;
    return Objects.equals(this.id, shippingZoneAttributes.id) &&
        Objects.equals(this.publicId, shippingZoneAttributes.publicId) &&
        Objects.equals(this.locationGroupId, shippingZoneAttributes.locationGroupId) &&
        Objects.equals(this.name, shippingZoneAttributes.name) &&
        Objects.equals(this.addressFilterId, shippingZoneAttributes.addressFilterId) &&
        Objects.equals(this.regionIds, shippingZoneAttributes.regionIds) &&
        Objects.equals(this.countryIds, shippingZoneAttributes.countryIds) &&
        Objects.equals(this.includesRestOfWorld, shippingZoneAttributes.includesRestOfWorld) &&
        Objects.equals(this.createdAt, shippingZoneAttributes.createdAt) &&
        Objects.equals(this.updatedAt, shippingZoneAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, shippingZoneAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, locationGroupId, name, addressFilterId, regionIds, countryIds, includesRestOfWorld, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingZoneAttributes {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    publicId: ").append(toIndentedString(publicId)).append("\n");
    sb.append("    locationGroupId: ").append(toIndentedString(locationGroupId)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    addressFilterId: ").append(toIndentedString(addressFilterId)).append("\n");
    ...
    sb.append("    includesRestOfWorld: ").append(toIndentedString(includesRestOfWorld)).append("\n");
  ...
  static {
    ...
    openapiFields.add("location_group_id");
    openapiFields.add("name");
    openapiFields.add("address_filter_id");
    openapiFields.add("region_ids");
    openapiFields.add("country_ids");
    openapiFields.add("includes_rest_of_world");
    ...
    openapiRequiredFields.add("location_group_id");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingZoneAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingZoneAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingZoneAttributes is not found in the empty JSON string", ShippingZoneAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingZoneAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingZoneAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingZoneAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingZoneAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingZoneAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingZoneAttributes>() {
           @Override
           public void write(JsonWriter out, ShippingZoneAttributes value) throws IOException {
           ...
           @Override
           public ShippingZoneAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingZoneAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingZoneAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingZoneAttributes
  * @throws IOException if the JSON string is invalid with respect to ShippingZoneAttributes
  */
  public static ShippingZoneAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingZoneAttributes.class);
  }

 /**
  * Convert an instance of ShippingZoneAttributes to an JSON string
  *
  * @return JSON string
  */
