...
import com.konfigthis.client.model.FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner;
 ...
 * Fulfillments
 */
@ApiModel(description = "Fulfillments")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FulfillmentParameters {
  ...
  private Object shippingProvider = null;

  public static final String SERIALIZED_NAME_TRACKING_CODE = "tracking_code";
  @SerializedName(SERIALIZED_NAME_TRACKING_CODE)
  private Object trackingCode = null;

  public static final String SERIALIZED_NAME_LOCATION_ID = "location_id";
  @SerializedName(SERIALIZED_NAME_LOCATION_ID)
  private Integer locationId;

  public static final String SERIALIZED_NAME_IGNORE_OUT_OF_STOCK = "ignore_out_of_stock";
  @SerializedName(SERIALIZED_NAME_IGNORE_OUT_OF_STOCK)
  private Boolean ignoreOutOfStock;

  public static final String SERIALIZED_NAME_NOTIFY_CUSTOMER = "notify_customer";
  @SerializedName(SERIALIZED_NAME_NOTIFY_CUSTOMER)
  private Boolean notifyCustomer;

  public static final String SERIALIZED_NAME_INCLUDED_ORDERS_INVOICES_LINE_ITEMS_ATTRIBUTES = "included_orders_invoices_line_items_attributes";
  @SerializedName(SERIALIZED_NAME_INCLUDED_ORDERS_INVOICES_LINE_ITEMS_ATTRIBUTES)
  private List<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner> includedOrdersInvoicesLineItemsAttributes = new ArrayList<>();

  public FulfillmentParameters() {
  }

  public FulfillmentParameters contactId(Integer contactId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "6", required = true, value = "Contact ID")
  ...
  public FulfillmentParameters trackingUrl(Object trackingUrl) {
  ...
  **/
  ...
  public FulfillmentParameters shippingProvider(Object shippingProvider) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shipping Provider")
  ...
  public FulfillmentParameters trackingCode(Object trackingCode) {
  ...
  **/
  ...
  public FulfillmentParameters locationId(Integer locationId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Location")
  ...
  public FulfillmentParameters ignoreOutOfStock(Boolean ignoreOutOfStock) {
   ...
   * @return ignoreOutOfStock
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Create a fulfillment despite the item being out of stock.")

  public Boolean getIgnoreOutOfStock() {
    return ignoreOutOfStock;
  }


  public void setIgnoreOutOfStock(Boolean ignoreOutOfStock) {
  ...
  public FulfillmentParameters notifyCustomer(Boolean notifyCustomer) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Send an email to the customer when the fulfillment is created.")
  ...
  public FulfillmentParameters includedOrdersInvoicesLineItemsAttributes(List<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner> includedOrdersInvoicesLineItemsAttributes) {
    
    
    
    
    this.includedOrdersInvoicesLineItemsAttributes = includedOrdersInvoicesLineItemsAttributes;
    return this;
  }

  public FulfillmentParameters addIncludedOrdersInvoicesLineItemsAttributesItem(FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner includedOrdersInvoicesLineItemsAttributesItem) {
    this.includedOrdersInvoicesLineItemsAttributes.add(includedOrdersInvoicesLineItemsAttributesItem);
    return this;
  }

   /**
   * The orders invoices line items to fulfill as part of this fulfillment.
   * @return includedOrdersInvoicesLineItemsAttributes
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The orders invoices line items to fulfill as part of this fulfillment.")

  public List<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner> getIncludedOrdersInvoicesLineItemsAttributes() {
    return includedOrdersInvoicesLineItemsAttributes;
  }


  public void setIncludedOrdersInvoicesLineItemsAttributes(List<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner> includedOrdersInvoicesLineItemsAttributes) {
   ...
   * @return the FulfillmentParameters instance itself
   */
  public FulfillmentParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentParameters fulfillmentParameters = (FulfillmentParameters) o;
    return Objects.equals(this.contactId, fulfillmentParameters.contactId) &&
        Objects.equals(this.trackingUrl, fulfillmentParameters.trackingUrl) &&
        Objects.equals(this.shippingProvider, fulfillmentParameters.shippingProvider) &&
        Objects.equals(this.trackingCode, fulfillmentParameters.trackingCode) &&
        Objects.equals(this.locationId, fulfillmentParameters.locationId) &&
        Objects.equals(this.ignoreOutOfStock, fulfillmentParameters.ignoreOutOfStock) &&
        Objects.equals(this.notifyCustomer, fulfillmentParameters.notifyCustomer) &&
        Objects.equals(this.includedOrdersInvoicesLineItemsAttributes, fulfillmentParameters.includedOrdersInvoicesLineItemsAttributes)&&
        Objects.equals(this.additionalProperties, fulfillmentParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contactId, trackingUrl, shippingProvider, trackingCode, locationId, ignoreOutOfStock, notifyCustomer, includedOrdersInvoicesLineItemsAttributes, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentParameters {\n");
    ...
    sb.append("    ignoreOutOfStock: ").append(toIndentedString(ignoreOutOfStock)).append("\n");
    sb.append("    notifyCustomer: ").append(toIndentedString(notifyCustomer)).append("\n");
    sb.append("    includedOrdersInvoicesLineItemsAttributes: ").append(toIndentedString(includedOrdersInvoicesLineItemsAttributes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ignore_out_of_stock");
    openapiFields.add("notify_customer");
    openapiFields.add("included_orders_invoices_line_items_attributes");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("contact_id");
    openapiRequiredFields.add("location_id");
    openapiRequiredFields.add("included_orders_invoices_line_items_attributes");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentParameters is not found in the empty JSON string", FulfillmentParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FulfillmentParameters.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("included_orders_invoices_line_items_attributes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `included_orders_invoices_line_items_attributes` to be an array in the JSON string but got `%s`", jsonObj.get("included_orders_invoices_line_items_attributes").toString()));
      }

      JsonArray jsonArrayincludedOrdersInvoicesLineItemsAttributes = jsonObj.getAsJsonArray("included_orders_invoices_line_items_attributes");
      // validate the required field `included_orders_invoices_line_items_attributes` (array)
      for (int i = 0; i < jsonArrayincludedOrdersInvoicesLineItemsAttributes.size(); i++) {
        FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner.validateJsonObject(jsonArrayincludedOrdersInvoicesLineItemsAttributes.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentParameters>() {
           @Override
           public void write(JsonWriter out, FulfillmentParameters value) throws IOException {
           ...
           @Override
           public FulfillmentParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FulfillmentParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FulfillmentParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentParameters
  * @throws IOException if the JSON string is invalid with respect to FulfillmentParameters
  */
  public static FulfillmentParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentParameters.class);
  }

 /**
  * Convert an instance of FulfillmentParameters to an JSON string
  *
  * @return JSON string
  */
