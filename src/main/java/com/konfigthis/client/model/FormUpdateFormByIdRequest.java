...
import com.konfigthis.client.model.FormParameters;
...
public class FormUpdateFormByIdRequest {
  public static final String SERIALIZED_NAME_FORM = "form";
  @SerializedName(SERIALIZED_NAME_FORM)
  private FormParameters form;

  public FormUpdateFormByIdRequest() {
  }

  public FormUpdateFormByIdRequest form(FormParameters form) {
  ...
  **/
  ...
  public void setForm(FormParameters form) {
   ...
   * @return the FormUpdateFormByIdRequest instance itself
   */
  public FormUpdateFormByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormUpdateFormByIdRequest formUpdateFormByIdRequest = (FormUpdateFormByIdRequest) o;
    return Objects.equals(this.form, formUpdateFormByIdRequest.form)&&
        Objects.equals(this.additionalProperties, formUpdateFormByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(form, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormUpdateFormByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormUpdateFormByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormUpdateFormByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormUpdateFormByIdRequest is not found in the empty JSON string", FormUpdateFormByIdRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormUpdateFormByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormUpdateFormByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormUpdateFormByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormUpdateFormByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FormUpdateFormByIdRequest>() {
           @Override
           public void write(JsonWriter out, FormUpdateFormByIdRequest value) throws IOException {
           ...
           @Override
           public FormUpdateFormByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormUpdateFormByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormUpdateFormByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormUpdateFormByIdRequest
  * @throws IOException if the JSON string is invalid with respect to FormUpdateFormByIdRequest
  */
  public static FormUpdateFormByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormUpdateFormByIdRequest.class);
  }

 /**
  * Convert an instance of FormUpdateFormByIdRequest to an JSON string
  *
  * @return JSON string
  */
