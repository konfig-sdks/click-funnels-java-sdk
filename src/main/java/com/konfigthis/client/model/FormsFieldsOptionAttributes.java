 ...
 * Options
 */
@ApiModel(description = "Options")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FormsFieldsOptionAttributes {
  ...
  public FormsFieldsOptionAttributes() {
  }

  public FormsFieldsOptionAttributes id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "5", required = true, value = "Option ID")
  ...
  public FormsFieldsOptionAttributes publicId(Object publicId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Option public ID")
  ...
  public FormsFieldsOptionAttributes fieldId(Integer fieldId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Field ID")
  ...
  public FormsFieldsOptionAttributes label(String label) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "accusamus", required = true, value = "Label")
  ...
  public FormsFieldsOptionAttributes createdAt(Object createdAt) {
  ...
  **/
  ...
  public FormsFieldsOptionAttributes updatedAt(Object updatedAt) {
  ...
  **/
   ...
   * @return the FormsFieldsOptionAttributes instance itself
   */
  public FormsFieldsOptionAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormsFieldsOptionAttributes formsFieldsOptionAttributes = (FormsFieldsOptionAttributes) o;
    return Objects.equals(this.id, formsFieldsOptionAttributes.id) &&
        Objects.equals(this.publicId, formsFieldsOptionAttributes.publicId) &&
        Objects.equals(this.fieldId, formsFieldsOptionAttributes.fieldId) &&
        Objects.equals(this.label, formsFieldsOptionAttributes.label) &&
        Objects.equals(this.createdAt, formsFieldsOptionAttributes.createdAt) &&
        Objects.equals(this.updatedAt, formsFieldsOptionAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, formsFieldsOptionAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, publicId, fieldId, label, createdAt, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsFieldsOptionAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FormsFieldsOptionAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FormsFieldsOptionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsFieldsOptionAttributes is not found in the empty JSON string", FormsFieldsOptionAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormsFieldsOptionAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsFieldsOptionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsFieldsOptionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsFieldsOptionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsFieldsOptionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsFieldsOptionAttributes>() {
           @Override
           public void write(JsonWriter out, FormsFieldsOptionAttributes value) throws IOException {
           ...
           @Override
           public FormsFieldsOptionAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FormsFieldsOptionAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FormsFieldsOptionAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FormsFieldsOptionAttributes
  * @throws IOException if the JSON string is invalid with respect to FormsFieldsOptionAttributes
  */
  public static FormsFieldsOptionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsFieldsOptionAttributes.class);
  }

 /**
  * Convert an instance of FormsFieldsOptionAttributes to an JSON string
  *
  * @return JSON string
  */
