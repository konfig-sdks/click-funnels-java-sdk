...
public class ShippingRateParameters {
 ...
 public enum LiveRatesProviderEnum {
  ...
  public ShippingRateParameters() {
  }

  public ShippingRateParameters providerName(Object providerName) {
  ...
  **/
  ...
  public ShippingRateParameters price(String price) {
  ...
  **/
  ...
  public ShippingRateParameters priceCurrency(String priceCurrency) {
  ...
  **/
  ...
  public ShippingRateParameters ratesNameId(Integer ratesNameId) {
  ...
  **/
  ...
  public ShippingRateParameters liveRatesProvider(LiveRatesProviderEnum liveRatesProvider) {
  ...
  **/
   ...
   * @return the ShippingRateParameters instance itself
   */
  public ShippingRateParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShippingRateParameters shippingRateParameters = (ShippingRateParameters) o;
    return Objects.equals(this.providerName, shippingRateParameters.providerName) &&
        Objects.equals(this.price, shippingRateParameters.price) &&
        Objects.equals(this.priceCurrency, shippingRateParameters.priceCurrency) &&
        Objects.equals(this.ratesNameId, shippingRateParameters.ratesNameId) &&
        Objects.equals(this.liveRatesProvider, shippingRateParameters.liveRatesProvider)&&
        Objects.equals(this.additionalProperties, shippingRateParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(providerName, price, priceCurrency, ratesNameId, liveRatesProvider, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingRateParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShippingRateParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShippingRateParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShippingRateParameters is not found in the empty JSON string", ShippingRateParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShippingRateParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShippingRateParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShippingRateParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShippingRateParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShippingRateParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ShippingRateParameters>() {
           @Override
           public void write(JsonWriter out, ShippingRateParameters value) throws IOException {
           ...
           @Override
           public ShippingRateParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShippingRateParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShippingRateParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShippingRateParameters
  * @throws IOException if the JSON string is invalid with respect to ShippingRateParameters
  */
  public static ShippingRateParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShippingRateParameters.class);
  }

 /**
  * Convert an instance of ShippingRateParameters to an JSON string
  *
  * @return JSON string
  */
