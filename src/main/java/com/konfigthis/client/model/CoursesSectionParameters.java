...
public class CoursesSectionParameters {
  ...
  public CoursesSectionParameters() {
  }

  public CoursesSectionParameters title(String title) {
  ...
  **/
  ...
  public CoursesSectionParameters description(Object description) {
  ...
  **/
  ...
  public CoursesSectionParameters daysTillDripAccess(Object daysTillDripAccess) {
  ...
  **/
  ...
  public CoursesSectionParameters blockerSectionId(Object blockerSectionId) {
  ...
  **/
  ...
  public CoursesSectionParameters blockerLessonId(String blockerLessonId) {
  ...
  **/
  ...
  public CoursesSectionParameters isHiddenFromNonMembers(Object isHiddenFromNonMembers) {
  ...
  **/
   ...
   * @return the CoursesSectionParameters instance itself
   */
  public CoursesSectionParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CoursesSectionParameters coursesSectionParameters = (CoursesSectionParameters) o;
    return Objects.equals(this.title, coursesSectionParameters.title) &&
        Objects.equals(this.description, coursesSectionParameters.description) &&
        Objects.equals(this.daysTillDripAccess, coursesSectionParameters.daysTillDripAccess) &&
        Objects.equals(this.blockerSectionId, coursesSectionParameters.blockerSectionId) &&
        Objects.equals(this.blockerLessonId, coursesSectionParameters.blockerLessonId) &&
        Objects.equals(this.isHiddenFromNonMembers, coursesSectionParameters.isHiddenFromNonMembers)&&
        Objects.equals(this.additionalProperties, coursesSectionParameters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, daysTillDripAccess, blockerSectionId, blockerLessonId, isHiddenFromNonMembers, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursesSectionParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CoursesSectionParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CoursesSectionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoursesSectionParameters is not found in the empty JSON string", CoursesSectionParameters.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoursesSectionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoursesSectionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoursesSectionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoursesSectionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoursesSectionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<CoursesSectionParameters>() {
           @Override
           public void write(JsonWriter out, CoursesSectionParameters value) throws IOException {
           ...
           @Override
           public CoursesSectionParameters read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CoursesSectionParameters instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CoursesSectionParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoursesSectionParameters
  * @throws IOException if the JSON string is invalid with respect to CoursesSectionParameters
  */
  public static CoursesSectionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoursesSectionParameters.class);
  }

 /**
  * Convert an instance of CoursesSectionParameters to an JSON string
  *
  * @return JSON string
  */
