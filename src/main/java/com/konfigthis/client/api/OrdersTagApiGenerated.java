...
import com.konfigthis.client.model.OrdersTagAttributes;
import com.konfigthis.client.model.OrdersTagCreateNewTagRequest;
import com.konfigthis.client.model.OrdersTagUpdateSpecificOrderTagRequest;
...
public class OrdersTagApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OrdersTagApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OrdersTagApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewTagCall(Integer workspaceId, OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = ordersTagCreateNewTagRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/orders/tags"
    ...
    private okhttp3.Call createNewTagValidateBeforeCall(Integer workspaceId, OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewTag(Async)");
        }

        // verify the required parameter 'ordersTagCreateNewTagRequest' is set
        if (ordersTagCreateNewTagRequest == null) {
            throw new ApiException("Missing the required parameter 'ordersTagCreateNewTagRequest' when calling createNewTag(Async)");
        }

        return createNewTagCall(workspaceId, ordersTagCreateNewTagRequest, _callback);

    }


    private ApiResponse<OrdersTagAttributes> createNewTagWithHttpInfo(Integer workspaceId, OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewTagValidateBeforeCall(workspaceId, ordersTagCreateNewTagRequest, null);
        Type localVarReturnType = new TypeToken<OrdersTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewTagAsync(Integer workspaceId, OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest, final ApiCallback<OrdersTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewTagValidateBeforeCall(workspaceId, ordersTagCreateNewTagRequest, _callback);
        Type localVarReturnType = new TypeToken<OrdersTagAttributes>(){}.getType();
    ...
    public class CreateNewTagRequestBuilder {
        ...
        private OrdersTagParameters ordersTag;
        ...
        /**
         * Set ordersTag
         * @param ordersTag  (optional)
         * @return CreateNewTagRequestBuilder
         */
        public CreateNewTagRequestBuilder ordersTag(OrdersTagParameters ordersTag) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest = buildBodyParams();
            return createNewTagCall(workspaceId, ordersTagCreateNewTagRequest, _callback);
        }

        private OrdersTagCreateNewTagRequest buildBodyParams() {
            OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest = new OrdersTagCreateNewTagRequest();
            ordersTagCreateNewTagRequest.ordersTag(this.ordersTag);
            return ordersTagCreateNewTagRequest;
        }

        /**
         * Execute createNewTag request
         * @return OrdersTagAttributes
         ...
         */
        public OrdersTagAttributes execute() throws ApiException {
            OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest = buildBodyParams();
            ApiResponse<OrdersTagAttributes> localVarResp = createNewTagWithHttpInfo(workspaceId, ordersTagCreateNewTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewTag request with HTTP info returned
         * @return ApiResponse&lt;OrdersTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrdersTagAttributes> executeWithHttpInfo() throws ApiException {
            OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest = buildBodyParams();
            return createNewTagWithHttpInfo(workspaceId, ordersTagCreateNewTagRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrdersTagAttributes> _callback) throws ApiException {
            OrdersTagCreateNewTagRequest ordersTagCreateNewTagRequest = buildBodyParams();
            return createNewTagAsync(workspaceId, ordersTagCreateNewTagRequest, _callback);
        }
    }
     ...
     * @param ordersTagCreateNewTagRequest Information about a new Tag (required)
     * @return CreateNewTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private okhttp3.Call getSingleCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/orders/tags/{id}"
    ...
    private ApiResponse<OrdersTagAttributes> getSingleWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OrdersTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(String id, final ApiCallback<OrdersTagAttributes> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         */
        public OrdersTagAttributes execute() throws ApiException {
            ApiResponse<OrdersTagAttributes> localVarResp = getSingleWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<List<OrdersTagAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<OrdersTagAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<OrdersTagAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @return List&lt;OrdersTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<OrdersTagAttributes> execute() throws ApiException {
            ApiResponse<List<OrdersTagAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;OrdersTagAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<OrdersTagAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<OrdersTagAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateSpecificOrderTagCall(String id, OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = ordersTagUpdateSpecificOrderTagRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSpecificOrderTagValidateBeforeCall(String id, OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSpecificOrderTag(Async)");
        }

        // verify the required parameter 'ordersTagUpdateSpecificOrderTagRequest' is set
        if (ordersTagUpdateSpecificOrderTagRequest == null) {
            throw new ApiException("Missing the required parameter 'ordersTagUpdateSpecificOrderTagRequest' when calling updateSpecificOrderTag(Async)");
        }

        return updateSpecificOrderTagCall(id, ordersTagUpdateSpecificOrderTagRequest, _callback);

    }


    private ApiResponse<OrdersTagAttributes> updateSpecificOrderTagWithHttpInfo(String id, OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSpecificOrderTagValidateBeforeCall(id, ordersTagUpdateSpecificOrderTagRequest, null);
        Type localVarReturnType = new TypeToken<OrdersTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSpecificOrderTagAsync(String id, OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest, final ApiCallback<OrdersTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSpecificOrderTagValidateBeforeCall(id, ordersTagUpdateSpecificOrderTagRequest, _callback);
        Type localVarReturnType = new TypeToken<OrdersTagAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSpecificOrderTagRequestBuilder {
        private final String id;
        private OrdersTagParameters ordersTag;

        private UpdateSpecificOrderTagRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set ordersTag
         * @param ordersTag  (optional)
         * @return UpdateSpecificOrderTagRequestBuilder
         */
        public UpdateSpecificOrderTagRequestBuilder ordersTag(OrdersTagParameters ordersTag) {
            this.ordersTag = ordersTag;
            return this;
        }
        
        /**
         * Build call for updateSpecificOrderTag
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest = buildBodyParams();
            return updateSpecificOrderTagCall(id, ordersTagUpdateSpecificOrderTagRequest, _callback);
        }

        private OrdersTagUpdateSpecificOrderTagRequest buildBodyParams() {
            OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest = new OrdersTagUpdateSpecificOrderTagRequest();
            ordersTagUpdateSpecificOrderTagRequest.ordersTag(this.ordersTag);
            return ordersTagUpdateSpecificOrderTagRequest;
        }

        /**
         * Execute updateSpecificOrderTag request
         * @return OrdersTagAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public OrdersTagAttributes execute() throws ApiException {
            OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest = buildBodyParams();
            ApiResponse<OrdersTagAttributes> localVarResp = updateSpecificOrderTagWithHttpInfo(id, ordersTagUpdateSpecificOrderTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSpecificOrderTag request with HTTP info returned
         * @return ApiResponse&lt;OrdersTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<OrdersTagAttributes> executeWithHttpInfo() throws ApiException {
            OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest = buildBodyParams();
            return updateSpecificOrderTagWithHttpInfo(id, ordersTagUpdateSpecificOrderTagRequest);
        }

        /**
         * Execute updateSpecificOrderTag request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<OrdersTagAttributes> _callback) throws ApiException {
            OrdersTagUpdateSpecificOrderTagRequest ordersTagUpdateSpecificOrderTagRequest = buildBodyParams();
            return updateSpecificOrderTagAsync(id, ordersTagUpdateSpecificOrderTagRequest, _callback);
        }
    }
     ...
     * Update an order tag
     * @param id  (required)
     * @param ordersTagUpdateSpecificOrderTagRequest Information about updated fields in Tag (required)
     * @return UpdateSpecificOrderTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSpecificOrderTagRequestBuilder updateSpecificOrderTag(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSpecificOrderTagRequestBuilder(id);
    }
}
