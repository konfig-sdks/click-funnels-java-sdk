...
import com.konfigthis.client.model.ContactsAppliedTagAttributes;
import com.konfigthis.client.model.ContactsAppliedTagCreateAppliedTagRequest;
...
public class ContactsAppliedTagApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ContactsAppliedTagApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ContactsAppliedTagApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createAppliedTagCall(Integer contactId, ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = contactsAppliedTagCreateAppliedTagRequest;

        // create path and map variables
        String localVarPath = "/contacts/{contact_id}/applied_tags"
    ...
    private okhttp3.Call createAppliedTagValidateBeforeCall(Integer contactId, ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'contactId' is set
        if (contactId == null) {
            throw new ApiException("Missing the required parameter 'contactId' when calling createAppliedTag(Async)");
        }

        // verify the required parameter 'contactsAppliedTagCreateAppliedTagRequest' is set
        if (contactsAppliedTagCreateAppliedTagRequest == null) {
            throw new ApiException("Missing the required parameter 'contactsAppliedTagCreateAppliedTagRequest' when calling createAppliedTag(Async)");
        }

        return createAppliedTagCall(contactId, contactsAppliedTagCreateAppliedTagRequest, _callback);

    }


    private ApiResponse<ContactsAppliedTagAttributes> createAppliedTagWithHttpInfo(Integer contactId, ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createAppliedTagValidateBeforeCall(contactId, contactsAppliedTagCreateAppliedTagRequest, null);
        Type localVarReturnType = new TypeToken<ContactsAppliedTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createAppliedTagAsync(Integer contactId, ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest, final ApiCallback<ContactsAppliedTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAppliedTagValidateBeforeCall(contactId, contactsAppliedTagCreateAppliedTagRequest, _callback);
        Type localVarReturnType = new TypeToken<ContactsAppliedTagAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateAppliedTagRequestBuilder {
        private final Integer contactId;
        private ContactsAppliedTagParameters contactsAppliedTag;

        private CreateAppliedTagRequestBuilder(Integer contactId) {
            this.contactId = contactId;
        }

        /**
         * Set contactsAppliedTag
         * @param contactsAppliedTag  (optional)
         * @return CreateAppliedTagRequestBuilder
         */
        public CreateAppliedTagRequestBuilder contactsAppliedTag(ContactsAppliedTagParameters contactsAppliedTag) {
            this.contactsAppliedTag = contactsAppliedTag;
            return this;
        }
        
        /**
         * Build call for createAppliedTag
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest = buildBodyParams();
            return createAppliedTagCall(contactId, contactsAppliedTagCreateAppliedTagRequest, _callback);
        }

        private ContactsAppliedTagCreateAppliedTagRequest buildBodyParams() {
            ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest = new ContactsAppliedTagCreateAppliedTagRequest();
            contactsAppliedTagCreateAppliedTagRequest.contactsAppliedTag(this.contactsAppliedTag);
            return contactsAppliedTagCreateAppliedTagRequest;
        }

        /**
         * Execute createAppliedTag request
         * @return ContactsAppliedTagAttributes
         ...
         */
        public ContactsAppliedTagAttributes execute() throws ApiException {
            ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest = buildBodyParams();
            ApiResponse<ContactsAppliedTagAttributes> localVarResp = createAppliedTagWithHttpInfo(contactId, contactsAppliedTagCreateAppliedTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createAppliedTag request with HTTP info returned
         * @return ApiResponse&lt;ContactsAppliedTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ContactsAppliedTagAttributes> executeWithHttpInfo() throws ApiException {
            ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest = buildBodyParams();
            return createAppliedTagWithHttpInfo(contactId, contactsAppliedTagCreateAppliedTagRequest);
        }

        /**
         * Execute createAppliedTag request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ContactsAppliedTagAttributes> _callback) throws ApiException {
            ContactsAppliedTagCreateAppliedTagRequest contactsAppliedTagCreateAppliedTagRequest = buildBodyParams();
            return createAppliedTagAsync(contactId, contactsAppliedTagCreateAppliedTagRequest, _callback);
        }
    }
     ...
     * @param contactsAppliedTagCreateAppliedTagRequest Information about a new Applied Tag (required)
     * @return CreateAppliedTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateAppliedTagRequestBuilder createAppliedTag(Integer contactId) throws IllegalArgumentException {
        if (contactId == null) throw new IllegalArgumentException("\"contactId\" is required but got null");
        return new CreateAppliedTagRequestBuilder(contactId);
    }
    private okhttp3.Call getForContactCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/contacts/applied_tags/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getForContactValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getForContact(Async)");
        }

        return getForContactCall(id, _callback);

    }


    private ApiResponse<ContactsAppliedTagAttributes> getForContactWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getForContactValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ContactsAppliedTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getForContactAsync(String id, final ApiCallback<ContactsAppliedTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getForContactValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ContactsAppliedTagAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetForContactRequestBuilder {
        private final String id;

        private GetForContactRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getForContact
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public ContactsAppliedTagAttributes execute() throws ApiException {
            ApiResponse<ContactsAppliedTagAttributes> localVarResp = getForContactWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getForContact request with HTTP info returned
         * @return ApiResponse&lt;ContactsAppliedTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ContactsAppliedTagAttributes> executeWithHttpInfo() throws ApiException {
            return getForContactWithHttpInfo(id);
        }

        /**
         * Execute getForContact request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ContactsAppliedTagAttributes> _callback) throws ApiException {
            return getForContactAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetForContactRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetForContactRequestBuilder getForContact(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetForContactRequestBuilder(id);
    }
    private okhttp3.Call listCall(Integer contactId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer contactId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'contactId' is set
        if (contactId == null) {
            throw new ApiException("Missing the required parameter 'contactId' when calling list(Async)");
        }

        return listCall(contactId, after, sortOrder, _callback);

    }


    private ApiResponse<List<ContactsAppliedTagAttributes>> listWithHttpInfo(Integer contactId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(contactId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ContactsAppliedTagAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer contactId, String after, String sortOrder, final ApiCallback<List<ContactsAppliedTagAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(contactId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<ContactsAppliedTagAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(Integer contactId) {
            this.contactId = contactId;
        }
         ...
         * @return List&lt;ContactsAppliedTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ContactsAppliedTagAttributes> execute() throws ApiException {
            ApiResponse<List<ContactsAppliedTagAttributes>> localVarResp = listWithHttpInfo(contactId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ContactsAppliedTagAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ContactsAppliedTagAttributes>> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(contactId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ContactsAppliedTagAttributes>> _callback) throws ApiException {
            return listAsync(contactId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(Integer contactId) throws IllegalArgumentException {
        if (contactId == null) throw new IllegalArgumentException("\"contactId\" is required but got null");
