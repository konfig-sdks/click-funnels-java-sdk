...
import com.konfigthis.client.model.OrdersInvoiceAttributes;
...
public class OrdersInvoiceApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OrdersInvoiceApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OrdersInvoiceApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getForOrderCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/orders/invoices/{id}"
    ...
    private okhttp3.Call getForOrderValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getForOrder(Async)");
        }

        return getForOrderCall(id, _callback);

    }


    private ApiResponse<OrdersInvoiceAttributes> getForOrderWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getForOrderValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OrdersInvoiceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getForOrderAsync(String id, final ApiCallback<OrdersInvoiceAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getForOrderValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<OrdersInvoiceAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetForOrderRequestBuilder {
        private final String id;

        private GetForOrderRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getForOrder
        ...
        /**
         * Execute getForOrder request
         * @return OrdersInvoiceAttributes
         ...
         */
        public OrdersInvoiceAttributes execute() throws ApiException {
            ApiResponse<OrdersInvoiceAttributes> localVarResp = getForOrderWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getForOrder request with HTTP info returned
         * @return ApiResponse&lt;OrdersInvoiceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrdersInvoiceAttributes> executeWithHttpInfo() throws ApiException {
            return getForOrderWithHttpInfo(id);
        }

        /**
         * Execute getForOrder request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrdersInvoiceAttributes> _callback) throws ApiException {
            return getForOrderAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetForOrderRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetForOrderRequestBuilder getForOrder(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetForOrderRequestBuilder(id);
    }
    private okhttp3.Call listForOrderCall(Integer orderId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/orders/{order_id}/invoices"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listForOrderValidateBeforeCall(Integer orderId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException("Missing the required parameter 'orderId' when calling listForOrder(Async)");
        }

        return listForOrderCall(orderId, after, sortOrder, _callback);

    }


    private ApiResponse<List<OrdersInvoiceAttributes>> listForOrderWithHttpInfo(Integer orderId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listForOrderValidateBeforeCall(orderId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<OrdersInvoiceAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listForOrderAsync(Integer orderId, String after, String sortOrder, final ApiCallback<List<OrdersInvoiceAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listForOrderValidateBeforeCall(orderId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<OrdersInvoiceAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListForOrderRequestBuilder {
        private final Integer orderId;
        private String after;
        private String sortOrder;

        private ListForOrderRequestBuilder(Integer orderId) {
         ...
         * @return ListForOrderRequestBuilder
         */
        public ListForOrderRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListForOrderRequestBuilder
         */
        public ListForOrderRequestBuilder sortOrder(String sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }
        
        /**
         * Build call for listForOrder
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listForOrder request
         * @return List&lt;OrdersInvoiceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<OrdersInvoiceAttributes> execute() throws ApiException {
            ApiResponse<List<OrdersInvoiceAttributes>> localVarResp = listForOrderWithHttpInfo(orderId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listForOrder request with HTTP info returned
         * @return ApiResponse&lt;List&lt;OrdersInvoiceAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<OrdersInvoiceAttributes>> executeWithHttpInfo() throws ApiException {
            return listForOrderWithHttpInfo(orderId, after, sortOrder);
        }

        /**
         * Execute listForOrder request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<OrdersInvoiceAttributes>> _callback) throws ApiException {
            return listForOrderAsync(orderId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListForOrderRequestBuilder listForOrder(Integer orderId) throws IllegalArgumentException {
        if (orderId == null) throw new IllegalArgumentException("\"orderId\" is required but got null");
        return new ListForOrderRequestBuilder(orderId);
    }
}
