...
import com.konfigthis.client.model.OrdersInvoicesRestockGetRestockResponse;
import com.konfigthis.client.model.Restocks;
...
public class OrdersInvoicesRestockApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OrdersInvoicesRestockApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OrdersInvoicesRestockApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getRestockCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/orders/invoices/restocks/{id}"
    ...
    private okhttp3.Call getRestockValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getRestock(Async)");
        }

        return getRestockCall(id, _callback);

    }


    private ApiResponse<OrdersInvoicesRestockGetRestockResponse> getRestockWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getRestockValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OrdersInvoicesRestockGetRestockResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getRestockAsync(String id, final ApiCallback<OrdersInvoicesRestockGetRestockResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRestockValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<OrdersInvoicesRestockGetRestockResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetRestockRequestBuilder {
        private final String id;

        private GetRestockRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getRestock
        ...
        /**
         * Execute getRestock request
         * @return OrdersInvoicesRestockGetRestockResponse
         ...
         */
        public OrdersInvoicesRestockGetRestockResponse execute() throws ApiException {
            ApiResponse<OrdersInvoicesRestockGetRestockResponse> localVarResp = getRestockWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getRestock request with HTTP info returned
         * @return ApiResponse&lt;OrdersInvoicesRestockGetRestockResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrdersInvoicesRestockGetRestockResponse> executeWithHttpInfo() throws ApiException {
            return getRestockWithHttpInfo(id);
        }

        /**
         * Execute getRestock request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrdersInvoicesRestockGetRestockResponse> _callback) throws ApiException {
            return getRestockAsync(id, _callback);
        }
    }
     ...
     * Fetch Restock
     * @param id  (required)
     * @return GetRestockRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetRestockRequestBuilder getRestock(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetRestockRequestBuilder(id);
    }
    private okhttp3.Call listRestocksCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/orders/invoices/restocks"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listRestocksValidateBeforeCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling listRestocks(Async)");
        }

        return listRestocksCall(workspaceId, after, sortOrder, _callback);

    }


    private ApiResponse<List<Restocks>> listRestocksWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listRestocksValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<Restocks>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listRestocksAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<Restocks>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listRestocksValidateBeforeCall(workspaceId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<Restocks>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListRestocksRequestBuilder {
        private final Integer workspaceId;
        private String after;
        private String sortOrder;

        private ListRestocksRequestBuilder(Integer workspaceId) {
         ...
         * @return ListRestocksRequestBuilder
         */
        public ListRestocksRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListRestocksRequestBuilder
         */
        public ListRestocksRequestBuilder sortOrder(String sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }
        
        /**
         * Build call for listRestocks
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public List<Restocks> execute() throws ApiException {
            ApiResponse<List<Restocks>> localVarResp = listRestocksWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listRestocks request with HTTP info returned
         * @return ApiResponse&lt;List&lt;Restocks&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<Restocks>> executeWithHttpInfo() throws ApiException {
            return listRestocksWithHttpInfo(workspaceId, after, sortOrder);
        }

        /**
         * Execute listRestocks request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<Restocks>> _callback) throws ApiException {
            return listRestocksAsync(workspaceId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRestocksRequestBuilder listRestocks(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new ListRestocksRequestBuilder(workspaceId);
    }
}
