...
import com.konfigthis.client.model.FulfillmentsLocationAttributes;
import com.konfigthis.client.model.FulfillmentsLocationCreateNewLocationRequest;
import com.konfigthis.client.model.FulfillmentsLocationUpdateByIdRequest;
...
public class FulfillmentsLocationApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public FulfillmentsLocationApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public FulfillmentsLocationApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewLocationCall(Integer workspaceId, FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = fulfillmentsLocationCreateNewLocationRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/fulfillments/locations"
    ...
    private okhttp3.Call createNewLocationValidateBeforeCall(Integer workspaceId, FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewLocation(Async)");
        }

        // verify the required parameter 'fulfillmentsLocationCreateNewLocationRequest' is set
        if (fulfillmentsLocationCreateNewLocationRequest == null) {
            throw new ApiException("Missing the required parameter 'fulfillmentsLocationCreateNewLocationRequest' when calling createNewLocation(Async)");
        }

        return createNewLocationCall(workspaceId, fulfillmentsLocationCreateNewLocationRequest, _callback);

    }


    private ApiResponse<FulfillmentsLocationAttributes> createNewLocationWithHttpInfo(Integer workspaceId, FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewLocationValidateBeforeCall(workspaceId, fulfillmentsLocationCreateNewLocationRequest, null);
        Type localVarReturnType = new TypeToken<FulfillmentsLocationAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewLocationAsync(Integer workspaceId, FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest, final ApiCallback<FulfillmentsLocationAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewLocationValidateBeforeCall(workspaceId, fulfillmentsLocationCreateNewLocationRequest, _callback);
        Type localVarReturnType = new TypeToken<FulfillmentsLocationAttributes>(){}.getType();
    ...
    public class CreateNewLocationRequestBuilder {
        ...
        private FulfillmentsLocationParameters fulfillmentsLocation;

        private CreateNewLocationRequestBuilder(Integer workspaceId) {
            this.workspaceId = workspaceId;
        }

        /**
         * Set fulfillmentsLocation
         * @param fulfillmentsLocation  (optional)
         * @return CreateNewLocationRequestBuilder
         */
        public CreateNewLocationRequestBuilder fulfillmentsLocation(FulfillmentsLocationParameters fulfillmentsLocation) {
            this.fulfillmentsLocation = fulfillmentsLocation;
            return this;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest = buildBodyParams();
            return createNewLocationCall(workspaceId, fulfillmentsLocationCreateNewLocationRequest, _callback);
        }

        private FulfillmentsLocationCreateNewLocationRequest buildBodyParams() {
            FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest = new FulfillmentsLocationCreateNewLocationRequest();
            fulfillmentsLocationCreateNewLocationRequest.fulfillmentsLocation(this.fulfillmentsLocation);
            return fulfillmentsLocationCreateNewLocationRequest;
        }

        /**
         * Execute createNewLocation request
         * @return FulfillmentsLocationAttributes
         ...
         */
        public FulfillmentsLocationAttributes execute() throws ApiException {
            FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest = buildBodyParams();
            ApiResponse<FulfillmentsLocationAttributes> localVarResp = createNewLocationWithHttpInfo(workspaceId, fulfillmentsLocationCreateNewLocationRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewLocation request with HTTP info returned
         * @return ApiResponse&lt;FulfillmentsLocationAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<FulfillmentsLocationAttributes> executeWithHttpInfo() throws ApiException {
            FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest = buildBodyParams();
            return createNewLocationWithHttpInfo(workspaceId, fulfillmentsLocationCreateNewLocationRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FulfillmentsLocationAttributes> _callback) throws ApiException {
            FulfillmentsLocationCreateNewLocationRequest fulfillmentsLocationCreateNewLocationRequest = buildBodyParams();
            return createNewLocationAsync(workspaceId, fulfillmentsLocationCreateNewLocationRequest, _callback);
        }
    }
     ...
     * @param fulfillmentsLocationCreateNewLocationRequest Information about a new Location (required)
     * @return CreateNewLocationRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewLocationRequestBuilder createNewLocation(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new CreateNewLocationRequestBuilder(workspaceId);
    }
    private okhttp3.Call getByIdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fulfillments/locations/{id}"
    ...
    private ApiResponse<FulfillmentsLocationAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<FulfillmentsLocationAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<FulfillmentsLocationAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public FulfillmentsLocationAttributes execute() throws ApiException {
            ApiResponse<FulfillmentsLocationAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<List<FulfillmentsLocationAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<FulfillmentsLocationAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<FulfillmentsLocationAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @return List&lt;FulfillmentsLocationAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<FulfillmentsLocationAttributes> execute() throws ApiException {
            ApiResponse<List<FulfillmentsLocationAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;FulfillmentsLocationAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<FulfillmentsLocationAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<FulfillmentsLocationAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateByIdCall(String id, FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = fulfillmentsLocationUpdateByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateByIdValidateBeforeCall(String id, FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateById(Async)");
        }

        // verify the required parameter 'fulfillmentsLocationUpdateByIdRequest' is set
        if (fulfillmentsLocationUpdateByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'fulfillmentsLocationUpdateByIdRequest' when calling updateById(Async)");
        }

        return updateByIdCall(id, fulfillmentsLocationUpdateByIdRequest, _callback);

    }


    private ApiResponse<FulfillmentsLocationAttributes> updateByIdWithHttpInfo(String id, FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, fulfillmentsLocationUpdateByIdRequest, null);
        Type localVarReturnType = new TypeToken<FulfillmentsLocationAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateByIdAsync(String id, FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest, final ApiCallback<FulfillmentsLocationAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, fulfillmentsLocationUpdateByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<FulfillmentsLocationAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateByIdRequestBuilder {
         ...
         */
        public UpdateByIdRequestBuilder fulfillmentsLocation(FulfillmentsLocationParameters fulfillmentsLocation) {
            this.fulfillmentsLocation = fulfillmentsLocation;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest = buildBodyParams();
            return updateByIdCall(id, fulfillmentsLocationUpdateByIdRequest, _callback);
        }

        private FulfillmentsLocationUpdateByIdRequest buildBodyParams() {
            FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest = new FulfillmentsLocationUpdateByIdRequest();
            fulfillmentsLocationUpdateByIdRequest.fulfillmentsLocation(this.fulfillmentsLocation);
            return fulfillmentsLocationUpdateByIdRequest;
        }
        ...
        public FulfillmentsLocationAttributes execute() throws ApiException {
            FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest = buildBodyParams();
            ApiResponse<FulfillmentsLocationAttributes> localVarResp = updateByIdWithHttpInfo(id, fulfillmentsLocationUpdateByIdRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<FulfillmentsLocationAttributes> executeWithHttpInfo() throws ApiException {
            FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest = buildBodyParams();
            return updateByIdWithHttpInfo(id, fulfillmentsLocationUpdateByIdRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<FulfillmentsLocationAttributes> _callback) throws ApiException {
            FulfillmentsLocationUpdateByIdRequest fulfillmentsLocationUpdateByIdRequest = buildBodyParams();
            return updateByIdAsync(id, fulfillmentsLocationUpdateByIdRequest, _callback);
        }
    }
     ...
     * Update Location
     * @param id  (required)
     * @param fulfillmentsLocationUpdateByIdRequest Information about updated fields in Location (required)
     * @return UpdateByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
