...
import com.konfigthis.client.model.ShippingZoneAddNewZoneRequest;
import com.konfigthis.client.model.ShippingZoneAttributes;
import com.konfigthis.client.model.ShippingZoneUpdateZoneByIdRequest;
...
public class ShippingZoneApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ShippingZoneApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ShippingZoneApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call addNewZoneCall(Integer locationGroupId, ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = shippingZoneAddNewZoneRequest;

        // create path and map variables
        String localVarPath = "/shipping/location_groups/{location_group_id}/zones"
            .replace("{" + "location_group_id" + "}", localVarApiClient.escapeString(locationGroupId.toString()));
    ...
    private okhttp3.Call addNewZoneValidateBeforeCall(Integer locationGroupId, ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'locationGroupId' is set
        if (locationGroupId == null) {
            throw new ApiException("Missing the required parameter 'locationGroupId' when calling addNewZone(Async)");
        }

        // verify the required parameter 'shippingZoneAddNewZoneRequest' is set
        if (shippingZoneAddNewZoneRequest == null) {
            throw new ApiException("Missing the required parameter 'shippingZoneAddNewZoneRequest' when calling addNewZone(Async)");
        }

        return addNewZoneCall(locationGroupId, shippingZoneAddNewZoneRequest, _callback);

    }


    private ApiResponse<ShippingZoneAttributes> addNewZoneWithHttpInfo(Integer locationGroupId, ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest) throws ApiException {
        okhttp3.Call localVarCall = addNewZoneValidateBeforeCall(locationGroupId, shippingZoneAddNewZoneRequest, null);
        Type localVarReturnType = new TypeToken<ShippingZoneAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call addNewZoneAsync(Integer locationGroupId, ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest, final ApiCallback<ShippingZoneAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = addNewZoneValidateBeforeCall(locationGroupId, shippingZoneAddNewZoneRequest, _callback);
        Type localVarReturnType = new TypeToken<ShippingZoneAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class AddNewZoneRequestBuilder {
        private final Integer locationGroupId;
        private ShippingZoneParameters shippingZone;

        private AddNewZoneRequestBuilder(Integer locationGroupId) {
            this.locationGroupId = locationGroupId;
        }

        /**
         * Set shippingZone
         * @param shippingZone  (optional)
         * @return AddNewZoneRequestBuilder
         */
        public AddNewZoneRequestBuilder shippingZone(ShippingZoneParameters shippingZone) {
            this.shippingZone = shippingZone;
            return this;
        }
        
        /**
         * Build call for addNewZone
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest = buildBodyParams();
            return addNewZoneCall(locationGroupId, shippingZoneAddNewZoneRequest, _callback);
        }

        private ShippingZoneAddNewZoneRequest buildBodyParams() {
            ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest = new ShippingZoneAddNewZoneRequest();
            shippingZoneAddNewZoneRequest.shippingZone(this.shippingZone);
            return shippingZoneAddNewZoneRequest;
        }

        /**
         * Execute addNewZone request
         * @return ShippingZoneAttributes
         ...
         */
        public ShippingZoneAttributes execute() throws ApiException {
            ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest = buildBodyParams();
            ApiResponse<ShippingZoneAttributes> localVarResp = addNewZoneWithHttpInfo(locationGroupId, shippingZoneAddNewZoneRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute addNewZone request with HTTP info returned
         * @return ApiResponse&lt;ShippingZoneAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ShippingZoneAttributes> executeWithHttpInfo() throws ApiException {
            ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest = buildBodyParams();
            return addNewZoneWithHttpInfo(locationGroupId, shippingZoneAddNewZoneRequest);
        }

        /**
         * Execute addNewZone request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ShippingZoneAttributes> _callback) throws ApiException {
            ShippingZoneAddNewZoneRequest shippingZoneAddNewZoneRequest = buildBodyParams();
            return addNewZoneAsync(locationGroupId, shippingZoneAddNewZoneRequest, _callback);
        }
    }
     ...
     * @param locationGroupId  (required)
     * @param shippingZoneAddNewZoneRequest Information about a new Zone (required)
     * @return AddNewZoneRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AddNewZoneRequestBuilder addNewZone(Integer locationGroupId) throws IllegalArgumentException {
        if (locationGroupId == null) throw new IllegalArgumentException("\"locationGroupId\" is required but got null");
        return new AddNewZoneRequestBuilder(locationGroupId);
    }
    private okhttp3.Call getZoneByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getZoneByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getZoneById(Async)");
        }

        return getZoneByIdCall(id, _callback);

    }


    private ApiResponse<ShippingZoneAttributes> getZoneByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getZoneByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ShippingZoneAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getZoneByIdAsync(String id, final ApiCallback<ShippingZoneAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getZoneByIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ShippingZoneAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetZoneByIdRequestBuilder {
        private final String id;

        private GetZoneByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public ShippingZoneAttributes execute() throws ApiException {
            ApiResponse<ShippingZoneAttributes> localVarResp = getZoneByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getZoneById request with HTTP info returned
         * @return ApiResponse&lt;ShippingZoneAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ShippingZoneAttributes> executeWithHttpInfo() throws ApiException {
            return getZoneByIdWithHttpInfo(id);
        }

        /**
         * Execute getZoneById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ShippingZoneAttributes> _callback) throws ApiException {
            return getZoneByIdAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetZoneByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetZoneByIdRequestBuilder getZoneById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetZoneByIdRequestBuilder(id);
    }
    private okhttp3.Call listZonesCall(Integer locationGroupId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listZonesValidateBeforeCall(Integer locationGroupId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'locationGroupId' is set
        if (locationGroupId == null) {
            throw new ApiException("Missing the required parameter 'locationGroupId' when calling listZones(Async)");
        }

        return listZonesCall(locationGroupId, after, sortOrder, _callback);

    }


    private ApiResponse<List<ShippingZoneAttributes>> listZonesWithHttpInfo(Integer locationGroupId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listZonesValidateBeforeCall(locationGroupId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ShippingZoneAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listZonesAsync(Integer locationGroupId, String after, String sortOrder, final ApiCallback<List<ShippingZoneAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listZonesValidateBeforeCall(locationGroupId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<ShippingZoneAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListZonesRequestBuilder {
        ...
        private ListZonesRequestBuilder(Integer locationGroupId) {
            this.locationGroupId = locationGroupId;
        }
         ...
         * @return ListZonesRequestBuilder
         */
        public ListZonesRequestBuilder sortOrder(String sortOrder) {
         ...
         * @return List&lt;ShippingZoneAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ShippingZoneAttributes> execute() throws ApiException {
            ApiResponse<List<ShippingZoneAttributes>> localVarResp = listZonesWithHttpInfo(locationGroupId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listZones request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ShippingZoneAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ShippingZoneAttributes>> executeWithHttpInfo() throws ApiException {
            return listZonesWithHttpInfo(locationGroupId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ShippingZoneAttributes>> _callback) throws ApiException {
            return listZonesAsync(locationGroupId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListZonesRequestBuilder listZones(Integer locationGroupId) throws IllegalArgumentException {
        if (locationGroupId == null) throw new IllegalArgumentException("\"locationGroupId\" is required but got null");
        return new ListZonesRequestBuilder(locationGroupId);
    }
    ...
    private okhttp3.Call updateZoneByIdCall(String id, ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = shippingZoneUpdateZoneByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateZoneByIdValidateBeforeCall(String id, ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateZoneById(Async)");
        }

        // verify the required parameter 'shippingZoneUpdateZoneByIdRequest' is set
        if (shippingZoneUpdateZoneByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'shippingZoneUpdateZoneByIdRequest' when calling updateZoneById(Async)");
        }

        return updateZoneByIdCall(id, shippingZoneUpdateZoneByIdRequest, _callback);

    }


    private ApiResponse<ShippingZoneAttributes> updateZoneByIdWithHttpInfo(String id, ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateZoneByIdValidateBeforeCall(id, shippingZoneUpdateZoneByIdRequest, null);
        Type localVarReturnType = new TypeToken<ShippingZoneAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateZoneByIdAsync(String id, ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest, final ApiCallback<ShippingZoneAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateZoneByIdValidateBeforeCall(id, shippingZoneUpdateZoneByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<ShippingZoneAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateZoneByIdRequestBuilder {
        private final String id;
        private ShippingZoneParameters shippingZone;

        private UpdateZoneByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set shippingZone
         * @param shippingZone  (optional)
         * @return UpdateZoneByIdRequestBuilder
         */
        public UpdateZoneByIdRequestBuilder shippingZone(ShippingZoneParameters shippingZone) {
            this.shippingZone = shippingZone;
            return this;
        }
        
        /**
         * Build call for updateZoneById
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest = buildBodyParams();
            return updateZoneByIdCall(id, shippingZoneUpdateZoneByIdRequest, _callback);
        }

        private ShippingZoneUpdateZoneByIdRequest buildBodyParams() {
            ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest = new ShippingZoneUpdateZoneByIdRequest();
            shippingZoneUpdateZoneByIdRequest.shippingZone(this.shippingZone);
            return shippingZoneUpdateZoneByIdRequest;
        }

        /**
         * Execute updateZoneById request
         * @return ShippingZoneAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ShippingZoneAttributes execute() throws ApiException {
            ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest = buildBodyParams();
            ApiResponse<ShippingZoneAttributes> localVarResp = updateZoneByIdWithHttpInfo(id, shippingZoneUpdateZoneByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateZoneById request with HTTP info returned
         * @return ApiResponse&lt;ShippingZoneAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ShippingZoneAttributes> executeWithHttpInfo() throws ApiException {
            ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest = buildBodyParams();
            return updateZoneByIdWithHttpInfo(id, shippingZoneUpdateZoneByIdRequest);
        }

        /**
         * Execute updateZoneById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ShippingZoneAttributes> _callback) throws ApiException {
            ShippingZoneUpdateZoneByIdRequest shippingZoneUpdateZoneByIdRequest = buildBodyParams();
            return updateZoneByIdAsync(id, shippingZoneUpdateZoneByIdRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param shippingZoneUpdateZoneByIdRequest Information about updated fields in Zone (required)
     * @return UpdateZoneByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateZoneByIdRequestBuilder updateZoneById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateZoneByIdRequestBuilder(id);
    }
}
