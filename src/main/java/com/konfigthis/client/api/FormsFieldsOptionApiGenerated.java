...
import com.konfigthis.client.model.FormsFieldsOptionAttributes;
import com.konfigthis.client.model.FormsFieldsOptionCreateNewFieldOptionRequest;
import com.konfigthis.client.model.FormsFieldsOptionUpdateFieldOptionRequest;
...
public class FormsFieldsOptionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public FormsFieldsOptionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public FormsFieldsOptionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewFieldOptionCall(Integer fieldId, FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = formsFieldsOptionCreateNewFieldOptionRequest;

        // create path and map variables
        String localVarPath = "/forms/fields/{field_id}/options"
    ...
    private okhttp3.Call createNewFieldOptionValidateBeforeCall(Integer fieldId, FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new ApiException("Missing the required parameter 'fieldId' when calling createNewFieldOption(Async)");
        }

        // verify the required parameter 'formsFieldsOptionCreateNewFieldOptionRequest' is set
        if (formsFieldsOptionCreateNewFieldOptionRequest == null) {
            throw new ApiException("Missing the required parameter 'formsFieldsOptionCreateNewFieldOptionRequest' when calling createNewFieldOption(Async)");
        }

        return createNewFieldOptionCall(fieldId, formsFieldsOptionCreateNewFieldOptionRequest, _callback);

    }


    private ApiResponse<FormsFieldsOptionAttributes> createNewFieldOptionWithHttpInfo(Integer fieldId, FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewFieldOptionValidateBeforeCall(fieldId, formsFieldsOptionCreateNewFieldOptionRequest, null);
        Type localVarReturnType = new TypeToken<FormsFieldsOptionAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewFieldOptionAsync(Integer fieldId, FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest, final ApiCallback<FormsFieldsOptionAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewFieldOptionValidateBeforeCall(fieldId, formsFieldsOptionCreateNewFieldOptionRequest, _callback);
        Type localVarReturnType = new TypeToken<FormsFieldsOptionAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewFieldOptionRequestBuilder {
        private final Integer fieldId;
        private FormsFieldsOptionParameters formsFieldsOption;

        private CreateNewFieldOptionRequestBuilder(Integer fieldId) {
            this.fieldId = fieldId;
        }

        /**
         * Set formsFieldsOption
         * @param formsFieldsOption  (optional)
         * @return CreateNewFieldOptionRequestBuilder
         */
        public CreateNewFieldOptionRequestBuilder formsFieldsOption(FormsFieldsOptionParameters formsFieldsOption) {
            this.formsFieldsOption = formsFieldsOption;
            return this;
        }
        
        /**
         * Build call for createNewFieldOption
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest = buildBodyParams();
            return createNewFieldOptionCall(fieldId, formsFieldsOptionCreateNewFieldOptionRequest, _callback);
        }

        private FormsFieldsOptionCreateNewFieldOptionRequest buildBodyParams() {
            FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest = new FormsFieldsOptionCreateNewFieldOptionRequest();
            formsFieldsOptionCreateNewFieldOptionRequest.formsFieldsOption(this.formsFieldsOption);
            return formsFieldsOptionCreateNewFieldOptionRequest;
        }

        /**
         * Execute createNewFieldOption request
         * @return FormsFieldsOptionAttributes
         ...
         */
        public FormsFieldsOptionAttributes execute() throws ApiException {
            FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest = buildBodyParams();
            ApiResponse<FormsFieldsOptionAttributes> localVarResp = createNewFieldOptionWithHttpInfo(fieldId, formsFieldsOptionCreateNewFieldOptionRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewFieldOption request with HTTP info returned
         * @return ApiResponse&lt;FormsFieldsOptionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<FormsFieldsOptionAttributes> executeWithHttpInfo() throws ApiException {
            FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest = buildBodyParams();
            return createNewFieldOptionWithHttpInfo(fieldId, formsFieldsOptionCreateNewFieldOptionRequest);
        }

        /**
         * Execute createNewFieldOption request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FormsFieldsOptionAttributes> _callback) throws ApiException {
            FormsFieldsOptionCreateNewFieldOptionRequest formsFieldsOptionCreateNewFieldOptionRequest = buildBodyParams();
            return createNewFieldOptionAsync(fieldId, formsFieldsOptionCreateNewFieldOptionRequest, _callback);
        }
    }
     ...
     * @param formsFieldsOptionCreateNewFieldOptionRequest Information about a new Option (required)
     * @return CreateNewFieldOptionRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewFieldOptionRequestBuilder createNewFieldOption(Integer fieldId) throws IllegalArgumentException {
        if (fieldId == null) throw new IllegalArgumentException("\"fieldId\" is required but got null");
        return new CreateNewFieldOptionRequestBuilder(fieldId);
    }
    private okhttp3.Call deleteOptionForFieldCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/forms/fields/options/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteOptionForFieldValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteOptionForField(Async)");
        }

        return deleteOptionForFieldCall(id, _callback);

    }


    private ApiResponse<Void> deleteOptionForFieldWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = deleteOptionForFieldValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteOptionForFieldAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteOptionForFieldValidateBeforeCall(id, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class DeleteOptionForFieldRequestBuilder {
        private final String id;

        private DeleteOptionForFieldRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for deleteOptionForField
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute deleteOptionForField request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public void execute() throws ApiException {
            deleteOptionForFieldWithHttpInfo(id);
        }

        /**
         * Execute deleteOptionForField request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteOptionForFieldWithHttpInfo(id);
        }

        /**
         * Execute deleteOptionForField request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteOptionForFieldAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return DeleteOptionForFieldRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> No Content </td><td>  -  </td></tr>
     ...
     */
    public DeleteOptionForFieldRequestBuilder deleteOptionForField(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new DeleteOptionForFieldRequestBuilder(id);
    }
    private okhttp3.Call getFieldOptionCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getFieldOptionValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getFieldOption(Async)");
        }

        return getFieldOptionCall(id, _callback);

    }


    private ApiResponse<FormsFieldsOptionAttributes> getFieldOptionWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getFieldOptionValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<FormsFieldsOptionAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getFieldOptionAsync(String id, final ApiCallback<FormsFieldsOptionAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getFieldOptionValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<FormsFieldsOptionAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetFieldOptionRequestBuilder {
        private final String id;

        private GetFieldOptionRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getFieldOption
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getFieldOption request
         * @return FormsFieldsOptionAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public FormsFieldsOptionAttributes execute() throws ApiException {
            ApiResponse<FormsFieldsOptionAttributes> localVarResp = getFieldOptionWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getFieldOption request with HTTP info returned
         * @return ApiResponse&lt;FormsFieldsOptionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<FormsFieldsOptionAttributes> executeWithHttpInfo() throws ApiException {
            return getFieldOptionWithHttpInfo(id);
        }

        /**
         * Execute getFieldOption request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FormsFieldsOptionAttributes> _callback) throws ApiException {
            return getFieldOptionAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetFieldOptionRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetFieldOptionRequestBuilder getFieldOption(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetFieldOptionRequestBuilder(id);
    }
    private okhttp3.Call listCall(Integer fieldId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer fieldId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new ApiException("Missing the required parameter 'fieldId' when calling list(Async)");
        }

        return listCall(fieldId, after, sortOrder, _callback);

    }


    private ApiResponse<List<FormsFieldsOptionAttributes>> listWithHttpInfo(Integer fieldId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(fieldId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<FormsFieldsOptionAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer fieldId, String after, String sortOrder, final ApiCallback<List<FormsFieldsOptionAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(fieldId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<FormsFieldsOptionAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(Integer fieldId) {
            this.fieldId = fieldId;
        }
         ...
         * @return List&lt;FormsFieldsOptionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<FormsFieldsOptionAttributes> execute() throws ApiException {
            ApiResponse<List<FormsFieldsOptionAttributes>> localVarResp = listWithHttpInfo(fieldId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;FormsFieldsOptionAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<FormsFieldsOptionAttributes>> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(fieldId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<FormsFieldsOptionAttributes>> _callback) throws ApiException {
            return listAsync(fieldId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(Integer fieldId) throws IllegalArgumentException {
        if (fieldId == null) throw new IllegalArgumentException("\"fieldId\" is required but got null");
        return new ListRequestBuilder(fieldId);
    }
    private okhttp3.Call updateFieldOptionCall(String id, FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = formsFieldsOptionUpdateFieldOptionRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateFieldOptionValidateBeforeCall(String id, FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateFieldOption(Async)");
        }

        // verify the required parameter 'formsFieldsOptionUpdateFieldOptionRequest' is set
        if (formsFieldsOptionUpdateFieldOptionRequest == null) {
            throw new ApiException("Missing the required parameter 'formsFieldsOptionUpdateFieldOptionRequest' when calling updateFieldOption(Async)");
        }

        return updateFieldOptionCall(id, formsFieldsOptionUpdateFieldOptionRequest, _callback);

    }


    private ApiResponse<FormsFieldsOptionAttributes> updateFieldOptionWithHttpInfo(String id, FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest) throws ApiException {
        okhttp3.Call localVarCall = updateFieldOptionValidateBeforeCall(id, formsFieldsOptionUpdateFieldOptionRequest, null);
        Type localVarReturnType = new TypeToken<FormsFieldsOptionAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateFieldOptionAsync(String id, FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest, final ApiCallback<FormsFieldsOptionAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateFieldOptionValidateBeforeCall(id, formsFieldsOptionUpdateFieldOptionRequest, _callback);
        Type localVarReturnType = new TypeToken<FormsFieldsOptionAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateFieldOptionRequestBuilder {
        private final String id;
        private FormsFieldsOptionParameters formsFieldsOption;

        private UpdateFieldOptionRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set formsFieldsOption
         * @param formsFieldsOption  (optional)
         * @return UpdateFieldOptionRequestBuilder
         */
        public UpdateFieldOptionRequestBuilder formsFieldsOption(FormsFieldsOptionParameters formsFieldsOption) {
            this.formsFieldsOption = formsFieldsOption;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest = buildBodyParams();
            return updateFieldOptionCall(id, formsFieldsOptionUpdateFieldOptionRequest, _callback);
        }

        private FormsFieldsOptionUpdateFieldOptionRequest buildBodyParams() {
            FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest = new FormsFieldsOptionUpdateFieldOptionRequest();
            formsFieldsOptionUpdateFieldOptionRequest.formsFieldsOption(this.formsFieldsOption);
            return formsFieldsOptionUpdateFieldOptionRequest;
        }

        /**
         * Execute updateFieldOption request
         * @return FormsFieldsOptionAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public FormsFieldsOptionAttributes execute() throws ApiException {
            FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest = buildBodyParams();
            ApiResponse<FormsFieldsOptionAttributes> localVarResp = updateFieldOptionWithHttpInfo(id, formsFieldsOptionUpdateFieldOptionRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateFieldOption request with HTTP info returned
         * @return ApiResponse&lt;FormsFieldsOptionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<FormsFieldsOptionAttributes> executeWithHttpInfo() throws ApiException {
            FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest = buildBodyParams();
            return updateFieldOptionWithHttpInfo(id, formsFieldsOptionUpdateFieldOptionRequest);
        }

        /**
         * Execute updateFieldOption request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<FormsFieldsOptionAttributes> _callback) throws ApiException {
            FormsFieldsOptionUpdateFieldOptionRequest formsFieldsOptionUpdateFieldOptionRequest = buildBodyParams();
            return updateFieldOptionAsync(id, formsFieldsOptionUpdateFieldOptionRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param formsFieldsOptionUpdateFieldOptionRequest Information about updated fields in Option (required)
     * @return UpdateFieldOptionRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateFieldOptionRequestBuilder updateFieldOption(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateFieldOptionRequestBuilder(id);
    }
}
