...
import com.konfigthis.client.model.ProductsVariantAttributes;
import com.konfigthis.client.model.ProductsVariantCreateNewVariantRequest;
import com.konfigthis.client.model.ProductsVariantUpdateSingleRequest;
...
public class ProductsVariantApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProductsVariantApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ProductsVariantApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewVariantCall(Integer productId, ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = productsVariantCreateNewVariantRequest;

        // create path and map variables
        String localVarPath = "/products/{product_id}/variants"
    ...
    private okhttp3.Call createNewVariantValidateBeforeCall(Integer productId, ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'productId' is set
        if (productId == null) {
            throw new ApiException("Missing the required parameter 'productId' when calling createNewVariant(Async)");
        }

        // verify the required parameter 'productsVariantCreateNewVariantRequest' is set
        if (productsVariantCreateNewVariantRequest == null) {
            throw new ApiException("Missing the required parameter 'productsVariantCreateNewVariantRequest' when calling createNewVariant(Async)");
        }

        return createNewVariantCall(productId, productsVariantCreateNewVariantRequest, _callback);

    }


    private ApiResponse<ProductsVariantAttributes> createNewVariantWithHttpInfo(Integer productId, ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewVariantValidateBeforeCall(productId, productsVariantCreateNewVariantRequest, null);
        Type localVarReturnType = new TypeToken<ProductsVariantAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewVariantAsync(Integer productId, ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest, final ApiCallback<ProductsVariantAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewVariantValidateBeforeCall(productId, productsVariantCreateNewVariantRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductsVariantAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewVariantRequestBuilder {
        private final Integer productId;
        private ProductsVariantParameters productsVariant;

        private CreateNewVariantRequestBuilder(Integer productId) {
            this.productId = productId;
        }

        /**
         * Set productsVariant
         * @param productsVariant  (optional)
         * @return CreateNewVariantRequestBuilder
         */
        public CreateNewVariantRequestBuilder productsVariant(ProductsVariantParameters productsVariant) {
            this.productsVariant = productsVariant;
            return this;
        }
        
        /**
         * Build call for createNewVariant
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest = buildBodyParams();
            return createNewVariantCall(productId, productsVariantCreateNewVariantRequest, _callback);
        }

        private ProductsVariantCreateNewVariantRequest buildBodyParams() {
            ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest = new ProductsVariantCreateNewVariantRequest();
            productsVariantCreateNewVariantRequest.productsVariant(this.productsVariant);
            return productsVariantCreateNewVariantRequest;
        }

        /**
         * Execute createNewVariant request
         * @return ProductsVariantAttributes
         ...
         */
        public ProductsVariantAttributes execute() throws ApiException {
            ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest = buildBodyParams();
            ApiResponse<ProductsVariantAttributes> localVarResp = createNewVariantWithHttpInfo(productId, productsVariantCreateNewVariantRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewVariant request with HTTP info returned
         * @return ApiResponse&lt;ProductsVariantAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ProductsVariantAttributes> executeWithHttpInfo() throws ApiException {
            ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest = buildBodyParams();
            return createNewVariantWithHttpInfo(productId, productsVariantCreateNewVariantRequest);
        }

        /**
         * Execute createNewVariant request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductsVariantAttributes> _callback) throws ApiException {
            ProductsVariantCreateNewVariantRequest productsVariantCreateNewVariantRequest = buildBodyParams();
            return createNewVariantAsync(productId, productsVariantCreateNewVariantRequest, _callback);
        }
    }
     ...
     * @param productsVariantCreateNewVariantRequest Information about a new Variant (required)
     * @return CreateNewVariantRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewVariantRequestBuilder createNewVariant(Integer productId) throws IllegalArgumentException {
        if (productId == null) throw new IllegalArgumentException("\"productId\" is required but got null");
        return new CreateNewVariantRequestBuilder(productId);
    }
    private okhttp3.Call getSingleCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/products/variants/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSingleValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getSingle(Async)");
        }

        return getSingleCall(id, _callback);

    }


    private ApiResponse<ProductsVariantAttributes> getSingleWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ProductsVariantAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(String id, final ApiCallback<ProductsVariantAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSingleValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ProductsVariantAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetSingleRequestBuilder {
        ...
        private GetSingleRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public ProductsVariantAttributes execute() throws ApiException {
            ApiResponse<ProductsVariantAttributes> localVarResp = getSingleWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<ProductsVariantAttributes> executeWithHttpInfo() throws ApiException {
            return getSingleWithHttpInfo(id);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductsVariantAttributes> _callback) throws ApiException {
            return getSingleAsync(id, _callback);
        }
    }
     ...
     */
    public GetSingleRequestBuilder getSingle(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetSingleRequestBuilder(id);
    }
    private okhttp3.Call listCall(Integer productId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer productId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'productId' is set
        if (productId == null) {
            throw new ApiException("Missing the required parameter 'productId' when calling list(Async)");
        }

        return listCall(productId, after, sortOrder, _callback);

    }


    private ApiResponse<List<ProductsVariantAttributes>> listWithHttpInfo(Integer productId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(productId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ProductsVariantAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer productId, String after, String sortOrder, final ApiCallback<List<ProductsVariantAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(productId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<ProductsVariantAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(Integer productId) {
            this.productId = productId;
        }
         ...
         * @return List&lt;ProductsVariantAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ProductsVariantAttributes> execute() throws ApiException {
            ApiResponse<List<ProductsVariantAttributes>> localVarResp = listWithHttpInfo(productId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ProductsVariantAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ProductsVariantAttributes>> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(productId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ProductsVariantAttributes>> _callback) throws ApiException {
            return listAsync(productId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(Integer productId) throws IllegalArgumentException {
        if (productId == null) throw new IllegalArgumentException("\"productId\" is required but got null");
        return new ListRequestBuilder(productId);
    }
    private okhttp3.Call updateSingleCall(String id, ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = productsVariantUpdateSingleRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSingleValidateBeforeCall(String id, ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSingle(Async)");
        }

        // verify the required parameter 'productsVariantUpdateSingleRequest' is set
        if (productsVariantUpdateSingleRequest == null) {
            throw new ApiException("Missing the required parameter 'productsVariantUpdateSingleRequest' when calling updateSingle(Async)");
        }

        return updateSingleCall(id, productsVariantUpdateSingleRequest, _callback);

    }


    private ApiResponse<ProductsVariantAttributes> updateSingleWithHttpInfo(String id, ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSingleValidateBeforeCall(id, productsVariantUpdateSingleRequest, null);
        Type localVarReturnType = new TypeToken<ProductsVariantAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSingleAsync(String id, ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest, final ApiCallback<ProductsVariantAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSingleValidateBeforeCall(id, productsVariantUpdateSingleRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductsVariantAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSingleRequestBuilder {
        private final String id;
        private ProductsVariantParameters productsVariant;

        private UpdateSingleRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set productsVariant
         * @param productsVariant  (optional)
         * @return UpdateSingleRequestBuilder
         */
        public UpdateSingleRequestBuilder productsVariant(ProductsVariantParameters productsVariant) {
            this.productsVariant = productsVariant;
            return this;
        }
        
        /**
         * Build call for updateSingle
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest = buildBodyParams();
            return updateSingleCall(id, productsVariantUpdateSingleRequest, _callback);
        }

        private ProductsVariantUpdateSingleRequest buildBodyParams() {
            ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest = new ProductsVariantUpdateSingleRequest();
            productsVariantUpdateSingleRequest.productsVariant(this.productsVariant);
            return productsVariantUpdateSingleRequest;
        }

        /**
         * Execute updateSingle request
         * @return ProductsVariantAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ProductsVariantAttributes execute() throws ApiException {
            ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest = buildBodyParams();
            ApiResponse<ProductsVariantAttributes> localVarResp = updateSingleWithHttpInfo(id, productsVariantUpdateSingleRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSingle request with HTTP info returned
         * @return ApiResponse&lt;ProductsVariantAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ProductsVariantAttributes> executeWithHttpInfo() throws ApiException {
            ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest = buildBodyParams();
            return updateSingleWithHttpInfo(id, productsVariantUpdateSingleRequest);
        }

        /**
         * Execute updateSingle request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ProductsVariantAttributes> _callback) throws ApiException {
            ProductsVariantUpdateSingleRequest productsVariantUpdateSingleRequest = buildBodyParams();
            return updateSingleAsync(id, productsVariantUpdateSingleRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param productsVariantUpdateSingleRequest Information about updated fields in Variant (required)
     * @return UpdateSingleRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSingleRequestBuilder updateSingle(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSingleRequestBuilder(id);
    }
}
