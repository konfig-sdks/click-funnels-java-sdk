...
import com.konfigthis.client.model.ProductsPriceAttributes;
import com.konfigthis.client.model.ProductsPriceCreateVariantPriceRequest;
import com.konfigthis.client.model.ProductsPriceUpdateSinglePriceRequest;
...
public class ProductsPriceApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProductsPriceApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ProductsPriceApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createVariantPriceCall(Integer productId, ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = productsPriceCreateVariantPriceRequest;
    ...
    private okhttp3.Call createVariantPriceValidateBeforeCall(Integer productId, ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'productId' is set
        if (productId == null) {
            throw new ApiException("Missing the required parameter 'productId' when calling createVariantPrice(Async)");
        }

        // verify the required parameter 'productsPriceCreateVariantPriceRequest' is set
        if (productsPriceCreateVariantPriceRequest == null) {
            throw new ApiException("Missing the required parameter 'productsPriceCreateVariantPriceRequest' when calling createVariantPrice(Async)");
        }

        return createVariantPriceCall(productId, productsPriceCreateVariantPriceRequest, _callback);

    }


    private ApiResponse<ProductsPriceAttributes> createVariantPriceWithHttpInfo(Integer productId, ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest) throws ApiException {
        okhttp3.Call localVarCall = createVariantPriceValidateBeforeCall(productId, productsPriceCreateVariantPriceRequest, null);
        Type localVarReturnType = new TypeToken<ProductsPriceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createVariantPriceAsync(Integer productId, ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest, final ApiCallback<ProductsPriceAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createVariantPriceValidateBeforeCall(productId, productsPriceCreateVariantPriceRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductsPriceAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateVariantPriceRequestBuilder {
        private final Integer productId;
        private ProductsPriceParameters productsPrice;

        private CreateVariantPriceRequestBuilder(Integer productId) {
            this.productId = productId;
        }

        /**
         * Set productsPrice
         * @param productsPrice  (optional)
         * @return CreateVariantPriceRequestBuilder
         */
        public CreateVariantPriceRequestBuilder productsPrice(ProductsPriceParameters productsPrice) {
            this.productsPrice = productsPrice;
            return this;
        }
        
        /**
         * Build call for createVariantPrice
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest = buildBodyParams();
            return createVariantPriceCall(productId, productsPriceCreateVariantPriceRequest, _callback);
        }

        private ProductsPriceCreateVariantPriceRequest buildBodyParams() {
            ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest = new ProductsPriceCreateVariantPriceRequest();
            productsPriceCreateVariantPriceRequest.productsPrice(this.productsPrice);
            return productsPriceCreateVariantPriceRequest;
        }

        /**
         * Execute createVariantPrice request
         * @return ProductsPriceAttributes
         ...
         */
        public ProductsPriceAttributes execute() throws ApiException {
            ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest = buildBodyParams();
            ApiResponse<ProductsPriceAttributes> localVarResp = createVariantPriceWithHttpInfo(productId, productsPriceCreateVariantPriceRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createVariantPrice request with HTTP info returned
         * @return ApiResponse&lt;ProductsPriceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ProductsPriceAttributes> executeWithHttpInfo() throws ApiException {
            ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest = buildBodyParams();
            return createVariantPriceWithHttpInfo(productId, productsPriceCreateVariantPriceRequest);
        }

        /**
         * Execute createVariantPrice request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductsPriceAttributes> _callback) throws ApiException {
            ProductsPriceCreateVariantPriceRequest productsPriceCreateVariantPriceRequest = buildBodyParams();
            return createVariantPriceAsync(productId, productsPriceCreateVariantPriceRequest, _callback);
        }
    }
     ...
     * @param productsPriceCreateVariantPriceRequest Information about a new Price (required)
     * @return CreateVariantPriceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateVariantPriceRequestBuilder createVariantPrice(Integer productId) throws IllegalArgumentException {
        if (productId == null) throw new IllegalArgumentException("\"productId\" is required but got null");
        return new CreateVariantPriceRequestBuilder(productId);
    }
    private okhttp3.Call getSinglePriceCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/products/prices/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSinglePriceValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getSinglePrice(Async)");
        }

        return getSinglePriceCall(id, _callback);

    }


    private ApiResponse<ProductsPriceAttributes> getSinglePriceWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSinglePriceValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ProductsPriceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSinglePriceAsync(String id, final ApiCallback<ProductsPriceAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSinglePriceValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ProductsPriceAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetSinglePriceRequestBuilder {
        private final String id;

        private GetSinglePriceRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getSinglePrice
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getSinglePrice request
         * @return ProductsPriceAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ProductsPriceAttributes execute() throws ApiException {
            ApiResponse<ProductsPriceAttributes> localVarResp = getSinglePriceWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSinglePrice request with HTTP info returned
         * @return ApiResponse&lt;ProductsPriceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ProductsPriceAttributes> executeWithHttpInfo() throws ApiException {
            return getSinglePriceWithHttpInfo(id);
        }

        /**
         * Execute getSinglePrice request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductsPriceAttributes> _callback) throws ApiException {
            return getSinglePriceAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetSinglePriceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetSinglePriceRequestBuilder getSinglePrice(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetSinglePriceRequestBuilder(id);
    }
    private okhttp3.Call listForVariantCall(Integer productId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listForVariantValidateBeforeCall(Integer productId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'productId' is set
        if (productId == null) {
            throw new ApiException("Missing the required parameter 'productId' when calling listForVariant(Async)");
        }

        return listForVariantCall(productId, after, sortOrder, _callback);

    }


    private ApiResponse<List<ProductsPriceAttributes>> listForVariantWithHttpInfo(Integer productId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listForVariantValidateBeforeCall(productId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ProductsPriceAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listForVariantAsync(Integer productId, String after, String sortOrder, final ApiCallback<List<ProductsPriceAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listForVariantValidateBeforeCall(productId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<ProductsPriceAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListForVariantRequestBuilder {
        private final Integer productId;
        private String after;
        private String sortOrder;

        private ListForVariantRequestBuilder(Integer productId) {
            this.productId = productId;
        }
         ...
         * @return ListForVariantRequestBuilder
         */
        public ListForVariantRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListForVariantRequestBuilder
         */
        public ListForVariantRequestBuilder sortOrder(String sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }
        
        /**
         * Build call for listForVariant
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listForVariant request
         * @return List&lt;ProductsPriceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ProductsPriceAttributes> execute() throws ApiException {
            ApiResponse<List<ProductsPriceAttributes>> localVarResp = listForVariantWithHttpInfo(productId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listForVariant request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ProductsPriceAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ProductsPriceAttributes>> executeWithHttpInfo() throws ApiException {
            return listForVariantWithHttpInfo(productId, after, sortOrder);
        }

        /**
         * Execute listForVariant request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ProductsPriceAttributes>> _callback) throws ApiException {
            return listForVariantAsync(productId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListForVariantRequestBuilder listForVariant(Integer productId) throws IllegalArgumentException {
        if (productId == null) throw new IllegalArgumentException("\"productId\" is required but got null");
        return new ListForVariantRequestBuilder(productId);
    }
    private okhttp3.Call updateSinglePriceCall(String id, ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = productsPriceUpdateSinglePriceRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSinglePriceValidateBeforeCall(String id, ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSinglePrice(Async)");
        }

        // verify the required parameter 'productsPriceUpdateSinglePriceRequest' is set
        if (productsPriceUpdateSinglePriceRequest == null) {
            throw new ApiException("Missing the required parameter 'productsPriceUpdateSinglePriceRequest' when calling updateSinglePrice(Async)");
        }

        return updateSinglePriceCall(id, productsPriceUpdateSinglePriceRequest, _callback);

    }


    private ApiResponse<ProductsPriceAttributes> updateSinglePriceWithHttpInfo(String id, ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSinglePriceValidateBeforeCall(id, productsPriceUpdateSinglePriceRequest, null);
        Type localVarReturnType = new TypeToken<ProductsPriceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSinglePriceAsync(String id, ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest, final ApiCallback<ProductsPriceAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSinglePriceValidateBeforeCall(id, productsPriceUpdateSinglePriceRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductsPriceAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSinglePriceRequestBuilder {
        private final String id;
        private ProductsPriceParameters productsPrice;

        private UpdateSinglePriceRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set productsPrice
         * @param productsPrice  (optional)
         * @return UpdateSinglePriceRequestBuilder
         */
        public UpdateSinglePriceRequestBuilder productsPrice(ProductsPriceParameters productsPrice) {
            this.productsPrice = productsPrice;
            return this;
        }
        
        /**
         * Build call for updateSinglePrice
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest = buildBodyParams();
            return updateSinglePriceCall(id, productsPriceUpdateSinglePriceRequest, _callback);
        }

        private ProductsPriceUpdateSinglePriceRequest buildBodyParams() {
            ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest = new ProductsPriceUpdateSinglePriceRequest();
            productsPriceUpdateSinglePriceRequest.productsPrice(this.productsPrice);
            return productsPriceUpdateSinglePriceRequest;
        }

        /**
         * Execute updateSinglePrice request
         * @return ProductsPriceAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ProductsPriceAttributes execute() throws ApiException {
            ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest = buildBodyParams();
            ApiResponse<ProductsPriceAttributes> localVarResp = updateSinglePriceWithHttpInfo(id, productsPriceUpdateSinglePriceRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSinglePrice request with HTTP info returned
         * @return ApiResponse&lt;ProductsPriceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ProductsPriceAttributes> executeWithHttpInfo() throws ApiException {
            ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest = buildBodyParams();
            return updateSinglePriceWithHttpInfo(id, productsPriceUpdateSinglePriceRequest);
        }

        /**
         * Execute updateSinglePrice request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ProductsPriceAttributes> _callback) throws ApiException {
            ProductsPriceUpdateSinglePriceRequest productsPriceUpdateSinglePriceRequest = buildBodyParams();
            return updateSinglePriceAsync(id, productsPriceUpdateSinglePriceRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param productsPriceUpdateSinglePriceRequest Information about updated fields in Price (required)
     * @return UpdateSinglePriceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSinglePriceRequestBuilder updateSinglePrice(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSinglePriceRequestBuilder(id);
    }
}
