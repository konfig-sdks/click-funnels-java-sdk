...
import com.konfigthis.client.model.FulfillmentAttributes;
import com.konfigthis.client.model.FulfillmentCreateRequest;
import com.konfigthis.client.model.FulfillmentUpdateByIdRequest;
...
public class FulfillmentApiGenerated {
    ...
    private okhttp3.Call cancelFulfillmentCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/fulfillments/{id}/cancel"
    ...
    private okhttp3.Call cancelFulfillmentValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling cancelFulfillment(Async)");
        }

        return cancelFulfillmentCall(id, _callback);

    }


    private ApiResponse<FulfillmentAttributes> cancelFulfillmentWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = cancelFulfillmentValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call cancelFulfillmentAsync(String id, final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancelFulfillmentValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
    ...
    public class CancelFulfillmentRequestBuilder {
        ...
        private CancelFulfillmentRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 409 </td><td> Conflict - occurs if product is already cancelled. </td><td>  -  </td></tr>
         ...
         */
        public FulfillmentAttributes execute() throws ApiException {
            ApiResponse<FulfillmentAttributes> localVarResp = cancelFulfillmentWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute cancelFulfillment request with HTTP info returned
         * @return ApiResponse&lt;FulfillmentAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<FulfillmentAttributes> executeWithHttpInfo() throws ApiException {
            return cancelFulfillmentWithHttpInfo(id);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {
            return cancelFulfillmentAsync(id, _callback);
        }
    }
     ...
     */
    public CancelFulfillmentRequestBuilder cancelFulfillment(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new CancelFulfillmentRequestBuilder(id);
    }
    private okhttp3.Call createCall(Integer workspaceId, FulfillmentCreateRequest fulfillmentCreateRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/fulfillments"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createValidateBeforeCall(Integer workspaceId, FulfillmentCreateRequest fulfillmentCreateRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling create(Async)");
        }

        // verify the required parameter 'fulfillmentCreateRequest' is set
        if (fulfillmentCreateRequest == null) {
            throw new ApiException("Missing the required parameter 'fulfillmentCreateRequest' when calling create(Async)");
        }

        return createCall(workspaceId, fulfillmentCreateRequest, _callback);

    }


    private ApiResponse<FulfillmentAttributes> createWithHttpInfo(Integer workspaceId, FulfillmentCreateRequest fulfillmentCreateRequest) throws ApiException {
        okhttp3.Call localVarCall = createValidateBeforeCall(workspaceId, fulfillmentCreateRequest, null);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createAsync(Integer workspaceId, FulfillmentCreateRequest fulfillmentCreateRequest, final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createValidateBeforeCall(workspaceId, fulfillmentCreateRequest, _callback);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class CreateRequestBuilder {
        ...
        private FulfillmentParameters fulfillment;

        private CreateRequestBuilder(Integer workspaceId) {
         ...
         */
        public CreateRequestBuilder fulfillment(FulfillmentParameters fulfillment) {
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FulfillmentCreateRequest fulfillmentCreateRequest = buildBodyParams();
            return createCall(workspaceId, fulfillmentCreateRequest, _callback);
        }

        private FulfillmentCreateRequest buildBodyParams() {
            FulfillmentCreateRequest fulfillmentCreateRequest = new FulfillmentCreateRequest();
            fulfillmentCreateRequest.fulfillment(this.fulfillment);
            return fulfillmentCreateRequest;
        }
        ...
        public FulfillmentAttributes execute() throws ApiException {
            FulfillmentCreateRequest fulfillmentCreateRequest = buildBodyParams();
            ApiResponse<FulfillmentAttributes> localVarResp = createWithHttpInfo(workspaceId, fulfillmentCreateRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<FulfillmentAttributes> executeWithHttpInfo() throws ApiException {
            FulfillmentCreateRequest fulfillmentCreateRequest = buildBodyParams();
            return createWithHttpInfo(workspaceId, fulfillmentCreateRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {
            FulfillmentCreateRequest fulfillmentCreateRequest = buildBodyParams();
            return createAsync(workspaceId, fulfillmentCreateRequest, _callback);
        }
    }
     ...
     * @param fulfillmentCreateRequest Information about a new Fulfillment (required)
     * @return CreateRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateRequestBuilder create(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new CreateRequestBuilder(workspaceId);
    }
    private okhttp3.Call getByIdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fulfillments/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    private ApiResponse<FulfillmentAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public FulfillmentAttributes execute() throws ApiException {
            ApiResponse<FulfillmentAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<List<FulfillmentAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<FulfillmentAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<FulfillmentAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @return List&lt;FulfillmentAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<FulfillmentAttributes> execute() throws ApiException {
            ApiResponse<List<FulfillmentAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;FulfillmentAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<FulfillmentAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<FulfillmentAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateByIdCall(String id, FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = fulfillmentUpdateByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateByIdValidateBeforeCall(String id, FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateById(Async)");
        }

        // verify the required parameter 'fulfillmentUpdateByIdRequest' is set
        if (fulfillmentUpdateByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'fulfillmentUpdateByIdRequest' when calling updateById(Async)");
        }

        return updateByIdCall(id, fulfillmentUpdateByIdRequest, _callback);

    }


    private ApiResponse<FulfillmentAttributes> updateByIdWithHttpInfo(String id, FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, fulfillmentUpdateByIdRequest, null);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateByIdAsync(String id, FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest, final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, fulfillmentUpdateByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<FulfillmentAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateByIdRequestBuilder {
         ...
         */
        public UpdateByIdRequestBuilder fulfillment(FulfillmentParameters fulfillment) {
            this.fulfillment = fulfillment;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest = buildBodyParams();
            return updateByIdCall(id, fulfillmentUpdateByIdRequest, _callback);
        }

        private FulfillmentUpdateByIdRequest buildBodyParams() {
            FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest = new FulfillmentUpdateByIdRequest();
            fulfillmentUpdateByIdRequest.fulfillment(this.fulfillment);
            return fulfillmentUpdateByIdRequest;
        }
        ...
        public FulfillmentAttributes execute() throws ApiException {
            FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest = buildBodyParams();
            ApiResponse<FulfillmentAttributes> localVarResp = updateByIdWithHttpInfo(id, fulfillmentUpdateByIdRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<FulfillmentAttributes> executeWithHttpInfo() throws ApiException {
            FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest = buildBodyParams();
            return updateByIdWithHttpInfo(id, fulfillmentUpdateByIdRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<FulfillmentAttributes> _callback) throws ApiException {
            FulfillmentUpdateByIdRequest fulfillmentUpdateByIdRequest = buildBodyParams();
            return updateByIdAsync(id, fulfillmentUpdateByIdRequest, _callback);
        }
    }
     ...
     * Update Fulfillment
     * @param id  (required)
     * @param fulfillmentUpdateByIdRequest Information about updated fields in Fulfillment (required)
     * @return UpdateByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
