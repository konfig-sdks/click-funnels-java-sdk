...
import com.konfigthis.client.model.ProductAddNewToWorkspaceRequest;
import com.konfigthis.client.model.ProductAttributes;
import com.konfigthis.client.model.ProductUpdateForWorkspaceRequest;
...
public class ProductApiGenerated {
    ...
    private okhttp3.Call addNewToWorkspaceCall(Integer workspaceId, ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = productAddNewToWorkspaceRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/products"
    ...
    private okhttp3.Call addNewToWorkspaceValidateBeforeCall(Integer workspaceId, ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling addNewToWorkspace(Async)");
        }

        // verify the required parameter 'productAddNewToWorkspaceRequest' is set
        if (productAddNewToWorkspaceRequest == null) {
            throw new ApiException("Missing the required parameter 'productAddNewToWorkspaceRequest' when calling addNewToWorkspace(Async)");
        }

        return addNewToWorkspaceCall(workspaceId, productAddNewToWorkspaceRequest, _callback);

    }


    private ApiResponse<ProductAttributes> addNewToWorkspaceWithHttpInfo(Integer workspaceId, ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest) throws ApiException {
        okhttp3.Call localVarCall = addNewToWorkspaceValidateBeforeCall(workspaceId, productAddNewToWorkspaceRequest, null);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call addNewToWorkspaceAsync(Integer workspaceId, ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest, final ApiCallback<ProductAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = addNewToWorkspaceValidateBeforeCall(workspaceId, productAddNewToWorkspaceRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class AddNewToWorkspaceRequestBuilder {
        private final Integer workspaceId;
        private ProductParameters product;

        private AddNewToWorkspaceRequestBuilder(Integer workspaceId) {
         ...
         * @return AddNewToWorkspaceRequestBuilder
         */
        public AddNewToWorkspaceRequestBuilder product(ProductParameters product) {
            this.product = product;
            return this;
        }
        
        /**
         * Build call for addNewToWorkspace
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest = buildBodyParams();
            return addNewToWorkspaceCall(workspaceId, productAddNewToWorkspaceRequest, _callback);
        }

        private ProductAddNewToWorkspaceRequest buildBodyParams() {
            ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest = new ProductAddNewToWorkspaceRequest();
            productAddNewToWorkspaceRequest.product(this.product);
            return productAddNewToWorkspaceRequest;
        }

        /**
         * Execute addNewToWorkspace request
         ...
         */
        public ProductAttributes execute() throws ApiException {
            ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest = buildBodyParams();
            ApiResponse<ProductAttributes> localVarResp = addNewToWorkspaceWithHttpInfo(workspaceId, productAddNewToWorkspaceRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute addNewToWorkspace request with HTTP info returned
         * @return ApiResponse&lt;ProductAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ProductAttributes> executeWithHttpInfo() throws ApiException {
            ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest = buildBodyParams();
            return addNewToWorkspaceWithHttpInfo(workspaceId, productAddNewToWorkspaceRequest);
        }

        /**
         * Execute addNewToWorkspace request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductAttributes> _callback) throws ApiException {
            ProductAddNewToWorkspaceRequest productAddNewToWorkspaceRequest = buildBodyParams();
            return addNewToWorkspaceAsync(workspaceId, productAddNewToWorkspaceRequest, _callback);
        }
    }
     ...
     * @param productAddNewToWorkspaceRequest Information about a new Product (required)
     * @return AddNewToWorkspaceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AddNewToWorkspaceRequestBuilder addNewToWorkspace(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new AddNewToWorkspaceRequestBuilder(workspaceId);
    }
    private okhttp3.Call archiveProductCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call archiveProductValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling archiveProduct(Async)");
        }

        return archiveProductCall(id, _callback);

    }


    private ApiResponse<ProductAttributes> archiveProductWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = archiveProductValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call archiveProductAsync(String id, final ApiCallback<ProductAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = archiveProductValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ArchiveProductRequestBuilder {
        private final String id;

        private ArchiveProductRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 409 </td><td> Conflict - occurs if product is already archived. </td><td>  -  </td></tr>
        ...
        /**
         * Execute archiveProduct request
         * @return ProductAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ProductAttributes execute() throws ApiException {
            ApiResponse<ProductAttributes> localVarResp = archiveProductWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute archiveProduct request with HTTP info returned
         * @return ApiResponse&lt;ProductAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ProductAttributes> executeWithHttpInfo() throws ApiException {
            return archiveProductWithHttpInfo(id);
        }

        /**
         * Execute archiveProduct request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductAttributes> _callback) throws ApiException {
            return archiveProductAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return ArchiveProductRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public ArchiveProductRequestBuilder archiveProduct(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new ArchiveProductRequestBuilder(id);
    }
    private okhttp3.Call getForWorkspaceCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getForWorkspaceValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getForWorkspace(Async)");
        }

        return getForWorkspaceCall(id, _callback);

    }


    private ApiResponse<ProductAttributes> getForWorkspaceWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getForWorkspaceValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getForWorkspaceAsync(String id, final ApiCallback<ProductAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getForWorkspaceValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetForWorkspaceRequestBuilder {
        private final String id;

        private GetForWorkspaceRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getForWorkspace
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getForWorkspace request
         * @return ProductAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ProductAttributes execute() throws ApiException {
            ApiResponse<ProductAttributes> localVarResp = getForWorkspaceWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getForWorkspace request with HTTP info returned
         * @return ApiResponse&lt;ProductAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ProductAttributes> executeWithHttpInfo() throws ApiException {
            return getForWorkspaceWithHttpInfo(id);
        }

        /**
         * Execute getForWorkspace request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductAttributes> _callback) throws ApiException {
            return getForWorkspaceAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetForWorkspaceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetForWorkspaceRequestBuilder getForWorkspace(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetForWorkspaceRequestBuilder(id);
    }
    ...
    private ApiResponse<List<ProductAttributes>> listForWorkspaceWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listForWorkspaceValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ProductAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listForWorkspaceAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<ProductAttributes>> _callback) throws ApiException {
    ...
    public class ListForWorkspaceRequestBuilder {
         ...
         */
        public List<ProductAttributes> execute() throws ApiException {
            ApiResponse<List<ProductAttributes>> localVarResp = listForWorkspaceWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listForWorkspace request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ProductAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ProductAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ProductAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call unarchiveByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/products/{id}/unarchive"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call unarchiveByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling unarchiveById(Async)");
        }

        return unarchiveByIdCall(id, _callback);

    }


    private ApiResponse<ProductAttributes> unarchiveByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = unarchiveByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call unarchiveByIdAsync(String id, final ApiCallback<ProductAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = unarchiveByIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UnarchiveByIdRequestBuilder {
        private final String id;

        private UnarchiveByIdRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for unarchiveById
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
            <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
            <tr><td> 409 </td><td> Conflict - occurs if product is not archived. </td><td>  -  </td></tr>
            <tr><td> 422 </td><td> Unprocessable Entity </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
         ...
         */
        public ProductAttributes execute() throws ApiException {
            ApiResponse<ProductAttributes> localVarResp = unarchiveByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute unarchiveById request with HTTP info returned
         * @return ApiResponse&lt;ProductAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ProductAttributes> executeWithHttpInfo() throws ApiException {
            return unarchiveByIdWithHttpInfo(id);
        }

        /**
         * Execute unarchiveById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductAttributes> _callback) throws ApiException {
            return unarchiveByIdAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return UnarchiveByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public UnarchiveByIdRequestBuilder unarchiveById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UnarchiveByIdRequestBuilder(id);
    }
    private okhttp3.Call updateForWorkspaceCall(String id, ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = productUpdateForWorkspaceRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateForWorkspaceValidateBeforeCall(String id, ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateForWorkspace(Async)");
        }

        // verify the required parameter 'productUpdateForWorkspaceRequest' is set
        if (productUpdateForWorkspaceRequest == null) {
            throw new ApiException("Missing the required parameter 'productUpdateForWorkspaceRequest' when calling updateForWorkspace(Async)");
        }

        return updateForWorkspaceCall(id, productUpdateForWorkspaceRequest, _callback);

    }


    private ApiResponse<ProductAttributes> updateForWorkspaceWithHttpInfo(String id, ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest) throws ApiException {
        okhttp3.Call localVarCall = updateForWorkspaceValidateBeforeCall(id, productUpdateForWorkspaceRequest, null);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateForWorkspaceAsync(String id, ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest, final ApiCallback<ProductAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateForWorkspaceValidateBeforeCall(id, productUpdateForWorkspaceRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateForWorkspaceRequestBuilder {
         ...
         */
        public UpdateForWorkspaceRequestBuilder product(ProductParameters product) {
            this.product = product;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest = buildBodyParams();
            return updateForWorkspaceCall(id, productUpdateForWorkspaceRequest, _callback);
        }

        private ProductUpdateForWorkspaceRequest buildBodyParams() {
            ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest = new ProductUpdateForWorkspaceRequest();
            productUpdateForWorkspaceRequest.product(this.product);
            return productUpdateForWorkspaceRequest;
        }
        ...
        public ProductAttributes execute() throws ApiException {
            ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest = buildBodyParams();
            ApiResponse<ProductAttributes> localVarResp = updateForWorkspaceWithHttpInfo(id, productUpdateForWorkspaceRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<ProductAttributes> executeWithHttpInfo() throws ApiException {
            ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest = buildBodyParams();
            return updateForWorkspaceWithHttpInfo(id, productUpdateForWorkspaceRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ProductAttributes> _callback) throws ApiException {
            ProductUpdateForWorkspaceRequest productUpdateForWorkspaceRequest = buildBodyParams();
            return updateForWorkspaceAsync(id, productUpdateForWorkspaceRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param productUpdateForWorkspaceRequest Information about updated fields in Product (required)
     * @return UpdateForWorkspaceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
