...
import com.konfigthis.client.model.UserUpdateSingleUserRequest;
...
public class UserApiGenerated {
    ...
    private ApiResponse<UserAttributes> getSingleWithHttpInfo(String id) throws ApiException {
    ...
    private okhttp3.Call getSingleAsync(String id, final ApiCallback<UserAttributes> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         */
        public UserAttributes execute() throws ApiException {
            ApiResponse<UserAttributes> localVarResp = getSingleWithHttpInfo(id);
         ...
         */
        public ApiResponse<UserAttributes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<UserAttributes> _callback) throws ApiException {
    ...
    private okhttp3.Call listCurrentAccountUsersCall(String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listCurrentAccountUsersValidateBeforeCall(String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        return listCurrentAccountUsersCall(after, sortOrder, _callback);

    }


    private ApiResponse<List<UserAttributes>> listCurrentAccountUsersWithHttpInfo(String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listCurrentAccountUsersValidateBeforeCall(after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<UserAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listCurrentAccountUsersAsync(String after, String sortOrder, final ApiCallback<List<UserAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listCurrentAccountUsersValidateBeforeCall(after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<UserAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListCurrentAccountUsersRequestBuilder {
        private String after;
        private String sortOrder;

        private ListCurrentAccountUsersRequestBuilder() {
        }

        /**
         * Set after
         * @param after ID of item after which the collection should be returned (optional)
         * @return ListCurrentAccountUsersRequestBuilder
         */
        public ListCurrentAccountUsersRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListCurrentAccountUsersRequestBuilder
         */
        public ListCurrentAccountUsersRequestBuilder sortOrder(String sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }
        
        /**
         * Build call for listCurrentAccountUsers
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listCurrentAccountUsers request
         * @return List&lt;UserAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<UserAttributes> execute() throws ApiException {
            ApiResponse<List<UserAttributes>> localVarResp = listCurrentAccountUsersWithHttpInfo(after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listCurrentAccountUsers request with HTTP info returned
         * @return ApiResponse&lt;List&lt;UserAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<UserAttributes>> executeWithHttpInfo() throws ApiException {
            return listCurrentAccountUsersWithHttpInfo(after, sortOrder);
        }

        /**
         * Execute listCurrentAccountUsers request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<UserAttributes>> _callback) throws ApiException {
            return listCurrentAccountUsersAsync(after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListCurrentAccountUsersRequestBuilder listCurrentAccountUsers() throws IllegalArgumentException {
        return new ListCurrentAccountUsersRequestBuilder();
    }
    private okhttp3.Call updateSingleUserCall(String id, UserUpdateSingleUserRequest userUpdateSingleUserRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = userUpdateSingleUserRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSingleUserValidateBeforeCall(String id, UserUpdateSingleUserRequest userUpdateSingleUserRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSingleUser(Async)");
        }

        // verify the required parameter 'userUpdateSingleUserRequest' is set
        if (userUpdateSingleUserRequest == null) {
            throw new ApiException("Missing the required parameter 'userUpdateSingleUserRequest' when calling updateSingleUser(Async)");
        }

        return updateSingleUserCall(id, userUpdateSingleUserRequest, _callback);

    }


    private ApiResponse<UserAttributes> updateSingleUserWithHttpInfo(String id, UserUpdateSingleUserRequest userUpdateSingleUserRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSingleUserValidateBeforeCall(id, userUpdateSingleUserRequest, null);
        Type localVarReturnType = new TypeToken<UserAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSingleUserAsync(String id, UserUpdateSingleUserRequest userUpdateSingleUserRequest, final ApiCallback<UserAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSingleUserValidateBeforeCall(id, userUpdateSingleUserRequest, _callback);
        Type localVarReturnType = new TypeToken<UserAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSingleUserRequestBuilder {
        private final String id;
        private UserParameters user;

        private UpdateSingleUserRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set user
         * @param user  (optional)
         * @return UpdateSingleUserRequestBuilder
         */
        public UpdateSingleUserRequestBuilder user(UserParameters user) {
            this.user = user;
            return this;
        }
        
        /**
         * Build call for updateSingleUser
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            UserUpdateSingleUserRequest userUpdateSingleUserRequest = buildBodyParams();
            return updateSingleUserCall(id, userUpdateSingleUserRequest, _callback);
        }

        private UserUpdateSingleUserRequest buildBodyParams() {
            UserUpdateSingleUserRequest userUpdateSingleUserRequest = new UserUpdateSingleUserRequest();
            userUpdateSingleUserRequest.user(this.user);
            return userUpdateSingleUserRequest;
        }

        /**
         * Execute updateSingleUser request
         * @return UserAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public UserAttributes execute() throws ApiException {
            UserUpdateSingleUserRequest userUpdateSingleUserRequest = buildBodyParams();
            ApiResponse<UserAttributes> localVarResp = updateSingleUserWithHttpInfo(id, userUpdateSingleUserRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSingleUser request with HTTP info returned
         * @return ApiResponse&lt;UserAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<UserAttributes> executeWithHttpInfo() throws ApiException {
            UserUpdateSingleUserRequest userUpdateSingleUserRequest = buildBodyParams();
            return updateSingleUserWithHttpInfo(id, userUpdateSingleUserRequest);
        }

        /**
         * Execute updateSingleUser request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<UserAttributes> _callback) throws ApiException {
            UserUpdateSingleUserRequest userUpdateSingleUserRequest = buildBodyParams();
            return updateSingleUserAsync(id, userUpdateSingleUserRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param userUpdateSingleUserRequest Information about updated fields in User (required)
     * @return UpdateSingleUserRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSingleUserRequestBuilder updateSingleUser(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSingleUserRequestBuilder(id);
    }
}
