...
import com.konfigthis.client.model.CoursesSectionAttributes;
import com.konfigthis.client.model.CoursesSectionUpdateSectionByIdRequest;
...
public class CoursesSectionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CoursesSectionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public CoursesSectionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getSectionCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/courses/sections/{id}"
    ...
    private ApiResponse<CoursesSectionAttributes> getSectionWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSectionValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<CoursesSectionAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSectionAsync(String id, final ApiCallback<CoursesSectionAttributes> _callback) throws ApiException {
    ...
    public class GetSectionRequestBuilder {
        private final String id;

        private GetSectionRequestBuilder(String id) {
            this.id = id;
        }
        ...
        /**
         * Execute getSection request
         * @return CoursesSectionAttributes
         ...
         */
        public CoursesSectionAttributes execute() throws ApiException {
            ApiResponse<CoursesSectionAttributes> localVarResp = getSectionWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSection request with HTTP info returned
         * @return ApiResponse&lt;CoursesSectionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<CoursesSectionAttributes> executeWithHttpInfo() throws ApiException {
            return getSectionWithHttpInfo(id);
        }

        /**
         * Execute getSection request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<CoursesSectionAttributes> _callback) throws ApiException {
            return getSectionAsync(id, _callback);
        }
    }
     ...
     */
    public GetSectionRequestBuilder getSection(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetSectionRequestBuilder(id);
    }
    private okhttp3.Call listSectionsCall(Integer courseId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/courses/{course_id}/sections"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listSectionsValidateBeforeCall(Integer courseId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'courseId' is set
        if (courseId == null) {
            throw new ApiException("Missing the required parameter 'courseId' when calling listSections(Async)");
        }

        return listSectionsCall(courseId, after, sortOrder, _callback);

    }


    private ApiResponse<List<CoursesSectionAttributes>> listSectionsWithHttpInfo(Integer courseId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listSectionsValidateBeforeCall(courseId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<CoursesSectionAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listSectionsAsync(Integer courseId, String after, String sortOrder, final ApiCallback<List<CoursesSectionAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listSectionsValidateBeforeCall(courseId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<CoursesSectionAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListSectionsRequestBuilder {
        ...
        private ListSectionsRequestBuilder(Integer courseId) {
         ...
         */
        public ListSectionsRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListSectionsRequestBuilder
         */
        public ListSectionsRequestBuilder sortOrder(String sortOrder) {
         ...
         * @return List&lt;CoursesSectionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<CoursesSectionAttributes> execute() throws ApiException {
            ApiResponse<List<CoursesSectionAttributes>> localVarResp = listSectionsWithHttpInfo(courseId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listSections request with HTTP info returned
         * @return ApiResponse&lt;List&lt;CoursesSectionAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<CoursesSectionAttributes>> executeWithHttpInfo() throws ApiException {
            return listSectionsWithHttpInfo(courseId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<CoursesSectionAttributes>> _callback) throws ApiException {
            return listSectionsAsync(courseId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListSectionsRequestBuilder listSections(Integer courseId) throws IllegalArgumentException {
        if (courseId == null) throw new IllegalArgumentException("\"courseId\" is required but got null");
        return new ListSectionsRequestBuilder(courseId);
    }
    private okhttp3.Call updateSectionByIdCall(String id, CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = coursesSectionUpdateSectionByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSectionByIdValidateBeforeCall(String id, CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSectionById(Async)");
        }

        // verify the required parameter 'coursesSectionUpdateSectionByIdRequest' is set
        if (coursesSectionUpdateSectionByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'coursesSectionUpdateSectionByIdRequest' when calling updateSectionById(Async)");
        }

        return updateSectionByIdCall(id, coursesSectionUpdateSectionByIdRequest, _callback);

    }


    private ApiResponse<CoursesSectionAttributes> updateSectionByIdWithHttpInfo(String id, CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSectionByIdValidateBeforeCall(id, coursesSectionUpdateSectionByIdRequest, null);
        Type localVarReturnType = new TypeToken<CoursesSectionAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSectionByIdAsync(String id, CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest, final ApiCallback<CoursesSectionAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSectionByIdValidateBeforeCall(id, coursesSectionUpdateSectionByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<CoursesSectionAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSectionByIdRequestBuilder {
        private final String id;
        private CoursesSectionParameters coursesSection;

        private UpdateSectionByIdRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Set coursesSection
         * @param coursesSection  (optional)
         * @return UpdateSectionByIdRequestBuilder
         */
        public UpdateSectionByIdRequestBuilder coursesSection(CoursesSectionParameters coursesSection) {
            this.coursesSection = coursesSection;
            return this;
        }
        
        /**
         * Build call for updateSectionById
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest = buildBodyParams();
            return updateSectionByIdCall(id, coursesSectionUpdateSectionByIdRequest, _callback);
        }

        private CoursesSectionUpdateSectionByIdRequest buildBodyParams() {
            CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest = new CoursesSectionUpdateSectionByIdRequest();
            coursesSectionUpdateSectionByIdRequest.coursesSection(this.coursesSection);
            return coursesSectionUpdateSectionByIdRequest;
        }

        /**
         * Execute updateSectionById request
         * @return CoursesSectionAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public CoursesSectionAttributes execute() throws ApiException {
            CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest = buildBodyParams();
            ApiResponse<CoursesSectionAttributes> localVarResp = updateSectionByIdWithHttpInfo(id, coursesSectionUpdateSectionByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSectionById request with HTTP info returned
         * @return ApiResponse&lt;CoursesSectionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<CoursesSectionAttributes> executeWithHttpInfo() throws ApiException {
            CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest = buildBodyParams();
            return updateSectionByIdWithHttpInfo(id, coursesSectionUpdateSectionByIdRequest);
        }

        /**
         * Execute updateSectionById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<CoursesSectionAttributes> _callback) throws ApiException {
            CoursesSectionUpdateSectionByIdRequest coursesSectionUpdateSectionByIdRequest = buildBodyParams();
            return updateSectionByIdAsync(id, coursesSectionUpdateSectionByIdRequest, _callback);
        }
    }
     ...
     * Update Section
     * @param id  (required)
     * @param coursesSectionUpdateSectionByIdRequest Information about updated fields in Section (required)
     * @return UpdateSectionByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSectionByIdRequestBuilder updateSectionById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSectionByIdRequestBuilder(id);
    }
}
