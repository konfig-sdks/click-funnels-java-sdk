...
import com.konfigthis.client.model.CoursesEnrollmentAttributes;
import com.konfigthis.client.model.CoursesEnrollmentCreateNewEnrollmentRequest;
import com.konfigthis.client.model.CoursesEnrollmentUpdateSpecificEnrollmentRequest;
...
public class CoursesEnrollmentApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CoursesEnrollmentApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public CoursesEnrollmentApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewEnrollmentCall(Integer courseId, CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = coursesEnrollmentCreateNewEnrollmentRequest;

        // create path and map variables
        String localVarPath = "/courses/{course_id}/enrollments"
    ...
    private okhttp3.Call createNewEnrollmentValidateBeforeCall(Integer courseId, CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'courseId' is set
        if (courseId == null) {
            throw new ApiException("Missing the required parameter 'courseId' when calling createNewEnrollment(Async)");
        }

        // verify the required parameter 'coursesEnrollmentCreateNewEnrollmentRequest' is set
        if (coursesEnrollmentCreateNewEnrollmentRequest == null) {
            throw new ApiException("Missing the required parameter 'coursesEnrollmentCreateNewEnrollmentRequest' when calling createNewEnrollment(Async)");
        }

        return createNewEnrollmentCall(courseId, coursesEnrollmentCreateNewEnrollmentRequest, _callback);

    }


    private ApiResponse<CoursesEnrollmentAttributes> createNewEnrollmentWithHttpInfo(Integer courseId, CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewEnrollmentValidateBeforeCall(courseId, coursesEnrollmentCreateNewEnrollmentRequest, null);
        Type localVarReturnType = new TypeToken<CoursesEnrollmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewEnrollmentAsync(Integer courseId, CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest, final ApiCallback<CoursesEnrollmentAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewEnrollmentValidateBeforeCall(courseId, coursesEnrollmentCreateNewEnrollmentRequest, _callback);
        Type localVarReturnType = new TypeToken<CoursesEnrollmentAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewEnrollmentRequestBuilder {
        private final Integer courseId;
        private CoursesEnrollmentParameters coursesEnrollment;

        private CreateNewEnrollmentRequestBuilder(Integer courseId) {
            this.courseId = courseId;
        }

        /**
         * Set coursesEnrollment
         * @param coursesEnrollment  (optional)
         * @return CreateNewEnrollmentRequestBuilder
         */
        public CreateNewEnrollmentRequestBuilder coursesEnrollment(CoursesEnrollmentParameters coursesEnrollment) {
            this.coursesEnrollment = coursesEnrollment;
            return this;
        }
        
        /**
         * Build call for createNewEnrollment
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest = buildBodyParams();
            return createNewEnrollmentCall(courseId, coursesEnrollmentCreateNewEnrollmentRequest, _callback);
        }

        private CoursesEnrollmentCreateNewEnrollmentRequest buildBodyParams() {
            CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest = new CoursesEnrollmentCreateNewEnrollmentRequest();
            coursesEnrollmentCreateNewEnrollmentRequest.coursesEnrollment(this.coursesEnrollment);
            return coursesEnrollmentCreateNewEnrollmentRequest;
        }

        /**
         * Execute createNewEnrollment request
         * @return CoursesEnrollmentAttributes
         ...
         */
        public CoursesEnrollmentAttributes execute() throws ApiException {
            CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest = buildBodyParams();
            ApiResponse<CoursesEnrollmentAttributes> localVarResp = createNewEnrollmentWithHttpInfo(courseId, coursesEnrollmentCreateNewEnrollmentRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewEnrollment request with HTTP info returned
         * @return ApiResponse&lt;CoursesEnrollmentAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<CoursesEnrollmentAttributes> executeWithHttpInfo() throws ApiException {
            CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest = buildBodyParams();
            return createNewEnrollmentWithHttpInfo(courseId, coursesEnrollmentCreateNewEnrollmentRequest);
        }

        /**
         * Execute createNewEnrollment request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<CoursesEnrollmentAttributes> _callback) throws ApiException {
            CoursesEnrollmentCreateNewEnrollmentRequest coursesEnrollmentCreateNewEnrollmentRequest = buildBodyParams();
            return createNewEnrollmentAsync(courseId, coursesEnrollmentCreateNewEnrollmentRequest, _callback);
        }
    }
     ...
     * @param coursesEnrollmentCreateNewEnrollmentRequest Information about a new Enrollment (required)
     * @return CreateNewEnrollmentRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewEnrollmentRequestBuilder createNewEnrollment(Integer courseId) throws IllegalArgumentException {
        if (courseId == null) throw new IllegalArgumentException("\"courseId\" is required but got null");
        return new CreateNewEnrollmentRequestBuilder(courseId);
    }
    private okhttp3.Call getByIdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/courses/enrollments/{id}"
    ...
    private ApiResponse<CoursesEnrollmentAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<CoursesEnrollmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<CoursesEnrollmentAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public CoursesEnrollmentAttributes execute() throws ApiException {
            ApiResponse<CoursesEnrollmentAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private okhttp3.Call listCall(Integer courseId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer courseId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'courseId' is set
        if (courseId == null) {
            throw new ApiException("Missing the required parameter 'courseId' when calling list(Async)");
        }

        return listCall(courseId, after, sortOrder, _callback);

    }


    private ApiResponse<List<CoursesEnrollmentAttributes>> listWithHttpInfo(Integer courseId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(courseId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<CoursesEnrollmentAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer courseId, String after, String sortOrder, final ApiCallback<List<CoursesEnrollmentAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(courseId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<CoursesEnrollmentAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(Integer courseId) {
            this.courseId = courseId;
        }
         ...
         * @return List&lt;CoursesEnrollmentAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<CoursesEnrollmentAttributes> execute() throws ApiException {
            ApiResponse<List<CoursesEnrollmentAttributes>> localVarResp = listWithHttpInfo(courseId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;CoursesEnrollmentAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<CoursesEnrollmentAttributes>> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(courseId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<CoursesEnrollmentAttributes>> _callback) throws ApiException {
            return listAsync(courseId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(Integer courseId) throws IllegalArgumentException {
        if (courseId == null) throw new IllegalArgumentException("\"courseId\" is required but got null");
        return new ListRequestBuilder(courseId);
    }
    private okhttp3.Call updateSpecificEnrollmentCall(String id, CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = coursesEnrollmentUpdateSpecificEnrollmentRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSpecificEnrollmentValidateBeforeCall(String id, CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSpecificEnrollment(Async)");
        }

        // verify the required parameter 'coursesEnrollmentUpdateSpecificEnrollmentRequest' is set
        if (coursesEnrollmentUpdateSpecificEnrollmentRequest == null) {
            throw new ApiException("Missing the required parameter 'coursesEnrollmentUpdateSpecificEnrollmentRequest' when calling updateSpecificEnrollment(Async)");
        }

        return updateSpecificEnrollmentCall(id, coursesEnrollmentUpdateSpecificEnrollmentRequest, _callback);

    }


    private ApiResponse<CoursesEnrollmentAttributes> updateSpecificEnrollmentWithHttpInfo(String id, CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSpecificEnrollmentValidateBeforeCall(id, coursesEnrollmentUpdateSpecificEnrollmentRequest, null);
        Type localVarReturnType = new TypeToken<CoursesEnrollmentAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSpecificEnrollmentAsync(String id, CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest, final ApiCallback<CoursesEnrollmentAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSpecificEnrollmentValidateBeforeCall(id, coursesEnrollmentUpdateSpecificEnrollmentRequest, _callback);
        Type localVarReturnType = new TypeToken<CoursesEnrollmentAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSpecificEnrollmentRequestBuilder {
        private final String id;
        private CoursesEnrollmentParameters coursesEnrollment;

        private UpdateSpecificEnrollmentRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set coursesEnrollment
         * @param coursesEnrollment  (optional)
         * @return UpdateSpecificEnrollmentRequestBuilder
         */
        public UpdateSpecificEnrollmentRequestBuilder coursesEnrollment(CoursesEnrollmentParameters coursesEnrollment) {
            this.coursesEnrollment = coursesEnrollment;
            return this;
        }
        
        /**
         * Build call for updateSpecificEnrollment
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest = buildBodyParams();
            return updateSpecificEnrollmentCall(id, coursesEnrollmentUpdateSpecificEnrollmentRequest, _callback);
        }

        private CoursesEnrollmentUpdateSpecificEnrollmentRequest buildBodyParams() {
            CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest = new CoursesEnrollmentUpdateSpecificEnrollmentRequest();
            coursesEnrollmentUpdateSpecificEnrollmentRequest.coursesEnrollment(this.coursesEnrollment);
            return coursesEnrollmentUpdateSpecificEnrollmentRequest;
        }

        /**
         * Execute updateSpecificEnrollment request
         * @return CoursesEnrollmentAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public CoursesEnrollmentAttributes execute() throws ApiException {
            CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest = buildBodyParams();
            ApiResponse<CoursesEnrollmentAttributes> localVarResp = updateSpecificEnrollmentWithHttpInfo(id, coursesEnrollmentUpdateSpecificEnrollmentRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSpecificEnrollment request with HTTP info returned
         * @return ApiResponse&lt;CoursesEnrollmentAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<CoursesEnrollmentAttributes> executeWithHttpInfo() throws ApiException {
            CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest = buildBodyParams();
            return updateSpecificEnrollmentWithHttpInfo(id, coursesEnrollmentUpdateSpecificEnrollmentRequest);
        }

        /**
         * Execute updateSpecificEnrollment request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<CoursesEnrollmentAttributes> _callback) throws ApiException {
            CoursesEnrollmentUpdateSpecificEnrollmentRequest coursesEnrollmentUpdateSpecificEnrollmentRequest = buildBodyParams();
            return updateSpecificEnrollmentAsync(id, coursesEnrollmentUpdateSpecificEnrollmentRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param coursesEnrollmentUpdateSpecificEnrollmentRequest Information about updated fields in Enrollment (required)
     * @return UpdateSpecificEnrollmentRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSpecificEnrollmentRequestBuilder updateSpecificEnrollment(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSpecificEnrollmentRequestBuilder(id);
    }
}
