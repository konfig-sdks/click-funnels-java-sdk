...
import com.konfigthis.client.model.ImageUpdateByIdRequest;
...
public class ImageApiGenerated {
    ...
    private okhttp3.Call createCall(Integer workspaceId, ImageCreateRequest imageCreateRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/workspaces/{workspace_id}/images"
    ...
    private okhttp3.Call createValidateBeforeCall(Integer workspaceId, ImageCreateRequest imageCreateRequest, final ApiCallback _callback) throws ApiException {
        ...
        if (imageCreateRequest == null) {
            throw new ApiException("Missing the required parameter 'imageCreateRequest' when calling create(Async)");
        }

        return createCall(workspaceId, imageCreateRequest, _callback);

    }


    private ApiResponse<ImageAttributes> createWithHttpInfo(Integer workspaceId, ImageCreateRequest imageCreateRequest) throws ApiException {
        okhttp3.Call localVarCall = createValidateBeforeCall(workspaceId, imageCreateRequest, null);
        Type localVarReturnType = new TypeToken<ImageAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createAsync(Integer workspaceId, ImageCreateRequest imageCreateRequest, final ApiCallback<ImageAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createValidateBeforeCall(workspaceId, imageCreateRequest, _callback);
        Type localVarReturnType = new TypeToken<ImageAttributes>(){}.getType();
    ...
    public class CreateRequestBuilder {
         ...
         */
        public CreateRequestBuilder image(ImageParameters image) {
            this.image = image;
            return this;
        }
        ...
        private ImageCreateRequest buildBodyParams() {
            ...
            imageCreateRequest.image(this.image);
         ...
         */
        public ImageAttributes execute() throws ApiException {
            ImageCreateRequest imageCreateRequest = buildBodyParams();
            ApiResponse<ImageAttributes> localVarResp = createWithHttpInfo(workspaceId, imageCreateRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute create request with HTTP info returned
         * @return ApiResponse&lt;ImageAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ImageAttributes> executeWithHttpInfo() throws ApiException {
            ImageCreateRequest imageCreateRequest = buildBodyParams();
            return createWithHttpInfo(workspaceId, imageCreateRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ImageAttributes> _callback) throws ApiException {
            ImageCreateRequest imageCreateRequest = buildBodyParams();
            return createAsync(workspaceId, imageCreateRequest, _callback);
        }
    }
     ...
     * @param imageCreateRequest Information about a new Image (required)
     * @return CreateRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private ApiResponse<ImageAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ImageAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<ImageAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public ImageAttributes execute() throws ApiException {
            ApiResponse<ImageAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<List<ImageAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ImageAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<ImageAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         */
        public List<ImageAttributes> execute() throws ApiException {
            ApiResponse<List<ImageAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ImageAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ImageAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ImageAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateByIdCall(String id, ImageUpdateByIdRequest imageUpdateByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = imageUpdateByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateByIdValidateBeforeCall(String id, ImageUpdateByIdRequest imageUpdateByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateById(Async)");
        }

        // verify the required parameter 'imageUpdateByIdRequest' is set
        if (imageUpdateByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'imageUpdateByIdRequest' when calling updateById(Async)");
        }

        return updateByIdCall(id, imageUpdateByIdRequest, _callback);

    }


    private ApiResponse<ImageAttributes> updateByIdWithHttpInfo(String id, ImageUpdateByIdRequest imageUpdateByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, imageUpdateByIdRequest, null);
        Type localVarReturnType = new TypeToken<ImageAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateByIdAsync(String id, ImageUpdateByIdRequest imageUpdateByIdRequest, final ApiCallback<ImageAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, imageUpdateByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<ImageAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateByIdRequestBuilder {
         ...
         */
        public UpdateByIdRequestBuilder image(ImageParameters image) {
            this.image = image;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ImageUpdateByIdRequest imageUpdateByIdRequest = buildBodyParams();
            return updateByIdCall(id, imageUpdateByIdRequest, _callback);
        }

        private ImageUpdateByIdRequest buildBodyParams() {
            ImageUpdateByIdRequest imageUpdateByIdRequest = new ImageUpdateByIdRequest();
            imageUpdateByIdRequest.image(this.image);
            return imageUpdateByIdRequest;
        }
        ...
        public ImageAttributes execute() throws ApiException {
            ImageUpdateByIdRequest imageUpdateByIdRequest = buildBodyParams();
            ApiResponse<ImageAttributes> localVarResp = updateByIdWithHttpInfo(id, imageUpdateByIdRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<ImageAttributes> executeWithHttpInfo() throws ApiException {
            ImageUpdateByIdRequest imageUpdateByIdRequest = buildBodyParams();
            return updateByIdWithHttpInfo(id, imageUpdateByIdRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ImageAttributes> _callback) throws ApiException {
            ImageUpdateByIdRequest imageUpdateByIdRequest = buildBodyParams();
            return updateByIdAsync(id, imageUpdateByIdRequest, _callback);
        }
    }
     ...
     * Update Image
     * @param id  (required)
     * @param imageUpdateByIdRequest Information about updated fields in Image (required)
     * @return UpdateByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
