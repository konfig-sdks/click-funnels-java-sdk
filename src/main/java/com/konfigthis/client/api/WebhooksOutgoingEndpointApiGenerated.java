...
import com.konfigthis.client.model.WebhooksOutgoingEndpointAttributes;
import com.konfigthis.client.model.WebhooksOutgoingEndpointCreateNewRequest;
import com.konfigthis.client.model.WebhooksOutgoingEndpointUpdateEndpointRequest;
...
public class WebhooksOutgoingEndpointApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WebhooksOutgoingEndpointApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public WebhooksOutgoingEndpointApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewCall(Integer workspaceId, WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = webhooksOutgoingEndpointCreateNewRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/webhooks/outgoing/endpoints"
    ...
    private okhttp3.Call createNewValidateBeforeCall(Integer workspaceId, WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNew(Async)");
        }

        // verify the required parameter 'webhooksOutgoingEndpointCreateNewRequest' is set
        if (webhooksOutgoingEndpointCreateNewRequest == null) {
            throw new ApiException("Missing the required parameter 'webhooksOutgoingEndpointCreateNewRequest' when calling createNew(Async)");
        }

        return createNewCall(workspaceId, webhooksOutgoingEndpointCreateNewRequest, _callback);

    }


    private ApiResponse<WebhooksOutgoingEndpointAttributes> createNewWithHttpInfo(Integer workspaceId, WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewValidateBeforeCall(workspaceId, webhooksOutgoingEndpointCreateNewRequest, null);
        Type localVarReturnType = new TypeToken<WebhooksOutgoingEndpointAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewAsync(Integer workspaceId, WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest, final ApiCallback<WebhooksOutgoingEndpointAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewValidateBeforeCall(workspaceId, webhooksOutgoingEndpointCreateNewRequest, _callback);
        Type localVarReturnType = new TypeToken<WebhooksOutgoingEndpointAttributes>(){}.getType();
    ...
    public class CreateNewRequestBuilder {
        ...
        private WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint;
        ...
        /**
         * Set webhooksOutgoingEndpoint
         * @param webhooksOutgoingEndpoint  (optional)
         * @return CreateNewRequestBuilder
         */
        public CreateNewRequestBuilder webhooksOutgoingEndpoint(WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint) {
            this.webhooksOutgoingEndpoint = webhooksOutgoingEndpoint;
            return this;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest = buildBodyParams();
            return createNewCall(workspaceId, webhooksOutgoingEndpointCreateNewRequest, _callback);
        }

        private WebhooksOutgoingEndpointCreateNewRequest buildBodyParams() {
            WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest = new WebhooksOutgoingEndpointCreateNewRequest();
            webhooksOutgoingEndpointCreateNewRequest.webhooksOutgoingEndpoint(this.webhooksOutgoingEndpoint);
            return webhooksOutgoingEndpointCreateNewRequest;
        }

        /**
         * Execute createNew request
         * @return WebhooksOutgoingEndpointAttributes
         ...
         */
        public WebhooksOutgoingEndpointAttributes execute() throws ApiException {
            WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest = buildBodyParams();
            ApiResponse<WebhooksOutgoingEndpointAttributes> localVarResp = createNewWithHttpInfo(workspaceId, webhooksOutgoingEndpointCreateNewRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNew request with HTTP info returned
         * @return ApiResponse&lt;WebhooksOutgoingEndpointAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<WebhooksOutgoingEndpointAttributes> executeWithHttpInfo() throws ApiException {
            WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest = buildBodyParams();
            return createNewWithHttpInfo(workspaceId, webhooksOutgoingEndpointCreateNewRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WebhooksOutgoingEndpointAttributes> _callback) throws ApiException {
            WebhooksOutgoingEndpointCreateNewRequest webhooksOutgoingEndpointCreateNewRequest = buildBodyParams();
            return createNewAsync(workspaceId, webhooksOutgoingEndpointCreateNewRequest, _callback);
        }
    }
     ...
     * @param webhooksOutgoingEndpointCreateNewRequest Information about a new Endpoint (required)
     * @return CreateNewRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private okhttp3.Call getCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/webhooks/outgoing/endpoints/{id}"
    ...
    private ApiResponse<WebhooksOutgoingEndpointAttributes> getWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<WebhooksOutgoingEndpointAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(String id, final ApiCallback<WebhooksOutgoingEndpointAttributes> _callback) throws ApiException {
    ...
    public class GetRequestBuilder {
         ...
         */
        public WebhooksOutgoingEndpointAttributes execute() throws ApiException {
            ApiResponse<WebhooksOutgoingEndpointAttributes> localVarResp = getWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private okhttp3.Call listEndpointsCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listEndpointsValidateBeforeCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling listEndpoints(Async)");
        }

        return listEndpointsCall(workspaceId, after, sortOrder, _callback);

    }


    private ApiResponse<List<WebhooksOutgoingEndpointAttributes>> listEndpointsWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listEndpointsValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<WebhooksOutgoingEndpointAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listEndpointsAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<WebhooksOutgoingEndpointAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listEndpointsValidateBeforeCall(workspaceId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<WebhooksOutgoingEndpointAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListEndpointsRequestBuilder {
        ...
        private ListEndpointsRequestBuilder(Integer workspaceId) {
            this.workspaceId = workspaceId;
        }
         ...
         */
        public ListEndpointsRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListEndpointsRequestBuilder
         */
        public ListEndpointsRequestBuilder sortOrder(String sortOrder) {
         ...
         * @return List&lt;WebhooksOutgoingEndpointAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<WebhooksOutgoingEndpointAttributes> execute() throws ApiException {
            ApiResponse<List<WebhooksOutgoingEndpointAttributes>> localVarResp = listEndpointsWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listEndpoints request with HTTP info returned
         * @return ApiResponse&lt;List&lt;WebhooksOutgoingEndpointAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<WebhooksOutgoingEndpointAttributes>> executeWithHttpInfo() throws ApiException {
            return listEndpointsWithHttpInfo(workspaceId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<WebhooksOutgoingEndpointAttributes>> _callback) throws ApiException {
            return listEndpointsAsync(workspaceId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListEndpointsRequestBuilder listEndpoints(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new ListEndpointsRequestBuilder(workspaceId);
    }
    private okhttp3.Call updateEndpointCall(String id, WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = webhooksOutgoingEndpointUpdateEndpointRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateEndpointValidateBeforeCall(String id, WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateEndpoint(Async)");
        }

        // verify the required parameter 'webhooksOutgoingEndpointUpdateEndpointRequest' is set
        if (webhooksOutgoingEndpointUpdateEndpointRequest == null) {
            throw new ApiException("Missing the required parameter 'webhooksOutgoingEndpointUpdateEndpointRequest' when calling updateEndpoint(Async)");
        }

        return updateEndpointCall(id, webhooksOutgoingEndpointUpdateEndpointRequest, _callback);

    }


    private ApiResponse<WebhooksOutgoingEndpointAttributes> updateEndpointWithHttpInfo(String id, WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest) throws ApiException {
        okhttp3.Call localVarCall = updateEndpointValidateBeforeCall(id, webhooksOutgoingEndpointUpdateEndpointRequest, null);
        Type localVarReturnType = new TypeToken<WebhooksOutgoingEndpointAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateEndpointAsync(String id, WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest, final ApiCallback<WebhooksOutgoingEndpointAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateEndpointValidateBeforeCall(id, webhooksOutgoingEndpointUpdateEndpointRequest, _callback);
        Type localVarReturnType = new TypeToken<WebhooksOutgoingEndpointAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateEndpointRequestBuilder {
        ...
        private UpdateEndpointRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public UpdateEndpointRequestBuilder webhooksOutgoingEndpoint(WebhooksOutgoingEndpointParameters webhooksOutgoingEndpoint) {
            this.webhooksOutgoingEndpoint = webhooksOutgoingEndpoint;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest = buildBodyParams();
            return updateEndpointCall(id, webhooksOutgoingEndpointUpdateEndpointRequest, _callback);
        }

        private WebhooksOutgoingEndpointUpdateEndpointRequest buildBodyParams() {
            WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest = new WebhooksOutgoingEndpointUpdateEndpointRequest();
            webhooksOutgoingEndpointUpdateEndpointRequest.webhooksOutgoingEndpoint(this.webhooksOutgoingEndpoint);
            return webhooksOutgoingEndpointUpdateEndpointRequest;
        }
        ...
        public WebhooksOutgoingEndpointAttributes execute() throws ApiException {
            WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest = buildBodyParams();
            ApiResponse<WebhooksOutgoingEndpointAttributes> localVarResp = updateEndpointWithHttpInfo(id, webhooksOutgoingEndpointUpdateEndpointRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<WebhooksOutgoingEndpointAttributes> executeWithHttpInfo() throws ApiException {
            WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest = buildBodyParams();
            return updateEndpointWithHttpInfo(id, webhooksOutgoingEndpointUpdateEndpointRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<WebhooksOutgoingEndpointAttributes> _callback) throws ApiException {
            WebhooksOutgoingEndpointUpdateEndpointRequest webhooksOutgoingEndpointUpdateEndpointRequest = buildBodyParams();
            return updateEndpointAsync(id, webhooksOutgoingEndpointUpdateEndpointRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param webhooksOutgoingEndpointUpdateEndpointRequest Information about updated fields in Endpoint (required)
     * @return UpdateEndpointRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateEndpointRequestBuilder updateEndpoint(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateEndpointRequestBuilder(id);
    }
}
