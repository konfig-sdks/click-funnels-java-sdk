...
import com.konfigthis.client.model.ContactsTagAttributes;
import com.konfigthis.client.model.ContactsTagCreateNewTagRequest;
import com.konfigthis.client.model.ContactsTagUpdateSpecificTagRequest;
...
public class ContactsTagApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ContactsTagApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ContactsTagApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewTagCall(Integer workspaceId, ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = contactsTagCreateNewTagRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/contacts/tags"
    ...
    private okhttp3.Call createNewTagValidateBeforeCall(Integer workspaceId, ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewTag(Async)");
        }

        // verify the required parameter 'contactsTagCreateNewTagRequest' is set
        if (contactsTagCreateNewTagRequest == null) {
            throw new ApiException("Missing the required parameter 'contactsTagCreateNewTagRequest' when calling createNewTag(Async)");
        }

        return createNewTagCall(workspaceId, contactsTagCreateNewTagRequest, _callback);

    }


    private ApiResponse<ContactsTagAttributes> createNewTagWithHttpInfo(Integer workspaceId, ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewTagValidateBeforeCall(workspaceId, contactsTagCreateNewTagRequest, null);
        Type localVarReturnType = new TypeToken<ContactsTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewTagAsync(Integer workspaceId, ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest, final ApiCallback<ContactsTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewTagValidateBeforeCall(workspaceId, contactsTagCreateNewTagRequest, _callback);
        Type localVarReturnType = new TypeToken<ContactsTagAttributes>(){}.getType();
    ...
    public class CreateNewTagRequestBuilder {
        ...
        private ContactsTagParameters contactsTag;
        ...
        /**
         * Set contactsTag
         * @param contactsTag  (optional)
         * @return CreateNewTagRequestBuilder
         */
        public CreateNewTagRequestBuilder contactsTag(ContactsTagParameters contactsTag) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest = buildBodyParams();
            return createNewTagCall(workspaceId, contactsTagCreateNewTagRequest, _callback);
        }

        private ContactsTagCreateNewTagRequest buildBodyParams() {
            ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest = new ContactsTagCreateNewTagRequest();
            contactsTagCreateNewTagRequest.contactsTag(this.contactsTag);
            return contactsTagCreateNewTagRequest;
        }

        /**
         * Execute createNewTag request
         * @return ContactsTagAttributes
         ...
         */
        public ContactsTagAttributes execute() throws ApiException {
            ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest = buildBodyParams();
            ApiResponse<ContactsTagAttributes> localVarResp = createNewTagWithHttpInfo(workspaceId, contactsTagCreateNewTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewTag request with HTTP info returned
         * @return ApiResponse&lt;ContactsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ContactsTagAttributes> executeWithHttpInfo() throws ApiException {
            ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest = buildBodyParams();
            return createNewTagWithHttpInfo(workspaceId, contactsTagCreateNewTagRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ContactsTagAttributes> _callback) throws ApiException {
            ContactsTagCreateNewTagRequest contactsTagCreateNewTagRequest = buildBodyParams();
            return createNewTagAsync(workspaceId, contactsTagCreateNewTagRequest, _callback);
        }
    }
     ...
     * @param contactsTagCreateNewTagRequest Information about a new Tag (required)
     * @return CreateNewTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private okhttp3.Call getSingleCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/contacts/tags/{id}"
    ...
    private ApiResponse<ContactsTagAttributes> getSingleWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ContactsTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(String id, final ApiCallback<ContactsTagAttributes> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         */
        public ContactsTagAttributes execute() throws ApiException {
            ApiResponse<ContactsTagAttributes> localVarResp = getSingleWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private ApiResponse<List<ContactsTagAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ContactsTagAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<ContactsTagAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @return List&lt;ContactsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ContactsTagAttributes> execute() throws ApiException {
            ApiResponse<List<ContactsTagAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ContactsTagAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ContactsTagAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ContactsTagAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateSpecificTagCall(String id, ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = contactsTagUpdateSpecificTagRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSpecificTagValidateBeforeCall(String id, ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSpecificTag(Async)");
        }

        // verify the required parameter 'contactsTagUpdateSpecificTagRequest' is set
        if (contactsTagUpdateSpecificTagRequest == null) {
            throw new ApiException("Missing the required parameter 'contactsTagUpdateSpecificTagRequest' when calling updateSpecificTag(Async)");
        }

        return updateSpecificTagCall(id, contactsTagUpdateSpecificTagRequest, _callback);

    }


    private ApiResponse<ContactsTagAttributes> updateSpecificTagWithHttpInfo(String id, ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSpecificTagValidateBeforeCall(id, contactsTagUpdateSpecificTagRequest, null);
        Type localVarReturnType = new TypeToken<ContactsTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSpecificTagAsync(String id, ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest, final ApiCallback<ContactsTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSpecificTagValidateBeforeCall(id, contactsTagUpdateSpecificTagRequest, _callback);
        Type localVarReturnType = new TypeToken<ContactsTagAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSpecificTagRequestBuilder {
        private final String id;
        private ContactsTagParameters contactsTag;

        private UpdateSpecificTagRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set contactsTag
         * @param contactsTag  (optional)
         * @return UpdateSpecificTagRequestBuilder
         */
        public UpdateSpecificTagRequestBuilder contactsTag(ContactsTagParameters contactsTag) {
            this.contactsTag = contactsTag;
            return this;
        }
        
        /**
         * Build call for updateSpecificTag
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest = buildBodyParams();
            return updateSpecificTagCall(id, contactsTagUpdateSpecificTagRequest, _callback);
        }

        private ContactsTagUpdateSpecificTagRequest buildBodyParams() {
            ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest = new ContactsTagUpdateSpecificTagRequest();
            contactsTagUpdateSpecificTagRequest.contactsTag(this.contactsTag);
            return contactsTagUpdateSpecificTagRequest;
        }

        /**
         * Execute updateSpecificTag request
         * @return ContactsTagAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ContactsTagAttributes execute() throws ApiException {
            ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest = buildBodyParams();
            ApiResponse<ContactsTagAttributes> localVarResp = updateSpecificTagWithHttpInfo(id, contactsTagUpdateSpecificTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSpecificTag request with HTTP info returned
         * @return ApiResponse&lt;ContactsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ContactsTagAttributes> executeWithHttpInfo() throws ApiException {
            ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest = buildBodyParams();
            return updateSpecificTagWithHttpInfo(id, contactsTagUpdateSpecificTagRequest);
        }

        /**
         * Execute updateSpecificTag request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ContactsTagAttributes> _callback) throws ApiException {
            ContactsTagUpdateSpecificTagRequest contactsTagUpdateSpecificTagRequest = buildBodyParams();
            return updateSpecificTagAsync(id, contactsTagUpdateSpecificTagRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param contactsTagUpdateSpecificTagRequest Information about updated fields in Tag (required)
     * @return UpdateSpecificTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSpecificTagRequestBuilder updateSpecificTag(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSpecificTagRequestBuilder(id);
    }
}
