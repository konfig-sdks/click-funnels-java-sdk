...
import com.konfigthis.client.model.ShippingRatesNameAttributes;
import com.konfigthis.client.model.ShippingRatesNameCreateNewRateNameRequest;
import com.konfigthis.client.model.ShippingRatesNameUpdateNameRequest;
...
public class ShippingRatesNameApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ShippingRatesNameApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ShippingRatesNameApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewRateNameCall(Integer workspaceId, ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = shippingRatesNameCreateNewRateNameRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/shipping/rates/names"
    ...
    private okhttp3.Call createNewRateNameValidateBeforeCall(Integer workspaceId, ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewRateName(Async)");
        }

        // verify the required parameter 'shippingRatesNameCreateNewRateNameRequest' is set
        if (shippingRatesNameCreateNewRateNameRequest == null) {
            throw new ApiException("Missing the required parameter 'shippingRatesNameCreateNewRateNameRequest' when calling createNewRateName(Async)");
        }

        return createNewRateNameCall(workspaceId, shippingRatesNameCreateNewRateNameRequest, _callback);

    }


    private ApiResponse<ShippingRatesNameAttributes> createNewRateNameWithHttpInfo(Integer workspaceId, ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewRateNameValidateBeforeCall(workspaceId, shippingRatesNameCreateNewRateNameRequest, null);
        Type localVarReturnType = new TypeToken<ShippingRatesNameAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewRateNameAsync(Integer workspaceId, ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest, final ApiCallback<ShippingRatesNameAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewRateNameValidateBeforeCall(workspaceId, shippingRatesNameCreateNewRateNameRequest, _callback);
        Type localVarReturnType = new TypeToken<ShippingRatesNameAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewRateNameRequestBuilder {
        private final Integer workspaceId;
        private ShippingRatesNameParameters shippingRatesName;

        private CreateNewRateNameRequestBuilder(Integer workspaceId) {
            this.workspaceId = workspaceId;
        }

        /**
         * Set shippingRatesName
         * @param shippingRatesName  (optional)
         * @return CreateNewRateNameRequestBuilder
         */
        public CreateNewRateNameRequestBuilder shippingRatesName(ShippingRatesNameParameters shippingRatesName) {
            this.shippingRatesName = shippingRatesName;
            return this;
        }
        
        /**
         * Build call for createNewRateName
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest = buildBodyParams();
            return createNewRateNameCall(workspaceId, shippingRatesNameCreateNewRateNameRequest, _callback);
        }

        private ShippingRatesNameCreateNewRateNameRequest buildBodyParams() {
            ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest = new ShippingRatesNameCreateNewRateNameRequest();
            shippingRatesNameCreateNewRateNameRequest.shippingRatesName(this.shippingRatesName);
            return shippingRatesNameCreateNewRateNameRequest;
        }

        /**
         * Execute createNewRateName request
         * @return ShippingRatesNameAttributes
         ...
         */
        public ShippingRatesNameAttributes execute() throws ApiException {
            ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest = buildBodyParams();
            ApiResponse<ShippingRatesNameAttributes> localVarResp = createNewRateNameWithHttpInfo(workspaceId, shippingRatesNameCreateNewRateNameRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewRateName request with HTTP info returned
         * @return ApiResponse&lt;ShippingRatesNameAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ShippingRatesNameAttributes> executeWithHttpInfo() throws ApiException {
            ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest = buildBodyParams();
            return createNewRateNameWithHttpInfo(workspaceId, shippingRatesNameCreateNewRateNameRequest);
        }

        /**
         * Execute createNewRateName request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ShippingRatesNameAttributes> _callback) throws ApiException {
            ShippingRatesNameCreateNewRateNameRequest shippingRatesNameCreateNewRateNameRequest = buildBodyParams();
            return createNewRateNameAsync(workspaceId, shippingRatesNameCreateNewRateNameRequest, _callback);
        }
    }
     ...
     * @param shippingRatesNameCreateNewRateNameRequest Information about a new Name (required)
     * @return CreateNewRateNameRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewRateNameRequestBuilder createNewRateName(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new CreateNewRateNameRequestBuilder(workspaceId);
    }
    private okhttp3.Call getRateNameCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/shipping/rates/names/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRateNameValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getRateName(Async)");
        }

        return getRateNameCall(id, _callback);

    }


    private ApiResponse<ShippingRatesNameAttributes> getRateNameWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getRateNameValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ShippingRatesNameAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getRateNameAsync(String id, final ApiCallback<ShippingRatesNameAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRateNameValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ShippingRatesNameAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetRateNameRequestBuilder {
        private final String id;

        private GetRateNameRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getRateName
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public ShippingRatesNameAttributes execute() throws ApiException {
            ApiResponse<ShippingRatesNameAttributes> localVarResp = getRateNameWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getRateName request with HTTP info returned
         * @return ApiResponse&lt;ShippingRatesNameAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ShippingRatesNameAttributes> executeWithHttpInfo() throws ApiException {
            return getRateNameWithHttpInfo(id);
        }

        /**
         * Execute getRateName request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ShippingRatesNameAttributes> _callback) throws ApiException {
            return getRateNameAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetRateNameRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetRateNameRequestBuilder getRateName(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetRateNameRequestBuilder(id);
    }
    ...
    private ApiResponse<List<ShippingRatesNameAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ShippingRatesNameAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<ShippingRatesNameAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @return List&lt;ShippingRatesNameAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ShippingRatesNameAttributes> execute() throws ApiException {
            ApiResponse<List<ShippingRatesNameAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ShippingRatesNameAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ShippingRatesNameAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ShippingRatesNameAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateNameCall(String id, ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = shippingRatesNameUpdateNameRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateNameValidateBeforeCall(String id, ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateName(Async)");
        }

        // verify the required parameter 'shippingRatesNameUpdateNameRequest' is set
        if (shippingRatesNameUpdateNameRequest == null) {
            throw new ApiException("Missing the required parameter 'shippingRatesNameUpdateNameRequest' when calling updateName(Async)");
        }

        return updateNameCall(id, shippingRatesNameUpdateNameRequest, _callback);

    }


    private ApiResponse<ShippingRatesNameAttributes> updateNameWithHttpInfo(String id, ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest) throws ApiException {
        okhttp3.Call localVarCall = updateNameValidateBeforeCall(id, shippingRatesNameUpdateNameRequest, null);
        Type localVarReturnType = new TypeToken<ShippingRatesNameAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateNameAsync(String id, ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest, final ApiCallback<ShippingRatesNameAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateNameValidateBeforeCall(id, shippingRatesNameUpdateNameRequest, _callback);
        Type localVarReturnType = new TypeToken<ShippingRatesNameAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateNameRequestBuilder {
        ...
        private UpdateNameRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public UpdateNameRequestBuilder shippingRatesName(ShippingRatesNameParameters shippingRatesName) {
            this.shippingRatesName = shippingRatesName;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest = buildBodyParams();
            return updateNameCall(id, shippingRatesNameUpdateNameRequest, _callback);
        }

        private ShippingRatesNameUpdateNameRequest buildBodyParams() {
            ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest = new ShippingRatesNameUpdateNameRequest();
            shippingRatesNameUpdateNameRequest.shippingRatesName(this.shippingRatesName);
            return shippingRatesNameUpdateNameRequest;
        }
        ...
        public ShippingRatesNameAttributes execute() throws ApiException {
            ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest = buildBodyParams();
            ApiResponse<ShippingRatesNameAttributes> localVarResp = updateNameWithHttpInfo(id, shippingRatesNameUpdateNameRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<ShippingRatesNameAttributes> executeWithHttpInfo() throws ApiException {
            ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest = buildBodyParams();
            return updateNameWithHttpInfo(id, shippingRatesNameUpdateNameRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ShippingRatesNameAttributes> _callback) throws ApiException {
            ShippingRatesNameUpdateNameRequest shippingRatesNameUpdateNameRequest = buildBodyParams();
            return updateNameAsync(id, shippingRatesNameUpdateNameRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param shippingRatesNameUpdateNameRequest Information about updated fields in Name (required)
     * @return UpdateNameRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateNameRequestBuilder updateName(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateNameRequestBuilder(id);
    }
}
