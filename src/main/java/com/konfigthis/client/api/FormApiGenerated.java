...
import com.konfigthis.client.model.FormAttributes;
import com.konfigthis.client.model.FormCreateNewFormRequest;
import com.konfigthis.client.model.FormUpdateFormByIdRequest;
...
public class FormApiGenerated {
    ...
    private okhttp3.Call createNewFormCall(Integer workspaceId, FormCreateNewFormRequest formCreateNewFormRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = formCreateNewFormRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/forms"
    ...
    private okhttp3.Call createNewFormValidateBeforeCall(Integer workspaceId, FormCreateNewFormRequest formCreateNewFormRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewForm(Async)");
        }

        // verify the required parameter 'formCreateNewFormRequest' is set
        if (formCreateNewFormRequest == null) {
            throw new ApiException("Missing the required parameter 'formCreateNewFormRequest' when calling createNewForm(Async)");
        }

        return createNewFormCall(workspaceId, formCreateNewFormRequest, _callback);

    }


    private ApiResponse<FormAttributes> createNewFormWithHttpInfo(Integer workspaceId, FormCreateNewFormRequest formCreateNewFormRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewFormValidateBeforeCall(workspaceId, formCreateNewFormRequest, null);
        Type localVarReturnType = new TypeToken<FormAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewFormAsync(Integer workspaceId, FormCreateNewFormRequest formCreateNewFormRequest, final ApiCallback<FormAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewFormValidateBeforeCall(workspaceId, formCreateNewFormRequest, _callback);
        Type localVarReturnType = new TypeToken<FormAttributes>(){}.getType();
    ...
    public class CreateNewFormRequestBuilder {
        ...
        private CreateNewFormRequestBuilder(Integer workspaceId) {
         ...
         */
        public CreateNewFormRequestBuilder form(FormParameters form) {
            this.form = form;
            return this;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FormCreateNewFormRequest formCreateNewFormRequest = buildBodyParams();
            return createNewFormCall(workspaceId, formCreateNewFormRequest, _callback);
        }

        private FormCreateNewFormRequest buildBodyParams() {
            FormCreateNewFormRequest formCreateNewFormRequest = new FormCreateNewFormRequest();
            formCreateNewFormRequest.form(this.form);
            return formCreateNewFormRequest;
        }
         ...
         */
        public FormAttributes execute() throws ApiException {
            FormCreateNewFormRequest formCreateNewFormRequest = buildBodyParams();
            ApiResponse<FormAttributes> localVarResp = createNewFormWithHttpInfo(workspaceId, formCreateNewFormRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewForm request with HTTP info returned
         * @return ApiResponse&lt;FormAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<FormAttributes> executeWithHttpInfo() throws ApiException {
            FormCreateNewFormRequest formCreateNewFormRequest = buildBodyParams();
            return createNewFormWithHttpInfo(workspaceId, formCreateNewFormRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FormAttributes> _callback) throws ApiException {
            FormCreateNewFormRequest formCreateNewFormRequest = buildBodyParams();
            return createNewFormAsync(workspaceId, formCreateNewFormRequest, _callback);
        }
    }
     ...
     * @param formCreateNewFormRequest Information about a new Form (required)
     * @return CreateNewFormRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewFormRequestBuilder createNewForm(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new CreateNewFormRequestBuilder(workspaceId);
    }
    private okhttp3.Call getFormCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call getFormValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        return getFormCall(id, _callback);

    }


    private ApiResponse<FormAttributes> getFormWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getFormValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<FormAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getFormAsync(String id, final ApiCallback<FormAttributes> _callback) throws ApiException {
    ...
    public class GetFormRequestBuilder {
        ...
        private GetFormRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public FormAttributes execute() throws ApiException {
            ApiResponse<FormAttributes> localVarResp = getFormWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getForm request with HTTP info returned
         * @return ApiResponse&lt;FormAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<FormAttributes> executeWithHttpInfo() throws ApiException {
            return getFormWithHttpInfo(id);
        }

        /**
         * Execute getForm request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<FormAttributes> _callback) throws ApiException {
            return getFormAsync(id, _callback);
        }
    }
     ...
     */
    public GetFormRequestBuilder getForm(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetFormRequestBuilder(id);
    }
    private okhttp3.Call listWorkspaceFormsCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listWorkspaceFormsValidateBeforeCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling listWorkspaceForms(Async)");
        }

        return listWorkspaceFormsCall(workspaceId, after, sortOrder, _callback);

    }


    private ApiResponse<List<FormAttributes>> listWorkspaceFormsWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listWorkspaceFormsValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<FormAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listWorkspaceFormsAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<FormAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listWorkspaceFormsValidateBeforeCall(workspaceId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<FormAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListWorkspaceFormsRequestBuilder {
        private final Integer workspaceId;
        private String after;
        private String sortOrder;

        private ListWorkspaceFormsRequestBuilder(Integer workspaceId) {
            this.workspaceId = workspaceId;
        }
         ...
         * @return ListWorkspaceFormsRequestBuilder
         */
        public ListWorkspaceFormsRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListWorkspaceFormsRequestBuilder
         */
        public ListWorkspaceFormsRequestBuilder sortOrder(String sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }
        
        /**
         * Build call for listWorkspaceForms
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listWorkspaceForms request
         * @return List&lt;FormAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<FormAttributes> execute() throws ApiException {
            ApiResponse<List<FormAttributes>> localVarResp = listWorkspaceFormsWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listWorkspaceForms request with HTTP info returned
         * @return ApiResponse&lt;List&lt;FormAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<FormAttributes>> executeWithHttpInfo() throws ApiException {
            return listWorkspaceFormsWithHttpInfo(workspaceId, after, sortOrder);
        }

        /**
         * Execute listWorkspaceForms request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<FormAttributes>> _callback) throws ApiException {
            return listWorkspaceFormsAsync(workspaceId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListWorkspaceFormsRequestBuilder listWorkspaceForms(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new ListWorkspaceFormsRequestBuilder(workspaceId);
    }
    ...
    private okhttp3.Call updateFormByIdCall(String id, FormUpdateFormByIdRequest formUpdateFormByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = formUpdateFormByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateFormByIdValidateBeforeCall(String id, FormUpdateFormByIdRequest formUpdateFormByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateFormById(Async)");
        }

        // verify the required parameter 'formUpdateFormByIdRequest' is set
        if (formUpdateFormByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'formUpdateFormByIdRequest' when calling updateFormById(Async)");
        }

        return updateFormByIdCall(id, formUpdateFormByIdRequest, _callback);

    }


    private ApiResponse<FormAttributes> updateFormByIdWithHttpInfo(String id, FormUpdateFormByIdRequest formUpdateFormByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateFormByIdValidateBeforeCall(id, formUpdateFormByIdRequest, null);
        Type localVarReturnType = new TypeToken<FormAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateFormByIdAsync(String id, FormUpdateFormByIdRequest formUpdateFormByIdRequest, final ApiCallback<FormAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateFormByIdValidateBeforeCall(id, formUpdateFormByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<FormAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateFormByIdRequestBuilder {
        private final String id;
        private FormParameters form;

        private UpdateFormByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set form
         * @param form  (optional)
         * @return UpdateFormByIdRequestBuilder
         */
        public UpdateFormByIdRequestBuilder form(FormParameters form) {
            this.form = form;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            FormUpdateFormByIdRequest formUpdateFormByIdRequest = buildBodyParams();
            return updateFormByIdCall(id, formUpdateFormByIdRequest, _callback);
        }

        private FormUpdateFormByIdRequest buildBodyParams() {
            FormUpdateFormByIdRequest formUpdateFormByIdRequest = new FormUpdateFormByIdRequest();
            formUpdateFormByIdRequest.form(this.form);
            return formUpdateFormByIdRequest;
        }

        /**
         * Execute updateFormById request
         * @return FormAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public FormAttributes execute() throws ApiException {
            FormUpdateFormByIdRequest formUpdateFormByIdRequest = buildBodyParams();
            ApiResponse<FormAttributes> localVarResp = updateFormByIdWithHttpInfo(id, formUpdateFormByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateFormById request with HTTP info returned
         * @return ApiResponse&lt;FormAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<FormAttributes> executeWithHttpInfo() throws ApiException {
            FormUpdateFormByIdRequest formUpdateFormByIdRequest = buildBodyParams();
            return updateFormByIdWithHttpInfo(id, formUpdateFormByIdRequest);
        }

        /**
         * Execute updateFormById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<FormAttributes> _callback) throws ApiException {
            FormUpdateFormByIdRequest formUpdateFormByIdRequest = buildBodyParams();
            return updateFormByIdAsync(id, formUpdateFormByIdRequest, _callback);
        }
    }
     ...
     * Update a form
     * @param id  (required)
     * @param formUpdateFormByIdRequest Information about updated fields in Form (required)
     * @return UpdateFormByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateFormByIdRequestBuilder updateFormById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateFormByIdRequestBuilder(id);
    }
}
