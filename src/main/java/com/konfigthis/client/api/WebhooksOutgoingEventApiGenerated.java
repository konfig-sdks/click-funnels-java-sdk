...
import com.konfigthis.client.model.WebhooksOutgoingEventAttributes;
...
public class WebhooksOutgoingEventApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WebhooksOutgoingEventApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public WebhooksOutgoingEventApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getForWorkspaceCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/webhooks/outgoing/events/{id}"
    ...
    private ApiResponse<WebhooksOutgoingEventAttributes> getForWorkspaceWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getForWorkspaceValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<WebhooksOutgoingEventAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getForWorkspaceAsync(String id, final ApiCallback<WebhooksOutgoingEventAttributes> _callback) throws ApiException {
    ...
    public class GetForWorkspaceRequestBuilder {
         ...
         * @return WebhooksOutgoingEventAttributes
         ...
         */
        public WebhooksOutgoingEventAttributes execute() throws ApiException {
            ApiResponse<WebhooksOutgoingEventAttributes> localVarResp = getForWorkspaceWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getForWorkspace request with HTTP info returned
         * @return ApiResponse&lt;WebhooksOutgoingEventAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<WebhooksOutgoingEventAttributes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WebhooksOutgoingEventAttributes> _callback) throws ApiException {
    ...
    private okhttp3.Call listForWorkspaceCall(Integer workspaceId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/webhooks/outgoing/events"
    ...
    private ApiResponse<List<WebhooksOutgoingEventAttributes>> listForWorkspaceWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listForWorkspaceValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<WebhooksOutgoingEventAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listForWorkspaceAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<WebhooksOutgoingEventAttributes>> _callback) throws ApiException {
    ...
    public class ListForWorkspaceRequestBuilder {
         ...
         * @return List&lt;WebhooksOutgoingEventAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<WebhooksOutgoingEventAttributes> execute() throws ApiException {
            ApiResponse<List<WebhooksOutgoingEventAttributes>> localVarResp = listForWorkspaceWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listForWorkspace request with HTTP info returned
         * @return ApiResponse&lt;List&lt;WebhooksOutgoingEventAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<WebhooksOutgoingEventAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<WebhooksOutgoingEventAttributes>> _callback) throws ApiException {
