...
import com.konfigthis.client.model.ShippingLocationGroupAttributes;
...
public class ShippingLocationGroupApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ShippingLocationGroupApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ShippingLocationGroupApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getProfileLocationGroupCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/shipping/location_groups/{id}"
    ...
    private okhttp3.Call getProfileLocationGroupValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getProfileLocationGroup(Async)");
        }

        return getProfileLocationGroupCall(id, _callback);

    }


    private ApiResponse<ShippingLocationGroupAttributes> getProfileLocationGroupWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getProfileLocationGroupValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ShippingLocationGroupAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getProfileLocationGroupAsync(String id, final ApiCallback<ShippingLocationGroupAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProfileLocationGroupValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ShippingLocationGroupAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetProfileLocationGroupRequestBuilder {
        private final String id;

        private GetProfileLocationGroupRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for getProfileLocationGroup
        ...
        /**
         * Execute getProfileLocationGroup request
         * @return ShippingLocationGroupAttributes
         ...
         */
        public ShippingLocationGroupAttributes execute() throws ApiException {
            ApiResponse<ShippingLocationGroupAttributes> localVarResp = getProfileLocationGroupWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getProfileLocationGroup request with HTTP info returned
         * @return ApiResponse&lt;ShippingLocationGroupAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ShippingLocationGroupAttributes> executeWithHttpInfo() throws ApiException {
            return getProfileLocationGroupWithHttpInfo(id);
        }

        /**
         * Execute getProfileLocationGroup request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ShippingLocationGroupAttributes> _callback) throws ApiException {
            return getProfileLocationGroupAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetProfileLocationGroupRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetProfileLocationGroupRequestBuilder getProfileLocationGroup(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetProfileLocationGroupRequestBuilder(id);
    }
    private okhttp3.Call listCall(Integer profileId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/shipping/profiles/{profile_id}/location_groups"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer profileId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'profileId' is set
        if (profileId == null) {
            throw new ApiException("Missing the required parameter 'profileId' when calling list(Async)");
        }

        return listCall(profileId, after, sortOrder, _callback);

    }


    private ApiResponse<List<ShippingLocationGroupAttributes>> listWithHttpInfo(Integer profileId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(profileId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ShippingLocationGroupAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer profileId, String after, String sortOrder, final ApiCallback<List<ShippingLocationGroupAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(profileId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<ShippingLocationGroupAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(Integer profileId) {
         ...
         * @return List&lt;ShippingLocationGroupAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ShippingLocationGroupAttributes> execute() throws ApiException {
            ApiResponse<List<ShippingLocationGroupAttributes>> localVarResp = listWithHttpInfo(profileId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ShippingLocationGroupAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ShippingLocationGroupAttributes>> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(profileId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ShippingLocationGroupAttributes>> _callback) throws ApiException {
            return listAsync(profileId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(Integer profileId) throws IllegalArgumentException {
        if (profileId == null) throw new IllegalArgumentException("\"profileId\" is required but got null");
        return new ListRequestBuilder(profileId);
    }
}
