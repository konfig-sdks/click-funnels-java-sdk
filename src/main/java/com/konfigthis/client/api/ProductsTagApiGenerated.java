...
import com.konfigthis.client.model.ProductsTagAttributes;
import com.konfigthis.client.model.ProductsTagCreateNewTagRequest;
import com.konfigthis.client.model.ProductsTagUpdateTagByIdRequest;
...
public class ProductsTagApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProductsTagApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ProductsTagApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createNewTagCall(Integer workspaceId, ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = productsTagCreateNewTagRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/products/tags"
    ...
    private okhttp3.Call createNewTagValidateBeforeCall(Integer workspaceId, ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewTag(Async)");
        }

        // verify the required parameter 'productsTagCreateNewTagRequest' is set
        if (productsTagCreateNewTagRequest == null) {
            throw new ApiException("Missing the required parameter 'productsTagCreateNewTagRequest' when calling createNewTag(Async)");
        }

        return createNewTagCall(workspaceId, productsTagCreateNewTagRequest, _callback);

    }


    private ApiResponse<ProductsTagAttributes> createNewTagWithHttpInfo(Integer workspaceId, ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewTagValidateBeforeCall(workspaceId, productsTagCreateNewTagRequest, null);
        Type localVarReturnType = new TypeToken<ProductsTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewTagAsync(Integer workspaceId, ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest, final ApiCallback<ProductsTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewTagValidateBeforeCall(workspaceId, productsTagCreateNewTagRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductsTagAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewTagRequestBuilder {
        private final Integer workspaceId;
        private ProductsTagParameters productsTag;

        private CreateNewTagRequestBuilder(Integer workspaceId) {
            this.workspaceId = workspaceId;
        }

        /**
         * Set productsTag
         * @param productsTag  (optional)
         * @return CreateNewTagRequestBuilder
         */
        public CreateNewTagRequestBuilder productsTag(ProductsTagParameters productsTag) {
            this.productsTag = productsTag;
            return this;
        }
        
        /**
         * Build call for createNewTag
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest = buildBodyParams();
            return createNewTagCall(workspaceId, productsTagCreateNewTagRequest, _callback);
        }

        private ProductsTagCreateNewTagRequest buildBodyParams() {
            ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest = new ProductsTagCreateNewTagRequest();
            productsTagCreateNewTagRequest.productsTag(this.productsTag);
            return productsTagCreateNewTagRequest;
        }

        /**
         * Execute createNewTag request
         * @return ProductsTagAttributes
         ...
         */
        public ProductsTagAttributes execute() throws ApiException {
            ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest = buildBodyParams();
            ApiResponse<ProductsTagAttributes> localVarResp = createNewTagWithHttpInfo(workspaceId, productsTagCreateNewTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewTag request with HTTP info returned
         * @return ApiResponse&lt;ProductsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ProductsTagAttributes> executeWithHttpInfo() throws ApiException {
            ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest = buildBodyParams();
            return createNewTagWithHttpInfo(workspaceId, productsTagCreateNewTagRequest);
        }

        /**
         * Execute createNewTag request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductsTagAttributes> _callback) throws ApiException {
            ProductsTagCreateNewTagRequest productsTagCreateNewTagRequest = buildBodyParams();
            return createNewTagAsync(workspaceId, productsTagCreateNewTagRequest, _callback);
        }
    }
     ...
     * @param productsTagCreateNewTagRequest Information about a new Tag (required)
     * @return CreateNewTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewTagRequestBuilder createNewTag(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new CreateNewTagRequestBuilder(workspaceId);
    }
    private okhttp3.Call deleteTagByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTagByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<Void> deleteTagByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = deleteTagByIdValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteTagByIdAsync(String id, final ApiCallback<Void> _callback) throws ApiException {
    ...
    public class DeleteTagByIdRequestBuilder {
        private final String id;

        private DeleteTagByIdRequestBuilder(String id) {
            this.id = id;
        }
        ...
        /**
         * Execute deleteTagById request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteTagByIdWithHttpInfo(id);
        }

        /**
         * Execute deleteTagById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteTagByIdAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return DeleteTagByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> No Content </td><td>  -  </td></tr>
     ...
     */
    public DeleteTagByIdRequestBuilder deleteTagById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new DeleteTagByIdRequestBuilder(id);
    }
    private okhttp3.Call getTagByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTagByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<ProductsTagAttributes> getTagByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getTagByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ProductsTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTagByIdAsync(String id, final ApiCallback<ProductsTagAttributes> _callback) throws ApiException {
    ...
    public class GetTagByIdRequestBuilder {
        private final String id;

        private GetTagByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public ProductsTagAttributes execute() throws ApiException {
            ApiResponse<ProductsTagAttributes> localVarResp = getTagByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getTagById request with HTTP info returned
         * @return ApiResponse&lt;ProductsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ProductsTagAttributes> executeWithHttpInfo() throws ApiException {
            return getTagByIdWithHttpInfo(id);
        }

        /**
         * Execute getTagById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProductsTagAttributes> _callback) throws ApiException {
            return getTagByIdAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return GetTagByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public GetTagByIdRequestBuilder getTagById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetTagByIdRequestBuilder(id);
    }
    ...
    private ApiResponse<List<ProductsTagAttributes>> listWithHttpInfo(Integer workspaceId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(workspaceId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<ProductsTagAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer workspaceId, String after, String sortOrder, final ApiCallback<List<ProductsTagAttributes>> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @return List&lt;ProductsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<ProductsTagAttributes> execute() throws ApiException {
            ApiResponse<List<ProductsTagAttributes>> localVarResp = listWithHttpInfo(workspaceId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ProductsTagAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ProductsTagAttributes>> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ProductsTagAttributes>> _callback) throws ApiException {
    ...
    private okhttp3.Call updateTagByIdCall(String id, ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = productsTagUpdateTagByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTagByIdValidateBeforeCall(String id, ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateTagById(Async)");
        }

        // verify the required parameter 'productsTagUpdateTagByIdRequest' is set
        if (productsTagUpdateTagByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'productsTagUpdateTagByIdRequest' when calling updateTagById(Async)");
        }

        return updateTagByIdCall(id, productsTagUpdateTagByIdRequest, _callback);

    }


    private ApiResponse<ProductsTagAttributes> updateTagByIdWithHttpInfo(String id, ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateTagByIdValidateBeforeCall(id, productsTagUpdateTagByIdRequest, null);
        Type localVarReturnType = new TypeToken<ProductsTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateTagByIdAsync(String id, ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest, final ApiCallback<ProductsTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateTagByIdValidateBeforeCall(id, productsTagUpdateTagByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<ProductsTagAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateTagByIdRequestBuilder {
        private final String id;
        private ProductsTagParameters productsTag;

        private UpdateTagByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set productsTag
         * @param productsTag  (optional)
         * @return UpdateTagByIdRequestBuilder
         */
        public UpdateTagByIdRequestBuilder productsTag(ProductsTagParameters productsTag) {
            this.productsTag = productsTag;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest = buildBodyParams();
            return updateTagByIdCall(id, productsTagUpdateTagByIdRequest, _callback);
        }

        private ProductsTagUpdateTagByIdRequest buildBodyParams() {
            ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest = new ProductsTagUpdateTagByIdRequest();
            productsTagUpdateTagByIdRequest.productsTag(this.productsTag);
            return productsTagUpdateTagByIdRequest;
        }

        /**
         * Execute updateTagById request
         * @return ProductsTagAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ProductsTagAttributes execute() throws ApiException {
            ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest = buildBodyParams();
            ApiResponse<ProductsTagAttributes> localVarResp = updateTagByIdWithHttpInfo(id, productsTagUpdateTagByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateTagById request with HTTP info returned
         * @return ApiResponse&lt;ProductsTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ProductsTagAttributes> executeWithHttpInfo() throws ApiException {
            ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest = buildBodyParams();
            return updateTagByIdWithHttpInfo(id, productsTagUpdateTagByIdRequest);
        }

        /**
         * Execute updateTagById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ProductsTagAttributes> _callback) throws ApiException {
            ProductsTagUpdateTagByIdRequest productsTagUpdateTagByIdRequest = buildBodyParams();
            return updateTagByIdAsync(id, productsTagUpdateTagByIdRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param productsTagUpdateTagByIdRequest Information about updated fields in Tag (required)
     * @return UpdateTagByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateTagByIdRequestBuilder updateTagById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateTagByIdRequestBuilder(id);
    }
}
