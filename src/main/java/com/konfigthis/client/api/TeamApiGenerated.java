...
import com.konfigthis.client.model.TeamAttributes;
...
public class TeamApiGenerated {
    ...
    private okhttp3.Call getAllCall(String after, String sortOrder, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllValidateBeforeCall(String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        return getAllCall(after, sortOrder, _callback);

    }


    private ApiResponse<List<TeamAttributes>> getAllWithHttpInfo(String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = getAllValidateBeforeCall(after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<TeamAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAllAsync(String after, String sortOrder, final ApiCallback<List<TeamAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllValidateBeforeCall(after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<TeamAttributes>>(){}.getType();
    ...
    public class GetAllRequestBuilder {
         ...
         * @return GetAllRequestBuilder
         */
        public GetAllRequestBuilder sortOrder(String sortOrder) {
         ...
         */
        public List<TeamAttributes> execute() throws ApiException {
            ApiResponse<List<TeamAttributes>> localVarResp = getAllWithHttpInfo(after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getAll request with HTTP info returned
         * @return ApiResponse&lt;List&lt;TeamAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<TeamAttributes>> executeWithHttpInfo() throws ApiException {
            return getAllWithHttpInfo(after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<TeamAttributes>> _callback) throws ApiException {
            return getAllAsync(after, sortOrder, _callback);
        }
    }
    ...
    private ApiResponse<TeamAttributes> getSingleWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<TeamAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(String id, final ApiCallback<TeamAttributes> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         */
        public TeamAttributes execute() throws ApiException {
            ApiResponse<TeamAttributes> localVarResp = getSingleWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSingle request with HTTP info returned
         * @return ApiResponse&lt;TeamAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TeamAttributes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TeamAttributes> _callback) throws ApiException {
    ...
    private okhttp3.Call updateTeamByIdValidateBeforeCall(String id, TeamUpdateTeamByIdRequest teamUpdateTeamByIdRequest, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'teamUpdateTeamByIdRequest' is set
        if (teamUpdateTeamByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'teamUpdateTeamByIdRequest' when calling updateTeamById(Async)");
        }
    ...
    private ApiResponse<TeamAttributes> updateTeamByIdWithHttpInfo(String id, TeamUpdateTeamByIdRequest teamUpdateTeamByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateTeamByIdValidateBeforeCall(id, teamUpdateTeamByIdRequest, null);
        Type localVarReturnType = new TypeToken<TeamAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateTeamByIdAsync(String id, TeamUpdateTeamByIdRequest teamUpdateTeamByIdRequest, final ApiCallback<TeamAttributes> _callback) throws ApiException {
    ...
    public class UpdateTeamByIdRequestBuilder {
         ...
         */
        public UpdateTeamByIdRequestBuilder team(TeamParameters team) {
            this.team = team;
            return this;
        }
        ...
        private TeamUpdateTeamByIdRequest buildBodyParams() {
            ...
            teamUpdateTeamByIdRequest.team(this.team);
        ...
        public TeamAttributes execute() throws ApiException {
            TeamUpdateTeamByIdRequest teamUpdateTeamByIdRequest = buildBodyParams();
            ApiResponse<TeamAttributes> localVarResp = updateTeamByIdWithHttpInfo(id, teamUpdateTeamByIdRequest);
            return localVarResp.getResponseBody();
        }
     ...
     * List all teams for the current account
     * @param id  (required)
     * @param teamUpdateTeamByIdRequest Information about updated fields in Team (required)
     * @return UpdateTeamByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
