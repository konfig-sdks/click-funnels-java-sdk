...
import com.konfigthis.client.model.CoursesLessonAttributes;
import com.konfigthis.client.model.CoursesLessonUpdateLessonByIdRequest;
...
public class CoursesLessonApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CoursesLessonApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public CoursesLessonApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getByIdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/courses/lessons/{id}"
    ...
    private ApiResponse<CoursesLessonAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<CoursesLessonAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<CoursesLessonAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         * @return CoursesLessonAttributes
         ...
         */
        public CoursesLessonAttributes execute() throws ApiException {
            ApiResponse<CoursesLessonAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getById request with HTTP info returned
         * @return ApiResponse&lt;CoursesLessonAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<CoursesLessonAttributes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<CoursesLessonAttributes> _callback) throws ApiException {
    ...
    private okhttp3.Call listLessonsCall(Integer sectionId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/courses/sections/{section_id}/lessons"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listLessonsValidateBeforeCall(Integer sectionId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sectionId' is set
        if (sectionId == null) {
            throw new ApiException("Missing the required parameter 'sectionId' when calling listLessons(Async)");
        }

        return listLessonsCall(sectionId, after, sortOrder, _callback);

    }


    private ApiResponse<List<CoursesLessonAttributes>> listLessonsWithHttpInfo(Integer sectionId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listLessonsValidateBeforeCall(sectionId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<CoursesLessonAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listLessonsAsync(Integer sectionId, String after, String sortOrder, final ApiCallback<List<CoursesLessonAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listLessonsValidateBeforeCall(sectionId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<CoursesLessonAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListLessonsRequestBuilder {
        private final Integer sectionId;
        private String after;
        private String sortOrder;

        private ListLessonsRequestBuilder(Integer sectionId) {
         ...
         * @return ListLessonsRequestBuilder
         */
        public ListLessonsRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListLessonsRequestBuilder
         */
        public ListLessonsRequestBuilder sortOrder(String sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }
        
        /**
         * Build call for listLessons
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listLessons request
         * @return List&lt;CoursesLessonAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<CoursesLessonAttributes> execute() throws ApiException {
            ApiResponse<List<CoursesLessonAttributes>> localVarResp = listLessonsWithHttpInfo(sectionId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listLessons request with HTTP info returned
         * @return ApiResponse&lt;List&lt;CoursesLessonAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<CoursesLessonAttributes>> executeWithHttpInfo() throws ApiException {
            return listLessonsWithHttpInfo(sectionId, after, sortOrder);
        }

        /**
         * Execute listLessons request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<CoursesLessonAttributes>> _callback) throws ApiException {
            return listLessonsAsync(sectionId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListLessonsRequestBuilder listLessons(Integer sectionId) throws IllegalArgumentException {
        if (sectionId == null) throw new IllegalArgumentException("\"sectionId\" is required but got null");
        return new ListLessonsRequestBuilder(sectionId);
    }
    private okhttp3.Call updateLessonByIdCall(String id, CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = coursesLessonUpdateLessonByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateLessonByIdValidateBeforeCall(String id, CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateLessonById(Async)");
        }

        // verify the required parameter 'coursesLessonUpdateLessonByIdRequest' is set
        if (coursesLessonUpdateLessonByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'coursesLessonUpdateLessonByIdRequest' when calling updateLessonById(Async)");
        }

        return updateLessonByIdCall(id, coursesLessonUpdateLessonByIdRequest, _callback);

    }


    private ApiResponse<CoursesLessonAttributes> updateLessonByIdWithHttpInfo(String id, CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateLessonByIdValidateBeforeCall(id, coursesLessonUpdateLessonByIdRequest, null);
        Type localVarReturnType = new TypeToken<CoursesLessonAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateLessonByIdAsync(String id, CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest, final ApiCallback<CoursesLessonAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateLessonByIdValidateBeforeCall(id, coursesLessonUpdateLessonByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<CoursesLessonAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateLessonByIdRequestBuilder {
        private final String id;
        private CoursesLessonParameters coursesLesson;

        private UpdateLessonByIdRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Set coursesLesson
         * @param coursesLesson  (optional)
         * @return UpdateLessonByIdRequestBuilder
         */
        public UpdateLessonByIdRequestBuilder coursesLesson(CoursesLessonParameters coursesLesson) {
            this.coursesLesson = coursesLesson;
            return this;
        }
        
        /**
         * Build call for updateLessonById
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest = buildBodyParams();
            return updateLessonByIdCall(id, coursesLessonUpdateLessonByIdRequest, _callback);
        }

        private CoursesLessonUpdateLessonByIdRequest buildBodyParams() {
            CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest = new CoursesLessonUpdateLessonByIdRequest();
            coursesLessonUpdateLessonByIdRequest.coursesLesson(this.coursesLesson);
            return coursesLessonUpdateLessonByIdRequest;
        }

        /**
         * Execute updateLessonById request
         * @return CoursesLessonAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public CoursesLessonAttributes execute() throws ApiException {
            CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest = buildBodyParams();
            ApiResponse<CoursesLessonAttributes> localVarResp = updateLessonByIdWithHttpInfo(id, coursesLessonUpdateLessonByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateLessonById request with HTTP info returned
         * @return ApiResponse&lt;CoursesLessonAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<CoursesLessonAttributes> executeWithHttpInfo() throws ApiException {
            CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest = buildBodyParams();
            return updateLessonByIdWithHttpInfo(id, coursesLessonUpdateLessonByIdRequest);
        }

        /**
         * Execute updateLessonById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<CoursesLessonAttributes> _callback) throws ApiException {
            CoursesLessonUpdateLessonByIdRequest coursesLessonUpdateLessonByIdRequest = buildBodyParams();
            return updateLessonByIdAsync(id, coursesLessonUpdateLessonByIdRequest, _callback);
        }
    }
     ...
     * Update Lesson
     * @param id  (required)
     * @param coursesLessonUpdateLessonByIdRequest Information about updated fields in Lesson (required)
     * @return UpdateLessonByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateLessonByIdRequestBuilder updateLessonById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateLessonByIdRequestBuilder(id);
    }
}
