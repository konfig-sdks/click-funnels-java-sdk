...
import com.konfigthis.client.model.OrderAttributes;
import com.konfigthis.client.model.OrderListOrdersFilterParameter;
import com.konfigthis.client.model.OrderUpdateSpecificRequest;
...
public class OrderApiGenerated {
    ...
    private ApiResponse<OrderAttributes> getSingleWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OrderAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(String id, final ApiCallback<OrderAttributes> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         */
        public OrderAttributes execute() throws ApiException {
            ApiResponse<OrderAttributes> localVarResp = getSingleWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSingle request with HTTP info returned
         * @return ApiResponse&lt;OrderAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrderAttributes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrderAttributes> _callback) throws ApiException {
    ...
    private okhttp3.Call listOrdersCall(Integer workspaceId, String after, String sortOrder, OrderListOrdersFilterParameter filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/orders"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listOrdersValidateBeforeCall(Integer workspaceId, String after, String sortOrder, OrderListOrdersFilterParameter filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling listOrders(Async)");
        }

        return listOrdersCall(workspaceId, after, sortOrder, filter, _callback);

    }


    private ApiResponse<List<OrderAttributes>> listOrdersWithHttpInfo(Integer workspaceId, String after, String sortOrder, OrderListOrdersFilterParameter filter) throws ApiException {
        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(workspaceId, after, sortOrder, filter, null);
        Type localVarReturnType = new TypeToken<List<OrderAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listOrdersAsync(Integer workspaceId, String after, String sortOrder, OrderListOrdersFilterParameter filter, final ApiCallback<List<OrderAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(workspaceId, after, sortOrder, filter, _callback);
        Type localVarReturnType = new TypeToken<List<OrderAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListOrdersRequestBuilder {
        ...
        private OrderListOrdersFilterParameter filter;

        private ListOrdersRequestBuilder(Integer workspaceId) {
         ...
         * @return ListOrdersRequestBuilder
         */
        public ListOrdersRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListOrdersRequestBuilder
         */
        public ListOrdersRequestBuilder sortOrder(String sortOrder) {
         ...
         * @return ListOrdersRequestBuilder
         */
        public ListOrdersRequestBuilder filter(OrderListOrdersFilterParameter filter) {
            this.filter = filter;
            return this;
        }
         ...
         */
        public List<OrderAttributes> execute() throws ApiException {
            ApiResponse<List<OrderAttributes>> localVarResp = listOrdersWithHttpInfo(workspaceId, after, sortOrder, filter);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listOrders request with HTTP info returned
         * @return ApiResponse&lt;List&lt;OrderAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<OrderAttributes>> executeWithHttpInfo() throws ApiException {
            return listOrdersWithHttpInfo(workspaceId, after, sortOrder, filter);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<OrderAttributes>> _callback) throws ApiException {
            return listOrdersAsync(workspaceId, after, sortOrder, filter, _callback);
        }
    }
     ...
     */
    public ListOrdersRequestBuilder listOrders(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new ListOrdersRequestBuilder(workspaceId);
    }
    private okhttp3.Call updateSpecificCall(String id, OrderUpdateSpecificRequest orderUpdateSpecificRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = orderUpdateSpecificRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSpecificValidateBeforeCall(String id, OrderUpdateSpecificRequest orderUpdateSpecificRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateSpecific(Async)");
        }

        // verify the required parameter 'orderUpdateSpecificRequest' is set
        if (orderUpdateSpecificRequest == null) {
            throw new ApiException("Missing the required parameter 'orderUpdateSpecificRequest' when calling updateSpecific(Async)");
        }

        return updateSpecificCall(id, orderUpdateSpecificRequest, _callback);

    }


    private ApiResponse<OrderAttributes> updateSpecificWithHttpInfo(String id, OrderUpdateSpecificRequest orderUpdateSpecificRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSpecificValidateBeforeCall(id, orderUpdateSpecificRequest, null);
        Type localVarReturnType = new TypeToken<OrderAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSpecificAsync(String id, OrderUpdateSpecificRequest orderUpdateSpecificRequest, final ApiCallback<OrderAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSpecificValidateBeforeCall(id, orderUpdateSpecificRequest, _callback);
        Type localVarReturnType = new TypeToken<OrderAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSpecificRequestBuilder {
        private final String id;
        private OrderParameters order;

        private UpdateSpecificRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * @return UpdateSpecificRequestBuilder
         */
        public UpdateSpecificRequestBuilder order(OrderParameters order) {
            this.order = order;
            return this;
        }
        
        /**
         * Build call for updateSpecific
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            OrderUpdateSpecificRequest orderUpdateSpecificRequest = buildBodyParams();
            return updateSpecificCall(id, orderUpdateSpecificRequest, _callback);
        }

        private OrderUpdateSpecificRequest buildBodyParams() {
            OrderUpdateSpecificRequest orderUpdateSpecificRequest = new OrderUpdateSpecificRequest();
            orderUpdateSpecificRequest.order(this.order);
            return orderUpdateSpecificRequest;
        }

        /**
         * Execute updateSpecific request
         * @return OrderAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public OrderAttributes execute() throws ApiException {
            OrderUpdateSpecificRequest orderUpdateSpecificRequest = buildBodyParams();
            ApiResponse<OrderAttributes> localVarResp = updateSpecificWithHttpInfo(id, orderUpdateSpecificRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSpecific request with HTTP info returned
         * @return ApiResponse&lt;OrderAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<OrderAttributes> executeWithHttpInfo() throws ApiException {
            OrderUpdateSpecificRequest orderUpdateSpecificRequest = buildBodyParams();
            return updateSpecificWithHttpInfo(id, orderUpdateSpecificRequest);
        }

        /**
         * Execute updateSpecific request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<OrderAttributes> _callback) throws ApiException {
            OrderUpdateSpecificRequest orderUpdateSpecificRequest = buildBodyParams();
            return updateSpecificAsync(id, orderUpdateSpecificRequest, _callback);
        }
    }
     ...
     * @param id  (required)
     * @param orderUpdateSpecificRequest Information about updated fields in Order (required)
     * @return UpdateSpecificRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateSpecificRequestBuilder updateSpecific(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateSpecificRequestBuilder(id);
    }
}
