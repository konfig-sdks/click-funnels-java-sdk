...
import com.konfigthis.client.model.OrdersTransactionAttributes;
...
public class OrdersTransactionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OrdersTransactionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OrdersTransactionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<OrdersTransactionAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OrdersTransactionAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<OrdersTransactionAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         * @return OrdersTransactionAttributes
         ...
         */
        public OrdersTransactionAttributes execute() throws ApiException {
            ApiResponse<OrdersTransactionAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getById request with HTTP info returned
         * @return ApiResponse&lt;OrdersTransactionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrdersTransactionAttributes> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrdersTransactionAttributes> _callback) throws ApiException {
    ...
    private okhttp3.Call getListCall(Integer orderId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/orders/{order_id}/transactions"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getListValidateBeforeCall(Integer orderId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException("Missing the required parameter 'orderId' when calling getList(Async)");
        }

        return getListCall(orderId, after, sortOrder, _callback);

    }


    private ApiResponse<List<OrdersTransactionAttributes>> getListWithHttpInfo(Integer orderId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = getListValidateBeforeCall(orderId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<OrdersTransactionAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getListAsync(Integer orderId, String after, String sortOrder, final ApiCallback<List<OrdersTransactionAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getListValidateBeforeCall(orderId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<OrdersTransactionAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetListRequestBuilder {
        ...
        private GetListRequestBuilder(Integer orderId) {
         ...
         * @return GetListRequestBuilder
         */
        public GetListRequestBuilder sortOrder(String sortOrder) {
         ...
         * @return List&lt;OrdersTransactionAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<OrdersTransactionAttributes> execute() throws ApiException {
            ApiResponse<List<OrdersTransactionAttributes>> localVarResp = getListWithHttpInfo(orderId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getList request with HTTP info returned
         * @return ApiResponse&lt;List&lt;OrdersTransactionAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<OrdersTransactionAttributes>> executeWithHttpInfo() throws ApiException {
            return getListWithHttpInfo(orderId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<OrdersTransactionAttributes>> _callback) throws ApiException {
            return getListAsync(orderId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public GetListRequestBuilder getList(Integer orderId) throws IllegalArgumentException {
        if (orderId == null) throw new IllegalArgumentException("\"orderId\" is required but got null");
        return new GetListRequestBuilder(orderId);
    }
}
