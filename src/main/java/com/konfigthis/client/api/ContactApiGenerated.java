...
import com.konfigthis.client.model.ContactCreateNewContactRequest;
import com.konfigthis.client.model.ContactListForWorkspaceFilterParameter;
import com.konfigthis.client.model.ContactUpdateContactByIdRequest;
import com.konfigthis.client.model.ContactUpsertRequest;
import com.konfigthis.client.model.ContactsProperty;
...
public class ContactApiGenerated {
    ...
    private okhttp3.Call createNewContactCall(Integer workspaceId, ContactCreateNewContactRequest contactCreateNewContactRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = contactCreateNewContactRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/contacts"
    ...
    private okhttp3.Call createNewContactValidateBeforeCall(Integer workspaceId, ContactCreateNewContactRequest contactCreateNewContactRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling createNewContact(Async)");
        }

        // verify the required parameter 'contactCreateNewContactRequest' is set
        if (contactCreateNewContactRequest == null) {
            throw new ApiException("Missing the required parameter 'contactCreateNewContactRequest' when calling createNewContact(Async)");
        }

        return createNewContactCall(workspaceId, contactCreateNewContactRequest, _callback);

    }


    private ApiResponse<ContactAttributes> createNewContactWithHttpInfo(Integer workspaceId, ContactCreateNewContactRequest contactCreateNewContactRequest) throws ApiException {
        okhttp3.Call localVarCall = createNewContactValidateBeforeCall(workspaceId, contactCreateNewContactRequest, null);
        Type localVarReturnType = new TypeToken<ContactAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewContactAsync(Integer workspaceId, ContactCreateNewContactRequest contactCreateNewContactRequest, final ApiCallback<ContactAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewContactValidateBeforeCall(workspaceId, contactCreateNewContactRequest, _callback);
        Type localVarReturnType = new TypeToken<ContactAttributes>(){}.getType();
    ...
    public class CreateNewContactRequestBuilder {
        ...
        private ContactParameters contact;

        private CreateNewContactRequestBuilder(Integer workspaceId) {
         ...
         */
        public CreateNewContactRequestBuilder contact(ContactParameters contact) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ContactCreateNewContactRequest contactCreateNewContactRequest = buildBodyParams();
            return createNewContactCall(workspaceId, contactCreateNewContactRequest, _callback);
        }

        private ContactCreateNewContactRequest buildBodyParams() {
            ContactCreateNewContactRequest contactCreateNewContactRequest = new ContactCreateNewContactRequest();
            contactCreateNewContactRequest.contact(this.contact);
            return contactCreateNewContactRequest;
        }
         ...
         */
        public ContactAttributes execute() throws ApiException {
            ContactCreateNewContactRequest contactCreateNewContactRequest = buildBodyParams();
            ApiResponse<ContactAttributes> localVarResp = createNewContactWithHttpInfo(workspaceId, contactCreateNewContactRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewContact request with HTTP info returned
         * @return ApiResponse&lt;ContactAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ContactAttributes> executeWithHttpInfo() throws ApiException {
            ContactCreateNewContactRequest contactCreateNewContactRequest = buildBodyParams();
            return createNewContactWithHttpInfo(workspaceId, contactCreateNewContactRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ContactAttributes> _callback) throws ApiException {
            ContactCreateNewContactRequest contactCreateNewContactRequest = buildBodyParams();
            return createNewContactAsync(workspaceId, contactCreateNewContactRequest, _callback);
        }
    }
     ...
     * @param contactCreateNewContactRequest Information about a new Contact (required)
     * @return CreateNewContactRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateNewContactRequestBuilder createNewContact(Integer workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
        return new CreateNewContactRequestBuilder(workspaceId);
    }
    private okhttp3.Call getContactByIdCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getContactByIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getContactById(Async)");
        }

        return getContactByIdCall(id, _callback);

    }


    private ApiResponse<ContactAttributes> getContactByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getContactByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ContactAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getContactByIdAsync(String id, final ApiCallback<ContactAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = getContactByIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ContactAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetContactByIdRequestBuilder {
        ...
        private GetContactByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         */
        public ContactAttributes execute() throws ApiException {
            ApiResponse<ContactAttributes> localVarResp = getContactByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<ContactAttributes> executeWithHttpInfo() throws ApiException {
            return getContactByIdWithHttpInfo(id);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ContactAttributes> _callback) throws ApiException {
            return getContactByIdAsync(id, _callback);
        }
    }
     ...
     */
    public GetContactByIdRequestBuilder getContactById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new GetContactByIdRequestBuilder(id);
    }
    private okhttp3.Call listForWorkspaceCall(Integer workspaceId, String after, String sortOrder, ContactListForWorkspaceFilterParameter filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listForWorkspaceValidateBeforeCall(Integer workspaceId, String after, String sortOrder, ContactListForWorkspaceFilterParameter filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling listForWorkspace(Async)");
        }

        return listForWorkspaceCall(workspaceId, after, sortOrder, filter, _callback);

    }


    private ApiResponse<List<ContactAttributes>> listForWorkspaceWithHttpInfo(Integer workspaceId, String after, String sortOrder, ContactListForWorkspaceFilterParameter filter) throws ApiException {
        okhttp3.Call localVarCall = listForWorkspaceValidateBeforeCall(workspaceId, after, sortOrder, filter, null);
        Type localVarReturnType = new TypeToken<List<ContactAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listForWorkspaceAsync(Integer workspaceId, String after, String sortOrder, ContactListForWorkspaceFilterParameter filter, final ApiCallback<List<ContactAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listForWorkspaceValidateBeforeCall(workspaceId, after, sortOrder, filter, _callback);
        Type localVarReturnType = new TypeToken<List<ContactAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListForWorkspaceRequestBuilder {
        ...
        private ContactListForWorkspaceFilterParameter filter;
        ...
        /**
         * Set filter
         * @param filter Filtering  - Keep in mind that depending on the tools that you use, you might run into different situations where additional encoding is needed. For example:     - You might need to encode &#x60;filter[id]&#x3D;1&#x60; as &#x60;filter%5Bid%5D&#x3D;1&#x60; or use special options in your tools of choice to do it for you (like &#x60;g&#x60; in CURL).     -  Special URL characters like &#x60;%&#x60;, &#x60;+&#x60;, or unicode characters in emails (like Chinese characters) will need additional encoding.   (optional)
         * @return ListForWorkspaceRequestBuilder
         */
        public ListForWorkspaceRequestBuilder filter(ContactListForWorkspaceFilterParameter filter) {
            this.filter = filter;
            return this;
        }
         ...
         */
        public List<ContactAttributes> execute() throws ApiException {
            ApiResponse<List<ContactAttributes>> localVarResp = listForWorkspaceWithHttpInfo(workspaceId, after, sortOrder, filter);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listForWorkspace request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ContactAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<ContactAttributes>> executeWithHttpInfo() throws ApiException {
            return listForWorkspaceWithHttpInfo(workspaceId, after, sortOrder, filter);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<ContactAttributes>> _callback) throws ApiException {
            return listForWorkspaceAsync(workspaceId, after, sortOrder, filter, _callback);
        }
    }
    ...
    private okhttp3.Call redactPersonallyIdentifiableCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/contacts/{id}/gdpr_destroy"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call redactPersonallyIdentifiableValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling redactPersonallyIdentifiable(Async)");
        }

        return redactPersonallyIdentifiableCall(id, _callback);

    }


    private ApiResponse<Void> redactPersonallyIdentifiableWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = redactPersonallyIdentifiableValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call redactPersonallyIdentifiableAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = redactPersonallyIdentifiableValidateBeforeCall(id, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class RedactPersonallyIdentifiableRequestBuilder {
        private final String id;

        private RedactPersonallyIdentifiableRequestBuilder(String id) {
            this.id = id;
        }

        /**
         * Build call for redactPersonallyIdentifiable
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute redactPersonallyIdentifiable request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public void execute() throws ApiException {
            redactPersonallyIdentifiableWithHttpInfo(id);
        }

        /**
         * Execute redactPersonallyIdentifiable request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return redactPersonallyIdentifiableWithHttpInfo(id);
        }

        /**
         * Execute redactPersonallyIdentifiable request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return redactPersonallyIdentifiableAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return RedactPersonallyIdentifiableRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public RedactPersonallyIdentifiableRequestBuilder redactPersonallyIdentifiable(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new RedactPersonallyIdentifiableRequestBuilder(id);
    }
    ...
    private okhttp3.Call updateContactByIdCall(String id, ContactUpdateContactByIdRequest contactUpdateContactByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = contactUpdateContactByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateContactByIdValidateBeforeCall(String id, ContactUpdateContactByIdRequest contactUpdateContactByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateContactById(Async)");
        }

        // verify the required parameter 'contactUpdateContactByIdRequest' is set
        if (contactUpdateContactByIdRequest == null) {
            throw new ApiException("Missing the required parameter 'contactUpdateContactByIdRequest' when calling updateContactById(Async)");
        }

        return updateContactByIdCall(id, contactUpdateContactByIdRequest, _callback);

    }


    private ApiResponse<ContactAttributes> updateContactByIdWithHttpInfo(String id, ContactUpdateContactByIdRequest contactUpdateContactByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateContactByIdValidateBeforeCall(id, contactUpdateContactByIdRequest, null);
        Type localVarReturnType = new TypeToken<ContactAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateContactByIdAsync(String id, ContactUpdateContactByIdRequest contactUpdateContactByIdRequest, final ApiCallback<ContactAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateContactByIdValidateBeforeCall(id, contactUpdateContactByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<ContactAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateContactByIdRequestBuilder {
        ...
        private UpdateContactByIdRequestBuilder(String id) {
            this.id = id;
        }
         ...
         * Set contact
         * @param contact  (optional)
         * @return UpdateContactByIdRequestBuilder
         */
        public UpdateContactByIdRequestBuilder contact(ContactParameters contact) {
            this.contact = contact;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ContactUpdateContactByIdRequest contactUpdateContactByIdRequest = buildBodyParams();
            return updateContactByIdCall(id, contactUpdateContactByIdRequest, _callback);
        }

        private ContactUpdateContactByIdRequest buildBodyParams() {
            ContactUpdateContactByIdRequest contactUpdateContactByIdRequest = new ContactUpdateContactByIdRequest();
            contactUpdateContactByIdRequest.contact(this.contact);
            return contactUpdateContactByIdRequest;
        }

        /**
         * Execute updateContactById request
         * @return ContactAttributes
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ContactAttributes execute() throws ApiException {
            ContactUpdateContactByIdRequest contactUpdateContactByIdRequest = buildBodyParams();
            ApiResponse<ContactAttributes> localVarResp = updateContactByIdWithHttpInfo(id, contactUpdateContactByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateContactById request with HTTP info returned
         * @return ApiResponse&lt;ContactAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ContactAttributes> executeWithHttpInfo() throws ApiException {
            ContactUpdateContactByIdRequest contactUpdateContactByIdRequest = buildBodyParams();
            return updateContactByIdWithHttpInfo(id, contactUpdateContactByIdRequest);
        }

        /**
         * Execute updateContactById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ContactAttributes> _callback) throws ApiException {
            ContactUpdateContactByIdRequest contactUpdateContactByIdRequest = buildBodyParams();
            return updateContactByIdAsync(id, contactUpdateContactByIdRequest, _callback);
        }
    }
     ...
     * Update a contact
     * @param id  (required)
     * @param contactUpdateContactByIdRequest Information about updated fields in Contact (required)
     * @return UpdateContactByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpdateContactByIdRequestBuilder updateContactById(String id) throws IllegalArgumentException {
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
            

        return new UpdateContactByIdRequestBuilder(id);
    }
    private okhttp3.Call upsertCall(String workspaceId, ContactUpsertRequest contactUpsertRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = contactUpsertRequest;

        // create path and map variables
        String localVarPath = "/workspaces/{workspace_id}/contacts/upsert"
            .replace("{" + "workspace_id" + "}", localVarApiClient.escapeString(workspaceId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertValidateBeforeCall(String workspaceId, ContactUpsertRequest contactUpsertRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspaceId' is set
        if (workspaceId == null) {
            throw new ApiException("Missing the required parameter 'workspaceId' when calling upsert(Async)");
        }

        // verify the required parameter 'contactUpsertRequest' is set
        if (contactUpsertRequest == null) {
            throw new ApiException("Missing the required parameter 'contactUpsertRequest' when calling upsert(Async)");
        }

        return upsertCall(workspaceId, contactUpsertRequest, _callback);

    }


    private ApiResponse<List<ContactAttributes>> upsertWithHttpInfo(String workspaceId, ContactUpsertRequest contactUpsertRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertValidateBeforeCall(workspaceId, contactUpsertRequest, null);
        Type localVarReturnType = new TypeToken<List<ContactAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call upsertAsync(String workspaceId, ContactUpsertRequest contactUpsertRequest, final ApiCallback<List<ContactAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertValidateBeforeCall(workspaceId, contactUpsertRequest, _callback);
        Type localVarReturnType = new TypeToken<List<ContactAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpsertRequestBuilder {
        ...
        private ContactsProperty contact;

        private UpsertRequestBuilder(String workspaceId) {
            this.workspaceId = workspaceId;
        }
         ...
         */
        public UpsertRequestBuilder contact(ContactsProperty contact) {
            this.contact = contact;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            ContactUpsertRequest contactUpsertRequest = buildBodyParams();
            return upsertCall(workspaceId, contactUpsertRequest, _callback);
        }

        private ContactUpsertRequest buildBodyParams() {
            ContactUpsertRequest contactUpsertRequest = new ContactUpsertRequest();
            contactUpsertRequest.contact(this.contact);
        ...
        public List<ContactAttributes> execute() throws ApiException {
            ContactUpsertRequest contactUpsertRequest = buildBodyParams();
            ApiResponse<List<ContactAttributes>> localVarResp = upsertWithHttpInfo(workspaceId, contactUpsertRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute upsert request with HTTP info returned
         * @return ApiResponse&lt;List&lt;ContactAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<List<ContactAttributes>> executeWithHttpInfo() throws ApiException {
            ContactUpsertRequest contactUpsertRequest = buildBodyParams();
            return upsertWithHttpInfo(workspaceId, contactUpsertRequest);
        }

        /**
         * Execute upsert request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<ContactAttributes>> _callback) throws ApiException {
            ContactUpsertRequest contactUpsertRequest = buildBodyParams();
            return upsertAsync(workspaceId, contactUpsertRequest, _callback);
        }
    }
     ...
     * @param workspaceId  (required)
     * @param contactUpsertRequest Contact to create or update, matching on the email address. Note that properties of a Contact are not reset when passed empty values, e.g. passing &#x60;null&#x60; for &#x60;first_name&#x60; or an empty array for &#x60;tag_ids&#x60; won&#39;t update previous values. To do that you would instead use the &#x60;Update Contact&#x60; endpoint. (required)
     * @return UpsertRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpsertRequestBuilder upsert(String workspaceId) throws IllegalArgumentException {
        if (workspaceId == null) throw new IllegalArgumentException("\"workspaceId\" is required but got null");
            

        return new UpsertRequestBuilder(workspaceId);
    }
}
