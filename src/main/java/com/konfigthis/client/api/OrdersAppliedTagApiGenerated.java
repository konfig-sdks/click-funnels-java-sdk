...
import com.konfigthis.client.model.OrdersAppliedTagAttributes;
import com.konfigthis.client.model.OrdersAppliedTagCreateAppliedTagRequest;
...
public class OrdersAppliedTagApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public OrdersAppliedTagApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OrdersAppliedTagApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createAppliedTagCall(Integer orderId, OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = ordersAppliedTagCreateAppliedTagRequest;

        // create path and map variables
        String localVarPath = "/orders/{order_id}/applied_tags"
    ...
    private okhttp3.Call createAppliedTagValidateBeforeCall(Integer orderId, OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException("Missing the required parameter 'orderId' when calling createAppliedTag(Async)");
        }

        // verify the required parameter 'ordersAppliedTagCreateAppliedTagRequest' is set
        if (ordersAppliedTagCreateAppliedTagRequest == null) {
            throw new ApiException("Missing the required parameter 'ordersAppliedTagCreateAppliedTagRequest' when calling createAppliedTag(Async)");
        }

        return createAppliedTagCall(orderId, ordersAppliedTagCreateAppliedTagRequest, _callback);

    }


    private ApiResponse<OrdersAppliedTagAttributes> createAppliedTagWithHttpInfo(Integer orderId, OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createAppliedTagValidateBeforeCall(orderId, ordersAppliedTagCreateAppliedTagRequest, null);
        Type localVarReturnType = new TypeToken<OrdersAppliedTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createAppliedTagAsync(Integer orderId, OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest, final ApiCallback<OrdersAppliedTagAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAppliedTagValidateBeforeCall(orderId, ordersAppliedTagCreateAppliedTagRequest, _callback);
        Type localVarReturnType = new TypeToken<OrdersAppliedTagAttributes>(){}.getType();
    ...
    public class CreateAppliedTagRequestBuilder {
        ...
        private OrdersAppliedTagParameters ordersAppliedTag;

        private CreateAppliedTagRequestBuilder(Integer orderId) {
            this.orderId = orderId;
        }

        /**
         * Set ordersAppliedTag
         * @param ordersAppliedTag  (optional)
         * @return CreateAppliedTagRequestBuilder
         */
        public CreateAppliedTagRequestBuilder ordersAppliedTag(OrdersAppliedTagParameters ordersAppliedTag) {
            this.ordersAppliedTag = ordersAppliedTag;
            return this;
        }
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest = buildBodyParams();
            return createAppliedTagCall(orderId, ordersAppliedTagCreateAppliedTagRequest, _callback);
        }

        private OrdersAppliedTagCreateAppliedTagRequest buildBodyParams() {
            OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest = new OrdersAppliedTagCreateAppliedTagRequest();
            ordersAppliedTagCreateAppliedTagRequest.ordersAppliedTag(this.ordersAppliedTag);
            return ordersAppliedTagCreateAppliedTagRequest;
        }

        /**
         * Execute createAppliedTag request
         * @return OrdersAppliedTagAttributes
         ...
         */
        public OrdersAppliedTagAttributes execute() throws ApiException {
            OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest = buildBodyParams();
            ApiResponse<OrdersAppliedTagAttributes> localVarResp = createAppliedTagWithHttpInfo(orderId, ordersAppliedTagCreateAppliedTagRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createAppliedTag request with HTTP info returned
         * @return ApiResponse&lt;OrdersAppliedTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrdersAppliedTagAttributes> executeWithHttpInfo() throws ApiException {
            OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest = buildBodyParams();
            return createAppliedTagWithHttpInfo(orderId, ordersAppliedTagCreateAppliedTagRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrdersAppliedTagAttributes> _callback) throws ApiException {
            OrdersAppliedTagCreateAppliedTagRequest ordersAppliedTagCreateAppliedTagRequest = buildBodyParams();
            return createAppliedTagAsync(orderId, ordersAppliedTagCreateAppliedTagRequest, _callback);
        }
    }
     ...
     * @param ordersAppliedTagCreateAppliedTagRequest Information about a new Applied Tag (required)
     * @return CreateAppliedTagRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CreateAppliedTagRequestBuilder createAppliedTag(Integer orderId) throws IllegalArgumentException {
        if (orderId == null) throw new IllegalArgumentException("\"orderId\" is required but got null");
        return new CreateAppliedTagRequestBuilder(orderId);
    }
    private okhttp3.Call getCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/orders/applied_tags/{id}"
    ...
    private ApiResponse<OrdersAppliedTagAttributes> getWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OrdersAppliedTagAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(String id, final ApiCallback<OrdersAppliedTagAttributes> _callback) throws ApiException {
    ...
    public class GetRequestBuilder {
         ...
         */
        public OrdersAppliedTagAttributes execute() throws ApiException {
            ApiResponse<OrdersAppliedTagAttributes> localVarResp = getWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private okhttp3.Call listCall(Integer orderId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer orderId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException("Missing the required parameter 'orderId' when calling list(Async)");
        }

        return listCall(orderId, after, sortOrder, _callback);

    }


    private ApiResponse<List<OrdersAppliedTagAttributes>> listWithHttpInfo(Integer orderId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(orderId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<OrdersAppliedTagAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer orderId, String after, String sortOrder, final ApiCallback<List<OrdersAppliedTagAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(orderId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<OrdersAppliedTagAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(Integer orderId) {
            this.orderId = orderId;
        }
         ...
         * @return List&lt;OrdersAppliedTagAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<OrdersAppliedTagAttributes> execute() throws ApiException {
            ApiResponse<List<OrdersAppliedTagAttributes>> localVarResp = listWithHttpInfo(orderId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;List&lt;OrdersAppliedTagAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<OrdersAppliedTagAttributes>> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(orderId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<OrdersAppliedTagAttributes>> _callback) throws ApiException {
            return listAsync(orderId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(Integer orderId) throws IllegalArgumentException {
        if (orderId == null) throw new IllegalArgumentException("\"orderId\" is required but got null");
        return new ListRequestBuilder(orderId);
    }
