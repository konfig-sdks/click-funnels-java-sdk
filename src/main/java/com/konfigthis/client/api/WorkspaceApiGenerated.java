...
import com.konfigthis.client.model.WorkspaceAddNewRequest;
import com.konfigthis.client.model.WorkspaceAttributes;
import com.konfigthis.client.model.WorkspaceUpdateRequest;
...
public class WorkspaceApiGenerated {
    ...
    private okhttp3.Call addNewCall(Integer teamId, WorkspaceAddNewRequest workspaceAddNewRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = workspaceAddNewRequest;

        // create path and map variables
        String localVarPath = "/teams/{team_id}/workspaces"
    ...
    private okhttp3.Call addNewValidateBeforeCall(Integer teamId, WorkspaceAddNewRequest workspaceAddNewRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamId' is set
        if (teamId == null) {
            throw new ApiException("Missing the required parameter 'teamId' when calling addNew(Async)");
        }

        // verify the required parameter 'workspaceAddNewRequest' is set
        if (workspaceAddNewRequest == null) {
            throw new ApiException("Missing the required parameter 'workspaceAddNewRequest' when calling addNew(Async)");
        }

        return addNewCall(teamId, workspaceAddNewRequest, _callback);

    }


    private ApiResponse<WorkspaceAttributes> addNewWithHttpInfo(Integer teamId, WorkspaceAddNewRequest workspaceAddNewRequest) throws ApiException {
        okhttp3.Call localVarCall = addNewValidateBeforeCall(teamId, workspaceAddNewRequest, null);
        Type localVarReturnType = new TypeToken<WorkspaceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call addNewAsync(Integer teamId, WorkspaceAddNewRequest workspaceAddNewRequest, final ApiCallback<WorkspaceAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = addNewValidateBeforeCall(teamId, workspaceAddNewRequest, _callback);
        Type localVarReturnType = new TypeToken<WorkspaceAttributes>(){}.getType();
    ...
    public class AddNewRequestBuilder {
        ...
        private WorkspaceParameters workspace;

        private AddNewRequestBuilder(Integer teamId) {
            this.teamId = teamId;
        }
         ...
         */
        public AddNewRequestBuilder workspace(WorkspaceParameters workspace) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            WorkspaceAddNewRequest workspaceAddNewRequest = buildBodyParams();
            return addNewCall(teamId, workspaceAddNewRequest, _callback);
        }

        private WorkspaceAddNewRequest buildBodyParams() {
            WorkspaceAddNewRequest workspaceAddNewRequest = new WorkspaceAddNewRequest();
            workspaceAddNewRequest.workspace(this.workspace);
            return workspaceAddNewRequest;
        }
         ...
         */
        public WorkspaceAttributes execute() throws ApiException {
            WorkspaceAddNewRequest workspaceAddNewRequest = buildBodyParams();
            ApiResponse<WorkspaceAttributes> localVarResp = addNewWithHttpInfo(teamId, workspaceAddNewRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute addNew request with HTTP info returned
         * @return ApiResponse&lt;WorkspaceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<WorkspaceAttributes> executeWithHttpInfo() throws ApiException {
            WorkspaceAddNewRequest workspaceAddNewRequest = buildBodyParams();
            return addNewWithHttpInfo(teamId, workspaceAddNewRequest);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WorkspaceAttributes> _callback) throws ApiException {
            WorkspaceAddNewRequest workspaceAddNewRequest = buildBodyParams();
            return addNewAsync(teamId, workspaceAddNewRequest, _callback);
        }
    }
     ...
     * @param workspaceAddNewRequest Information about a new Workspace (required)
     * @return AddNewRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AddNewRequestBuilder addNew(Integer teamId) throws IllegalArgumentException {
        if (teamId == null) throw new IllegalArgumentException("\"teamId\" is required but got null");
        return new AddNewRequestBuilder(teamId);
    }
    ...
    private ApiResponse<WorkspaceAttributes> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<WorkspaceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<WorkspaceAttributes> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public WorkspaceAttributes execute() throws ApiException {
            ApiResponse<WorkspaceAttributes> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }
    ...
    private okhttp3.Call listWorkspacesCall(Integer teamId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listWorkspacesValidateBeforeCall(Integer teamId, String after, String sortOrder, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'teamId' is set
        if (teamId == null) {
            throw new ApiException("Missing the required parameter 'teamId' when calling listWorkspaces(Async)");
        }

        return listWorkspacesCall(teamId, after, sortOrder, _callback);

    }


    private ApiResponse<List<WorkspaceAttributes>> listWorkspacesWithHttpInfo(Integer teamId, String after, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = listWorkspacesValidateBeforeCall(teamId, after, sortOrder, null);
        Type localVarReturnType = new TypeToken<List<WorkspaceAttributes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listWorkspacesAsync(Integer teamId, String after, String sortOrder, final ApiCallback<List<WorkspaceAttributes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listWorkspacesValidateBeforeCall(teamId, after, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<List<WorkspaceAttributes>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListWorkspacesRequestBuilder {
        ...
        private ListWorkspacesRequestBuilder(Integer teamId) {
            this.teamId = teamId;
        }
         ...
         * @return ListWorkspacesRequestBuilder
         */
        public ListWorkspacesRequestBuilder after(String after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListWorkspacesRequestBuilder
         */
        public ListWorkspacesRequestBuilder sortOrder(String sortOrder) {
         ...
         * @return List&lt;WorkspaceAttributes&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public List<WorkspaceAttributes> execute() throws ApiException {
            ApiResponse<List<WorkspaceAttributes>> localVarResp = listWorkspacesWithHttpInfo(teamId, after, sortOrder);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listWorkspaces request with HTTP info returned
         * @return ApiResponse&lt;List&lt;WorkspaceAttributes&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<WorkspaceAttributes>> executeWithHttpInfo() throws ApiException {
            return listWorkspacesWithHttpInfo(teamId, after, sortOrder);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<WorkspaceAttributes>> _callback) throws ApiException {
            return listWorkspacesAsync(teamId, after, sortOrder, _callback);
        }
    }
     ...
     */
    public ListWorkspacesRequestBuilder listWorkspaces(Integer teamId) throws IllegalArgumentException {
        if (teamId == null) throw new IllegalArgumentException("\"teamId\" is required but got null");
        return new ListWorkspacesRequestBuilder(teamId);
    }
    private okhttp3.Call updateCall(String id, WorkspaceUpdateRequest workspaceUpdateRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateValidateBeforeCall(String id, WorkspaceUpdateRequest workspaceUpdateRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        if (workspaceUpdateRequest == null) {
            throw new ApiException("Missing the required parameter 'workspaceUpdateRequest' when calling update(Async)");
        }

        return updateCall(id, workspaceUpdateRequest, _callback);

    }


    private ApiResponse<WorkspaceAttributes> updateWithHttpInfo(String id, WorkspaceUpdateRequest workspaceUpdateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateValidateBeforeCall(id, workspaceUpdateRequest, null);
        Type localVarReturnType = new TypeToken<WorkspaceAttributes>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateAsync(String id, WorkspaceUpdateRequest workspaceUpdateRequest, final ApiCallback<WorkspaceAttributes> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateValidateBeforeCall(id, workspaceUpdateRequest, _callback);
        Type localVarReturnType = new TypeToken<WorkspaceAttributes>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateRequestBuilder {
         ...
         */
        public UpdateRequestBuilder workspace(WorkspaceParameters workspace) {
            this.workspace = workspace;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            WorkspaceUpdateRequest workspaceUpdateRequest = buildBodyParams();
            return updateCall(id, workspaceUpdateRequest, _callback);
        }

        private WorkspaceUpdateRequest buildBodyParams() {
            WorkspaceUpdateRequest workspaceUpdateRequest = new WorkspaceUpdateRequest();
            workspaceUpdateRequest.workspace(this.workspace);
        ...
        public WorkspaceAttributes execute() throws ApiException {
            WorkspaceUpdateRequest workspaceUpdateRequest = buildBodyParams();
            ApiResponse<WorkspaceAttributes> localVarResp = updateWithHttpInfo(id, workspaceUpdateRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<WorkspaceAttributes> executeWithHttpInfo() throws ApiException {
            WorkspaceUpdateRequest workspaceUpdateRequest = buildBodyParams();
            return updateWithHttpInfo(id, workspaceUpdateRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<WorkspaceAttributes> _callback) throws ApiException {
            WorkspaceUpdateRequest workspaceUpdateRequest = buildBodyParams();
            return updateAsync(id, workspaceUpdateRequest, _callback);
        }
    }
     ...
     * Update a workspace
     * @param id  (required)
     * @param workspaceUpdateRequest Information about updated fields in Workspace (required)
     * @return UpdateRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
