...
public class ContactApiTest {
    ...
    public void createNewContactTest() throws ApiException {
        ...
        ContactParameters contact = null;
        ContactAttributes response = api.createNewContact(workspaceId)
                .contact(contact)
                .execute();
    ...
    public void getContactByIdTest() throws ApiException {
        String id = null;
        ContactAttributes response = api.getContactById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void listForWorkspaceTest() throws ApiException {
        ...
        ContactListForWorkspaceFilterParameter filter = null;
        List<ContactAttributes> response = api.listForWorkspace(workspaceId)
                .after(after)
                .sortOrder(sortOrder)
                .filter(filter)
                .execute();
     ...
     */
    @Test
    public void redactPersonallyIdentifiableTest() throws ApiException {
        String id = null;
        api.redactPersonallyIdentifiable(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateContactByIdTest() throws ApiException {
        String id = null;
        ContactParameters contact = null;
        ContactAttributes response = api.updateContactById(id)
                .contact(contact)
                .execute();
        // TODO: test validations
    }
    ...
    public void upsertTest() throws ApiException {
        ...
        ContactsProperty contact = null;
        List<ContactAttributes> response = api.upsert(workspaceId)
                .contact(contact)
                .execute();
        // TODO: test validations
    }
