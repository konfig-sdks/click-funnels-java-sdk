...
public class ProductApiTest {
     ...
     */
    @Test
    public void addNewToWorkspaceTest() throws ApiException {
        Integer workspaceId = null;
        ProductParameters product = null;
        ProductAttributes response = api.addNewToWorkspace(workspaceId)
                .product(product)
                .execute();
    ...
    public void archiveProductTest() throws ApiException {
        String id = null;
        ProductAttributes response = api.archiveProduct(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getForWorkspaceTest() throws ApiException {
        String id = null;
        ProductAttributes response = api.getForWorkspace(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void listForWorkspaceTest() throws ApiException {
        ...
        List<ProductAttributes> response = api.listForWorkspace(workspaceId)
                .after(after)
                .sortOrder(sortOrder)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void unarchiveByIdTest() throws ApiException {
        String id = null;
        ProductAttributes response = api.unarchiveById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateForWorkspaceTest() throws ApiException {
        String id = null;
        ProductParameters product = null;
        ProductAttributes response = api.updateForWorkspace(id)
                .product(product)
                .execute();
        // TODO: test validations
    }
