...
|------------- | ------------- | -------------|
| [**getRestock**](OrdersInvoicesRestockApi.md#getRestock) | **GET** /orders/invoices/restocks/{id} | Fetch Restock |
| [**listRestocks**](OrdersInvoicesRestockApi.md#listRestocks) | **GET** /workspaces/{workspace_id}/orders/invoices/restocks | List Restocks |


<a name="getRestock"></a>
# **getRestock**
> OrdersInvoicesRestockGetRestockResponse getRestock(id).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OrdersInvoicesRestockGetRestockResponse result = client
              .ordersInvoicesRestock
              .getRestock(id)
              .execute();
      ...
      System.err.println("Exception when calling OrdersInvoicesRestockApi#getRestock");
    ...
    try {
      ApiResponse<OrdersInvoicesRestockGetRestockResponse> response = client
              .ordersInvoicesRestock
              .getRestock(id)
              .executeWithHttpInfo();
...
[**OrdersInvoicesRestockGetRestockResponse**](OrdersInvoicesRestockGetRestockResponse.md)
...
<a name="listRestocks"></a>
# **listRestocks**
> List&lt;Restocks&gt; listRestocks(workspaceId).after(after).sortOrder(sortOrder).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Restocks> result = client
              .ordersInvoicesRestock
              .listRestocks(workspaceId)
              .after(after)
              .sortOrder(sortOrder)
              .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrdersInvoicesRestockApi#listRestocks");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<List<Restocks>> response = client
              .ordersInvoicesRestock
              .listRestocks(workspaceId)
              .after(after)
              .sortOrder(sortOrder)
